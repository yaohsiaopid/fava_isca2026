/******************************
  Program "past_builds/VI_build/s1_gmsg_cnt/out/in_GetMsg_cnt.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_build/s1_gmsg_cnt/out/in_GetMsg_cnt"
...
bool mu__boolexpr14;
  ...
  mu__boolexpr13 = ((mu_gBuf.mu_mtype) == (mu_GetMsg)) ; 
}
if ( mu__boolexpr13 )
{
mu_cnt = (mu_cnt) + (1);
...
bool mu__boolexpr16;
  ...
  mu__boolexpr15 = ((mu_gBuf.mu_mtype) == (mu_GetMsg)) ; 
}
if ( mu__boolexpr15 )
{
mu_cnt = (mu_cnt) + (1);
...
/********************
  Invariant records
 ********************/
int mu__invariant_29() // Invariant "core_recv_GetMsg_cnt"
{
return (mu_cnt) <= (1);
};

bool mu__condition_30() // Condition for Rule "core_recv_GetMsg_cnt"
{
...
{"core_recv_GetMsg_cnt", &mu__condition_30, NULL, },
};
