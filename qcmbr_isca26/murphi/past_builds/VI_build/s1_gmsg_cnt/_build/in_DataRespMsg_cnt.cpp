/******************************
  Program "past_builds/VI_build/s1_gmsg_cnt/out/in_DataRespMsg_cnt.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_build/s1_gmsg_cnt/out/in_DataRespMsg_cnt"
...
/********************
  Invariant records
 ********************/
int mu__invariant_29() // Invariant "core_recv_DataRespMsg_cnt"
{
return (mu_cnt) <= (1);
};

bool mu__condition_30() // Condition for Rule "core_recv_DataRespMsg_cnt"
{
...
{"core_recv_DataRespMsg_cnt", &mu__condition_30, NULL, },
};
