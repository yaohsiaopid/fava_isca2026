/******************************
  Program "past_builds/VI_build/s1_gmsg_cnt/out/PutMsg_cnt.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_build/s1_gmsg_cnt/out/PutMsg_cnt"
...
bool mu__boolexpr9;
  ...
  mu__boolexpr8 = ((mu_gBuf.mu_mtype) == (mu_PutMsg)) ; 
}
if ( mu__boolexpr8 )
{
mu_cnt = (mu_cnt) + (1);
...
bool mu__boolexpr11;
  ...
  mu__boolexpr10 = ((mu_msg.mu_mtype) == (mu_PutMsg)) ; 
}
if ( mu__boolexpr10 )
{
mu_cnt = (mu_cnt) + (1);
...
/********************
  Invariant records
 ********************/
int mu__invariant_29() // Invariant "core_sent_PutMsg_cnt"
{
return (mu_cnt) <= (1);
};

bool mu__condition_30() // Condition for Rule "core_sent_PutMsg_cnt"
{
...
{"core_sent_PutMsg_cnt", &mu__condition_30, NULL, },
};
