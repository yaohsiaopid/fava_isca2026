/******************************
  Program "build/core_s2_req_acc_state_prime/out/P_V_GetMsg_P_I.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "build/core_s2_req_acc_state_prime/out/P_V_GetMsg_P_I"
...
/********************
  Invariant records
 ********************/
int mu__invariant_27() // Invariant "P_V_rec_GetMsg"
{
bool mu__boolexpr28;
bool mu__boolexpr29;
bool mu__boolexpr30;
...
bool mu__boolexpr36;
  ...
  mu__boolexpr28 = (!((mu_Procs[mu_selc].mu_state) == (mu_P_I))) ; 
}
