/******************************
  Program "build/home_s2_msg_out/out/H_V_PutMsg_msg_assert.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "build/home_s2_msg_out/out/H_V_PutMsg_msg_assert"
...
/*** Variable declaration ***/
mu_1__type_2 mu_prevSentMsgSet("prevSentMsgSet",24);
...
/*** Variable declaration ***/
mu_1__type_4 mu_ackBus("ackBus",168);

/*** Variable declaration ***/
mu_1__type_5 mu_msgBuf("msgBuf",200);

/*** Variable declaration ***/
mu_0_boolean mu_msgBufNonEmpty("msgBufNonEmpty",328);

/*** Variable declaration ***/
mu_1__type_6 mu_curRequsts("curRequsts",336);
...
mu_prevSentMsgSet[mu_m] = mu_false;
};
};
...
if ( mu__boolexpr7 )
{
mu_prevSentMsgSet[mu_gBuf.mu_mtype] = mu_true;
}
};
/*** end procedure declaration ***/
...
bool mu__boolexpr8;
  if (!(!(mu_cur_node.isundefined()))) mu__boolexpr8 = FALSE ;
  else {
  mu__boolexpr8 = ((mu_cur_node) == (mu_selh)) ; 
}
if ( mu__boolexpr8 )
{
mu_prevSentMsgSet[mu_msg.mu_mtype] = mu_true;
}
};
/*** end procedure declaration ***/
...
bool mu__boolexpr9;
bool mu__boolexpr10;
  if (!(!(mu_curRequsts[mu_p].mu_vld.isundefined()))) mu__boolexpr10 = FALSE ;
  else {
  mu__boolexpr10 = (mu_curRequsts[mu_p].mu_vld) ; 
}
  if (!(mu__boolexpr10)) mu__boolexpr9 = FALSE ;
  else {
  mu__boolexpr9 = ((mu_curRequsts[mu_p].mu_tp) == (mu_store)) ; 
}
if ( mu__boolexpr9 )
{
...
void world_class::print_statistic()
{
  ...
  mu_prevSentMsgSet.print_statistic();
...
void world_class::print_diff( state *prevstate )
{
  if ( prevstate != NULL )
  {
    ...
    mu_prevSentMsgSet.print_diff(prevstate);
...
void world_class::to_state(state *newstate)
{
  ...
  mu_prevSentMsgSet.to_state( newstate );
...
for(int mu_n = 1; mu_n <= 6; mu_n++)
  if (( ( mu_n >= 1 ) && ( mu_n <= 3 ) )|| ( ( mu_n >= 6 ) && ( mu_n <= 6 ) )) {
bool mu__boolexpr11;
  if (!(mu_allAck)) mu__boolexpr11 = FALSE ;
  else {
  mu__boolexpr11 = (mu_ackBus[mu_n]) ; 
}
mu_allAck = mu__boolexpr11;
};
};
if ( mu_allAck )
{
...
public:
  ...
  bool Condition(unsigned r)
  {
    ...
    r = r / 4;
bool mu__boolexpr12;
  if (!(!(mu_gBuf.mu_src.isundefined()))) mu__boolexpr12 = FALSE ;
  else {
  mu__boolexpr12 = (!(mu_ackBus[mu_n])) ; 
}
  ...
  void NextRule(unsigned & what_rule)
  {
	...
	if ( ( TRUE  ) ) {
bool mu__boolexpr13;
  if (!(!(mu_gBuf.mu_src.isundefined()))) mu__boolexpr13 = FALSE ;
  else {
  mu__boolexpr13 = (!(mu_ackBus[mu_n])) ; 
}
	      if (mu__boolexpr13) {
		if ( ( TRUE  ) )
		  return;
...
bool mu__boolexpr14;
  ...
  mu__boolexpr14 = ((mu_cur_node) == (mu_selh)) ; 
}
if ( mu__boolexpr14 )
{
...
{
bool mu__boolexpr15;
  if (!(!(mu_cur_node.isundefined()))) mu__boolexpr15 = FALSE ;
  else {
  mu__boolexpr15 = ((mu_cur_node) == (mu_selh)) ; 
}
if ( mu__boolexpr15 )
{
if (mu_gBuf.mu_mtype.isundefined())
...
bool mu__boolexpr16;
bool mu__boolexpr17;
  if (!((mu_p.mu_state) == (mu_P_V))) mu__boolexpr17 = FALSE ;
  else {
  mu__boolexpr17 = (!(mu_msgBufNonEmpty)) ; 
}
  if (!(mu__boolexpr17)) mu__boolexpr16 = FALSE ;
  else {
  mu__boolexpr16 = (mu_gBuf.mu_src.isundefined()) ; 
}
...
bool mu__boolexpr18;
bool mu__boolexpr19;
  if (!((mu_p.mu_state) == (mu_P_V))) mu__boolexpr19 = FALSE ;
  else {
  mu__boolexpr19 = (!(mu_msgBufNonEmpty)) ; 
}
  if (!(mu__boolexpr19)) mu__boolexpr18 = FALSE ;
  else {
  mu__boolexpr18 = (mu_gBuf.mu_src.isundefined()) ; 
}
	      if (mu__boolexpr18) {
		if ( ( TRUE  ) )
		  return;
...
bool mu__boolexpr20;
bool mu__boolexpr21;
  if (!((mu_p.mu_state) == (mu_P_I))) mu__boolexpr21 = FALSE ;
  else {
  mu__boolexpr21 = (!(mu_msgBufNonEmpty)) ; 
}
  if (!(mu__boolexpr21)) mu__boolexpr20 = FALSE ;
  else {
  mu__boolexpr20 = (mu_gBuf.mu_src.isundefined()) ; 
}
...
bool mu__boolexpr22;
bool mu__boolexpr23;
  if (!((mu_p.mu_state) == (mu_P_I))) mu__boolexpr23 = FALSE ;
  else {
  mu__boolexpr23 = (!(mu_msgBufNonEmpty)) ; 
}
  if (!(mu__boolexpr23)) mu__boolexpr22 = FALSE ;
  else {
  mu__boolexpr22 = (mu_gBuf.mu_src.isundefined()) ; 
}
	      if (mu__boolexpr22) {
		if ( ( TRUE  ) )
		  return;
...
bool mu__boolexpr24;
bool mu__boolexpr25;
  if (!((mu_p.mu_state) == (mu_P_I))) mu__boolexpr25 = FALSE ;
  else {
  mu__boolexpr25 = (!(mu_msgBufNonEmpty)) ; 
}
  if (!(mu__boolexpr25)) mu__boolexpr24 = FALSE ;
  else {
  mu__boolexpr24 = (mu_gBuf.mu_src.isundefined()) ; 
}
...
bool mu__boolexpr26;
bool mu__boolexpr27;
  if (!((mu_p.mu_state) == (mu_P_I))) mu__boolexpr27 = FALSE ;
  else {
  mu__boolexpr27 = (!(mu_msgBufNonEmpty)) ; 
}
  if (!(mu__boolexpr27)) mu__boolexpr26 = FALSE ;
  else {
  mu__boolexpr26 = (mu_gBuf.mu_src.isundefined()) ; 
}
	      if (mu__boolexpr26) {
		if ( ( TRUE  ) )
		  return;
...
/********************
  Invariant records
 ********************/
int mu__invariant_28() // Invariant "ASSERT_H_V_accept_req_PutMsg"
{
bool mu__boolexpr29;
bool mu__boolexpr30;
bool mu__boolexpr31;
bool mu__boolexpr32;
  if (!(!(mu_prevHomeNode.isundefined()))) mu__boolexpr32 = FALSE ;
  else {
  mu__boolexpr32 = ((mu_prevHomeNode) == (mu_H_V)) ; 
}
  if (!(mu__boolexpr32)) mu__boolexpr31 = FALSE ;
  else {
  mu__boolexpr31 = (!(mu_prevRecProcMsg.isundefined())) ; 
}
  if (!(mu__boolexpr31)) mu__boolexpr30 = FALSE ;
  else {
  mu__boolexpr30 = ((mu_prevRecProcMsg) == (mu_PutMsg)) ; 
}
  if (!(mu__boolexpr30)) mu__boolexpr29 = TRUE ;
  else {
bool mu__boolexpr33;
bool mu__boolexpr34;
  if (!((mu_prevSentMsgSet[mu_GetMsg]) == (mu_false))) mu__boolexpr34 = FALSE ;
  else {
  mu__boolexpr34 = ((mu_prevSentMsgSet[mu_PutMsg]) == (mu_false)) ; 
}
  if (!(mu__boolexpr34)) mu__boolexpr33 = FALSE ;
  else {
  mu__boolexpr33 = ((mu_prevSentMsgSet[mu_DataRespMsg]) == (mu_false)) ; 
}
  mu__boolexpr29 = (mu__boolexpr33) ; 
}
return mu__boolexpr29;
};

bool mu__condition_35() // Condition for Rule "ASSERT_H_V_accept_req_PutMsg"
{
...
int mu__invariant_36() // Invariant "swmr"
{
bool mu__quant37; 
mu__quant37 = TRUE;
{
...
bool mu__boolexpr39;
bool mu__boolexpr40;
  if (!((mu_c1) != (mu_c2))) mu__boolexpr40 = FALSE ;
  else {
  mu__boolexpr40 = ((mu_Procs[mu_c1].mu_state) == (mu_P_V)) ; 
}
  if (!(mu__boolexpr40)) mu__boolexpr39 = TRUE ;
  else {
  mu__boolexpr39 = ((mu_Procs[mu_c2].mu_state) != (mu_P_V)) ; 
}
if ( !(mu__boolexpr39) )
...
bool mu__condition_41() // Condition for Rule "swmr"
{
...
int mu__invariant_42() // Invariant "values in valid state match last write"
{
bool mu__quant43; 
mu__quant43 = TRUE;
{
...
bool mu__boolexpr44;
  if (!((mu_Procs[mu_n].mu_state) == (mu_P_V))) mu__boolexpr44 = TRUE ;
  else {
  mu__boolexpr44 = ((mu_Procs[mu_n].mu_val) == (mu_LastWrite)) ; 
}
if ( !(mu__boolexpr44) )
...
bool mu__condition_45() // Condition for Rule "values in valid state match last write"
{
...
int mu__invariant_46() // Invariant "value in memory matches value of last write, when invalid"
{
bool mu__boolexpr47;
  if (!((mu_HomeNode.mu_state) == (mu_H_I))) mu__boolexpr47 = TRUE ;
  else {
  mu__boolexpr47 = ((mu_MainMemory) == (mu_LastWrite)) ; 
}
return mu__boolexpr47;
};

bool mu__condition_48() // Condition for Rule "value in memory matches value of last write, when invalid"
{
...
int mu__invariant_49() // Invariant "Invalid implies empty owner"
{
bool mu__boolexpr50;
...
if ( !(!((mu_Procs[mu_n].mu_state) == (mu_P_V))) )
  ...
  mu__boolexpr50 = (mu__quant51) ; 
}
return mu__boolexpr50;
};

bool mu__condition_52() // Condition for Rule "Invalid implies empty owner"
{
...
{"Invalid implies empty owner", &mu__condition_52, NULL, },
{"value in memory matches value of last write, when invalid", &mu__condition_48, NULL, },
{"values in valid state match last write", &mu__condition_45, NULL, },
{"swmr", &mu__condition_41, NULL, },
{"ASSERT_H_V_accept_req_PutMsg", &mu__condition_35, NULL, },
};
...
void SymmetryClass::MultisetSort(state* s)
{
        ...
        mu_prevSentMsgSet.MultisetSort();
  ...
  if (args->symmetry_reduction.value)
    {
      if (  args->sym_alg.mode == argsym_alg::Exhaustive_Fast_Canonicalize
          ...
          if (Perm.In(i))
            {
              ...
              if (args->multiset_reduction.value)
                mu_selh.MultisetSort();
              mu_prevSentMsgSet.Permute(Perm,i);
              if (args->multiset_reduction.value)
                mu_prevSentMsgSet.MultisetSort();
        ...
        if (ns != workingstate)
          ...
          if (args->multiset_reduction.value)
            mu_selh.MultisetSort();
          mu_prevSentMsgSet.Permute(Perm,0);
          if (args->multiset_reduction.value)
            mu_prevSentMsgSet.MultisetSort();
