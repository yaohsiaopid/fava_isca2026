/******************************
  Program "past_builds/VI_build/global_chk/out/P_V_imply_cover_H_V.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_build/global_chk/out/P_V_imply_cover_H_V"
...
/********************
  Invariant records
 ********************/
int mu__invariant_23() // Invariant "P_V_imply_H_V"
{
bool mu__quant24; 
mu__quant24 = TRUE;
{
...
if ( !(mu__boolexpr31) )
  ...
  mu__boolexpr26 = ((mu_Procs[mu_n].mu_state) == (mu_P_V)) ; 
}
...
if ( !((mu_HomeNode.mu_state) == (mu_H_V)) )
...
bool mu__condition_33() // Condition for Rule "P_V_imply_H_V"
{
...
{"P_V_imply_H_V", &mu__condition_33, NULL, },
};
