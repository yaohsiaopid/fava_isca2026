/******************************
  Program "past_builds/VI_build/s4_constrained/out/P_I_ci_store_0_3.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_build/s4_constrained/out/P_I_ci_store_0_3"
...
class mu__subrange_19: public mu__byte
{
 public:
  ...
  mu__subrange_19 (const char *name, int os): mu__byte(0, 1, 2, name, os) {};
  mu__subrange_19 (void): mu__byte(0, 1, 2) {};
  mu__subrange_19 (int val): mu__byte(0, 1, 2, "Parameter or function result.", 0)
  {
    operator=(val);
  };
  char * Name() { return tsprintf("%d",value()); };
...
/*** Variable declaration ***/
mu_0_boolean mu_tracked("tracked",32);

/*** Variable declaration ***/
mu_0_boolean mu_start("start",40);

/*** Variable declaration ***/
mu_1__type_3 mu_cur_idx("cur_idx",48);

/*** Variable declaration ***/
mu_1__type_4 mu_tar("tar",56);
...
bool mu__boolexpr11;
bool mu__boolexpr12;
  if (!((mu_msg_imm_sent_set[mu_GetMsg]) == (mu_true))) mu__boolexpr12 = FALSE ;
  else {
  mu__boolexpr12 = ((mu_msg_imm_sent_set[mu_PutMsg]) == (mu_true)) ; 
}
...
bool mu__boolexpr13;
bool mu__boolexpr14;
  if (!((mu_msg_imm_sent_set[mu_GetMsg]) == (mu_true))) mu__boolexpr14 = FALSE ;
  else {
  mu__boolexpr14 = ((mu_msg_imm_sent_set[mu_PutMsg]) == (mu_false)) ; 
}
  if (!(mu__boolexpr14)) mu__boolexpr13 = FALSE ;
  else {
  mu__boolexpr13 = ((mu_msg_imm_sent_set[mu_DataRespMsg]) == (mu_true)) ; 
}
if ( mu__boolexpr13 )
{
mu_match = (mu_match) + (1);
...
{
bool mu__boolexpr15;
  if (!((mu_cur_idx) < (2))) mu__boolexpr15 = FALSE ;
  else {
  mu__boolexpr15 = ((mu_cur_state) == (mu_tar[mu_cur_idx])) ; 
}
if ( mu__boolexpr15 )
{
...
bool mu__boolexpr16;
bool mu__boolexpr17;
  if (!(!(mu_curRequsts[mu_p].mu_vld.isundefined()))) mu__boolexpr17 = FALSE ;
  else {
  mu__boolexpr17 = (mu_curRequsts[mu_p].mu_vld) ; 
}
  if (!(mu__boolexpr17)) mu__boolexpr16 = FALSE ;
  else {
  mu__boolexpr16 = ((mu_curRequsts[mu_p].mu_tp) == (mu_store)) ; 
}
if ( mu__boolexpr16 )
{
...
bool mu__boolexpr20;
bool mu__boolexpr21;
  if (!(!(mu_tracked))) mu__boolexpr21 = FALSE ;
  else {
  mu__boolexpr21 = (!(mu_prevProcs.isundefined())) ; 
}
  if (!(mu__boolexpr21)) mu__boolexpr20 = FALSE ;
  else {
  mu__boolexpr20 = ((mu_prevProcs) == (mu_P_I)) ; 
}
  if (!(mu__boolexpr20)) mu__boolexpr19 = FALSE ;
  else {
  mu__boolexpr19 = (!(mu_prevProcReq.mu_tp.isundefined())) ; 
}
  if (!(mu__boolexpr19)) mu__boolexpr18 = FALSE ;
  else {
  mu__boolexpr18 = ((mu_prevProcReq.mu_tp) == (mu_ci_store)) ; 
}
...
for(int mu_n = 1; mu_n <= 6; mu_n++)
  if (( ( mu_n >= 1 ) && ( mu_n <= 3 ) )|| ( ( mu_n >= 6 ) && ( mu_n <= 6 ) )) {
bool mu__boolexpr26;
  if (!(mu_allAck)) mu__boolexpr26 = FALSE ;
  else {
  mu__boolexpr26 = (mu_ackBus[mu_n]) ; 
}
mu_allAck = mu__boolexpr26;
};
};
if ( mu_allAck )
{
...
public:
  ...
  bool Condition(unsigned r)
  {
    ...
    r = r / 4;
bool mu__boolexpr27;
  if (!(!(mu_gBuf.mu_src.isundefined()))) mu__boolexpr27 = FALSE ;
  else {
...
bool mu__boolexpr29;
bool mu__boolexpr30;
  if (!(mu_start)) mu__boolexpr30 = FALSE ;
  else {
  mu__boolexpr30 = (!(mu_cur_node.isundefined())) ; 
}
  if (!(mu__boolexpr30)) mu__boolexpr29 = FALSE ;
  else {
  mu__boolexpr29 = ((mu_cur_node) == (mu_selc)) ; 
}
if ( mu__boolexpr29 )
{
...
bool mu__boolexpr35;
bool mu__boolexpr36;
  if (!((mu_p.mu_state) == (mu_P_V))) mu__boolexpr36 = FALSE ;
  else {
...
bool mu__boolexpr43;
bool mu__boolexpr44;
  if (!((mu_p.mu_state) == (mu_P_I))) mu__boolexpr44 = FALSE ;
  else {
  mu__boolexpr44 = (!(mu_msgBufNonEmpty)) ; 
}
  if (!(mu__boolexpr44)) mu__boolexpr43 = FALSE ;
  else {
  mu__boolexpr43 = (mu_gBuf.mu_src.isundefined()) ; 
}
	      if (mu__boolexpr43) {
		if ( ( TRUE  ) )
		  return;
...
/********************
  Invariant records
 ********************/
int mu__invariant_45() // Invariant "P_I_ci_store_rset_0"
{
bool mu__boolexpr46;
bool mu__boolexpr47;
bool mu__boolexpr48;
  if (!(mu_tracked)) mu__boolexpr48 = FALSE ;
  else {
  mu__boolexpr48 = (!(mu_start)) ; 
}
  if (!(mu__boolexpr48)) mu__boolexpr47 = FALSE ;
  else {
  mu__boolexpr47 = ((mu_cur_idx) == (2)) ; 
}
  if (!(mu__boolexpr47)) mu__boolexpr46 = TRUE ;
  else {
  mu__boolexpr46 = ((mu_match) != (2)) ; 
}
return mu__boolexpr46;
};

bool mu__condition_49() // Condition for Rule "P_I_ci_store_rset_0"
{
...
int mu__invariant_50() // Invariant "swmr"
{
bool mu__quant51; 
mu__quant51 = TRUE;
{
...
bool mu__boolexpr53;
bool mu__boolexpr54;
  if (!((mu_c1) != (mu_c2))) mu__boolexpr54 = FALSE ;
  else {
  mu__boolexpr54 = ((mu_Procs[mu_c1].mu_state) == (mu_P_V)) ; 
}
  if (!(mu__boolexpr54)) mu__boolexpr53 = TRUE ;
  else {
  mu__boolexpr53 = ((mu_Procs[mu_c2].mu_state) != (mu_P_V)) ; 
}
if ( !(mu__boolexpr53) )
...
bool mu__condition_55() // Condition for Rule "swmr"
{
...
int mu__invariant_56() // Invariant "values in valid state match last write"
{
bool mu__quant57; 
mu__quant57 = TRUE;
{
for(int mu_n = 1; mu_n <= 3; mu_n++) {
bool mu__boolexpr58;
  if (!((mu_Procs[mu_n].mu_state) == (mu_P_V))) mu__boolexpr58 = TRUE ;
  else {
  mu__boolexpr58 = ((mu_Procs[mu_n].mu_val) == (mu_LastWrite)) ; 
}
if ( !(mu__boolexpr58) )
...
bool mu__condition_59() // Condition for Rule "values in valid state match last write"
{
...
int mu__invariant_60() // Invariant "value in memory matches value of last write, when invalid"
{
bool mu__boolexpr61;
  if (!((mu_HomeNode.mu_state) == (mu_H_I))) mu__boolexpr61 = TRUE ;
  else {
  mu__boolexpr61 = ((mu_MainMemory) == (mu_LastWrite)) ; 
}
return mu__boolexpr61;
};

bool mu__condition_62() // Condition for Rule "value in memory matches value of last write, when invalid"
{
...
int mu__invariant_63() // Invariant "Invalid implies empty owner"
{
bool mu__boolexpr64;
...
if ( !(!((mu_Procs[mu_n].mu_state) == (mu_P_V))) )
  ...
  mu__boolexpr64 = (mu__quant65) ; 
}
return mu__boolexpr64;
};

bool mu__condition_66() // Condition for Rule "Invalid implies empty owner"
{
...
{"Invalid implies empty owner", &mu__condition_66, NULL, },
{"value in memory matches value of last write, when invalid", &mu__condition_62, NULL, },
{"values in valid state match last write", &mu__condition_59, NULL, },
{"swmr", &mu__condition_55, NULL, },
{"P_I_ci_store_rset_0", &mu__condition_49, NULL, },
};
