/******************************
  Program "past_builds/VI_build/s4_constrained/out/P_V_ci_evict_0_0_sent.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_build/s4_constrained/out/P_V_ci_evict_0_0_sent"
#define BITS_IN_WORLD 464
#define ALIGN
...
/*** Variable declaration ***/
mu_1_ProcStateEnum mu_prevProcs("prevProcs",64);

/*** Variable declaration ***/
mu_1_CoreReq mu_prevProcReq("prevProcReq",72);

/*** Variable declaration ***/
mu_1_Proc mu_selc("selc",96);

/*** Variable declaration ***/
mu_1__type_5 mu_match("match",104);

/*** Variable declaration ***/
mu_1_HomeState mu_HomeNode("HomeNode",112);

/*** Variable declaration ***/
mu_1__type_6 mu_Procs("Procs",128);

/*** Variable declaration ***/
mu_1_Value mu_LastWrite("LastWrite",176);

/*** Variable declaration ***/
mu_1_Value mu_MainMemory("MainMemory",184);

/*** Variable declaration ***/
mu_1_Message mu_gBuf("gBuf",192);

/*** Variable declaration ***/
mu_1__type_7 mu_ackBus("ackBus",224);

/*** Variable declaration ***/
mu_1__type_8 mu_msgBuf("msgBuf",256);

/*** Variable declaration ***/
mu_0_boolean mu_msgBufNonEmpty("msgBufNonEmpty",384);

/*** Variable declaration ***/
mu_1__type_9 mu_curRequsts("curRequsts",392);
...
bool mu__boolexpr16;
bool mu__boolexpr17;
  if (!(mu_start)) mu__boolexpr17 = FALSE ;
  else {
  mu__boolexpr17 = (!(mu_cur_node.isundefined())) ; 
}
...
bool mu__boolexpr18;
bool mu__boolexpr19;
  if (!(!(mu_curRequsts[mu_p].mu_vld.isundefined()))) mu__boolexpr19 = FALSE ;
  else {
  mu__boolexpr19 = (mu_curRequsts[mu_p].mu_vld) ; 
}
  if (!(mu__boolexpr19)) mu__boolexpr18 = FALSE ;
  else {
  mu__boolexpr18 = ((mu_curRequsts[mu_p].mu_tp) == (mu_store)) ; 
}
if ( mu__boolexpr18 )
{
