/******************************
  Program "build/s1_msg_per_transition_iter/out/P_I_P_IVD_rec_5.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "build/s1_msg_per_transition_iter/out/P_I_P_IVD_rec_5"
...
/********************
  Invariant records
 ********************/
int mu__invariant_27() // Invariant "P_I_to_P_IVD"
{
bool mu__boolexpr28;
bool mu__boolexpr29;
bool mu__boolexpr30;
  ...
  mu__boolexpr30 = ((mu_prevProcs) == (mu_P_I)) ; 
}
  if (!(mu__boolexpr30)) mu__boolexpr29 = FALSE ;
  else {
  mu__boolexpr29 = ((mu_Procs[mu_selc].mu_state) == (mu_P_IVD)) ; 
}
...
bool mu__boolexpr36;
bool mu__boolexpr37;
  if (!((mu_msg_imm_rec_set[mu_GetMsg]) == (mu_false))) mu__boolexpr37 = FALSE ;
  else {
  mu__boolexpr37 = ((mu_msg_imm_rec_set[mu_PutMsg]) == (mu_false)) ; 
}
  if (!(mu__boolexpr37)) mu__boolexpr36 = FALSE ;
  else {
  mu__boolexpr36 = ((mu_msg_imm_rec_set[mu_DataRespMsg]) == (mu_false)) ; 
}
  if (mu__boolexpr36) mu__boolexpr35 = TRUE ;
  else {
bool mu__boolexpr38;
bool mu__boolexpr39;
  if (!((mu_msg_imm_rec_set[mu_GetMsg]) == (mu_true))) mu__boolexpr39 = FALSE ;
  else {
  mu__boolexpr39 = ((mu_msg_imm_rec_set[mu_PutMsg]) == (mu_false)) ; 
}
  if (!(mu__boolexpr39)) mu__boolexpr38 = FALSE ;
  else {
  mu__boolexpr38 = ((mu_msg_imm_rec_set[mu_DataRespMsg]) == (mu_true)) ; 
}
  mu__boolexpr35 = (mu__boolexpr38) ; 
}
  if (mu__boolexpr35) mu__boolexpr34 = TRUE ;
  else {
bool mu__boolexpr40;
bool mu__boolexpr41;
  if (!((mu_msg_imm_rec_set[mu_GetMsg]) == (mu_false))) mu__boolexpr41 = FALSE ;
  else {
  mu__boolexpr41 = ((mu_msg_imm_rec_set[mu_PutMsg]) == (mu_true)) ; 
}
  if (!(mu__boolexpr41)) mu__boolexpr40 = FALSE ;
  else {
  mu__boolexpr40 = ((mu_msg_imm_rec_set[mu_DataRespMsg]) == (mu_false)) ; 
}
  mu__boolexpr34 = (mu__boolexpr40) ; 
}
  if (mu__boolexpr34) mu__boolexpr33 = TRUE ;
  else {
bool mu__boolexpr42;
bool mu__boolexpr43;
  if (!((mu_msg_imm_rec_set[mu_GetMsg]) == (mu_true))) mu__boolexpr43 = FALSE ;
  else {
  mu__boolexpr43 = ((mu_msg_imm_rec_set[mu_PutMsg]) == (mu_true)) ; 
}
  if (!(mu__boolexpr43)) mu__boolexpr42 = FALSE ;
  else {
  mu__boolexpr42 = ((mu_msg_imm_rec_set[mu_DataRespMsg]) == (mu_true)) ; 
}
  mu__boolexpr33 = (mu__boolexpr42) ; 
}
  if (mu__boolexpr33) mu__boolexpr32 = TRUE ;
  else {
bool mu__boolexpr44;
bool mu__boolexpr45;
  if (!((mu_msg_imm_rec_set[mu_GetMsg]) == (mu_false))) mu__boolexpr45 = FALSE ;
  else {
  mu__boolexpr45 = ((mu_msg_imm_rec_set[mu_PutMsg]) == (mu_false)) ; 
}
  if (!(mu__boolexpr45)) mu__boolexpr44 = FALSE ;
  else {
  mu__boolexpr44 = ((mu_msg_imm_rec_set[mu_DataRespMsg]) == (mu_true)) ; 
}
  mu__boolexpr32 = (mu__boolexpr44) ; 
}
  if (mu__boolexpr32) mu__boolexpr31 = TRUE ;
  else {
bool mu__boolexpr46;
bool mu__boolexpr47;
  if (!((mu_msg_imm_rec_set[mu_GetMsg]) == (mu_false))) mu__boolexpr47 = FALSE ;
  else {
  mu__boolexpr47 = ((mu_msg_imm_rec_set[mu_PutMsg]) == (mu_true)) ; 
}
  if (!(mu__boolexpr47)) mu__boolexpr46 = FALSE ;
  else {
  mu__boolexpr46 = ((mu_msg_imm_rec_set[mu_DataRespMsg]) == (mu_true)) ; 
}
  mu__boolexpr31 = (mu__boolexpr46) ; 
}
...
bool mu__condition_48() // Condition for Rule "P_I_to_P_IVD"
{
...
int mu__invariant_49() // Invariant "swmr"
{
bool mu__quant50; 
mu__quant50 = TRUE;
{
...
bool mu__boolexpr52;
bool mu__boolexpr53;
  if (!((mu_c1) != (mu_c2))) mu__boolexpr53 = FALSE ;
  else {
  mu__boolexpr53 = ((mu_Procs[mu_c1].mu_state) == (mu_P_V)) ; 
}
  if (!(mu__boolexpr53)) mu__boolexpr52 = TRUE ;
  else {
  mu__boolexpr52 = ((mu_Procs[mu_c2].mu_state) != (mu_P_V)) ; 
}
if ( !(mu__boolexpr52) )
...
bool mu__condition_54() // Condition for Rule "swmr"
{
...
int mu__invariant_55() // Invariant "values in valid state match last write"
{
bool mu__quant56; 
mu__quant56 = TRUE;
{
for(int mu_n = 1; mu_n <= 3; mu_n++) {
bool mu__boolexpr57;
  if (!((mu_Procs[mu_n].mu_state) == (mu_P_V))) mu__boolexpr57 = TRUE ;
  else {
  mu__boolexpr57 = ((mu_Procs[mu_n].mu_val) == (mu_LastWrite)) ; 
}
if ( !(mu__boolexpr57) )
...
bool mu__condition_58() // Condition for Rule "values in valid state match last write"
{
...
int mu__invariant_59() // Invariant "value in memory matches value of last write, when invalid"
{
bool mu__boolexpr60;
  if (!((mu_HomeNode.mu_state) == (mu_H_I))) mu__boolexpr60 = TRUE ;
  else {
  mu__boolexpr60 = ((mu_MainMemory) == (mu_LastWrite)) ; 
}
return mu__boolexpr60;
};

bool mu__condition_61() // Condition for Rule "value in memory matches value of last write, when invalid"
{
...
if ( !(!((mu_Procs[mu_n].mu_state) == (mu_P_V))) )
  ...
  mu__boolexpr63 = (mu__quant64) ; 
}
return mu__boolexpr63;
};

bool mu__condition_65() // Condition for Rule "Invalid implies empty owner"
{
...
{"Invalid implies empty owner", &mu__condition_65, NULL, },
{"value in memory matches value of last write, when invalid", &mu__condition_61, NULL, },
{"values in valid state match last write", &mu__condition_58, NULL, },
{"swmr", &mu__condition_54, NULL, },
{"P_I_to_P_IVD", &mu__condition_48, NULL, },
};
