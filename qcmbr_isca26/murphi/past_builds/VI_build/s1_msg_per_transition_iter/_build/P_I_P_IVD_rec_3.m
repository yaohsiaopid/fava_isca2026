...
invariant "P_I_to_P_IVD"
  ...
  ((msg_imm_rec_set[GetMsg] = false & msg_imm_rec_set[PutMsg] = false & msg_imm_rec_set[DataRespMsg] = false) | (msg_imm_rec_set[GetMsg] = true & msg_imm_rec_set[PutMsg] = false & msg_imm_rec_set[DataRespMsg] = true) | (msg_imm_rec_set[GetMsg] = false & msg_imm_rec_set[PutMsg] = true & msg_imm_rec_set[DataRespMsg] = false) | (msg_imm_rec_set[GetMsg] = true & msg_imm_rec_set[PutMsg] = true & msg_imm_rec_set[DataRespMsg] = true));
