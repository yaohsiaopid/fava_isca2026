...
invariant "P_V_to_P_I"
  ((!IsUndefined(prevProcs) & (prevProcs = P_V))
  & (Procs[selc].state = P_I)) ->
  ((msg_imm_sent_set[GetMsg] = false & msg_imm_sent_set[PutMsg] = true & msg_imm_sent_set[DataRespMsg] = false) | (msg_imm_sent_set[GetMsg] = false & msg_imm_sent_set[PutMsg] = false & msg_imm_sent_set[DataRespMsg] = true));
