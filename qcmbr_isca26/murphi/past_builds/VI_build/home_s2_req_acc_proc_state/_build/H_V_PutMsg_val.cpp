/******************************
  Program "build/home_s2_req_acc_proc_state/out/H_V_PutMsg_val.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "build/home_s2_req_acc_proc_state/out/H_V_PutMsg_val"
...
bool mu__boolexpr6;
bool mu__boolexpr7;
  if (!(!(mu_curRequsts[mu_p].mu_vld.isundefined()))) mu__boolexpr7 = FALSE ;
  else {
  mu__boolexpr7 = (mu_curRequsts[mu_p].mu_vld) ; 
}
  if (!(mu__boolexpr7)) mu__boolexpr6 = FALSE ;
  else {
  mu__boolexpr6 = ((mu_curRequsts[mu_p].mu_tp) == (mu_store)) ; 
}
if ( mu__boolexpr6 )
{
...
/********************
  Invariant records
 ********************/
int mu__invariant_25() // Invariant "H_V_accept_req_PutMsg"
{
bool mu__boolexpr26;
bool mu__boolexpr27;
bool mu__boolexpr28;
bool mu__boolexpr29;
  ...
  mu__boolexpr28 = (!(mu_prevRecProcMsg.isundefined())) ; 
}
  if (!(mu__boolexpr28)) mu__boolexpr27 = FALSE ;
  else {
  mu__boolexpr27 = ((mu_prevRecProcMsg) == (mu_PutMsg)) ; 
}
  if (!(mu__boolexpr27)) mu__boolexpr26 = TRUE ;
  else {
  mu__boolexpr26 = ((mu_prevHomeNodeVal) == (mu_HomeNode.mu_val)) ; 
}
return mu__boolexpr26;
};

bool mu__condition_30() // Condition for Rule "H_V_accept_req_PutMsg"
{
...
{"H_V_accept_req_PutMsg", &mu__condition_30, NULL, },
};
