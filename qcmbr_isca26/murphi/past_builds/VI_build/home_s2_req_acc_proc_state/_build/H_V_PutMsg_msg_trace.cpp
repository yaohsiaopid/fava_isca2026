/******************************
  Program "build/home_s2_req_acc_proc_state/out/H_V_PutMsg_msg_trace.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "build/home_s2_req_acc_proc_state/out/H_V_PutMsg_msg_trace"
...
/********************
  Invariant records
 ********************/
int mu__invariant_28() // Invariant "H_V_consistent_w_PutMsg"
{
bool mu__boolexpr29;
bool mu__boolexpr30;
  if (!(!(mu_prevHomeNode.isundefined()))) mu__boolexpr30 = FALSE ;
  else {
  mu__boolexpr30 = ((mu_prevHomeNode) == (mu_H_V)) ; 
}
  if (!(mu__boolexpr30)) mu__boolexpr29 = TRUE ;
  else {
bool mu__boolexpr31;
  if (mu_prevRecProcMsg.isundefined()) mu__boolexpr31 = TRUE ;
  else {
  mu__boolexpr31 = ((mu_prevRecProcMsg) != (mu_PutMsg)) ; 
}
  mu__boolexpr29 = (mu__boolexpr31) ; 
}
return mu__boolexpr29;
};

bool mu__condition_32() // Condition for Rule "H_V_consistent_w_PutMsg"
{
...
int mu__invariant_33() // Invariant "swmr"
{
bool mu__quant34; 
mu__quant34 = TRUE;
{
...
bool mu__boolexpr36;
bool mu__boolexpr37;
  if (!((mu_c1) != (mu_c2))) mu__boolexpr37 = FALSE ;
  else {
  mu__boolexpr37 = ((mu_Procs[mu_c1].mu_state) == (mu_P_V)) ; 
}
  if (!(mu__boolexpr37)) mu__boolexpr36 = TRUE ;
  else {
  mu__boolexpr36 = ((mu_Procs[mu_c2].mu_state) != (mu_P_V)) ; 
}
if ( !(mu__boolexpr36) )
...
bool mu__condition_38() // Condition for Rule "swmr"
{
...
int mu__invariant_39() // Invariant "values in valid state match last write"
{
bool mu__quant40; 
mu__quant40 = TRUE;
{
...
bool mu__boolexpr41;
  if (!((mu_Procs[mu_n].mu_state) == (mu_P_V))) mu__boolexpr41 = TRUE ;
  else {
...
bool mu__condition_42() // Condition for Rule "values in valid state match last write"
{
...
bool mu__boolexpr44;
  ...
  mu__boolexpr44 = ((mu_MainMemory) == (mu_LastWrite)) ; 
}
...
int mu__invariant_46() // Invariant "Invalid implies empty owner"
{
bool mu__boolexpr47;
...
{"Invalid implies empty owner", &mu__condition_49, NULL, },
{"value in memory matches value of last write, when invalid", &mu__condition_45, NULL, },
{"values in valid state match last write", &mu__condition_42, NULL, },
{"swmr", &mu__condition_38, NULL, },
{"H_V_consistent_w_PutMsg", &mu__condition_32, NULL, },
};
