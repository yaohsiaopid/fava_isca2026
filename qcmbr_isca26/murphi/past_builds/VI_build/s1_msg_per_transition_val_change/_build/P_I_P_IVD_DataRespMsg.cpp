/******************************
  Program "past_builds/VI_build/s1_msg_per_transition_val_change/out/P_I_P_IVD_DataRespMsg.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_build/s1_msg_per_transition_val_change/out/P_I_P_IVD_DataRespMsg"
...
bool mu__boolexpr8;
  ...
  mu__boolexpr8 = ((mu_prevProcs) == (mu_P_I)) ; 
}
  if (!(mu__boolexpr8)) mu__boolexpr7 = FALSE ;
  else {
  mu__boolexpr7 = ((mu_Procs[mu_selc].mu_state) == (mu_P_IVD)) ; 
}
