/******************************
  Program "past_builds/VI_build/s4_4_picl_val_from_msg/out/P_I_ci_load_0_0_P_V_val_change.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_build/s4_4_picl_val_from_msg/out/P_I_ci_load_0_0_P_V_val_change"
...
class mu_1__type_3
{
 ...
 public:
  ...
  void set_self_2( const char *n, const char *n2, int os);
  void set_self_ar( const char *n, const char *n2, int os);
  mu_1__type_3 (const char *n, int os): current_size(0), max_size(0) { set_self(n, os); };
...
/*** Variable declaration ***/
mu_1__type_3 mu_reached_set("reached_set",56);

/*** Variable declaration ***/
mu_1_ProcStateEnum mu_prevProcs("prevProcs",104);

/*** Variable declaration ***/
mu_1_CoreReq mu_prevProcReq("prevProcReq",112);

/*** Variable declaration ***/
mu_1_Proc mu_selc("selc",136);

/*** Variable declaration ***/
mu_0_boolean mu_val_chk("val_chk",144);

/*** Variable declaration ***/
mu_1_Value mu_prevProcVal("prevProcVal",152);

/*** Variable declaration ***/
mu_1_HomeState mu_HomeNode("HomeNode",160);

/*** Variable declaration ***/
mu_1__type_4 mu_Procs("Procs",176);

/*** Variable declaration ***/
mu_1_Value mu_LastWrite("LastWrite",224);

/*** Variable declaration ***/
mu_1_Value mu_MainMemory("MainMemory",232);

/*** Variable declaration ***/
mu_1_Message mu_gBuf("gBuf",240);

/*** Variable declaration ***/
mu_1__type_5 mu_ackBus("ackBus",272);

/*** Variable declaration ***/
mu_1__type_6 mu_msgBuf("msgBuf",304);

/*** Variable declaration ***/
mu_0_boolean mu_msgBufNonEmpty("msgBufNonEmpty",432);

/*** Variable declaration ***/
mu_1__type_7 mu_curRequsts("curRequsts",440);
...
bool mu__boolexpr8;
  if ((mu_cur_state) == (mu_P_I)) mu__boolexpr8 = TRUE ;
  else {
  mu__boolexpr8 = ((mu_cur_state) == (mu_P_V)) ; 
}
mu_in_stable_state = mu__boolexpr8;
if ( mu_start )
{
bool mu__boolexpr9;
  if (!((mu_Procs[mu_selc].mu_state) == (mu_P_V))) mu__boolexpr9 = FALSE ;
  else {
  mu__boolexpr9 = ((mu_prevProcVal) != (mu_Procs[mu_selc].mu_val)) ; 
}
if ( mu__boolexpr9 )
{
mu_val_chk = mu_true;
if ( !((mu_Procs[mu_selc].mu_state) != (mu_prevProcs)) ) Error.Error("Assertion failed: NO PERMISSION STATE CHANGE?");
}
...
/*** begin multisetcount 0 declaration ***/
  ...
  for (mu_i = 0; ; mu_i=mu_i+1)
	...
	{
	  if ( (mu_reached_set[mu_i]) == (mu_cur_state) ) mu__intexpr10++;
	}
      if (mu_i == 3-1) break;
    }
  }
...
if (mu_Procs[mu_selc].mu_val.isundefined())
  mu_prevProcVal.undefine();
else
  mu_prevProcVal = mu_Procs[mu_selc].mu_val;
};
...
bool mu__boolexpr11;
bool mu__boolexpr12;
  if (!(!(mu_curRequsts[mu_p].mu_vld.isundefined()))) mu__boolexpr12 = FALSE ;
  else {
  mu__boolexpr12 = (mu_curRequsts[mu_p].mu_vld) ; 
}
  if (!(mu__boolexpr12)) mu__boolexpr11 = FALSE ;
  else {
  mu__boolexpr11 = ((mu_curRequsts[mu_p].mu_tp) == (mu_store)) ; 
}
if ( mu__boolexpr11 )
{
...
void world_class::print_statistic()
{
  ...
  mu_val_chk.print_statistic();
  mu_prevProcVal.print_statistic();
...
void world_class::print_diff( state *prevstate )
{
  if ( prevstate != NULL )
  {
    ...
    mu_val_chk.print_diff(prevstate);
    mu_prevProcVal.print_diff(prevstate);
...
void world_class::to_state(state *newstate)
{
  ...
  mu_val_chk.to_state( newstate );
  mu_prevProcVal.to_state( newstate );
...
bool mu__boolexpr15;
bool mu__boolexpr16;
  if (!(!(mu_tracked))) mu__boolexpr16 = FALSE ;
  else {
  mu__boolexpr16 = (!(mu_prevProcs.isundefined())) ; 
}
  if (!(mu__boolexpr16)) mu__boolexpr15 = FALSE ;
  else {
  mu__boolexpr15 = ((mu_prevProcs) == (mu_P_I)) ; 
}
  if (!(mu__boolexpr15)) mu__boolexpr14 = FALSE ;
  else {
  mu__boolexpr14 = (!(mu_prevProcReq.mu_tp.isundefined())) ; 
}
  if (!(mu__boolexpr14)) mu__boolexpr13 = FALSE ;
  else {
  mu__boolexpr13 = ((mu_prevProcReq.mu_tp) == (mu_ci_load)) ; 
}
...
bool mu__boolexpr19;
bool mu__boolexpr20;
  if (!(!(mu_tracked))) mu__boolexpr20 = FALSE ;
  else {
  mu__boolexpr20 = (!(mu_prevProcs.isundefined())) ; 
}
  if (!(mu__boolexpr20)) mu__boolexpr19 = FALSE ;
  else {
  mu__boolexpr19 = ((mu_prevProcs) == (mu_P_I)) ; 
}
  if (!(mu__boolexpr19)) mu__boolexpr18 = FALSE ;
  else {
  mu__boolexpr18 = (!(mu_prevProcReq.mu_tp.isundefined())) ; 
}
  if (!(mu__boolexpr18)) mu__boolexpr17 = FALSE ;
  else {
  mu__boolexpr17 = ((mu_prevProcReq.mu_tp) == (mu_ci_load)) ; 
}
	      if (mu__boolexpr17) {
		if ( ( TRUE  ) )
		  return;
...
for(int mu_n = 1; mu_n <= 6; mu_n++)
  if (( ( mu_n >= 1 ) && ( mu_n <= 3 ) )|| ( ( mu_n >= 6 ) && ( mu_n <= 6 ) )) {
bool mu__boolexpr21;
  if (!(mu_allAck)) mu__boolexpr21 = FALSE ;
  else {
  mu__boolexpr21 = (mu_ackBus[mu_n]) ; 
}
mu_allAck = mu__boolexpr21;
};
};
if ( mu_allAck )
{
...
public:
  ...
  bool Condition(unsigned r)
  {
    ...
    r = r / 4;
bool mu__boolexpr22;
  if (!(!(mu_gBuf.mu_src.isundefined()))) mu__boolexpr22 = FALSE ;
  else {
  mu__boolexpr22 = (!(mu_ackBus[mu_n])) ; 
}
  ...
  void NextRule(unsigned & what_rule)
  {
	...
	if ( ( TRUE  ) ) {
bool mu__boolexpr23;
  if (!(!(mu_gBuf.mu_src.isundefined()))) mu__boolexpr23 = FALSE ;
  else {
  mu__boolexpr23 = (!(mu_ackBus[mu_n])) ; 
}
	      if (mu__boolexpr23) {
		if ( ( TRUE  ) )
		  return;
...
bool mu__boolexpr24;
bool mu__boolexpr25;
  if (!(mu_start)) mu__boolexpr25 = FALSE ;
  else {
  mu__boolexpr25 = (!(mu_cur_node.isundefined())) ; 
}
  if (!(mu__boolexpr25)) mu__boolexpr24 = FALSE ;
  else {
  mu__boolexpr24 = ((mu_cur_node) == (mu_selc)) ; 
}
if ( mu__boolexpr24 )
{
...
bool mu__boolexpr26;
bool mu__boolexpr27;
  if (!(mu_start)) mu__boolexpr27 = FALSE ;
  else {
  mu__boolexpr27 = (!(mu_cur_node.isundefined())) ; 
}
  if (!(mu__boolexpr27)) mu__boolexpr26 = FALSE ;
  else {
  mu__boolexpr26 = ((mu_cur_node) == (mu_selc)) ; 
}
if ( mu__boolexpr26 )
{
mu_msg_rec_set[mu_gBuf.mu_mtype] = mu_true;
...
bool mu__boolexpr28;
bool mu__boolexpr29;
  if (!((mu_p.mu_state) == (mu_P_V))) mu__boolexpr29 = FALSE ;
  else {
  mu__boolexpr29 = (!(mu_msgBufNonEmpty)) ; 
}
  if (!(mu__boolexpr29)) mu__boolexpr28 = FALSE ;
  else {
  mu__boolexpr28 = (mu_gBuf.mu_src.isundefined()) ; 
}
...
bool mu__boolexpr30;
bool mu__boolexpr31;
  if (!((mu_p.mu_state) == (mu_P_V))) mu__boolexpr31 = FALSE ;
  else {
  mu__boolexpr31 = (!(mu_msgBufNonEmpty)) ; 
}
  if (!(mu__boolexpr31)) mu__boolexpr30 = FALSE ;
  else {
  mu__boolexpr30 = (mu_gBuf.mu_src.isundefined()) ; 
}
	      if (mu__boolexpr30) {
		if ( ( TRUE  ) )
		  return;
...
bool mu__boolexpr33;
  ...
  mu__boolexpr33 = (!(mu_msgBufNonEmpty)) ; 
}
  if (!(mu__boolexpr33)) mu__boolexpr32 = FALSE ;
  else {
  mu__boolexpr32 = (mu_gBuf.mu_src.isundefined()) ; 
}
...
bool mu__boolexpr35;
  ...
  mu__boolexpr35 = (!(mu_msgBufNonEmpty)) ; 
}
  if (!(mu__boolexpr35)) mu__boolexpr34 = FALSE ;
  else {
  mu__boolexpr34 = (mu_gBuf.mu_src.isundefined()) ; 
}
	      if (mu__boolexpr34) {
		if ( ( TRUE  ) )
		  return;
...
bool mu__boolexpr37;
  ...
  mu__boolexpr37 = (!(mu_msgBufNonEmpty)) ; 
}
  if (!(mu__boolexpr37)) mu__boolexpr36 = FALSE ;
  else {
  mu__boolexpr36 = (mu_gBuf.mu_src.isundefined()) ; 
}
...
bool mu__boolexpr38;
bool mu__boolexpr39;
  if (!((mu_p.mu_state) == (mu_P_I))) mu__boolexpr39 = FALSE ;
  else {
  mu__boolexpr39 = (!(mu_msgBufNonEmpty)) ; 
}
  if (!(mu__boolexpr39)) mu__boolexpr38 = FALSE ;
  else {
  mu__boolexpr38 = (mu_gBuf.mu_src.isundefined()) ; 
}
	      if (mu__boolexpr38) {
		if ( ( TRUE  ) )
		  return;
...
/********************
  Invariant records
 ********************/
int mu__invariant_40() // Invariant "P_I_ci_load_rset_0"
{
bool mu__boolexpr41;
bool mu__boolexpr42;
bool mu__boolexpr43;
  ...
  for (mu_i = 0; ; mu_i=mu_i+1)
    {
      if (mu_reached_set.valid[(int)mu_i].value())
	{
	  if ( (mu_reached_set[mu_i]) == (mu_P_I) ) mu__intexpr47++;
	}
      if (mu_i == 3-1) break;
    }
  }
/*** end multisetcount 1 declaration ***/
  mu__boolexpr45 = ((mu__intexpr47) == (0)) ; 
}
  ...
  for (mu_i = 0; ; mu_i=mu_i+1)
    {
      if (mu_reached_set.valid[(int)mu_i].value())
	{
	  if ( (mu_reached_set[mu_i]) == (mu_P_IVD) ) mu__intexpr48++;
	}
      if (mu_i == 3-1) break;
    }
  }
/*** end multisetcount 2 declaration ***/
  mu__boolexpr44 = ((mu__intexpr48) == (1)) ; 
}
  ...
  for (mu_i = 0; ; mu_i=mu_i+1)
    {
      if (mu_reached_set.valid[(int)mu_i].value())
	{
	  if ( (mu_reached_set[mu_i]) == (mu_P_V) ) mu__intexpr49++;
	}
      if (mu_i == 3-1) break;
    }
  }
/*** end multisetcount 3 declaration ***/
  mu__boolexpr43 = ((mu__intexpr49) == (1)) ; 
}
  if (!(mu__boolexpr43)) mu__boolexpr42 = FALSE ;
  else {
bool mu__boolexpr50;
bool mu__boolexpr51;
  if (!((mu_msg_rec_set[mu_GetMsg]) == (mu_true))) mu__boolexpr51 = FALSE ;
  else {
  mu__boolexpr51 = ((mu_msg_rec_set[mu_PutMsg]) == (mu_false)) ; 
}
  if (!(mu__boolexpr51)) mu__boolexpr50 = FALSE ;
  else {
  mu__boolexpr50 = ((mu_msg_rec_set[mu_DataRespMsg]) == (mu_true)) ; 
}
  mu__boolexpr42 = (mu__boolexpr50) ; 
}
  if (!(mu__boolexpr42)) mu__boolexpr41 = TRUE ;
  else {
  mu__boolexpr41 = (!((mu_val_chk) == (mu_true))) ; 
}
return mu__boolexpr41;
};

bool mu__condition_52() // Condition for Rule "P_I_ci_load_rset_0"
{
...
int mu__invariant_53() // Invariant "swmr"
{
bool mu__quant54; 
mu__quant54 = TRUE;
{
...
bool mu__boolexpr56;
bool mu__boolexpr57;
  if (!((mu_c1) != (mu_c2))) mu__boolexpr57 = FALSE ;
  else {
  mu__boolexpr57 = ((mu_Procs[mu_c1].mu_state) == (mu_P_V)) ; 
}
  if (!(mu__boolexpr57)) mu__boolexpr56 = TRUE ;
  else {
  mu__boolexpr56 = ((mu_Procs[mu_c2].mu_state) != (mu_P_V)) ; 
}
if ( !(mu__boolexpr56) )
...
bool mu__condition_58() // Condition for Rule "swmr"
{
...
int mu__invariant_59() // Invariant "values in valid state match last write"
{
bool mu__quant60; 
mu__quant60 = TRUE;
{
for(int mu_n = 1; mu_n <= 3; mu_n++) {
bool mu__boolexpr61;
  if (!((mu_Procs[mu_n].mu_state) == (mu_P_V))) mu__boolexpr61 = TRUE ;
  else {
  mu__boolexpr61 = ((mu_Procs[mu_n].mu_val) == (mu_LastWrite)) ; 
}
if ( !(mu__boolexpr61) )
...
bool mu__condition_62() // Condition for Rule "values in valid state match last write"
{
...
int mu__invariant_63() // Invariant "value in memory matches value of last write, when invalid"
{
bool mu__boolexpr64;
  if (!((mu_HomeNode.mu_state) == (mu_H_I))) mu__boolexpr64 = TRUE ;
  else {
  mu__boolexpr64 = ((mu_MainMemory) == (mu_LastWrite)) ; 
}
return mu__boolexpr64;
};

bool mu__condition_65() // Condition for Rule "value in memory matches value of last write, when invalid"
{
...
{
bool mu__boolexpr67;
  if (!((mu_HomeNode.mu_state) == (mu_H_I))) mu__boolexpr67 = TRUE ;
  else {
bool mu__quant68; 
mu__quant68 = TRUE;
{
...
{"value in memory matches value of last write, when invalid", &mu__condition_65, NULL, },
{"values in valid state match last write", &mu__condition_62, NULL, },
{"swmr", &mu__condition_58, NULL, },
{"P_I_ci_load_rset_0", &mu__condition_52, NULL, },
};
...
void SymmetryClass::Heuristic_Fast_Canonicalize(state* s)
{
  ...
  mu_prevProcVal.SimpleCanonicalize(Perm);
