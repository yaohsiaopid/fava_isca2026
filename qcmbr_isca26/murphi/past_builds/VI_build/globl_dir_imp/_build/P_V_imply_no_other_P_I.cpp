/******************************
  Program "past_builds/VI_build/globl_dir_imp/out/P_V_imply_no_other_P_I.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_build/globl_dir_imp/out/P_V_imply_no_other_P_I"
...
/********************
  Invariant records
 ********************/
int mu__invariant_23() // Invariant "P_V_imply_not_P_I_others"
{
bool mu__quant24; 
mu__quant24 = TRUE;
{
...
if ( !(mu__boolexpr31) )
  ...
  mu__boolexpr26 = ((mu_Procs[mu_n1].mu_state) == (mu_P_V)) ; 
}
...
bool mu__condition_34() // Condition for Rule "P_V_imply_not_P_I_others"
{
...
{"P_V_imply_not_P_I_others", &mu__condition_34, NULL, },
};
