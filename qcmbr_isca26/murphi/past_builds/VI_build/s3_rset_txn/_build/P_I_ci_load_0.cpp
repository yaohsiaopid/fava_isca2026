/******************************
  Program "past_builds/VI_build/s3_rset_txn/out/P_I_ci_load_0.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_build/s3_rset_txn/out/P_I_ci_load_0"
...
bool mu__boolexpr15;
  ...
  mu__boolexpr12 = ((mu_prevProcReq.mu_tp) == (mu_ci_load)) ; 
}
...
bool mu__boolexpr19;
  ...
  mu__boolexpr16 = ((mu_prevProcReq.mu_tp) == (mu_ci_load)) ; 
}
	      if (mu__boolexpr16) {
		if ( ( TRUE  ) )
		  return;
...
/********************
  Invariant records
 ********************/
int mu__invariant_35() // Invariant "P_I_ci_load_rset_0"
{
bool mu__boolexpr36;
bool mu__boolexpr37;
...
bool mu__condition_38() // Condition for Rule "P_I_ci_load_rset_0"
{
...
{"P_I_ci_load_rset_0", &mu__condition_38, NULL, },
};
