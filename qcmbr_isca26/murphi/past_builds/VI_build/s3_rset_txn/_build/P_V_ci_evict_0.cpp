/******************************
  Program "past_builds/VI_build/s3_rset_txn/out/P_V_ci_evict_0.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_build/s3_rset_txn/out/P_V_ci_evict_0"
...
/*** Variable declaration ***/
mu_1__type_4 mu_Procs("Procs",88);
...
/*** Variable declaration ***/
mu_1__type_5 mu_ackBus("ackBus",184);

/*** Variable declaration ***/
mu_1__type_6 mu_msgBuf("msgBuf",216);

/*** Variable declaration ***/
mu_0_boolean mu_msgBufNonEmpty("msgBufNonEmpty",344);

/*** Variable declaration ***/
mu_1__type_7 mu_curRequsts("curRequsts",352);
...
{
bool mu__boolexpr9;
  if (!((mu_cur_idx) < (1))) mu__boolexpr9 = FALSE ;
  else {
...
bool mu__boolexpr15;
  ...
  mu__boolexpr14 = ((mu_prevProcs) == (mu_P_V)) ; 
}
  ...
  mu__boolexpr12 = ((mu_prevProcReq.mu_tp) == (mu_ci_evict)) ; 
}
...
bool mu__boolexpr19;
  ...
  mu__boolexpr18 = ((mu_prevProcs) == (mu_P_V)) ; 
}
  ...
  mu__boolexpr16 = ((mu_prevProcReq.mu_tp) == (mu_ci_evict)) ; 
}
	      if (mu__boolexpr16) {
		if ( ( TRUE  ) )
		  return;
...
/********************
  Invariant records
 ********************/
int mu__invariant_35() // Invariant "P_V_ci_evict_rset_0"
{
bool mu__boolexpr36;
bool mu__boolexpr37;
  ...
  mu__boolexpr36 = ((mu_cur_idx) != (1)) ; 
}
return mu__boolexpr36;
};

bool mu__condition_38() // Condition for Rule "P_V_ci_evict_rset_0"
{
...
{"P_V_ci_evict_rset_0", &mu__condition_38, NULL, },
};
