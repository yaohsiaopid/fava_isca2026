/******************************
  Program "build/home_s0_transition/out/H_V_H_I.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "build/home_s0_transition/out/H_V_H_I"
...
/********************
  Invariant records
 ********************/
int mu__invariant_23() // Invariant "H_V_to_H_I"
{
bool mu__boolexpr24;
bool mu__boolexpr25;
  if (!(!(mu_prevHomeNode.isundefined()))) mu__boolexpr25 = FALSE ;
  else {
  mu__boolexpr25 = ((mu_prevHomeNode) == (mu_H_V)) ; 
}
...
bool mu__condition_26() // Condition for Rule "H_V_to_H_I"
{
...
{"H_V_to_H_I", &mu__condition_26, NULL, },
};
