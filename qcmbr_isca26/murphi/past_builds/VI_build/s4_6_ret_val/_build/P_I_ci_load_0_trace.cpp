/******************************
  Program "build/s4_6_ret_val/out/P_I_ci_load_0_trace.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "build/s4_6_ret_val/out/P_I_ci_load_0_trace"
...
bool mu__boolexpr11;
bool mu__boolexpr12;
  if (!(mu_start)) mu__boolexpr12 = FALSE ;
  else {
  mu__boolexpr12 = (!(mu_cur_node.isundefined())) ; 
}
...
bool mu__boolexpr28;
bool mu__boolexpr29;
  if (!(mu_start)) mu__boolexpr29 = FALSE ;
  else {
  mu__boolexpr29 = (!(mu_cur_node.isundefined())) ; 
}
  if (!(mu__boolexpr29)) mu__boolexpr28 = FALSE ;
  else {
  mu__boolexpr28 = ((mu_cur_node) == (mu_selc)) ; 
}
if ( mu__boolexpr28 )
{
if ( !(mu_state_ret_val.isundefined()) )
...
/********************
  Invariant records
 ********************/
int mu__invariant_38() // Invariant "P_I_ci_load_rset_0"
{
bool mu__boolexpr39;
bool mu__boolexpr40;
  ...
  for (mu_i = 0; ; mu_i=mu_i+1)
    {
      if (mu_reached_set.valid[(int)mu_i].value())
	{
	  if ( (mu_reached_set[mu_i]) == (mu_P_I) ) mu__intexpr44++;
	}
      if (mu_i == 3-1) break;
    }
  }
/*** end multisetcount 1 declaration ***/
  if (!((mu__intexpr44) == (0))) mu__boolexpr43 = FALSE ;
  else {
  ...
  for (mu_i = 0; ; mu_i=mu_i+1)
    {
      if (mu_reached_set.valid[(int)mu_i].value())
	{
	  if ( (mu_reached_set[mu_i]) == (mu_P_IVD) ) mu__intexpr45++;
	}
      if (mu_i == 3-1) break;
    }
  }
/*** end multisetcount 2 declaration ***/
  mu__boolexpr43 = ((mu__intexpr45) == (1)) ; 
}
  ...
  for (mu_i = 0; ; mu_i=mu_i+1)
    {
      if (mu_reached_set.valid[(int)mu_i].value())
	{
	  if ( (mu_reached_set[mu_i]) == (mu_P_V) ) mu__intexpr46++;
	}
      if (mu_i == 3-1) break;
    }
  }
/*** end multisetcount 3 declaration ***/
  mu__boolexpr42 = ((mu__intexpr46) == (1)) ; 
}
  if (!(mu__boolexpr42)) mu__boolexpr41 = FALSE ;
  else {
  mu__boolexpr41 = (mu_true) ; 
}
...
bool mu__condition_47() // Condition for Rule "P_I_ci_load_rset_0"
{
...
{"P_I_ci_load_rset_0", &mu__condition_47, NULL, },
};
