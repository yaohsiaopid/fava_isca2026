/******************************
  Program "past_builds/VI_build/core_s3_req_send/out/P_V_GetMsg_P_I_val.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_build/core_s3_req_send/out/P_V_GetMsg_P_I_val"
...
/********************
  Invariant records
 ********************/
int mu__invariant_23() // Invariant "ASSERT_P_V_to_P_I"
{
bool mu__boolexpr24;
bool mu__boolexpr25;
bool mu__boolexpr26;
  if (!(!(mu_prevProcs.isundefined()))) mu__boolexpr26 = FALSE ;
  else {
  mu__boolexpr26 = ((mu_prevProcs) == (mu_P_V)) ; 
}
  if (!(mu__boolexpr26)) mu__boolexpr25 = FALSE ;
  else {
  mu__boolexpr25 = ((mu_Procs[mu_selc].mu_state) == (mu_P_I)) ; 
}
  if (!(mu__boolexpr25)) mu__boolexpr24 = TRUE ;
  else {
  mu__boolexpr24 = ((mu_prevStateVal) == (mu_Procs[mu_selc].mu_val)) ; 
}
return mu__boolexpr24;
};

bool mu__condition_27() // Condition for Rule "ASSERT_P_V_to_P_I"
{
...
{"ASSERT_P_V_to_P_I", &mu__condition_27, NULL, },
};
