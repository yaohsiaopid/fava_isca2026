/******************************
  Program "past_builds/VI_build/s4_3_v2_src_dst/out/P_I_ci_store_0_trace_0_0_3.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_build/s4_3_v2_src_dst/out/P_I_ci_store_0_trace_0_0_3"
...
/*** Variable declaration ***/
mu_1_HomeStateEnum mu_prevHomeNode("prevHomeNode",8);

/*** Variable declaration ***/
mu_1_Home mu_selh("selh",16);

/*** Variable declaration ***/
mu_1__type_2 mu_msg_rec_set("msg_rec_set",24);

/*** Variable declaration ***/
mu_1__type_3 mu_msg_sent_set("msg_sent_set",48);

/*** Variable declaration ***/
mu_1_MessageType mu_prevMsg("prevMsg",72);

/*** Variable declaration ***/
mu_0_boolean mu_tracked("tracked",80);

/*** Variable declaration ***/
mu_0_boolean mu_start("start",88);

/*** Variable declaration ***/
mu_1__type_4 mu_reached_set("reached_set",96);

/*** Variable declaration ***/
mu_1_ProcStateEnum mu_prevProcs("prevProcs",144);

/*** Variable declaration ***/
mu_1_CoreReq mu_prevProcReq("prevProcReq",152);

/*** Variable declaration ***/
mu_1_Proc mu_selc("selc",176);

/*** Variable declaration ***/
mu_1_Node mu_prevMsgReceiver("prevMsgReceiver",184);

/*** Variable declaration ***/
mu_0_boolean mu_prevSent("prevSent",192);
...
bool mu__boolexpr11;
bool mu__boolexpr12;
  if (!(!(mu_prevHomeNode.isundefined()))) mu__boolexpr12 = FALSE ;
  else {
  mu__boolexpr12 = ((mu_prevHomeNode) != (mu_HomeNode.mu_state)) ; 
}
...
/*** begin multisetcount 0 declaration ***/
  ...
  for (mu_i = 0; ; mu_i=mu_i+1)
	...
	{
	  if ( (mu_reached_set[mu_i]) == (mu_cur_state) ) mu__intexpr13++;
	}
      if (mu_i == 3-1) break;
    }
  }
...
if (mu_m.isundefined())
  ...
  mu_cur_node = mu_m;
if (mu_HomeNode.mu_state.isundefined())
  mu_prevHomeNode.undefine();
else
  mu_prevHomeNode = mu_HomeNode.mu_state;
mu_prevMsg.undefine();
if (mu_Procs[mu_selc].mu_state.isundefined())
...
bool mu__boolexpr20;
bool mu__boolexpr21;
  if (!(!(mu_curRequsts[mu_p].mu_vld.isundefined()))) mu__boolexpr21 = FALSE ;
  else {
  mu__boolexpr21 = (mu_curRequsts[mu_p].mu_vld) ; 
}
  if (!(mu__boolexpr21)) mu__boolexpr20 = FALSE ;
  else {
  mu__boolexpr20 = ((mu_curRequsts[mu_p].mu_tp) == (mu_store)) ; 
}
if ( mu__boolexpr20 )
{
...
void world_class::print_statistic()
{
  ...
  mu_prevHomeNode.print_statistic();
  mu_selh.print_statistic();
...
void world_class::print_diff( state *prevstate )
{
  if ( prevstate != NULL )
  {
    ...
    mu_prevHomeNode.print_diff(prevstate);
    mu_selh.print_diff(prevstate);
...
void world_class::to_state(state *newstate)
{
  ...
  mu_prevHomeNode.to_state( newstate );
  mu_selh.to_state( newstate );
...
public:
  ...
  {
    return tsprintf("track_P_I_ci_store");
  }
...
bool mu__boolexpr24;
bool mu__boolexpr25;
  if (!(!(mu_tracked))) mu__boolexpr25 = FALSE ;
  else {
  mu__boolexpr25 = (!(mu_prevProcs.isundefined())) ; 
}
  if (!(mu__boolexpr25)) mu__boolexpr24 = FALSE ;
  else {
  mu__boolexpr24 = ((mu_prevProcs) == (mu_P_I)) ; 
}
  if (!(mu__boolexpr24)) mu__boolexpr23 = FALSE ;
  else {
  mu__boolexpr23 = (!(mu_prevProcReq.mu_tp.isundefined())) ; 
}
  if (!(mu__boolexpr23)) mu__boolexpr22 = FALSE ;
  else {
  mu__boolexpr22 = ((mu_prevProcReq.mu_tp) == (mu_ci_store)) ; 
}
...
bool mu__boolexpr28;
bool mu__boolexpr29;
  if (!(!(mu_tracked))) mu__boolexpr29 = FALSE ;
  else {
  mu__boolexpr29 = (!(mu_prevProcs.isundefined())) ; 
}
  if (!(mu__boolexpr29)) mu__boolexpr28 = FALSE ;
  else {
  mu__boolexpr28 = ((mu_prevProcs) == (mu_P_I)) ; 
}
  if (!(mu__boolexpr28)) mu__boolexpr27 = FALSE ;
  else {
  mu__boolexpr27 = (!(mu_prevProcReq.mu_tp.isundefined())) ; 
}
  if (!(mu__boolexpr27)) mu__boolexpr26 = FALSE ;
  else {
  mu__boolexpr26 = ((mu_prevProcReq.mu_tp) == (mu_ci_store)) ; 
}
	      if (mu__boolexpr26) {
		if ( ( TRUE  ) )
		  return;
...
for(int mu_n = 1; mu_n <= 6; mu_n++)
  if (( ( mu_n >= 1 ) && ( mu_n <= 3 ) )|| ( ( mu_n >= 6 ) && ( mu_n <= 6 ) )) {
bool mu__boolexpr30;
  if (!(mu_allAck)) mu__boolexpr30 = FALSE ;
  else {
  mu__boolexpr30 = (mu_ackBus[mu_n]) ; 
}
mu_allAck = mu__boolexpr30;
};
};
if ( mu_allAck )
{
...
bool mu__boolexpr31;
  ...
  void NextRule(unsigned & what_rule)
  {
	...
	if ( ( TRUE  ) ) {
bool mu__boolexpr32;
  if (!(!(mu_gBuf.mu_src.isundefined()))) mu__boolexpr32 = FALSE ;
  else {
  mu__boolexpr32 = (!(mu_ackBus[mu_n])) ; 
}
	      if (mu__boolexpr32) {
		if ( ( TRUE  ) )
		  return;
...
{
bool mu__boolexpr33;
  if (!(!(mu_cur_node.isundefined()))) mu__boolexpr33 = FALSE ;
  else {
...
bool mu__boolexpr34;
bool mu__boolexpr35;
  if (!(mu_start)) mu__boolexpr35 = FALSE ;
  else {
  mu__boolexpr35 = (!(mu_cur_node.isundefined())) ; 
}
  if (!(mu__boolexpr35)) mu__boolexpr34 = FALSE ;
  else {
  mu__boolexpr34 = ((mu_cur_node) == (mu_selc)) ; 
}
if ( mu__boolexpr34 )
{
...
bool mu__boolexpr37;
bool mu__boolexpr38;
  if (!(mu_start)) mu__boolexpr38 = FALSE ;
  else {
  mu__boolexpr38 = ((mu_gBuf.mu_mtype) == (mu_DataRespMsg)) ; 
}
  if (!(mu__boolexpr38)) mu__boolexpr37 = FALSE ;
  else {
  mu__boolexpr37 = (!(mu_cur_node.isundefined())) ; 
}
  if (!(mu__boolexpr37)) mu__boolexpr36 = FALSE ;
  else {
  mu__boolexpr36 = ((mu_cur_node) == (mu_selc)) ; 
}
if ( mu__boolexpr36 )
{
bool mu__boolexpr39;
  if (!(mu_chk)) mu__boolexpr39 = FALSE ;
  else {
  mu__boolexpr39 = ((mu_gBuf.mu_src>=6 && mu_gBuf.mu_src<=6)) ; 
}
mu_chk = mu__boolexpr39;
}
bool mu__boolexpr40;
bool mu__boolexpr41;
bool mu__boolexpr42;
  if (!(mu_start)) mu__boolexpr42 = FALSE ;
  else {
  mu__boolexpr42 = ((mu_gBuf.mu_mtype) == (mu_GetMsg)) ; 
}
  if (!(mu__boolexpr42)) mu__boolexpr41 = FALSE ;
  else {
  mu__boolexpr41 = ((mu_gBuf.mu_src) == (mu_selc)) ; 
}
  if (!(mu__boolexpr41)) mu__boolexpr40 = FALSE ;
  else {
  mu__boolexpr40 = ((mu_cur_node>=6 && mu_cur_node<=6)) ; 
}
if ( mu__boolexpr40 )
{
...
{
bool mu__boolexpr43;
  if (!(!(mu_cur_node.isundefined()))) mu__boolexpr43 = FALSE ;
  else {
...
bool mu__boolexpr44;
bool mu__boolexpr45;
  if (!(mu_start)) mu__boolexpr45 = FALSE ;
  else {
  mu__boolexpr45 = (!(mu_cur_node.isundefined())) ; 
}
  if (!(mu__boolexpr45)) mu__boolexpr44 = FALSE ;
  else {
  mu__boolexpr44 = ((mu_cur_node) == (mu_selc)) ; 
}
if ( mu__boolexpr44 )
{
mu_msg_rec_set[mu_gBuf.mu_mtype] = mu_true;
...
bool mu__boolexpr47;
bool mu__boolexpr48;
  if (!(mu_start)) mu__boolexpr48 = FALSE ;
  else {
  mu__boolexpr48 = ((mu_gBuf.mu_mtype) == (mu_DataRespMsg)) ; 
}
  if (!(mu__boolexpr48)) mu__boolexpr47 = FALSE ;
  else {
  mu__boolexpr47 = (!(mu_cur_node.isundefined())) ; 
}
  if (!(mu__boolexpr47)) mu__boolexpr46 = FALSE ;
  else {
  mu__boolexpr46 = ((mu_cur_node) == (mu_selc)) ; 
}
if ( mu__boolexpr46 )
{
bool mu__boolexpr49;
  if (!(mu_chk)) mu__boolexpr49 = FALSE ;
  else {
  mu__boolexpr49 = ((mu_gBuf.mu_src>=6 && mu_gBuf.mu_src<=6)) ; 
}
mu_chk = mu__boolexpr49;
}
bool mu__boolexpr50;
bool mu__boolexpr51;
bool mu__boolexpr52;
  if (!(mu_start)) mu__boolexpr52 = FALSE ;
  else {
  mu__boolexpr52 = ((mu_gBuf.mu_mtype) == (mu_GetMsg)) ; 
}
  if (!(mu__boolexpr52)) mu__boolexpr51 = FALSE ;
  else {
  mu__boolexpr51 = ((mu_gBuf.mu_src) == (mu_selc)) ; 
}
  if (!(mu__boolexpr51)) mu__boolexpr50 = FALSE ;
  else {
  mu__boolexpr50 = ((mu_cur_node>=6 && mu_cur_node<=6)) ; 
}
if ( mu__boolexpr50 )
{
if (mu_cur_node.isundefined())
...
bool mu__boolexpr53;
bool mu__boolexpr54;
  if (!((mu_p.mu_state) == (mu_P_V))) mu__boolexpr54 = FALSE ;
  else {
  mu__boolexpr54 = (!(mu_msgBufNonEmpty)) ; 
}
  if (!(mu__boolexpr54)) mu__boolexpr53 = FALSE ;
  else {
  mu__boolexpr53 = (mu_gBuf.mu_src.isundefined()) ; 
}
...
bool mu__boolexpr55;
bool mu__boolexpr56;
  if (!((mu_p.mu_state) == (mu_P_V))) mu__boolexpr56 = FALSE ;
  else {
  mu__boolexpr56 = (!(mu_msgBufNonEmpty)) ; 
}
  if (!(mu__boolexpr56)) mu__boolexpr55 = FALSE ;
  else {
  mu__boolexpr55 = (mu_gBuf.mu_src.isundefined()) ; 
}
	      if (mu__boolexpr55) {
		if ( ( TRUE  ) )
		  return;
...
bool mu__boolexpr57;
bool mu__boolexpr58;
  if (!((mu_p.mu_state) == (mu_P_I))) mu__boolexpr58 = FALSE ;
  else {
  mu__boolexpr58 = (!(mu_msgBufNonEmpty)) ; 
}
  if (!(mu__boolexpr58)) mu__boolexpr57 = FALSE ;
  else {
  mu__boolexpr57 = (mu_gBuf.mu_src.isundefined()) ; 
}
...
bool mu__boolexpr59;
bool mu__boolexpr60;
  if (!((mu_p.mu_state) == (mu_P_I))) mu__boolexpr60 = FALSE ;
  else {
  mu__boolexpr60 = (!(mu_msgBufNonEmpty)) ; 
}
  if (!(mu__boolexpr60)) mu__boolexpr59 = FALSE ;
  else {
  mu__boolexpr59 = (mu_gBuf.mu_src.isundefined()) ; 
}
	      if (mu__boolexpr59) {
		if ( ( TRUE  ) )
		  return;
...
bool mu__boolexpr61;
bool mu__boolexpr62;
  if (!((mu_p.mu_state) == (mu_P_I))) mu__boolexpr62 = FALSE ;
  else {
  mu__boolexpr62 = (!(mu_msgBufNonEmpty)) ; 
}
  if (!(mu__boolexpr62)) mu__boolexpr61 = FALSE ;
  else {
  mu__boolexpr61 = (mu_gBuf.mu_src.isundefined()) ; 
}
...
bool mu__boolexpr63;
bool mu__boolexpr64;
  if (!((mu_p.mu_state) == (mu_P_I))) mu__boolexpr64 = FALSE ;
  else {
  mu__boolexpr64 = (!(mu_msgBufNonEmpty)) ; 
}
  if (!(mu__boolexpr64)) mu__boolexpr63 = FALSE ;
  else {
  mu__boolexpr63 = (mu_gBuf.mu_src.isundefined()) ; 
}
	      if (mu__boolexpr63) {
		if ( ( TRUE  ) )
		  return;
...
/********************
  Invariant records
 ********************/
int mu__invariant_65() // Invariant "P_I_ci_store_rset_0"
{
bool mu__boolexpr66;
bool mu__boolexpr67;
bool mu__boolexpr68;
...
bool mu__boolexpr70;
bool mu__boolexpr71;
  if (!(mu_tracked)) mu__boolexpr71 = FALSE ;
  else {
  mu__boolexpr71 = (!(mu_start)) ; 
}
  ...
  for (mu_i = 0; ; mu_i=mu_i+1)
    {
      if (mu_reached_set.valid[(int)mu_i].value())
	{
	  if ( (mu_reached_set[mu_i]) == (mu_P_I) ) mu__intexpr72++;
	}
      if (mu_i == 3-1) break;
    }
  }
/*** end multisetcount 1 declaration ***/
  mu__boolexpr70 = ((mu__intexpr72) == (0)) ; 
}
  ...
  for (mu_i = 0; ; mu_i=mu_i+1)
    {
      if (mu_reached_set.valid[(int)mu_i].value())
	{
	  if ( (mu_reached_set[mu_i]) == (mu_P_IVD) ) mu__intexpr73++;
	}
      if (mu_i == 3-1) break;
    }
  }
/*** end multisetcount 2 declaration ***/
  mu__boolexpr69 = ((mu__intexpr73) == (1)) ; 
}
  ...
  for (mu_i = 0; ; mu_i=mu_i+1)
    {
      if (mu_reached_set.valid[(int)mu_i].value())
	{
	  if ( (mu_reached_set[mu_i]) == (mu_P_V) ) mu__intexpr74++;
	}
      if (mu_i == 3-1) break;
    }
  }
/*** end multisetcount 3 declaration ***/
  mu__boolexpr68 = ((mu__intexpr74) == (1)) ; 
}
...
bool mu__boolexpr78;
bool mu__boolexpr79;
  if (!((mu_msg_rec_set[mu_GetMsg]) == (mu_true))) mu__boolexpr79 = FALSE ;
  else {
  mu__boolexpr79 = ((mu_msg_rec_set[mu_PutMsg]) == (mu_false)) ; 
}
  if (!(mu__boolexpr79)) mu__boolexpr78 = FALSE ;
  else {
  mu__boolexpr78 = ((mu_msg_rec_set[mu_DataRespMsg]) == (mu_true)) ; 
}
  if (!(mu__boolexpr78)) mu__boolexpr77 = FALSE ;
  else {
  mu__boolexpr77 = ((mu_msg_sent_set[mu_GetMsg]) == (mu_true)) ; 
}
  if (!(mu__boolexpr77)) mu__boolexpr76 = FALSE ;
  else {
  mu__boolexpr76 = ((mu_msg_sent_set[mu_PutMsg]) == (mu_false)) ; 
}
  if (!(mu__boolexpr76)) mu__boolexpr75 = FALSE ;
  else {
  mu__boolexpr75 = ((mu_msg_sent_set[mu_DataRespMsg]) == (mu_false)) ; 
}
  mu__boolexpr67 = (mu__boolexpr75) ; 
}
  if (!(mu__boolexpr67)) mu__boolexpr66 = TRUE ;
  else {
  mu__boolexpr66 = (!(mu_chk)) ; 
}
return mu__boolexpr66;
};

bool mu__condition_80() // Condition for Rule "P_I_ci_store_rset_0"
{
...
int mu__invariant_81() // Invariant "swmr"
{
bool mu__quant82; 
mu__quant82 = TRUE;
{
...
bool mu__boolexpr84;
bool mu__boolexpr85;
  if (!((mu_c1) != (mu_c2))) mu__boolexpr85 = FALSE ;
  else {
  mu__boolexpr85 = ((mu_Procs[mu_c1].mu_state) == (mu_P_V)) ; 
}
  if (!(mu__boolexpr85)) mu__boolexpr84 = TRUE ;
  else {
  mu__boolexpr84 = ((mu_Procs[mu_c2].mu_state) != (mu_P_V)) ; 
}
if ( !(mu__boolexpr84) )
...
bool mu__condition_86() // Condition for Rule "swmr"
{
...
int mu__invariant_87() // Invariant "values in valid state match last write"
{
bool mu__quant88; 
mu__quant88 = TRUE;
{
for(int mu_n = 1; mu_n <= 3; mu_n++) {
bool mu__boolexpr89;
  if (!((mu_Procs[mu_n].mu_state) == (mu_P_V))) mu__boolexpr89 = TRUE ;
  else {
...
bool mu__condition_90() // Condition for Rule "values in valid state match last write"
{
...
int mu__invariant_91() // Invariant "value in memory matches value of last write, when invalid"
{
bool mu__boolexpr92;
  if (!((mu_HomeNode.mu_state) == (mu_H_I))) mu__boolexpr92 = TRUE ;
  else {
  mu__boolexpr92 = ((mu_MainMemory) == (mu_LastWrite)) ; 
}
return mu__boolexpr92;
};

bool mu__condition_93() // Condition for Rule "value in memory matches value of last write, when invalid"
{
...
int mu__invariant_94() // Invariant "Invalid implies empty owner"
{
bool mu__boolexpr95;
  if (!((mu_HomeNode.mu_state) == (mu_H_I))) mu__boolexpr95 = TRUE ;
  else {
bool mu__quant96; 
mu__quant96 = TRUE;
{
...
if ( !(!((mu_Procs[mu_n].mu_state) == (mu_P_V))) )
  { mu__quant96 = FALSE; break; }
};
};
  mu__boolexpr95 = (mu__quant96) ; 
}
return mu__boolexpr95;
};

bool mu__condition_97() // Condition for Rule "Invalid implies empty owner"
{
...
{"Invalid implies empty owner", &mu__condition_97, NULL, },
{"value in memory matches value of last write, when invalid", &mu__condition_93, NULL, },
{"values in valid state match last write", &mu__condition_90, NULL, },
{"swmr", &mu__condition_86, NULL, },
{"P_I_ci_store_rset_0", &mu__condition_80, NULL, },
};
...
void SymmetryClass::MultisetSort(state* s)
{
        ...
        mu_prevHomeNode.MultisetSort();
        mu_selh.MultisetSort();
  ...
  if (args->symmetry_reduction.value)
    {
      if (  args->sym_alg.mode == argsym_alg::Exhaustive_Fast_Canonicalize
          ...
          if (Perm.In(i))
            {
              ...
              if (args->multiset_reduction.value)
                mu_prevMsg.MultisetSort();
              mu_prevHomeNode.Permute(Perm,i);
              if (args->multiset_reduction.value)
                mu_prevHomeNode.MultisetSort();
              mu_selh.Permute(Perm,i);
              if (args->multiset_reduction.value)
                mu_selh.MultisetSort();
        ...
        if (ns != workingstate)
          ...
          if (args->multiset_reduction.value)
            mu_prevMsg.MultisetSort();
          mu_prevHomeNode.Permute(Perm,0);
          if (args->multiset_reduction.value)
            mu_prevHomeNode.MultisetSort();
          mu_selh.Permute(Perm,0);
          if (args->multiset_reduction.value)
            mu_selh.MultisetSort();
