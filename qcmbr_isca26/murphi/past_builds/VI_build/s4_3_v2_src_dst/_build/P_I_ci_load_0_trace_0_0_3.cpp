/******************************
  Program "past_builds/VI_build/s4_3_v2_src_dst/out/P_I_ci_load_0_trace_0_0_3.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_build/s4_3_v2_src_dst/out/P_I_ci_load_0_trace_0_0_3"
...
bool mu__boolexpr25;
  ...
  mu__boolexpr22 = ((mu_prevProcReq.mu_tp) == (mu_ci_load)) ; 
}
...
bool mu__boolexpr29;
  ...
  mu__boolexpr26 = ((mu_prevProcReq.mu_tp) == (mu_ci_load)) ; 
}
	      if (mu__boolexpr26) {
		if ( ( TRUE  ) )
		  return;
...
/********************
  Invariant records
 ********************/
int mu__invariant_65() // Invariant "P_I_ci_load_rset_0"
{
bool mu__boolexpr66;
bool mu__boolexpr67;
bool mu__boolexpr68;
...
bool mu__condition_80() // Condition for Rule "P_I_ci_load_rset_0"
{
...
{"P_I_ci_load_rset_0", &mu__condition_80, NULL, },
};
