/******************************
  Program "build/s2_req_proc_state/out/P_V_ci_store.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "build/s2_req_proc_state/out/P_V_ci_store"
...
/********************
  Invariant records
 ********************/
int mu__invariant_23() // Invariant "P_V_accept_and_perform_ci_store"
{
bool mu__boolexpr24;
bool mu__boolexpr25;
bool mu__boolexpr26;
bool mu__boolexpr27;
  ...
  mu__boolexpr27 = ((mu_prevProcs_2) == (mu_P_V)) ; 
}
...
bool mu__condition_29() // Condition for Rule "P_V_accept_and_perform_ci_store"
{
...
{"P_V_accept_and_perform_ci_store", &mu__condition_29, NULL, },
};
