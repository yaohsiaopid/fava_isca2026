/******************************
  Program "build/s2_req_proc_state/out/P_I_ci_load.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "build/s2_req_proc_state/out/P_I_ci_load"
...
/********************
  Invariant records
 ********************/
int mu__invariant_23() // Invariant "P_I_accept_and_perform_ci_load"
{
bool mu__boolexpr24;
bool mu__boolexpr25;
bool mu__boolexpr26;
...
bool mu__condition_29() // Condition for Rule "P_I_accept_and_perform_ci_load"
{
...
{"P_I_accept_and_perform_ci_load", &mu__condition_29, NULL, },
};
