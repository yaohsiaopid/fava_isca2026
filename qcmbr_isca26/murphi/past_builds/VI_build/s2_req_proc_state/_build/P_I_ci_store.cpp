/******************************
  Program "build/s2_req_proc_state/out/P_I_ci_store.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "build/s2_req_proc_state/out/P_I_ci_store"
...
/********************
  Invariant records
 ********************/
int mu__invariant_23() // Invariant "P_I_accept_and_perform_ci_store"
{
bool mu__boolexpr24;
bool mu__boolexpr25;
bool mu__boolexpr26;
bool mu__boolexpr27;
  if (!(!(mu_prevProcs_2.isundefined()))) mu__boolexpr27 = FALSE ;
  else {
  mu__boolexpr27 = ((mu_prevProcs_2) == (mu_P_I)) ; 
}
  if (!(mu__boolexpr27)) mu__boolexpr26 = FALSE ;
  else {
  mu__boolexpr26 = (!(mu_prevProcReq_2.mu_tp.isundefined())) ; 
}
  if (!(mu__boolexpr26)) mu__boolexpr25 = FALSE ;
  else {
  mu__boolexpr25 = ((mu_prevProcReq_2.mu_tp) == (mu_ci_store)) ; 
}
  if (!(mu__boolexpr25)) mu__boolexpr24 = TRUE ;
  else {
bool mu__boolexpr28;
  if (mu_prevProcReq.mu_tp.isundefined()) mu__boolexpr28 = TRUE ;
  else {
  mu__boolexpr28 = ((mu_prevProcReq.mu_tp) != (mu_ci_store)) ; 
}
...
bool mu__condition_29() // Condition for Rule "P_I_accept_and_perform_ci_store"
{
...
{"P_I_accept_and_perform_ci_store", &mu__condition_29, NULL, },
};
