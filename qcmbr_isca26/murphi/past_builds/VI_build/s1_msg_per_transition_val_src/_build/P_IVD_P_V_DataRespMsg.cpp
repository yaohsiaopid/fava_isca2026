/******************************
  Program "past_builds/VI_build/s1_msg_per_transition_val_src/out/P_IVD_P_V_DataRespMsg.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_build/s1_msg_per_transition_val_src/out/P_IVD_P_V_DataRespMsg"
...
/*** Variable declaration ***/
mu_1_ProcStateEnum mu_prevProcs("prevProcs",8);

/*** Variable declaration ***/
mu_1_Proc mu_selc("selc",16);

/*** Variable declaration ***/
mu_1_Value mu_tmpcl("tmpcl",24);
...
if ( mu__boolexpr6 )
{
if ( !((mu_tmpcl) == (mu_Procs[mu_selc].mu_val)) ) Error.Error("Assertion failed: DIFF_EQ_MSG");
}
bool mu__boolexpr9;
...
void SymmetryClass::Heuristic_Fast_Canonicalize(state* s)
{
  ...
  mu_tmpcl.SimpleCanonicalize(Perm);
