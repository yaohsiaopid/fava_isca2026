...
if (Procs[selc].state = P_IVD & prevStateVal != Procs[selc].val) then
  val_chk := true; 
...
(tracked & !start & cur_idx = 2 & 
 ...
 true) ->
!(val_chk = true); 
-- violation: P_IVD is in the reachable_set and change value is possible
