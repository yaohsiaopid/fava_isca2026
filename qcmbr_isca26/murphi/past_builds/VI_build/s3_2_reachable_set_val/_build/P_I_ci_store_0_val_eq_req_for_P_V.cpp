/******************************
  Program "past_builds/VI_build/s3_2_reachable_set_val/out/P_I_ci_store_0_val_eq_req_for_P_V.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_build/s3_2_reachable_set_val/out/P_I_ci_store_0_val_eq_req_for_P_V"
...
if ( mu_start )
{
if ( (mu_Procs[mu_selc].mu_state) == (mu_P_V) )
{
