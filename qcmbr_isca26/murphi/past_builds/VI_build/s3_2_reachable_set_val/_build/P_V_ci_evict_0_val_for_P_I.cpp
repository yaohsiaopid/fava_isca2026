/******************************
  Program "past_builds/VI_build/s3_2_reachable_set_val/out/P_V_ci_evict_0_val_for_P_I.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_build/s3_2_reachable_set_val/out/P_V_ci_evict_0_val_for_P_I"
...
/*** Variable declaration ***/
mu_1_CoreReq mu_prevProcReq("prevProcReq",48);

/*** Variable declaration ***/
mu_1_Proc mu_selc("selc",72);

/*** Variable declaration ***/
mu_0_boolean mu_val_chk("val_chk",80);
...
/*** Variable declaration ***/
mu_1__type_5 mu_ackBus("ackBus",200);

/*** Variable declaration ***/
mu_1__type_6 mu_msgBuf("msgBuf",232);

/*** Variable declaration ***/
mu_0_boolean mu_msgBufNonEmpty("msgBufNonEmpty",360);

/*** Variable declaration ***/
mu_1__type_7 mu_curRequsts("curRequsts",368);
...
{
bool mu__boolexpr9;
  if (!((mu_Procs[mu_selc].mu_state) == (mu_P_I))) mu__boolexpr9 = FALSE ;
  else {
...
{
bool mu__boolexpr10;
  if (!((mu_cur_idx) < (1))) mu__boolexpr10 = FALSE ;
  else {
...
bool mu__boolexpr16;
  ...
  mu__boolexpr15 = ((mu_prevProcs) == (mu_P_V)) ; 
}
  ...
  mu__boolexpr13 = ((mu_prevProcReq.mu_tp) == (mu_ci_evict)) ; 
}
...
bool mu__boolexpr20;
  ...
  mu__boolexpr19 = ((mu_prevProcs) == (mu_P_V)) ; 
}
  ...
  mu__boolexpr17 = ((mu_prevProcReq.mu_tp) == (mu_ci_evict)) ; 
}
	      if (mu__boolexpr17) {
		if ( ( TRUE  ) )
		  return;
...
/********************
  Invariant records
 ********************/
int mu__invariant_36() // Invariant "P_V_ci_evict_rset_0"
{
bool mu__boolexpr37;
bool mu__boolexpr38;
bool mu__boolexpr39;
...
bool mu__condition_41() // Condition for Rule "P_V_ci_evict_rset_0"
{
...
{"P_V_ci_evict_rset_0", &mu__condition_41, NULL, },
};
