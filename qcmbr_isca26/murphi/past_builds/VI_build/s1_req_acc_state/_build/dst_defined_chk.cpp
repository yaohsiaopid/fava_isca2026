/******************************
  Program "build/s1_req_acc_state/out/dst_defined_chk.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "build/s1_req_acc_state/out/dst_defined_chk"
...
/********************
  Invariant records
 ********************/
int mu__invariant_23() // Invariant "swmr"
{
bool mu__quant24; 
mu__quant24 = TRUE;
{
...
bool mu__boolexpr26;
bool mu__boolexpr27;
  if (!((mu_c1) != (mu_c2))) mu__boolexpr27 = FALSE ;
  else {
  mu__boolexpr27 = ((mu_Procs[mu_c1].mu_state) == (mu_P_V)) ; 
}
  if (!(mu__boolexpr27)) mu__boolexpr26 = TRUE ;
  else {
  mu__boolexpr26 = ((mu_Procs[mu_c2].mu_state) != (mu_P_V)) ; 
}
if ( !(mu__boolexpr26) )
...
bool mu__condition_28() // Condition for Rule "swmr"
{
...
int mu__invariant_29() // Invariant "values in valid state match last write"
{
bool mu__quant30; 
mu__quant30 = TRUE;
{
...
bool mu__boolexpr31;
  if (!((mu_Procs[mu_n].mu_state) == (mu_P_V))) mu__boolexpr31 = TRUE ;
  else {
  mu__boolexpr31 = ((mu_Procs[mu_n].mu_val) == (mu_LastWrite)) ; 
}
if ( !(mu__boolexpr31) )
...
bool mu__condition_32() // Condition for Rule "values in valid state match last write"
{
...
int mu__invariant_33() // Invariant "value in memory matches value of last write, when invalid"
{
bool mu__boolexpr34;
  if (!((mu_HomeNode.mu_state) == (mu_H_I))) mu__boolexpr34 = TRUE ;
  else {
  mu__boolexpr34 = ((mu_MainMemory) == (mu_LastWrite)) ; 
}
return mu__boolexpr34;
};

bool mu__condition_35() // Condition for Rule "value in memory matches value of last write, when invalid"
{
...
int mu__invariant_36() // Invariant "Invalid implies empty owner"
{
bool mu__boolexpr37;
...
if ( !(!((mu_Procs[mu_n].mu_state) == (mu_P_V))) )
  ...
  mu__boolexpr37 = (mu__quant38) ; 
}
return mu__boolexpr37;
};

bool mu__condition_39() // Condition for Rule "Invalid implies empty owner"
{
...
{"Invalid implies empty owner", &mu__condition_39, NULL, },
{"value in memory matches value of last write, when invalid", &mu__condition_35, NULL, },
{"values in valid state match last write", &mu__condition_32, NULL, },
{"swmr", &mu__condition_28, NULL, },
};
