/******************************
  Program "build/s1_req_acc_state/out/P_V_ci_evict.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "build/s1_req_acc_state/out/P_V_ci_evict"
...
mu_1_CoreReq mu_prevProcReq("prevProcReq",0);

/*** Variable declaration ***/
mu_1_ProcStateEnum mu_prevProcs("prevProcs",24);
...
/********************
  Invariant records
 ********************/
int mu__invariant_23() // Invariant "P_V_accept_req_ci_evict"
{
bool mu__boolexpr24;
bool mu__boolexpr25;
...
bool mu__condition_27() // Condition for Rule "P_V_accept_req_ci_evict"
{
...
{"P_V_accept_req_ci_evict", &mu__condition_27, NULL, },
};
