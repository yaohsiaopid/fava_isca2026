/******************************
  Program "past_builds/VI_build/s1_msg_per_transition/out/P_IVD_P_V_sent_trace.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_build/s1_msg_per_transition/out/P_IVD_P_V_sent_trace"
...
bool mu__boolexpr29;
  ...
  mu__boolexpr29 = ((mu_prevProcs) == (mu_P_IVD)) ; 
}
  if (!(mu__boolexpr29)) mu__boolexpr28 = TRUE ;
  else {
  mu__boolexpr28 = (!((mu_Procs[mu_selc].mu_state) == (mu_P_V))) ; 
}
return mu__boolexpr28;
};

bool mu__condition_30() // Condition for Rule "P_IVD_to_P_V"
{
...
{"P_IVD_to_P_V", &mu__condition_30, NULL, },
};
