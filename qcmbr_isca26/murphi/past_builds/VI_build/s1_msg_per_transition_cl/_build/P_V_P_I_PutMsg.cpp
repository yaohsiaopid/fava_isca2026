/******************************
  Program "past_builds/VI_build/s1_msg_per_transition_cl/out/P_V_P_I_PutMsg.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_build/s1_msg_per_transition_cl/out/P_V_P_I_PutMsg"
...
bool mu__boolexpr10;
  ...
  mu__boolexpr6 = ((mu_gBuf.mu_mtype) == (mu_PutMsg)) ; 
}
if ( mu__boolexpr6 )
{
...
bool mu__boolexpr15;
  ...
  mu__boolexpr11 = ((mu_msg.mu_mtype) == (mu_PutMsg)) ; 
}
if ( mu__boolexpr11 )
{
