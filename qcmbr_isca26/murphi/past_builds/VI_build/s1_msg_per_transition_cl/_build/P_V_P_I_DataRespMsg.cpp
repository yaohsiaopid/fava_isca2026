/******************************
  Program "past_builds/VI_build/s1_msg_per_transition_cl/out/P_V_P_I_DataRespMsg.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_build/s1_msg_per_transition_cl/out/P_V_P_I_DataRespMsg"
...
bool mu__boolexpr10;
  ...
  mu__boolexpr10 = ((mu_cur_node) == (mu_selc)) ; 
}
  if (!(mu__boolexpr10)) mu__boolexpr9 = FALSE ;
  else {
  mu__boolexpr9 = (!(mu_prevProcs.isundefined())) ; 
}
  if (!(mu__boolexpr9)) mu__boolexpr8 = FALSE ;
  else {
  mu__boolexpr8 = ((mu_prevProcs) == (mu_P_V)) ; 
}
  if (!(mu__boolexpr8)) mu__boolexpr7 = FALSE ;
  else {
  mu__boolexpr7 = ((mu_Procs[mu_selc].mu_state) == (mu_P_I)) ; 
}
...
if ( mu__boolexpr6 )
{
if ( !((mu_gBuf.mu_val) == (mu_prevStateVal)) ) Error.Error("Assertion failed: DIFF");
}
};
/*** end procedure declaration ***/
...
bool mu__boolexpr15;
  ...
  mu__boolexpr12 = ((mu_Procs[mu_selc].mu_state) == (mu_P_I)) ; 
}
  if (!(mu__boolexpr12)) mu__boolexpr11 = FALSE ;
  else {
  mu__boolexpr11 = ((mu_msg.mu_mtype) == (mu_DataRespMsg)) ; 
}
if ( mu__boolexpr11 )
{
if ( !((mu_msg.mu_val) == (mu_prevStateVal)) ) Error.Error("Assertion failed: DIFF");
}
};
/*** end procedure declaration ***/
