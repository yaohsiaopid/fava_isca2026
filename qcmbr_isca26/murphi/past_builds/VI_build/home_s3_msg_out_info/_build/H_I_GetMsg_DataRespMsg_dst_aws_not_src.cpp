/******************************
  Program "build/home_s3_msg_out_info/out/H_I_GetMsg_DataRespMsg_dst_aws_not_src.m" compiled by "Caching Murphi Release 5.4.9.1"

  Murphi Last Compiled date: "Oct 27 2025"
 ******************************/
...
#define MURPHI_DATE "Oct 27 2025"
#define PROTOCOL_NAME "build/home_s3_msg_out_info/out/H_I_GetMsg_DataRespMsg_dst_aws_not_src"
...
bool mu__boolexpr14;
bool mu__boolexpr15;
  if (!(!(mu_curRequsts[mu_p].mu_vld.isundefined()))) mu__boolexpr15 = FALSE ;
  else {
  mu__boolexpr15 = (mu_curRequsts[mu_p].mu_vld) ; 
}
  if (!(mu__boolexpr15)) mu__boolexpr14 = FALSE ;
  else {
  mu__boolexpr14 = ((mu_curRequsts[mu_p].mu_tp) == (mu_store)) ; 
}
if ( mu__boolexpr14 )
{
...
for(int mu_n = 1; mu_n <= 6; mu_n++)
  if (( ( mu_n >= 1 ) && ( mu_n <= 3 ) )|| ( ( mu_n >= 6 ) && ( mu_n <= 6 ) )) {
bool mu__boolexpr16;
  if (!(mu_allAck)) mu__boolexpr16 = FALSE ;
  else {
  mu__boolexpr16 = (mu_ackBus[mu_n]) ; 
}
mu_allAck = mu__boolexpr16;
};
};
if ( mu_allAck )
{
...
public:
  ...
  bool Condition(unsigned r)
  {
    ...
    r = r / 4;
bool mu__boolexpr17;
  if (!(!(mu_gBuf.mu_src.isundefined()))) mu__boolexpr17 = FALSE ;
  else {
  mu__boolexpr17 = (!(mu_ackBus[mu_n])) ; 
}
  ...
  void NextRule(unsigned & what_rule)
  {
	...
	if ( ( TRUE  ) ) {
bool mu__boolexpr18;
  if (!(!(mu_gBuf.mu_src.isundefined()))) mu__boolexpr18 = FALSE ;
  else {
  mu__boolexpr18 = (!(mu_ackBus[mu_n])) ; 
}
	      if (mu__boolexpr18) {
		if ( ( TRUE  ) )
		  return;
...
{
bool mu__boolexpr19;
  if (!(!(mu_cur_node.isundefined()))) mu__boolexpr19 = FALSE ;
  else {
  mu__boolexpr19 = ((mu_cur_node) == (mu_selh)) ; 
}
if ( mu__boolexpr19 )
{
...
{
bool mu__boolexpr20;
  if (!(!(mu_cur_node.isundefined()))) mu__boolexpr20 = FALSE ;
  else {
  mu__boolexpr20 = ((mu_cur_node) == (mu_selh)) ; 
}
if ( mu__boolexpr20 )
{
if (mu_gBuf.mu_mtype.isundefined())
...
bool mu__boolexpr23;
bool mu__boolexpr24;
  if (!((mu_p.mu_state) == (mu_P_V))) mu__boolexpr24 = FALSE ;
  else {
...
bool mu__boolexpr31;
bool mu__boolexpr32;
  if (!((mu_p.mu_state) == (mu_P_I))) mu__boolexpr32 = FALSE ;
  else {
...
/********************
  Invariant records
 ********************/
int mu__invariant_33() // Invariant "ASSERT_H_I_accept_req_GetMsg"
{
bool mu__boolexpr34;
bool mu__boolexpr35;
bool mu__boolexpr36;
bool mu__boolexpr37;
bool mu__boolexpr38;
  if (!(!(mu_prevHomeNode.isundefined()))) mu__boolexpr38 = FALSE ;
  else {
  mu__boolexpr38 = ((mu_prevHomeNode) == (mu_H_I)) ; 
}
  if (!(mu__boolexpr38)) mu__boolexpr37 = FALSE ;
  else {
  mu__boolexpr37 = (!(mu_prevRecProcMsg.isundefined())) ; 
}
  if (!(mu__boolexpr37)) mu__boolexpr36 = FALSE ;
  else {
  mu__boolexpr36 = ((mu_prevRecProcMsg) == (mu_GetMsg)) ; 
}
  if (!(mu__boolexpr36)) mu__boolexpr35 = FALSE ;
  else {
  mu__boolexpr35 = (mu_sent) ; 
}
  if (!(mu__boolexpr35)) mu__boolexpr34 = TRUE ;
  else {
  mu__boolexpr34 = (!((mu_out_msg_dst) == (mu_in_msg_src))) ; 
}
return mu__boolexpr34;
};

bool mu__condition_39() // Condition for Rule "ASSERT_H_I_accept_req_GetMsg"
{
...
int mu__invariant_40() // Invariant "swmr"
{
bool mu__quant41; 
mu__quant41 = TRUE;
{
...
bool mu__boolexpr43;
bool mu__boolexpr44;
  if (!((mu_c1) != (mu_c2))) mu__boolexpr44 = FALSE ;
  else {
  mu__boolexpr44 = ((mu_Procs[mu_c1].mu_state) == (mu_P_V)) ; 
}
  if (!(mu__boolexpr44)) mu__boolexpr43 = TRUE ;
  else {
  mu__boolexpr43 = ((mu_Procs[mu_c2].mu_state) != (mu_P_V)) ; 
}
if ( !(mu__boolexpr43) )
...
bool mu__condition_45() // Condition for Rule "swmr"
{
...
int mu__invariant_46() // Invariant "values in valid state match last write"
{
bool mu__quant47; 
mu__quant47 = TRUE;
{
...
bool mu__boolexpr48;
  if (!((mu_Procs[mu_n].mu_state) == (mu_P_V))) mu__boolexpr48 = TRUE ;
  else {
  mu__boolexpr48 = ((mu_Procs[mu_n].mu_val) == (mu_LastWrite)) ; 
}
if ( !(mu__boolexpr48) )
...
bool mu__boolexpr51;
  ...
  mu__boolexpr51 = ((mu_MainMemory) == (mu_LastWrite)) ; 
}
...
bool mu__condition_56() // Condition for Rule "Invalid implies empty owner"
{
...
{"Invalid implies empty owner", &mu__condition_56, NULL, },
{"value in memory matches value of last write, when invalid", &mu__condition_52, NULL, },
{"values in valid state match last write", &mu__condition_49, NULL, },
{"swmr", &mu__condition_45, NULL, },
{"ASSERT_H_I_accept_req_GetMsg", &mu__condition_39, NULL, },
};
