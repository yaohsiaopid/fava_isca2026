/******************************
  Program "past_builds/VI_buggy_build/s3_2_reachable_set_val/out/P_V_ci_evict_0_val_for_P_I.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_buggy_build/s3_2_reachable_set_val/out/P_V_ci_evict_0_val_for_P_I"
...
bool mu__boolexpr14;
  ...
  mu__boolexpr13 = ((mu_prevProcs) == (mu_P_V)) ; 
}
  ...
  mu__boolexpr11 = ((mu_prevProcReq.mu_tp) == (mu_ci_evict)) ; 
}
...
bool mu__boolexpr18;
  ...
  mu__boolexpr17 = ((mu_prevProcs) == (mu_P_V)) ; 
}
  ...
  mu__boolexpr15 = ((mu_prevProcReq.mu_tp) == (mu_ci_evict)) ; 
}
	      if (mu__boolexpr15) {
		if ( ( TRUE  ) )
		  return;
...
/********************
  Invariant records
 ********************/
int mu__invariant_34() // Invariant "P_V_ci_evict_rset_0"
{
bool mu__boolexpr35;
bool mu__boolexpr36;
bool mu__boolexpr37;
...
bool mu__condition_39() // Condition for Rule "P_V_ci_evict_rset_0"
{
...
{"P_V_ci_evict_rset_0", &mu__condition_39, NULL, },
};
