/******************************
  Program "past_builds/VI_buggy_build/s3_2_reachable_set_val/out/P_I_ci_store_0_val_eq_req_for_P_IVD.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_buggy_build/s3_2_reachable_set_val/out/P_I_ci_store_0_val_eq_req_for_P_IVD"
...
bool mu__boolexpr14;
  ...
  mu__boolexpr11 = ((mu_prevProcReq.mu_tp) == (mu_ci_store)) ; 
}
...
bool mu__boolexpr18;
  ...
  mu__boolexpr15 = ((mu_prevProcReq.mu_tp) == (mu_ci_store)) ; 
}
	      if (mu__boolexpr15) {
		if ( ( TRUE  ) )
		  return;
...
/********************
  Invariant records
 ********************/
int mu__invariant_34() // Invariant "P_I_ci_store_rset_0"
{
bool mu__boolexpr35;
bool mu__boolexpr36;
bool mu__boolexpr37;
bool mu__boolexpr38;
  ...
  mu__boolexpr37 = ((mu_cur_idx) == (2)) ; 
}
  if (!(mu__boolexpr37)) mu__boolexpr36 = FALSE ;
  else {
  mu__boolexpr36 = (mu_true) ; 
}
  if (!(mu__boolexpr36)) mu__boolexpr35 = TRUE ;
  else {
  mu__boolexpr35 = ((mu_val_chk) == (mu_true)) ; 
}
return mu__boolexpr35;
};

bool mu__condition_39() // Condition for Rule "P_I_ci_store_rset_0"
{
...
{"P_I_ci_store_rset_0", &mu__condition_39, NULL, },
};
