/******************************
  Program "past_builds/VI_buggy_build/global_chk/out/P_V_imply_cover_H_V.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_buggy_build/global_chk/out/P_V_imply_cover_H_V"
...
/********************
  Invariant records
 ********************/
int mu__invariant_21() // Invariant "P_V_imply_H_V"
{
bool mu__quant22; 
mu__quant22 = TRUE;
{
...
if ( !(mu__boolexpr29) )
  ...
  mu__boolexpr24 = ((mu_Procs[mu_n].mu_state) == (mu_P_V)) ; 
}
...
bool mu__condition_31() // Condition for Rule "P_V_imply_H_V"
{
...
{"P_V_imply_H_V", &mu__condition_31, NULL, },
};
