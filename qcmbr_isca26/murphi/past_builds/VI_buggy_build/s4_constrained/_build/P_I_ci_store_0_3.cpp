/******************************
  Program "past_builds/VI_buggy_build/s4_constrained/out/P_I_ci_store_0_3.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_buggy_build/s4_constrained/out/P_I_ci_store_0_3"
...
/*** Variable declaration ***/
mu_1_ProcStateEnum mu_prevProcs("prevProcs",80);

/*** Variable declaration ***/
mu_1_CoreReq mu_prevProcReq("prevProcReq",88);

/*** Variable declaration ***/
mu_1_Proc mu_selc("selc",112);

/*** Variable declaration ***/
mu_1__type_5 mu_match("match",120);

/*** Variable declaration ***/
mu_1_HomeState mu_HomeNode("HomeNode",128);

/*** Variable declaration ***/
mu_1__type_6 mu_Procs("Procs",144);
...
/*** Variable declaration ***/
mu_1__type_7 mu_ackBus("ackBus",240);

/*** Variable declaration ***/
mu_1__type_8 mu_msgBuf("msgBuf",272);

/*** Variable declaration ***/
mu_0_boolean mu_msgBufNonEmpty("msgBufNonEmpty",400);

/*** Variable declaration ***/
mu_1__type_9 mu_curRequsts("curRequsts",408);
...
for(int mu_n = 1; mu_n <= 6; mu_n++)
  if (( ( mu_n >= 1 ) && ( mu_n <= 3 ) )|| ( ( mu_n >= 6 ) && ( mu_n <= 6 ) )) {
bool mu__boolexpr24;
  if (!(mu_allAck)) mu__boolexpr24 = FALSE ;
  else {
  mu__boolexpr24 = (mu_ackBus[mu_n]) ; 
}
mu_allAck = mu__boolexpr24;
};
};
if ( mu_allAck )
{
...
public:
  ...
  bool Condition(unsigned r)
  {
    ...
    r = r / 4;
bool mu__boolexpr25;
  if (!(!(mu_gBuf.mu_src.isundefined()))) mu__boolexpr25 = FALSE ;
  else {
  mu__boolexpr25 = (!(mu_ackBus[mu_n])) ; 
}
  ...
  void NextRule(unsigned & what_rule)
  {
	...
	if ( ( TRUE  ) ) {
bool mu__boolexpr26;
  if (!(!(mu_gBuf.mu_src.isundefined()))) mu__boolexpr26 = FALSE ;
  else {
...
bool mu__boolexpr27;
bool mu__boolexpr28;
  if (!(mu_start)) mu__boolexpr28 = FALSE ;
  else {
  mu__boolexpr28 = (!(mu_cur_node.isundefined())) ; 
}
  if (!(mu__boolexpr28)) mu__boolexpr27 = FALSE ;
  else {
  mu__boolexpr27 = ((mu_cur_node) == (mu_selc)) ; 
}
if ( mu__boolexpr27 )
{
...
/********************
  Invariant records
 ********************/
int mu__invariant_43() // Invariant "P_I_ci_store_rset_0"
{
bool mu__boolexpr44;
bool mu__boolexpr45;
bool mu__boolexpr46;
  ...
  mu__boolexpr45 = ((mu_cur_idx) == (2)) ; 
}
  if (!(mu__boolexpr45)) mu__boolexpr44 = TRUE ;
  else {
  mu__boolexpr44 = ((mu_match) != (2)) ; 
}
return mu__boolexpr44;
};

bool mu__condition_47() // Condition for Rule "P_I_ci_store_rset_0"
{
...
{"P_I_ci_store_rset_0", &mu__condition_47, NULL, },
};
