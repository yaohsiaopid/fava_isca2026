/******************************
  Program "past_builds/VI_buggy_build/globl_dir_imp/out/P_I_imply_no_other_P_V.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_buggy_build/globl_dir_imp/out/P_I_imply_no_other_P_V"
#define BITS_IN_WORLD 368
#define ALIGN
...
mu_1_HomeStateEnum mu_prevHomeNode("prevHomeNode",0);

/*** Variable declaration ***/
mu_1_Home mu_selh("selh",8);

/*** Variable declaration ***/
mu_1_HomeState mu_HomeNode("HomeNode",16);

/*** Variable declaration ***/
mu_1__type_2 mu_Procs("Procs",32);

/*** Variable declaration ***/
mu_1_Value mu_LastWrite("LastWrite",80);

/*** Variable declaration ***/
mu_1_Value mu_MainMemory("MainMemory",88);

/*** Variable declaration ***/
mu_1_Message mu_gBuf("gBuf",96);

/*** Variable declaration ***/
mu_1__type_3 mu_ackBus("ackBus",128);

/*** Variable declaration ***/
mu_1__type_4 mu_msgBuf("msgBuf",160);

/*** Variable declaration ***/
mu_0_boolean mu_msgBufNonEmpty("msgBufNonEmpty",288);

/*** Variable declaration ***/
mu_1__type_5 mu_curRequsts("curRequsts",296);
...
/********************
  Invariant records
 ********************/
int mu__invariant_21() // Invariant "P_I_imply_not_P_V_others"
{
bool mu__quant22; 
mu__quant22 = TRUE;
{
...
mu__quant26 = TRUE;
{
for(int mu_tmpn = 1; mu_tmpn <= 3; mu_tmpn++) {
bool mu__boolexpr27;
  if ((mu_Procs[mu_tmpn].mu_state) == (mu_P_I)) mu__boolexpr27 = TRUE ;
  else {
  mu__boolexpr27 = ((mu_Procs[mu_tmpn].mu_state) == (mu_P_V)) ; 
}
if ( !(mu__boolexpr27) )
  { mu__quant26 = FALSE; break; }
};
};
  if (!(mu__quant26)) mu__boolexpr25 = FALSE ;
  else {
bool mu__quant28; 
mu__quant28 = TRUE;
{
for(int mu_d = 6; mu_d <= 6; mu_d++) {
bool mu__boolexpr29;
  if ((mu_HomeNode.mu_state) == (mu_H_I)) mu__boolexpr29 = TRUE ;
  else {
  mu__boolexpr29 = ((mu_HomeNode.mu_state) == (mu_H_V)) ; 
}
if ( !(mu__boolexpr29) )
  { mu__quant28 = FALSE; break; }
};
};
  mu__boolexpr25 = (mu__quant28) ; 
}
  if (!(mu__boolexpr25)) mu__boolexpr24 = FALSE ;
  else {
  mu__boolexpr24 = ((mu_Procs[mu_n1].mu_state) == (mu_P_I)) ; 
}
...
bool mu__boolexpr31;
  if (!((mu_n2) != (mu_n1))) mu__boolexpr31 = TRUE ;
  else {
  mu__boolexpr31 = ((mu_Procs[mu_n2].mu_state) != (mu_P_V)) ; 
}
if ( !(mu__boolexpr31) )
  { mu__quant30 = FALSE; break; }
};
};
  mu__boolexpr23 = (mu__quant30) ; 
}
if ( !(mu__boolexpr23) )
...
bool mu__condition_32() // Condition for Rule "P_I_imply_not_P_V_others"
{
...
{"P_I_imply_not_P_V_others", &mu__condition_32, NULL, },
};
