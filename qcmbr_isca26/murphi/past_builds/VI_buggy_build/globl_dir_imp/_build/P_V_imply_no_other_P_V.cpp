/******************************
  Program "past_builds/VI_buggy_build/globl_dir_imp/out/P_V_imply_no_other_P_V.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_buggy_build/globl_dir_imp/out/P_V_imply_no_other_P_V"
...
/********************
  Invariant records
 ********************/
int mu__invariant_21() // Invariant "P_V_imply_not_P_V_others"
{
bool mu__quant22; 
mu__quant22 = TRUE;
{
...
if ( !(mu__boolexpr29) )
  ...
  mu__boolexpr24 = ((mu_Procs[mu_n1].mu_state) == (mu_P_V)) ; 
}
...
bool mu__condition_32() // Condition for Rule "P_V_imply_not_P_V_others"
{
...
{"P_V_imply_not_P_V_others", &mu__condition_32, NULL, },
};
