/******************************
  Program "past_builds/VI_buggy_build/s1_msg_per_transition/out/P_IVD_P_V_sent_trace.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_buggy_build/s1_msg_per_transition/out/P_IVD_P_V_sent_trace"
...
/********************
  Invariant records
 ********************/
int mu__invariant_25() // Invariant "P_IVD_to_P_V"
{
bool mu__boolexpr26;
bool mu__boolexpr27;
  if (!(!(mu_prevProcs.isundefined()))) mu__boolexpr27 = FALSE ;
  else {
  mu__boolexpr27 = ((mu_prevProcs) == (mu_P_IVD)) ; 
}
  if (!(mu__boolexpr27)) mu__boolexpr26 = TRUE ;
  else {
  mu__boolexpr26 = (!((mu_Procs[mu_selc].mu_state) == (mu_P_V))) ; 
}
return mu__boolexpr26;
};

bool mu__condition_28() // Condition for Rule "P_IVD_to_P_V"
{
...
{"P_IVD_to_P_V", &mu__condition_28, NULL, },
};
