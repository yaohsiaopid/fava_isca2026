/******************************
  Program "past_builds/VI_buggy_build/core_s2_req_acc_state_prime/out/P_V_GetMsg_P_I.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_buggy_build/core_s2_req_acc_state_prime/out/P_V_GetMsg_P_I"
...
/********************
  Invariant records
 ********************/
int mu__invariant_25() // Invariant "P_V_rec_GetMsg"
{
bool mu__boolexpr26;
bool mu__boolexpr27;
bool mu__boolexpr28;
...
bool mu__boolexpr34;
  ...
  mu__boolexpr26 = (!((mu_Procs[mu_selc].mu_state) == (mu_P_I))) ; 
}
