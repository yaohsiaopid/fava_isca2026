/******************************
  Program "past_builds/VI_buggy_build/s1_3_global_msg/out/DataRespMsg_from_core_to_home.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_buggy_build/s1_3_global_msg/out/DataRespMsg_from_core_to_home"
...
/*** Variable declaration ***/
mu_1_ProcStateEnum mu_prevProcs("prevProcs",56);

/*** Variable declaration ***/
mu_1_Proc mu_selc("selc",64);
...
/********************
  Invariant records
 ********************/
int mu__invariant_25() // Invariant "home_rec_from_core_DataRespMsg"
{
bool mu__boolexpr26;
bool mu__boolexpr27;
  if (!(!(mu_prevMsg.isundefined()))) mu__boolexpr27 = FALSE ;
  else {
  mu__boolexpr27 = ((mu_prevMsg) == (mu_DataRespMsg)) ; 
}
...
bool mu__boolexpr30;
  ...
  mu__boolexpr30 = ((mu_prevHomeNode) != (mu_HomeNode.mu_state)) ; 
}
  if (mu__boolexpr30) mu__boolexpr29 = TRUE ;
  else {
bool mu__boolexpr31;
  if (!(!(mu_prevMsgDst.isundefined()))) mu__boolexpr31 = FALSE ;
  else {
  mu__boolexpr31 = ((mu_prevMsgDst) == (mu_selh)) ; 
}
  mu__boolexpr29 = (mu__boolexpr31) ; 
}
  if (mu__boolexpr29) mu__boolexpr28 = TRUE ;
  else {
  mu__boolexpr28 = (!(mu_prevSentMsg.isundefined())) ; 
}
...
bool mu__condition_32() // Condition for Rule "home_rec_from_core_DataRespMsg"
{
...
{"home_rec_from_core_DataRespMsg", &mu__condition_32, NULL, },
};
