/******************************
  Program "past_builds/VI_buggy_build/s1_3_global_msg/out/PutMsg_from_core_to_core.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_buggy_build/s1_3_global_msg/out/PutMsg_from_core_to_core"
...
/********************
  Invariant records
 ********************/
int mu__invariant_25() // Invariant "core_rec_from_Proc_PutMsg"
{
bool mu__boolexpr26;
bool mu__boolexpr27;
bool mu__boolexpr28;
  ...
  mu__boolexpr28 = ((mu_prevMsg) == (mu_PutMsg)) ; 
}
...
bool mu__condition_34() // Condition for Rule "core_rec_from_Proc_PutMsg"
{
...
{"core_rec_from_Proc_PutMsg", &mu__condition_34, NULL, },
};
