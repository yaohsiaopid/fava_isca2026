/******************************
  Program "past_builds/VI_buggy_build/s1_3_global_msg/out/GetMsg_from_core_to_home.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_buggy_build/s1_3_global_msg/out/GetMsg_from_core_to_home"
...
/********************
  Invariant records
 ********************/
int mu__invariant_25() // Invariant "home_rec_from_core_GetMsg"
{
bool mu__boolexpr26;
bool mu__boolexpr27;
  if (!(!(mu_prevMsg.isundefined()))) mu__boolexpr27 = FALSE ;
  else {
  mu__boolexpr27 = ((mu_prevMsg) == (mu_GetMsg)) ; 
}
...
bool mu__condition_32() // Condition for Rule "home_rec_from_core_GetMsg"
{
...
{"home_rec_from_core_GetMsg", &mu__condition_32, NULL, },
};
