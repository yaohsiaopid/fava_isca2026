...
invariant "swmr"
  ...
  -- can a core ever receives and proc DataRespMsg message with src from someone
  invariant "home_rec_from_core_DataRespMsg"
  !(!isundefined(prevMsg) & prevMsg = DataRespMsg & 
    -- proecess or dst defined
    ((!isundefined(prevHomeNode) & prevHomeNode != HomeNode.state) |
