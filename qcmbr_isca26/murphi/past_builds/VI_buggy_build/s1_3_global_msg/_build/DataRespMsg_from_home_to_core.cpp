/******************************
  Program "past_builds/VI_buggy_build/s1_3_global_msg/out/DataRespMsg_from_home_to_core.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_buggy_build/s1_3_global_msg/out/DataRespMsg_from_home_to_core"
...
/********************
  Invariant records
 ********************/
int mu__invariant_25() // Invariant "core_rec_from_Home_DataRespMsg"
{
bool mu__boolexpr26;
bool mu__boolexpr27;
bool mu__boolexpr28;
  if (!(!(mu_prevMsg.isundefined()))) mu__boolexpr28 = FALSE ;
  else {
  mu__boolexpr28 = ((mu_prevMsg) == (mu_DataRespMsg)) ; 
}
...
bool mu__boolexpr30;
bool mu__boolexpr31;
  if (!(!(mu_prevProcs.isundefined()))) mu__boolexpr31 = FALSE ;
  else {
  mu__boolexpr31 = ((mu_prevProcs) != (mu_Procs[mu_selc].mu_state)) ; 
}
...
bool mu__boolexpr32;
  ...
  mu__boolexpr32 = ((mu_prevMsgDst) == (mu_selc)) ; 
}
  mu__boolexpr30 = (mu__boolexpr32) ; 
}
  if (mu__boolexpr30) mu__boolexpr29 = TRUE ;
  else {
  mu__boolexpr29 = (!(mu_prevSentMsg.isundefined())) ; 
}
...
bool mu__boolexpr33;
  if (!(!(mu_prevMsgSrc.isundefined()))) mu__boolexpr33 = FALSE ;
  else {
  mu__boolexpr33 = ((mu_prevMsgSrc>=6 && mu_prevMsgSrc<=6)) ; 
}
...
bool mu__condition_34() // Condition for Rule "core_rec_from_Home_DataRespMsg"
{
...
int mu__invariant_35() // Invariant "swmr"
{
bool mu__quant36; 
mu__quant36 = TRUE;
{
...
bool mu__boolexpr38;
bool mu__boolexpr39;
  if (!((mu_c1) != (mu_c2))) mu__boolexpr39 = FALSE ;
  else {
  mu__boolexpr39 = ((mu_Procs[mu_c1].mu_state) == (mu_P_V)) ; 
}
  if (!(mu__boolexpr39)) mu__boolexpr38 = TRUE ;
  else {
  mu__boolexpr38 = ((mu_Procs[mu_c2].mu_state) != (mu_P_V)) ; 
}
if ( !(mu__boolexpr38) )
...
bool mu__condition_40() // Condition for Rule "swmr"
{
...
int mu__invariant_41() // Invariant "values in valid state match last write"
{
bool mu__quant42; 
mu__quant42 = TRUE;
{
for(int mu_n = 1; mu_n <= 3; mu_n++) {
bool mu__boolexpr43;
  if (!((mu_Procs[mu_n].mu_state) == (mu_P_V))) mu__boolexpr43 = TRUE ;
  else {
  mu__boolexpr43 = ((mu_Procs[mu_n].mu_val) == (mu_LastWrite)) ; 
}
if ( !(mu__boolexpr43) )
...
bool mu__condition_44() // Condition for Rule "values in valid state match last write"
{
...
bool mu__boolexpr46;
  ...
  mu__boolexpr46 = ((mu_MainMemory) == (mu_LastWrite)) ; 
}
...
int mu__invariant_48() // Invariant "Invalid implies empty owner"
{
bool mu__boolexpr49;
...
if ( !(!((mu_Procs[mu_n].mu_state) == (mu_P_V))) )
  ...
  mu__boolexpr49 = (mu__quant50) ; 
}
return mu__boolexpr49;
};

bool mu__condition_51() // Condition for Rule "Invalid implies empty owner"
{
...
{"Invalid implies empty owner", &mu__condition_51, NULL, },
{"value in memory matches value of last write, when invalid", &mu__condition_47, NULL, },
{"values in valid state match last write", &mu__condition_44, NULL, },
{"swmr", &mu__condition_40, NULL, },
{"core_rec_from_Home_DataRespMsg", &mu__condition_34, NULL, },
};
