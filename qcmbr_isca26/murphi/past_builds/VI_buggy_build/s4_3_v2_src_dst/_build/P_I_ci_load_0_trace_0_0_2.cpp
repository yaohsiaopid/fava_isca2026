/******************************
  Program "past_builds/VI_buggy_build/s4_3_v2_src_dst/out/P_I_ci_load_0_trace_0_0_2.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_buggy_build/s4_3_v2_src_dst/out/P_I_ci_load_0_trace_0_0_2"
...
bool mu__boolexpr23;
  ...
  mu__boolexpr20 = ((mu_prevProcReq.mu_tp) == (mu_ci_load)) ; 
}
...
bool mu__boolexpr27;
  ...
  mu__boolexpr24 = ((mu_prevProcReq.mu_tp) == (mu_ci_load)) ; 
}
	      if (mu__boolexpr24) {
		if ( ( TRUE  ) )
		  return;
...
/********************
  Invariant records
 ********************/
int mu__invariant_63() // Invariant "P_I_ci_load_rset_0"
{
bool mu__boolexpr64;
bool mu__boolexpr65;
bool mu__boolexpr66;
...
bool mu__condition_78() // Condition for Rule "P_I_ci_load_rset_0"
{
...
{"P_I_ci_load_rset_0", &mu__condition_78, NULL, },
};
