/******************************
  Program "past_builds/VI_buggy_build/s4_3_v2_src_dst/out/P_I_ci_store_0_trace_0_0_0.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_buggy_build/s4_3_v2_src_dst/out/P_I_ci_store_0_trace_0_0_0"
...
bool mu__boolexpr21;
bool mu__boolexpr22;
  if (!(!(mu_tracked))) mu__boolexpr22 = FALSE ;
  else {
  mu__boolexpr22 = (!(mu_prevProcs.isundefined())) ; 
}
  if (!(mu__boolexpr22)) mu__boolexpr21 = FALSE ;
  else {
  mu__boolexpr21 = ((mu_prevProcs) == (mu_P_I)) ; 
}
  if (!(mu__boolexpr21)) mu__boolexpr20 = FALSE ;
  else {
  mu__boolexpr20 = (!(mu_prevProcReq.mu_tp.isundefined())) ; 
}
  if (!(mu__boolexpr20)) mu__boolexpr19 = FALSE ;
  else {
  mu__boolexpr19 = ((mu_prevProcReq.mu_tp) == (mu_ci_store)) ; 
}
...
bool mu__boolexpr25;
bool mu__boolexpr26;
  if (!(!(mu_tracked))) mu__boolexpr26 = FALSE ;
  else {
  mu__boolexpr26 = (!(mu_prevProcs.isundefined())) ; 
}
  if (!(mu__boolexpr26)) mu__boolexpr25 = FALSE ;
  else {
  mu__boolexpr25 = ((mu_prevProcs) == (mu_P_I)) ; 
}
  if (!(mu__boolexpr25)) mu__boolexpr24 = FALSE ;
  else {
  mu__boolexpr24 = (!(mu_prevProcReq.mu_tp.isundefined())) ; 
}
  if (!(mu__boolexpr24)) mu__boolexpr23 = FALSE ;
  else {
  mu__boolexpr23 = ((mu_prevProcReq.mu_tp) == (mu_ci_store)) ; 
}
	      if (mu__boolexpr23) {
		if ( ( TRUE  ) )
		  return;
...
for(int mu_n = 1; mu_n <= 6; mu_n++)
  if (( ( mu_n >= 1 ) && ( mu_n <= 3 ) )|| ( ( mu_n >= 6 ) && ( mu_n <= 6 ) )) {
bool mu__boolexpr27;
  if (!(mu_allAck)) mu__boolexpr27 = FALSE ;
  else {
  mu__boolexpr27 = (mu_ackBus[mu_n]) ; 
}
mu_allAck = mu__boolexpr27;
};
};
if ( mu_allAck )
{
...
public:
  ...
  bool Condition(unsigned r)
  {
    ...
    r = r / 4;
bool mu__boolexpr28;
  if (!(!(mu_gBuf.mu_src.isundefined()))) mu__boolexpr28 = FALSE ;
  else {
...
{
bool mu__boolexpr30;
  if (!(!(mu_cur_node.isundefined()))) mu__boolexpr30 = FALSE ;
  else {
  mu__boolexpr30 = ((mu_cur_node) == (mu_selc)) ; 
}
if ( mu__boolexpr30 )
{
if (mu_gBuf.mu_mtype.isundefined())
...
bool mu__boolexpr31;
bool mu__boolexpr32;
  if (!(mu_start)) mu__boolexpr32 = FALSE ;
  else {
  mu__boolexpr32 = (!(mu_cur_node.isundefined())) ; 
}
...
bool mu__boolexpr35;
  ...
  mu__boolexpr35 = ((mu_gBuf.mu_mtype) == (mu_DataRespMsg)) ; 
}
...
{
bool mu__boolexpr36;
  if (!(mu_chk)) mu__boolexpr36 = FALSE ;
  else {
  mu__boolexpr36 = ((mu_gBuf.mu_src>=1 && mu_gBuf.mu_src<=3)) ; 
}
mu_chk = mu__boolexpr36;
}
bool mu__boolexpr37;
bool mu__boolexpr38;
bool mu__boolexpr39;
  if (!(mu_start)) mu__boolexpr39 = FALSE ;
  else {
  mu__boolexpr39 = ((mu_gBuf.mu_mtype) == (mu_GetMsg)) ; 
}
  if (!(mu__boolexpr39)) mu__boolexpr38 = FALSE ;
  else {
  mu__boolexpr38 = ((mu_gBuf.mu_src) == (mu_selc)) ; 
}
  if (!(mu__boolexpr38)) mu__boolexpr37 = FALSE ;
  else {
  mu__boolexpr37 = ((mu_cur_node) == (mu_selc2)) ; 
}
if ( mu__boolexpr37 )
{
...
{
bool mu__boolexpr40;
  if (!(!(mu_cur_node.isundefined()))) mu__boolexpr40 = FALSE ;
  else {
  mu__boolexpr40 = ((mu_cur_node) == (mu_selc)) ; 
}
if ( mu__boolexpr40 )
{
if (mu_gBuf.mu_mtype.isundefined())
...
bool mu__boolexpr42;
  ...
  mu__boolexpr42 = (!(mu_cur_node.isundefined())) ; 
}
...
bool mu__boolexpr45;
  ...
  mu__boolexpr45 = ((mu_gBuf.mu_mtype) == (mu_DataRespMsg)) ; 
}
...
{
bool mu__boolexpr46;
  if (!(mu_chk)) mu__boolexpr46 = FALSE ;
  else {
  mu__boolexpr46 = ((mu_gBuf.mu_src>=1 && mu_gBuf.mu_src<=3)) ; 
}
mu_chk = mu__boolexpr46;
}
bool mu__boolexpr47;
bool mu__boolexpr48;
bool mu__boolexpr49;
  if (!(mu_start)) mu__boolexpr49 = FALSE ;
  else {
  mu__boolexpr49 = ((mu_gBuf.mu_mtype) == (mu_GetMsg)) ; 
}
  if (!(mu__boolexpr49)) mu__boolexpr48 = FALSE ;
  else {
  mu__boolexpr48 = ((mu_gBuf.mu_src) == (mu_selc)) ; 
}
  if (!(mu__boolexpr48)) mu__boolexpr47 = FALSE ;
  else {
  mu__boolexpr47 = ((mu_cur_node) == (mu_selc2)) ; 
}
if ( mu__boolexpr47 )
{
if (mu_cur_node.isundefined())
...
bool mu__boolexpr50;
bool mu__boolexpr51;
  if (!((mu_p.mu_state) == (mu_P_V))) mu__boolexpr51 = FALSE ;
  else {
  mu__boolexpr51 = (!(mu_msgBufNonEmpty)) ; 
}
  if (!(mu__boolexpr51)) mu__boolexpr50 = FALSE ;
  else {
  mu__boolexpr50 = (mu_gBuf.mu_src.isundefined()) ; 
}
...
bool mu__boolexpr54;
bool mu__boolexpr55;
  if (!((mu_p.mu_state) == (mu_P_I))) mu__boolexpr55 = FALSE ;
  else {
...
/********************
  Invariant records
 ********************/
int mu__invariant_62() // Invariant "P_I_ci_store_rset_0"
{
bool mu__boolexpr63;
bool mu__boolexpr64;
bool mu__boolexpr65;
...
bool mu__boolexpr67;
bool mu__boolexpr68;
  if (!(mu_tracked)) mu__boolexpr68 = FALSE ;
  else {
  mu__boolexpr68 = (!(mu_start)) ; 
}
  ...
  for (mu_i = 0; ; mu_i=mu_i+1)
    {
      if (mu_reached_set.valid[(int)mu_i].value())
	{
	  if ( (mu_reached_set[mu_i]) == (mu_P_I) ) mu__intexpr69++;
	}
      if (mu_i == 3-1) break;
    }
  }
/*** end multisetcount 1 declaration ***/
  mu__boolexpr67 = ((mu__intexpr69) == (0)) ; 
}
  ...
  for (mu_i = 0; ; mu_i=mu_i+1)
    {
      if (mu_reached_set.valid[(int)mu_i].value())
	{
	  if ( (mu_reached_set[mu_i]) == (mu_P_IVD) ) mu__intexpr70++;
	}
      if (mu_i == 3-1) break;
    }
  }
/*** end multisetcount 2 declaration ***/
  mu__boolexpr66 = ((mu__intexpr70) == (1)) ; 
}
  ...
  for (mu_i = 0; ; mu_i=mu_i+1)
    {
      if (mu_reached_set.valid[(int)mu_i].value())
	{
	  if ( (mu_reached_set[mu_i]) == (mu_P_V) ) mu__intexpr71++;
	}
      if (mu_i == 3-1) break;
    }
  }
/*** end multisetcount 3 declaration ***/
  mu__boolexpr65 = ((mu__intexpr71) == (1)) ; 
}
...
bool mu__boolexpr75;
bool mu__boolexpr76;
  if (!((mu_msg_rec_set[mu_GetMsg]) == (mu_true))) mu__boolexpr76 = FALSE ;
  else {
  mu__boolexpr76 = ((mu_msg_rec_set[mu_PutMsg]) == (mu_false)) ; 
}
  if (!(mu__boolexpr76)) mu__boolexpr75 = FALSE ;
  else {
  mu__boolexpr75 = ((mu_msg_rec_set[mu_DataRespMsg]) == (mu_true)) ; 
}
  if (!(mu__boolexpr75)) mu__boolexpr74 = FALSE ;
  else {
  mu__boolexpr74 = ((mu_msg_sent_set[mu_GetMsg]) == (mu_true)) ; 
}
  if (!(mu__boolexpr74)) mu__boolexpr73 = FALSE ;
  else {
  mu__boolexpr73 = ((mu_msg_sent_set[mu_PutMsg]) == (mu_false)) ; 
}
  if (!(mu__boolexpr73)) mu__boolexpr72 = FALSE ;
  else {
  mu__boolexpr72 = ((mu_msg_sent_set[mu_DataRespMsg]) == (mu_false)) ; 
}
  mu__boolexpr64 = (mu__boolexpr72) ; 
}
  if (!(mu__boolexpr64)) mu__boolexpr63 = TRUE ;
  else {
  mu__boolexpr63 = (!(mu_chk)) ; 
}
return mu__boolexpr63;
};

bool mu__condition_77() // Condition for Rule "P_I_ci_store_rset_0"
{
...
int mu__invariant_78() // Invariant "swmr"
{
bool mu__quant79; 
mu__quant79 = TRUE;
{
...
bool mu__boolexpr81;
bool mu__boolexpr82;
  if (!((mu_c1) != (mu_c2))) mu__boolexpr82 = FALSE ;
  else {
  mu__boolexpr82 = ((mu_Procs[mu_c1].mu_state) == (mu_P_V)) ; 
}
  if (!(mu__boolexpr82)) mu__boolexpr81 = TRUE ;
  else {
  mu__boolexpr81 = ((mu_Procs[mu_c2].mu_state) != (mu_P_V)) ; 
}
if ( !(mu__boolexpr81) )
...
bool mu__condition_83() // Condition for Rule "swmr"
{
...
int mu__invariant_84() // Invariant "values in valid state match last write"
{
bool mu__quant85; 
mu__quant85 = TRUE;
{
for(int mu_n = 1; mu_n <= 3; mu_n++) {
bool mu__boolexpr86;
  if (!((mu_Procs[mu_n].mu_state) == (mu_P_V))) mu__boolexpr86 = TRUE ;
  else {
  mu__boolexpr86 = ((mu_Procs[mu_n].mu_val) == (mu_LastWrite)) ; 
}
if ( !(mu__boolexpr86) )
...
bool mu__condition_87() // Condition for Rule "values in valid state match last write"
{
...
int mu__invariant_88() // Invariant "value in memory matches value of last write, when invalid"
{
bool mu__boolexpr89;
  if (!((mu_HomeNode.mu_state) == (mu_H_I))) mu__boolexpr89 = TRUE ;
  else {
  mu__boolexpr89 = ((mu_MainMemory) == (mu_LastWrite)) ; 
}
return mu__boolexpr89;
};

bool mu__condition_90() // Condition for Rule "value in memory matches value of last write, when invalid"
{
...
int mu__invariant_91() // Invariant "Invalid implies empty owner"
{
bool mu__boolexpr92;
...
if ( !(!((mu_Procs[mu_n].mu_state) == (mu_P_V))) )
  ...
  mu__boolexpr92 = (mu__quant93) ; 
}
return mu__boolexpr92;
};

bool mu__condition_94() // Condition for Rule "Invalid implies empty owner"
{
...
{"Invalid implies empty owner", &mu__condition_94, NULL, },
{"value in memory matches value of last write, when invalid", &mu__condition_90, NULL, },
{"values in valid state match last write", &mu__condition_87, NULL, },
{"swmr", &mu__condition_83, NULL, },
{"P_I_ci_store_rset_0", &mu__condition_77, NULL, },
};
