/******************************
  Program "past_builds/VI_buggy_build/home_s0_transition/out/H_I_H_V.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_buggy_build/home_s0_transition/out/H_I_H_V"
...
/********************
  Invariant records
 ********************/
int mu__invariant_21() // Invariant "H_I_to_H_V"
{
bool mu__boolexpr22;
bool mu__boolexpr23;
  if (!(!(mu_prevHomeNode.isundefined()))) mu__boolexpr23 = FALSE ;
  else {
  mu__boolexpr23 = ((mu_prevHomeNode) == (mu_H_I)) ; 
}
  if (!(mu__boolexpr23)) mu__boolexpr22 = TRUE ;
  else {
  mu__boolexpr22 = (!((mu_HomeNode.mu_state) == (mu_H_V))) ; 
}
return mu__boolexpr22;
};

bool mu__condition_24() // Condition for Rule "H_I_to_H_V"
{
...
{"H_I_to_H_V", &mu__condition_24, NULL, },
};
