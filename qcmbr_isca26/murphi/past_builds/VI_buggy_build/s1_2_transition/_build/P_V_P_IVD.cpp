/******************************
  Program "past_builds/VI_buggy_build/s1_2_transition/out/P_V_P_IVD.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_buggy_build/s1_2_transition/out/P_V_P_IVD"
...
/********************
  Invariant records
 ********************/
int mu__invariant_21() // Invariant "P_V_to_P_IVD"
{
bool mu__boolexpr22;
bool mu__boolexpr23;
  ...
  mu__boolexpr22 = (!((mu_Procs[mu_selc].mu_state) == (mu_P_IVD))) ; 
}
return mu__boolexpr22;
};

bool mu__condition_24() // Condition for Rule "P_V_to_P_IVD"
{
...
{"P_V_to_P_IVD", &mu__condition_24, NULL, },
};
