/******************************
  Program "past_builds/VI_buggy_build/s1_2_transition/out/P_IVD_P_I.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_buggy_build/s1_2_transition/out/P_IVD_P_I"
...
/********************
  Invariant records
 ********************/
int mu__invariant_21() // Invariant "P_IVD_to_P_I"
{
bool mu__boolexpr22;
bool mu__boolexpr23;
  ...
  mu__boolexpr22 = (!((mu_Procs[mu_selc].mu_state) == (mu_P_I))) ; 
}
return mu__boolexpr22;
};

bool mu__condition_24() // Condition for Rule "P_IVD_to_P_I"
{
...
{"P_IVD_to_P_I", &mu__condition_24, NULL, },
};
