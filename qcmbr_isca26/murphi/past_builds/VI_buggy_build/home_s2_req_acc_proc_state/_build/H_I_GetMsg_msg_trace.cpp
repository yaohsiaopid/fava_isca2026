/******************************
  Program "past_builds/VI_buggy_build/home_s2_req_acc_proc_state/out/H_I_GetMsg_msg_trace.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_buggy_build/home_s2_req_acc_proc_state/out/H_I_GetMsg_msg_trace"
...
/********************
  Invariant records
 ********************/
int mu__invariant_26() // Invariant "H_I_consistent_w_GetMsg"
{
bool mu__boolexpr27;
bool mu__boolexpr28;
...
bool mu__boolexpr29;
  if (mu_prevRecProcMsg.isundefined()) mu__boolexpr29 = TRUE ;
  else {
  mu__boolexpr29 = ((mu_prevRecProcMsg) != (mu_GetMsg)) ; 
}
...
bool mu__condition_30() // Condition for Rule "H_I_consistent_w_GetMsg"
{
...
int mu__invariant_31() // Invariant "swmr"
{
bool mu__quant32; 
mu__quant32 = TRUE;
{
...
bool mu__boolexpr34;
bool mu__boolexpr35;
  if (!((mu_c1) != (mu_c2))) mu__boolexpr35 = FALSE ;
  else {
  mu__boolexpr35 = ((mu_Procs[mu_c1].mu_state) == (mu_P_V)) ; 
}
  if (!(mu__boolexpr35)) mu__boolexpr34 = TRUE ;
  else {
  mu__boolexpr34 = ((mu_Procs[mu_c2].mu_state) != (mu_P_V)) ; 
}
if ( !(mu__boolexpr34) )
...
bool mu__condition_36() // Condition for Rule "swmr"
{
...
int mu__invariant_37() // Invariant "values in valid state match last write"
{
bool mu__quant38; 
mu__quant38 = TRUE;
{
...
bool mu__boolexpr39;
  if (!((mu_Procs[mu_n].mu_state) == (mu_P_V))) mu__boolexpr39 = TRUE ;
  else {
...
bool mu__condition_40() // Condition for Rule "values in valid state match last write"
{
...
bool mu__boolexpr42;
  ...
  mu__boolexpr42 = ((mu_MainMemory) == (mu_LastWrite)) ; 
}
...
int mu__invariant_44() // Invariant "Invalid implies empty owner"
{
bool mu__boolexpr45;
...
if ( !(!((mu_Procs[mu_n].mu_state) == (mu_P_V))) )
  ...
  mu__boolexpr45 = (mu__quant46) ; 
}
return mu__boolexpr45;
};

bool mu__condition_47() // Condition for Rule "Invalid implies empty owner"
{
...
{"Invalid implies empty owner", &mu__condition_47, NULL, },
{"value in memory matches value of last write, when invalid", &mu__condition_43, NULL, },
{"values in valid state match last write", &mu__condition_40, NULL, },
{"swmr", &mu__condition_36, NULL, },
{"H_I_consistent_w_GetMsg", &mu__condition_30, NULL, },
};
