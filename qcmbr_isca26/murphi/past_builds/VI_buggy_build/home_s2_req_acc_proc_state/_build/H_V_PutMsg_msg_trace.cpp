/******************************
  Program "past_builds/VI_buggy_build/home_s2_req_acc_proc_state/out/H_V_PutMsg_msg_trace.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_buggy_build/home_s2_req_acc_proc_state/out/H_V_PutMsg_msg_trace"
...
/********************
  Invariant records
 ********************/
int mu__invariant_26() // Invariant "H_V_consistent_w_PutMsg"
{
bool mu__boolexpr27;
bool mu__boolexpr28;
...
bool mu__boolexpr29;
  ...
  mu__boolexpr29 = ((mu_prevRecProcMsg) != (mu_PutMsg)) ; 
}
...
bool mu__condition_30() // Condition for Rule "H_V_consistent_w_PutMsg"
{
...
{"H_V_consistent_w_PutMsg", &mu__condition_30, NULL, },
};
