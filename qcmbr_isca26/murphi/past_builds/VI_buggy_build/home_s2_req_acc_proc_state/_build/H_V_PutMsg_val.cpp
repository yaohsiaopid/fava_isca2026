/******************************
  Program "past_builds/VI_buggy_build/home_s2_req_acc_proc_state/out/H_V_PutMsg_val.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_buggy_build/home_s2_req_acc_proc_state/out/H_V_PutMsg_val"
...
bool mu__boolexpr27;
  ...
  mu__boolexpr27 = ((mu_prevHomeNode) == (mu_H_V)) ; 
}
  ...
  mu__boolexpr25 = ((mu_prevRecProcMsg) == (mu_PutMsg)) ; 
}
...
bool mu__condition_28() // Condition for Rule "H_V_accept_req_PutMsg"
{
...
{"H_V_accept_req_PutMsg", &mu__condition_28, NULL, },
};
