...
-- check H_I receives/processes GetMsg and has value change
invariant "H_I_accept_req_GetMsg"
  (!isundefined(prevHomeNode) & (prevHomeNode = H_I) & 
   !isundefined(prevRecProcMsg) & prevRecProcMsg = GetMsg) ->
   (prevHomeNodeVal = HomeNode.val);
