/******************************
  Program "past_builds/VI_buggy_build/s1_msg_per_transition_val_change/out/P_I_P_IVD_DataRespMsg.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_buggy_build/s1_msg_per_transition_val_change/out/P_I_P_IVD_DataRespMsg"
...
bool mu__boolexpr14;
  ...
  mu__boolexpr13 = ((mu_gBuf.mu_mtype) == (mu_DataRespMsg)) ; 
}
if ( mu__boolexpr13 )
{
mu_rec = mu_true;
