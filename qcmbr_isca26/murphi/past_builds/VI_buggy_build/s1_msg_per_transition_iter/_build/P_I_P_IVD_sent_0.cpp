/******************************
  Program "past_builds/VI_buggy_build/s1_msg_per_transition_iter/out/P_I_P_IVD_sent_0.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_buggy_build/s1_msg_per_transition_iter/out/P_I_P_IVD_sent_0"
...
bool mu__boolexpr29;
bool mu__boolexpr30;
  if (!((mu_msg_imm_sent_set[mu_GetMsg]) == (mu_true))) mu__boolexpr30 = FALSE ;
  else {
...
bool mu__condition_31() // Condition for Rule "P_I_to_P_IVD"
{
...
{"P_I_to_P_IVD", &mu__condition_31, NULL, },
};
