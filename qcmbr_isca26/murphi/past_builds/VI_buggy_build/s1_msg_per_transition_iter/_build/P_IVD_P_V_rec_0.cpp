/******************************
  Program "past_builds/VI_buggy_build/s1_msg_per_transition_iter/out/P_IVD_P_V_rec_0.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_buggy_build/s1_msg_per_transition_iter/out/P_IVD_P_V_rec_0"
...
bool mu__boolexpr29;
bool mu__boolexpr30;
  if (!((mu_msg_imm_rec_set[mu_GetMsg]) == (mu_true))) mu__boolexpr30 = FALSE ;
  else {
  mu__boolexpr30 = ((mu_msg_imm_rec_set[mu_PutMsg]) == (mu_false)) ; 
}
  if (!(mu__boolexpr30)) mu__boolexpr29 = FALSE ;
  else {
  mu__boolexpr29 = ((mu_msg_imm_rec_set[mu_DataRespMsg]) == (mu_true)) ; 
}
