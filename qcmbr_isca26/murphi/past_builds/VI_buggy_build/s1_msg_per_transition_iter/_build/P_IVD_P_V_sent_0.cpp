/******************************
  Program "past_builds/VI_buggy_build/s1_msg_per_transition_iter/out/P_IVD_P_V_sent_0.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_buggy_build/s1_msg_per_transition_iter/out/P_IVD_P_V_sent_0"
...
bool mu__boolexpr28;
  ...
  mu__boolexpr28 = ((mu_prevProcs) == (mu_P_IVD)) ; 
}
  if (!(mu__boolexpr28)) mu__boolexpr27 = FALSE ;
  else {
  mu__boolexpr27 = ((mu_Procs[mu_selc].mu_state) == (mu_P_V)) ; 
}
  if (!(mu__boolexpr27)) mu__boolexpr26 = TRUE ;
  else {
bool mu__boolexpr29;
bool mu__boolexpr30;
  if (!((mu_msg_imm_sent_set[mu_GetMsg]) == (mu_false))) mu__boolexpr30 = FALSE ;
  else {
  mu__boolexpr30 = ((mu_msg_imm_sent_set[mu_PutMsg]) == (mu_false)) ; 
}
  if (!(mu__boolexpr30)) mu__boolexpr29 = FALSE ;
  else {
  mu__boolexpr29 = ((mu_msg_imm_sent_set[mu_DataRespMsg]) == (mu_false)) ; 
}
...
bool mu__condition_31() // Condition for Rule "P_IVD_to_P_V"
{
...
{"P_IVD_to_P_V", &mu__condition_31, NULL, },
};
