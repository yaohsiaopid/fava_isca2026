/******************************
  Program "past_builds/VI_buggy_build/s1_msg_per_transition_iter/out/P_V_P_I_sent_1.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_buggy_build/s1_msg_per_transition_iter/out/P_V_P_I_sent_1"
...
bool mu__boolexpr30;
bool mu__boolexpr31;
  if (!((mu_msg_imm_sent_set[mu_GetMsg]) == (mu_false))) mu__boolexpr31 = FALSE ;
  else {
  mu__boolexpr31 = ((mu_msg_imm_sent_set[mu_PutMsg]) == (mu_true)) ; 
}
  if (!(mu__boolexpr31)) mu__boolexpr30 = FALSE ;
  else {
  mu__boolexpr30 = ((mu_msg_imm_sent_set[mu_DataRespMsg]) == (mu_false)) ; 
}
...
bool mu__boolexpr33;
  ...
  mu__boolexpr33 = ((mu_msg_imm_sent_set[mu_PutMsg]) == (mu_false)) ; 
}
  if (!(mu__boolexpr33)) mu__boolexpr32 = FALSE ;
  else {
  mu__boolexpr32 = ((mu_msg_imm_sent_set[mu_DataRespMsg]) == (mu_true)) ; 
}
  mu__boolexpr29 = (mu__boolexpr32) ; 
}
...
bool mu__condition_34() // Condition for Rule "P_V_to_P_I"
{
...
{"P_V_to_P_I", &mu__condition_34, NULL, },
};
