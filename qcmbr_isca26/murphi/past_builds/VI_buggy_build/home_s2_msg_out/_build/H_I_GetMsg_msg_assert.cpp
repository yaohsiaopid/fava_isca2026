/******************************
  Program "past_builds/VI_buggy_build/home_s2_msg_out/out/H_I_GetMsg_msg_assert.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_buggy_build/home_s2_msg_out/out/H_I_GetMsg_msg_assert"
...
/********************
  Invariant records
 ********************/
int mu__invariant_26() // Invariant "ASSERT_H_I_accept_req_GetMsg"
{
bool mu__boolexpr27;
bool mu__boolexpr28;
bool mu__boolexpr29;
bool mu__boolexpr30;
  ...
  mu__boolexpr28 = ((mu_prevRecProcMsg) == (mu_GetMsg)) ; 
}
...
bool mu__boolexpr32;
  ...
  mu__boolexpr31 = ((mu_prevSentMsgSet[mu_DataRespMsg]) == (mu_true)) ; 
}
...
bool mu__condition_33() // Condition for Rule "ASSERT_H_I_accept_req_GetMsg"
{
...
{"ASSERT_H_I_accept_req_GetMsg", &mu__condition_33, NULL, },
};
