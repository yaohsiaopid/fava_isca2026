/******************************
  Program "past_builds/VI_buggy_build/home_s2_msg_out/out/H_I_GetMsg_H_V_val_mainmem.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_buggy_build/home_s2_msg_out/out/H_I_GetMsg_H_V_val_mainmem"
...
/*** Variable declaration ***/
mu_1_Value mu_prevMainMem("prevMainMem",24);
...
if (mu_MainMemory.isundefined())
  mu_prevMainMem.undefine();
else
  mu_prevMainMem = mu_MainMemory;
...
void world_class::print_statistic()
{
  ...
  mu_prevMainMem.print_statistic();
...
void world_class::print_diff( state *prevstate )
{
  if ( prevstate != NULL )
  {
    ...
    mu_prevMainMem.print_diff(prevstate);
...
void world_class::to_state(state *newstate)
{
  ...
  mu_prevMainMem.to_state( newstate );
...
bool mu__boolexpr28;
  ...
  mu__boolexpr24 = ((mu_HomeNode.mu_val) == (mu_prevMainMem)) ; 
}
...
void SymmetryClass::Heuristic_Fast_Canonicalize(state* s)
{
  ...
  mu_prevMainMem.SimpleCanonicalize(Perm);
