/******************************
  Program "past_builds/VI_buggy_build/home_s2_msg_out/out/H_V_PutMsg_H_I_val_inmsg.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_buggy_build/home_s2_msg_out/out/H_V_PutMsg_H_I_val_inmsg"
...
/********************
  Invariant records
 ********************/
int mu__invariant_23() // Invariant "H_V_accept_req_PutMsg"
{
bool mu__boolexpr24;
bool mu__boolexpr25;
bool mu__boolexpr26;
...
bool mu__boolexpr28;
  ...
  mu__boolexpr28 = ((mu_prevHomeNode) == (mu_H_V)) ; 
}
  ...
  mu__boolexpr26 = ((mu_prevRecProcMsg) == (mu_PutMsg)) ; 
}
  if (!(mu__boolexpr26)) mu__boolexpr25 = FALSE ;
  else {
  mu__boolexpr25 = ((mu_HomeNode.mu_state) == (mu_H_I)) ; 
}
...
bool mu__condition_29() // Condition for Rule "H_V_accept_req_PutMsg"
{
...
{"H_V_accept_req_PutMsg", &mu__condition_29, NULL, },
};
