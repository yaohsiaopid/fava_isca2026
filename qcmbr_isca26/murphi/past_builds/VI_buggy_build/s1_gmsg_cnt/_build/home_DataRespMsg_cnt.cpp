/******************************
  Program "past_builds/VI_buggy_build/s1_gmsg_cnt/out/home_DataRespMsg_cnt.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_buggy_build/s1_gmsg_cnt/out/home_DataRespMsg_cnt"
...
/********************
  Invariant records
 ********************/
int mu__invariant_27() // Invariant "home_sent_DataRespMsg_cnt"
{
return (mu_cnt) <= (1);
};

bool mu__condition_28() // Condition for Rule "home_sent_DataRespMsg_cnt"
{
...
{"home_sent_DataRespMsg_cnt", &mu__condition_28, NULL, },
};
