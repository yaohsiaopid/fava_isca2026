/******************************
  Program "past_builds/VI_buggy_build/s1_gmsg_cnt/out/PutMsg_cnt.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_buggy_build/s1_gmsg_cnt/out/PutMsg_cnt"
...
/********************
  Invariant records
 ********************/
int mu__invariant_27() // Invariant "core_sent_PutMsg_cnt"
{
return (mu_cnt) <= (1);
};

bool mu__condition_28() // Condition for Rule "core_sent_PutMsg_cnt"
{
...
{"core_sent_PutMsg_cnt", &mu__condition_28, NULL, },
};
