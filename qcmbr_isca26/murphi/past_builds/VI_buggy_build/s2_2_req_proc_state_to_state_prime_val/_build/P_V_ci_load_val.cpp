/******************************
  Program "past_builds/VI_buggy_build/s2_2_req_proc_state_to_state_prime_val/out/P_V_ci_load_val.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_buggy_build/s2_2_req_proc_state_to_state_prime_val/out/P_V_ci_load_val"
...
/********************
  Invariant records
 ********************/
int mu__invariant_21() // Invariant "P_V_accept_and_perform_ci_load_value_change"
{
bool mu__boolexpr22;
bool mu__boolexpr23;
bool mu__boolexpr24;
bool mu__boolexpr25;
  ...
  mu__boolexpr23 = ((mu_prevProcReq_2.mu_tp) == (mu_ci_load)) ; 
}
...
bool mu__condition_29() // Condition for Rule "P_V_accept_and_perform_ci_load_value_change"
{
...
{"P_V_accept_and_perform_ci_load_value_change", &mu__condition_29, NULL, },
};
