/******************************
  Program "past_builds/VI_buggy_build/s4_6_ret_val/out/P_V_ci_load_no_txn_ini_trace.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_buggy_build/s4_6_ret_val/out/P_V_ci_load_no_txn_ini_trace"
...
for(int mu_n = 1; mu_n <= 6; mu_n++)
  if (( ( mu_n >= 1 ) && ( mu_n <= 3 ) )|| ( ( mu_n >= 6 ) && ( mu_n <= 6 ) )) {
bool mu__boolexpr7;
  if (!(mu_allAck)) mu__boolexpr7 = FALSE ;
  else {
  mu__boolexpr7 = (mu_ackBus[mu_n]) ; 
}
mu_allAck = mu__boolexpr7;
};
};
if ( mu_allAck )
{
...
bool mu__boolexpr10;
bool mu__boolexpr11;
  if (!((mu_p.mu_state) == (mu_P_V))) mu__boolexpr11 = FALSE ;
  else {
  mu__boolexpr11 = (!(mu_msgBufNonEmpty)) ; 
}
  if (!(mu__boolexpr11)) mu__boolexpr10 = FALSE ;
  else {
  mu__boolexpr10 = (mu_gBuf.mu_src.isundefined()) ; 
}
...
bool mu__boolexpr24;
bool mu__boolexpr25;
  if (!(!(mu_prevProcs.isundefined()))) mu__boolexpr25 = FALSE ;
  else {
  mu__boolexpr25 = ((mu_prevProcs) == (mu_P_V)) ; 
}
