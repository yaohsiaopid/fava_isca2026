/******************************
  Program "past_builds/VI_buggy_build/s1_req_acc_state/out/P_V_ci_store.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_buggy_build/s1_req_acc_state/out/P_V_ci_store"
...
/********************
  Invariant records
 ********************/
int mu__invariant_21() // Invariant "P_V_accept_req_ci_store"
{
bool mu__boolexpr22;
bool mu__boolexpr23;
  if (!(!(mu_prevProcs.isundefined()))) mu__boolexpr23 = FALSE ;
  else {
  mu__boolexpr23 = ((mu_prevProcs) == (mu_P_V)) ; 
}
...
bool mu__condition_25() // Condition for Rule "P_V_accept_req_ci_store"
{
...
{"P_V_accept_req_ci_store", &mu__condition_25, NULL, },
};
