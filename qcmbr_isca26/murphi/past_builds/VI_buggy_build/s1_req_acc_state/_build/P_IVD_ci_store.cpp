/******************************
  Program "past_builds/VI_buggy_build/s1_req_acc_state/out/P_IVD_ci_store.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_buggy_build/s1_req_acc_state/out/P_IVD_ci_store"
...
/********************
  Invariant records
 ********************/
int mu__invariant_21() // Invariant "P_IVD_accept_req_ci_store"
{
bool mu__boolexpr22;
bool mu__boolexpr23;
  if (!(!(mu_prevProcs.isundefined()))) mu__boolexpr23 = FALSE ;
  else {
  mu__boolexpr23 = ((mu_prevProcs) == (mu_P_IVD)) ; 
}
  if (!(mu__boolexpr23)) mu__boolexpr22 = TRUE ;
  else {
bool mu__boolexpr24;
  if (mu_prevProcReq.mu_tp.isundefined()) mu__boolexpr24 = TRUE ;
  else {
...
bool mu__condition_25() // Condition for Rule "P_IVD_accept_req_ci_store"
{
...
{"P_IVD_accept_req_ci_store", &mu__condition_25, NULL, },
};
