/******************************
  Program "past_builds/VI_buggy_build/home_s3_msg_out_info/out/H_I_GetMsg_DataRespMsg.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_buggy_build/home_s3_msg_out_info/out/H_I_GetMsg_DataRespMsg"
...
/*** Variable declaration ***/
mu_1_Value mu_home_val("home_val",24);

/*** Variable declaration ***/
mu_0_boolean mu_val_match("val_match",32);
...
if (mu_HomeNode.mu_val.isundefined())
  mu_home_val.undefine();
else
  mu_home_val = mu_HomeNode.mu_val;
mu_sent = mu_false;
...
if ( mu__boolexpr8 )
{
mu_val_match = (mu_gBuf.mu_val) == (mu_home_val);
}
};
/*** end procedure declaration ***/
...
if ( mu__boolexpr12 )
{
mu_val_match = (mu_msg.mu_val) == (mu_home_val);
}
};
/*** end procedure declaration ***/
...
void world_class::print_statistic()
{
  ...
  mu_home_val.print_statistic();
  mu_val_match.print_statistic();
...
void world_class::print_diff( state *prevstate )
{
  if ( prevstate != NULL )
  {
    ...
    mu_home_val.print_diff(prevstate);
    mu_val_match.print_diff(prevstate);
...
void world_class::to_state(state *newstate)
{
  ...
  mu_home_val.to_state( newstate );
  mu_val_match.to_state( newstate );
...
void SymmetryClass::Heuristic_Fast_Canonicalize(state* s)
{
  ...
  mu_home_val.SimpleCanonicalize(Perm);
