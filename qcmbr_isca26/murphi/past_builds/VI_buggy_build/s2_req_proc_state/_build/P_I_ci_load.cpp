/******************************
  Program "past_builds/VI_buggy_build/s2_req_proc_state/out/P_I_ci_load.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_buggy_build/s2_req_proc_state/out/P_I_ci_load"
...
/********************
  Invariant records
 ********************/
int mu__invariant_21() // Invariant "P_I_accept_and_perform_ci_load"
{
bool mu__boolexpr22;
bool mu__boolexpr23;
bool mu__boolexpr24;
...
bool mu__condition_27() // Condition for Rule "P_I_accept_and_perform_ci_load"
{
...
{"P_I_accept_and_perform_ci_load", &mu__condition_27, NULL, },
};
