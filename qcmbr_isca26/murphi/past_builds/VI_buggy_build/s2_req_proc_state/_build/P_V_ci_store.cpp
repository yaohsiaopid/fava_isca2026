/******************************
  Program "past_builds/VI_buggy_build/s2_req_proc_state/out/P_V_ci_store.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_buggy_build/s2_req_proc_state/out/P_V_ci_store"
...
/********************
  Invariant records
 ********************/
int mu__invariant_21() // Invariant "P_V_accept_and_perform_ci_store"
{
bool mu__boolexpr22;
bool mu__boolexpr23;
bool mu__boolexpr24;
...
bool mu__condition_27() // Condition for Rule "P_V_accept_and_perform_ci_store"
{
...
{"P_V_accept_and_perform_ci_store", &mu__condition_27, NULL, },
};
