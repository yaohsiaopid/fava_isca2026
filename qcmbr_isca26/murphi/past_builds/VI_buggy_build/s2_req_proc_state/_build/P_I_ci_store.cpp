/******************************
  Program "past_builds/VI_buggy_build/s2_req_proc_state/out/P_I_ci_store.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_buggy_build/s2_req_proc_state/out/P_I_ci_store"
...
/********************
  Invariant records
 ********************/
int mu__invariant_21() // Invariant "P_I_accept_and_perform_ci_store"
{
bool mu__boolexpr22;
bool mu__boolexpr23;
bool mu__boolexpr24;
bool mu__boolexpr25;
  ...
  mu__boolexpr25 = ((mu_prevProcs_2) == (mu_P_I)) ; 
}
...
bool mu__boolexpr26;
  if (mu_prevProcReq.mu_tp.isundefined()) mu__boolexpr26 = TRUE ;
  else {
...
bool mu__condition_27() // Condition for Rule "P_I_accept_and_perform_ci_store"
{
...
int mu__invariant_28() // Invariant "swmr"
{
bool mu__quant29; 
mu__quant29 = TRUE;
{
...
bool mu__boolexpr31;
bool mu__boolexpr32;
  if (!((mu_c1) != (mu_c2))) mu__boolexpr32 = FALSE ;
  else {
  mu__boolexpr32 = ((mu_Procs[mu_c1].mu_state) == (mu_P_V)) ; 
}
  if (!(mu__boolexpr32)) mu__boolexpr31 = TRUE ;
  else {
  mu__boolexpr31 = ((mu_Procs[mu_c2].mu_state) != (mu_P_V)) ; 
}
if ( !(mu__boolexpr31) )
...
bool mu__condition_33() // Condition for Rule "swmr"
{
...
int mu__invariant_34() // Invariant "values in valid state match last write"
{
bool mu__quant35; 
mu__quant35 = TRUE;
{
for(int mu_n = 1; mu_n <= 3; mu_n++) {
bool mu__boolexpr36;
  if (!((mu_Procs[mu_n].mu_state) == (mu_P_V))) mu__boolexpr36 = TRUE ;
  else {
  mu__boolexpr36 = ((mu_Procs[mu_n].mu_val) == (mu_LastWrite)) ; 
}
if ( !(mu__boolexpr36) )
...
bool mu__condition_37() // Condition for Rule "values in valid state match last write"
{
...
int mu__invariant_38() // Invariant "value in memory matches value of last write, when invalid"
{
bool mu__boolexpr39;
  if (!((mu_HomeNode.mu_state) == (mu_H_I))) mu__boolexpr39 = TRUE ;
  else {
  mu__boolexpr39 = ((mu_MainMemory) == (mu_LastWrite)) ; 
}
return mu__boolexpr39;
};

bool mu__condition_40() // Condition for Rule "value in memory matches value of last write, when invalid"
{
...
int mu__invariant_41() // Invariant "Invalid implies empty owner"
{
bool mu__boolexpr42;
...
if ( !(!((mu_Procs[mu_n].mu_state) == (mu_P_V))) )
  ...
  mu__boolexpr42 = (mu__quant43) ; 
}
return mu__boolexpr42;
};

bool mu__condition_44() // Condition for Rule "Invalid implies empty owner"
{
...
{"Invalid implies empty owner", &mu__condition_44, NULL, },
{"value in memory matches value of last write, when invalid", &mu__condition_40, NULL, },
{"values in valid state match last write", &mu__condition_37, NULL, },
{"swmr", &mu__condition_33, NULL, },
{"P_I_accept_and_perform_ci_store", &mu__condition_27, NULL, },
};
