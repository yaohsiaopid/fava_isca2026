...
-- The request that the randomly selected processor is currently processing
  -- prevProcs: ENTRY_cache;
  -- STATE_TRANSITION prevProcs: s_cache;
  -- STATE_TRANSITION selc: OBJSET_cache;  
  -- STATE_TRANSITION myaddr: Address; 

   cur_node: Machines;  -- MSG_CHK
-- } FVT
...
begin
  ...
  -- STATE_TRANSITION prevProcs := i_cache[selc].CL[myaddr].State;    -- other data are assoc. w/ this prevState
...
--   -- FVT
  ...
  -- STATE_TRANSITION undefine prevProcs;
