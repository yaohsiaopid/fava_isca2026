...
i0_LW_0: assume property (i0[14:12] == 3'b010);
i0_LW_1: assume property (i0[11:7] != 5'd0);
i0_LW_2: assume property (i0[6:0] == 7'b0000011);

ADDR: assert property (@(posedge clk_i) mem_req_s1 |-> ex_stage_i.lsu_i.dcache_req_ports_o_ld.virtual_address == addr0);
