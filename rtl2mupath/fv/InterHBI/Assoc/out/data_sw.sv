...
// register-read stage
i0_data: assume property (@(posedge clk_i) issue_s16 |-> 
 (issue_stage_i.i_issue_read_operands.fu_data_o.operand_b == data0));


i_SW_0: assume property (i0[14:12] == 3'b010);
i_SW_1: assume property (i0[6:0] == 7'b0100011);

DATA: assert property (@(posedge clk_i) mem_req_s1 |-> (ex_stage_i.lsu_i.dcache_req_ports_o_st.data_wdata == data0));
