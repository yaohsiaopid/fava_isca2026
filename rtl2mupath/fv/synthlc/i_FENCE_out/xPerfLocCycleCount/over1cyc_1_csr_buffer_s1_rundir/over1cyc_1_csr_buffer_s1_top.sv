...
N_scb_0_s14: assume property (@(posedge clk_i) !scb_0_s14);
...
N_scb_1_s14: assume property (@(posedge clk_i) !scb_1_s14);
...
N_scb_2_s14: assume property (@(posedge clk_i) !scb_2_s14);
...
N_scb_3_s14: assume property (@(posedge clk_i) !scb_3_s14);
...
A_PATH: assume property (@(posedge clk_i) first |-> s_eventually (id_stage_s1_hpn && issue_s2_hpn && scb_0_s12_hpn && scb_0_s13_hpn && scb_0_s8_hpn && csr_buffer_s1_hpn && 1'b1));
CS_gt_csr_buffer_s1_2: cover property (@(posedge clk_i) csr_buffer_s1 [*2] ##1 !csr_buffer_s1 ##[0:$] (id_stage_s1_hpn && issue_s2_hpn && scb_0_s12_hpn && scb_0_s13_hpn && scb_0_s8_hpn && csr_buffer_s1_hpn && 1'b1 & !(id_stage_s1 | issue_s2 | scb_0_s12 | scb_0_s13 | scb_0_s8 | csr_buffer_s1 | 1'b0))); 
endmodule // ariane
