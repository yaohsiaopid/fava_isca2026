...
`ifndef WHB
HB_57: assert property (@(posedge clk_i) ((id_stage_s1) && !id_stage_s1_hpn) |-> !(issue_s2_hpn || (issue_s2)));
`else
WHB_57: assert property (@(posedge clk_i) ((id_stage_s1) && !id_stage_s1_hpn) |-> !issue_s2_hpn);
WHB_CONCUR_57: assert property (@(posedge clk_i) ((id_stage_s1) && !id_stage_s1_hpn) |-> ((issue_s2) && !issue_s2_hpn));
`endif
