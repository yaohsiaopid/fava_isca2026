...
`ifndef WHB
HB_465: assert property (@(posedge clk_i) ((scb_0_s8 || scb_1_s8 || scb_2_s8 || scb_3_s8) && !scb_0_s8_hpn) |-> !(csr_buffer_s1_hpn || (csr_buffer_s1)));
`else
WHB_465: assert property (@(posedge clk_i) ((scb_0_s8 || scb_1_s8 || scb_2_s8 || scb_3_s8) && !scb_0_s8_hpn) |-> !csr_buffer_s1_hpn);
WHB_CONCUR_465: assert property (@(posedge clk_i) ((scb_0_s8 || scb_1_s8 || scb_2_s8 || scb_3_s8) && !scb_0_s8_hpn) |-> ((csr_buffer_s1) && !csr_buffer_s1_hpn));
`endif
