...
`ifndef WHB
HB_121: assert property (@(posedge clk_i) ((issue_s2) && !issue_s2_hpn) |-> !(id_stage_s1_hpn || (id_stage_s1)));
`else
WHB_121: assert property (@(posedge clk_i) ((issue_s2) && !issue_s2_hpn) |-> !id_stage_s1_hpn);
WHB_CONCUR_121: assert property (@(posedge clk_i) ((issue_s2) && !issue_s2_hpn) |-> ((id_stage_s1) && !id_stage_s1_hpn));
`endif
