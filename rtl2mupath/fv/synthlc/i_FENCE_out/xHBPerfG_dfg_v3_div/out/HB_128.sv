...
`ifndef WHB
HB_128: assert property (@(posedge clk_i) ((issue_s2) && !issue_s2_hpn) |-> !(scb_0_s12_hpn || (scb_0_s12 || scb_1_s12 || scb_2_s12 || scb_3_s12)));
`else
WHB_128: assert property (@(posedge clk_i) ((issue_s2) && !issue_s2_hpn) |-> !scb_0_s12_hpn);
WHB_CONCUR_128: assert property (@(posedge clk_i) ((issue_s2) && !issue_s2_hpn) |-> ((scb_0_s12 || scb_1_s12 || scb_2_s12 || scb_3_s12) && !scb_0_s12_hpn));
`endif
