...
`ifndef WHB
HB_131: assert property (@(posedge clk_i) ((issue_s2) && !issue_s2_hpn) |-> !(scb_0_s8_hpn || (scb_0_s8 || scb_1_s8 || scb_2_s8 || scb_3_s8)));
`else
WHB_131: assert property (@(posedge clk_i) ((issue_s2) && !issue_s2_hpn) |-> !scb_0_s8_hpn);
WHB_CONCUR_131: assert property (@(posedge clk_i) ((issue_s2) && !issue_s2_hpn) |-> ((scb_0_s8 || scb_1_s8 || scb_2_s8 || scb_3_s8) && !scb_0_s8_hpn));
`endif
