...
`ifndef WHB
HB_1133: assert property (@(posedge clk_i) ((csr_buffer_s1) && !csr_buffer_s1_hpn) |-> !(issue_s2_hpn || (issue_s2)));
`else
WHB_1133: assert property (@(posedge clk_i) ((csr_buffer_s1) && !csr_buffer_s1_hpn) |-> !issue_s2_hpn);
WHB_CONCUR_1133: assert property (@(posedge clk_i) ((csr_buffer_s1) && !csr_buffer_s1_hpn) |-> ((issue_s2) && !issue_s2_hpn));
`endif
