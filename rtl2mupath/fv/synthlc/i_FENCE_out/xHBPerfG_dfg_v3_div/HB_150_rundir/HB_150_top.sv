...
`ifndef WHB
HB_150: assert property (@(posedge clk_i) ((issue_s2) && !issue_s2_hpn) |-> !(csr_buffer_s1_hpn || (csr_buffer_s1)));
`else
WHB_150: assert property (@(posedge clk_i) ((issue_s2) && !issue_s2_hpn) |-> !csr_buffer_s1_hpn);
WHB_CONCUR_150: assert property (@(posedge clk_i) ((issue_s2) && !issue_s2_hpn) |-> ((csr_buffer_s1) && !csr_buffer_s1_hpn));
`endif
