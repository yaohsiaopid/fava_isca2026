...
`ifndef WHB
HB_321: assert property (@(posedge clk_i) ((scb_0_s12 || scb_1_s12 || scb_2_s12 || scb_3_s12) && !scb_0_s12_hpn) |-> !(id_stage_s1_hpn || (id_stage_s1)));
`else
WHB_321: assert property (@(posedge clk_i) ((scb_0_s12 || scb_1_s12 || scb_2_s12 || scb_3_s12) && !scb_0_s12_hpn) |-> !id_stage_s1_hpn);
WHB_CONCUR_321: assert property (@(posedge clk_i) ((scb_0_s12 || scb_1_s12 || scb_2_s12 || scb_3_s12) && !scb_0_s12_hpn) |-> ((id_stage_s1) && !id_stage_s1_hpn));
`endif
