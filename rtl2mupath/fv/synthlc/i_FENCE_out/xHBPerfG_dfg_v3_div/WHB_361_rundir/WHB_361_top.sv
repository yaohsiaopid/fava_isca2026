...
`ifndef WHB
HB_361: assert property (@(posedge clk_i) ((scb_0_s13 || scb_1_s13 || scb_2_s13 || scb_3_s13) && !scb_0_s13_hpn) |-> !(issue_s2_hpn || (issue_s2)));
`else
WHB_361: assert property (@(posedge clk_i) ((scb_0_s13 || scb_1_s13 || scb_2_s13 || scb_3_s13) && !scb_0_s13_hpn) |-> !issue_s2_hpn);
WHB_CONCUR_361: assert property (@(posedge clk_i) ((scb_0_s13 || scb_1_s13 || scb_2_s13 || scb_3_s13) && !scb_0_s13_hpn) |-> ((issue_s2) && !issue_s2_hpn));
`endif
