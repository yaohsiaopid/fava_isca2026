...
`ifndef WHB
HB_1131: assert property (@(posedge clk_i) ((csr_buffer_s1) && !csr_buffer_s1_hpn) |-> !(id_stage_s1_hpn || (id_stage_s1)));
`else
WHB_1131: assert property (@(posedge clk_i) ((csr_buffer_s1) && !csr_buffer_s1_hpn) |-> !id_stage_s1_hpn);
WHB_CONCUR_1131: assert property (@(posedge clk_i) ((csr_buffer_s1) && !csr_buffer_s1_hpn) |-> ((id_stage_s1) && !id_stage_s1_hpn));
`endif
