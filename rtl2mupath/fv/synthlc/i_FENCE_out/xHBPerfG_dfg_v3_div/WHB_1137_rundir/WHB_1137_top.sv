...
`ifndef WHB
HB_1137: assert property (@(posedge clk_i) ((csr_buffer_s1) && !csr_buffer_s1_hpn) |-> !(scb_0_s12_hpn || (scb_0_s12 || scb_1_s12 || scb_2_s12 || scb_3_s12)));
`else
WHB_1137: assert property (@(posedge clk_i) ((csr_buffer_s1) && !csr_buffer_s1_hpn) |-> !scb_0_s12_hpn);
WHB_CONCUR_1137: assert property (@(posedge clk_i) ((csr_buffer_s1) && !csr_buffer_s1_hpn) |-> ((scb_0_s12 || scb_1_s12 || scb_2_s12 || scb_3_s12) && !scb_0_s12_hpn));
`endif
