...
`ifndef WHB
HB_scb_0_s13_LEAVING_csr_buffer_s1: assert property (@(posedge clk_i) 
    ($past(!scb_0_s13_hpn) && scb_0_s13 && (csr_buffer_s1_hpn || csr_buffer_s1)) |=>
     csr_buffer_s1);
`else 
WHB_scb_0_s13_LEAVING_csr_buffer_s1: assert property (@(posedge clk_i) 
    ($past(!scb_0_s13_hpn) && scb_0_s13 && csr_buffer_s1_hpn) |->
    csr_buffer_s1);
WHB_CONCUR_scb_0_s13_LEAVING_csr_buffer_s1: assert property (@(posedge clk_i) 
    ($past(!scb_0_s13_hpn) && scb_0_s13 && csr_buffer_s1_hpn && csr_buffer_s1) |=>
    (!(csr_buffer_s1)));
`endif 
