...
`ifndef WHB
HB_csr_buffer_s1_LEAVING_id_stage_s1: assert property (@(posedge clk_i) 
    ($past(!csr_buffer_s1_hpn) && csr_buffer_s1 && (id_stage_s1_hpn || id_stage_s1)) |=>
     id_stage_s1);
`else 
WHB_csr_buffer_s1_LEAVING_id_stage_s1: assert property (@(posedge clk_i) 
    ($past(!csr_buffer_s1_hpn) && csr_buffer_s1 && id_stage_s1_hpn) |->
    id_stage_s1);
WHB_CONCUR_csr_buffer_s1_LEAVING_id_stage_s1: assert property (@(posedge clk_i) 
    ($past(!csr_buffer_s1_hpn) && csr_buffer_s1 && id_stage_s1_hpn && id_stage_s1) |=>
    (!(id_stage_s1)));
`endif 

`ifndef WHB
HB_LEAVING_csr_buffer_s1_LEAVING_id_stage_s1: assert property (@(posedge clk_i) 
    ($past(csr_buffer_s1, 2) && $past(csr_buffer_s1) && (!(csr_buffer_s1))) |-> 
    ((id_stage_s1_hpn && id_stage_s1) || !id_stage_s1_hpn));
`else 
WHB_LEAVING_csr_buffer_s1_LEAVING_id_stage_s1: assert property (@(posedge clk_i) 
    ($past(csr_buffer_s1, 2) && $past(csr_buffer_s1) && (!(csr_buffer_s1))) |-> 
    $past((id_stage_s1_hpn && id_stage_s1) || !id_stage_s1_hpn));
WHB_CONCUR_LEAVING_csr_buffer_s1_LEAVING_id_stage_s1: assert property (@(posedge clk_i) 
    ($past(csr_buffer_s1, 2) && $past(csr_buffer_s1) && (!(csr_buffer_s1))) |-> 
