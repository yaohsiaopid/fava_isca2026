...
always @(posedge clk_i) begin
    if (!rst_ni)
        scb_0_s14_hpn <= 1'b0;
    else if (scb_0_s14 || scb_1_s14 || scb_2_s14 || scb_3_s14)
        scb_0_s14_hpn <= 1'b1;
end
...
assume property (@(posedge clk_i) !scb_0_s14); 
assume property (@(posedge clk_i) !scb_1_s12); 
assume property (@(posedge clk_i) !scb_1_s13); 
assume property (@(posedge clk_i) !scb_1_s14); 
assume property (@(posedge clk_i) !scb_1_s8); 
assume property (@(posedge clk_i) !scb_2_s12); 
assume property (@(posedge clk_i) !scb_2_s13); 
assume property (@(posedge clk_i) !scb_2_s14); 
assume property (@(posedge clk_i) !scb_2_s8); 
assume property (@(posedge clk_i) !scb_3_s12); 
assume property (@(posedge clk_i) !scb_3_s13); 
assume property (@(posedge clk_i) !scb_3_s14); 
assume property (@(posedge clk_i) !scb_3_s8); 
C_1_N: cover property (@(posedge clk_i) id_stage_s1_hpn & issue_s2_hpn & scb_0_s12_hpn & scb_0_s13_hpn & scb_0_s8_hpn & csr_buffer_s1_hpn & 1'b1 & !(id_stage_s1 | issue_s2 | scb_0_s12 | scb_0_s13 | scb_0_s8 | csr_buffer_s1 | 1'b0));
endmodule // ariane
