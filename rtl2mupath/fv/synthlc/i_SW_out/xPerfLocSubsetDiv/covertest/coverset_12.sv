...
assume property (@(posedge clk_i) !stb_com_0_s1); 
assume property (@(posedge clk_i) !stb_com_1_s1); 
assume property (@(posedge clk_i) !stb_spec_0_s1); 
assume property (@(posedge clk_i) !stb_spec_1_s1); 
assume property (@(posedge clk_i) !store_unit_s3); 
assume property (@(posedge clk_i) !mem_req_s1); 
C_12_N: cover property (@(posedge clk_i) id_stage_s1_hpn & issue_s16_hpn & scb_0_s12_hpn & scb_0_s13_hpn & scb_0_s8_hpn & store_unit_s1_hpn & 1'b1 & !(id_stage_s1 | issue_s16 | scb_0_s12 | scb_0_s13 | scb_0_s8 | store_unit_s1 | 1'b0));