...
A_stb_com_0_s1_hb_mem_req_s1: assume property (@(posedge clk_i) (stb_com_0_s1 & !stb_com_0_s1_hpn) |-> !(mem_req_s1 | mem_req_s1_hpn));
...
CS_stb_com_0_s1___final_hb_mem_req_s1: cover property (@(posedge clk_i) stb_com_0_s1 ##1 (!stb_com_0_s1 & !(mem_req_s1_hpn | mem_req_s1)) ##[0:$] set_r);

CS_mem_req_s1_concur_stb_com_0_s1___final: cover property (@(posedge clk_i) (mem_req_s1 & !mem_req_s1_hpn & stb_com_0_s1) ##1 (!stb_com_0_s1) ##[0:$] set_r);
