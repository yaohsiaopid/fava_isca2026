...
`ifndef WHB
HB_LEAVING_scb_0_s8_store_unit_s3: assert property (@(posedge clk_i) 
    ($past(scb_0_s8, 2) && 
        $past(scb_0_s8) && (!(scb_0_s8 || scb_1_s8 || scb_2_s8 || scb_3_s8))) |-> 
    $past(!(store_unit_s3_hpn || store_unit_s3)));
`else 
WHB_LEAVING_scb_0_s8_hb_store_unit_s3: assert property (@(posedge clk_i) 
    ($past(scb_0_s8, 2) && 
        $past(scb_0_s8) && (!(scb_0_s8 || scb_1_s8 || scb_2_s8 || scb_3_s8))) |-> $past(!(store_unit_s3_hpn)));
WHB_CONCUR_LEAVING_scb_0_s8_hb_store_unit_s3: assert property (@(posedge clk_i) 
    ($past(scb_0_s8, 2) && 
        $past(scb_0_s8) && (!(scb_0_s8 || scb_1_s8 || scb_2_s8 || scb_3_s8))) |-> $past(!(store_unit_s3_hpn) && store_unit_s3));
`endif 

// if precondition in unreachable meaning s2 already left when s1 enters
`ifndef WHB
HB_scb_0_s8_LEAVING_store_unit_s3: assert property (@(posedge clk_i) 
    ($past(!scb_0_s8_hpn) && scb_0_s8 && (store_unit_s3_hpn || store_unit_s3)) |=>
     store_unit_s3);
`else 
WHB_scb_0_s8_LEAVING_store_unit_s3: assert property (@(posedge clk_i) 
    ($past(!scb_0_s8_hpn) && scb_0_s8 && store_unit_s3_hpn) |->
    store_unit_s3);
WHB_CONCUR_scb_0_s8_LEAVING_store_unit_s3: assert property (@(posedge clk_i) 
    ($past(!scb_0_s8_hpn) && scb_0_s8 && store_unit_s3_hpn && store_unit_s3) |=>
    (!(store_unit_s3)));
`endif 

`ifndef WHB
HB_LEAVING_scb_0_s8_LEAVING_store_unit_s3: assert property (@(posedge clk_i) 
    ($past(scb_0_s8, 2) && $past(scb_0_s8) && (!(scb_0_s8 || scb_1_s8 || scb_2_s8 || scb_3_s8))) |-> 
    ((store_unit_s3_hpn && store_unit_s3) || !store_unit_s3_hpn));
`else 
WHB_LEAVING_scb_0_s8_LEAVING_store_unit_s3: assert property (@(posedge clk_i) 
    ($past(scb_0_s8, 2) && $past(scb_0_s8) && (!(scb_0_s8 || scb_1_s8 || scb_2_s8 || scb_3_s8))) |-> 
    $past((store_unit_s3_hpn && store_unit_s3) || !store_unit_s3_hpn));
WHB_CONCUR_LEAVING_scb_0_s8_LEAVING_store_unit_s3: assert property (@(posedge clk_i) 
    ($past(scb_0_s8, 2) && $past(scb_0_s8) && (!(scb_0_s8 || scb_1_s8 || scb_2_s8 || scb_3_s8))) |-> 
