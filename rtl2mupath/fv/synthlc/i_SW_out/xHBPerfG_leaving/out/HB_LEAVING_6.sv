...
`ifndef WHB
HB_issue_s16_LEAVING_stb_com_0_s1: assert property (@(posedge clk_i) 
    ($past(!issue_s16_hpn) && issue_s16 && (stb_com_0_s1_hpn || stb_com_0_s1)) |=>
     stb_com_0_s1);
`else 
WHB_issue_s16_LEAVING_stb_com_0_s1: assert property (@(posedge clk_i) 
    ($past(!issue_s16_hpn) && issue_s16 && stb_com_0_s1_hpn) |->
    stb_com_0_s1);
WHB_CONCUR_issue_s16_LEAVING_stb_com_0_s1: assert property (@(posedge clk_i) 
    ($past(!issue_s16_hpn) && issue_s16 && stb_com_0_s1_hpn && stb_com_0_s1) |=>
