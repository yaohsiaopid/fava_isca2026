...
S2_STAY_AT_LEAST_TWO: assume property (@(posedge clk_i) first |-> s_eventually
    ( !scb_0_s12 || scb_1_s12 || scb_2_s12 || scb_3_s12 [*0:$] ##1 scb_0_s12 || scb_1_s12 || scb_2_s12 || scb_3_s12 ##1 scb_0_s12 || scb_1_s12 || scb_2_s12 || scb_3_s12));

`ifndef WHB
HB_LEAVING_stb_spec_0_s1_scb_0_s12: assert property (@(posedge clk_i) 
    ($past(stb_spec_0_s1, 2) && 
        $past(stb_spec_0_s1) && (!(stb_spec_0_s1 || stb_spec_1_s1))) |-> 
    $past(!(scb_0_s12_hpn || scb_0_s12)));
`else 
WHB_LEAVING_stb_spec_0_s1_hb_scb_0_s12: assert property (@(posedge clk_i) 
    ($past(stb_spec_0_s1, 2) && 
        $past(stb_spec_0_s1) && (!(stb_spec_0_s1 || stb_spec_1_s1))) |-> $past(!(scb_0_s12_hpn)));
WHB_CONCUR_LEAVING_stb_spec_0_s1_hb_scb_0_s12: assert property (@(posedge clk_i) 
    ($past(stb_spec_0_s1, 2) && 
        $past(stb_spec_0_s1) && (!(stb_spec_0_s1 || stb_spec_1_s1))) |-> $past(!(scb_0_s12_hpn) && scb_0_s12));
`endif 

// if precondition in unreachable meaning s2 already left when s1 enters
`ifndef WHB
HB_stb_spec_0_s1_LEAVING_scb_0_s12: assert property (@(posedge clk_i) 
    ($past(!stb_spec_0_s1_hpn) && stb_spec_0_s1 && (scb_0_s12_hpn || scb_0_s12)) |=>
     scb_0_s12);
`else 
WHB_stb_spec_0_s1_LEAVING_scb_0_s12: assert property (@(posedge clk_i) 
    ($past(!stb_spec_0_s1_hpn) && stb_spec_0_s1 && scb_0_s12_hpn) |->
    scb_0_s12);
WHB_CONCUR_stb_spec_0_s1_LEAVING_scb_0_s12: assert property (@(posedge clk_i) 
    ($past(!stb_spec_0_s1_hpn) && stb_spec_0_s1 && scb_0_s12_hpn && scb_0_s12) |=>
    (!(scb_0_s12 || scb_1_s12 || scb_2_s12 || scb_3_s12)));
`endif 

`ifndef WHB
HB_LEAVING_stb_spec_0_s1_LEAVING_scb_0_s12: assert property (@(posedge clk_i) 
    ($past(stb_spec_0_s1, 2) && $past(stb_spec_0_s1) && (!(stb_spec_0_s1 || stb_spec_1_s1))) |-> 
    ((scb_0_s12_hpn && scb_0_s12) || !scb_0_s12_hpn));
`else 
WHB_LEAVING_stb_spec_0_s1_LEAVING_scb_0_s12: assert property (@(posedge clk_i) 
    ($past(stb_spec_0_s1, 2) && $past(stb_spec_0_s1) && (!(stb_spec_0_s1 || stb_spec_1_s1))) |-> 
    $past((scb_0_s12_hpn && scb_0_s12) || !scb_0_s12_hpn));
WHB_CONCUR_LEAVING_stb_spec_0_s1_LEAVING_scb_0_s12: assert property (@(posedge clk_i) 
    ($past(stb_spec_0_s1, 2) && $past(stb_spec_0_s1) && (!(stb_spec_0_s1 || stb_spec_1_s1))) |-> 
    ($past(scb_0_s12, 2) && $past(scb_0_s12) && (!(scb_0_s12 || scb_1_s12 || scb_2_s12 || scb_3_s12)))); 
`endif 
