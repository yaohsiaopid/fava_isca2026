...
`ifndef WHB
HB_LEAVING_stb_spec_0_s1_stb_com_0_s1: assert property (@(posedge clk_i) 
    ($past(stb_spec_0_s1, 2) && 
        $past(stb_spec_0_s1) && (!(stb_spec_0_s1 || stb_spec_1_s1))) |-> 
    $past(!(stb_com_0_s1_hpn || stb_com_0_s1)));
`else 
WHB_LEAVING_stb_spec_0_s1_hb_stb_com_0_s1: assert property (@(posedge clk_i) 
    ($past(stb_spec_0_s1, 2) && 
        $past(stb_spec_0_s1) && (!(stb_spec_0_s1 || stb_spec_1_s1))) |-> $past(!(stb_com_0_s1_hpn)));
WHB_CONCUR_LEAVING_stb_spec_0_s1_hb_stb_com_0_s1: assert property (@(posedge clk_i) 
    ($past(stb_spec_0_s1, 2) && 
        $past(stb_spec_0_s1) && (!(stb_spec_0_s1 || stb_spec_1_s1))) |-> $past(!(stb_com_0_s1_hpn) && stb_com_0_s1));
`endif 

`ifndef WHB
HB_LEAVING_stb_spec_0_s1_LEAVING_stb_com_0_s1: assert property (@(posedge clk_i) 
    ($past(stb_spec_0_s1, 2) && $past(stb_spec_0_s1) && (!(stb_spec_0_s1 || stb_spec_1_s1))) |-> 
    ((stb_com_0_s1_hpn && stb_com_0_s1) || !stb_com_0_s1_hpn));
`else 
WHB_LEAVING_stb_spec_0_s1_LEAVING_stb_com_0_s1: assert property (@(posedge clk_i) 
    ($past(stb_spec_0_s1, 2) && $past(stb_spec_0_s1) && (!(stb_spec_0_s1 || stb_spec_1_s1))) |-> 
    $past((stb_com_0_s1_hpn && stb_com_0_s1) || !stb_com_0_s1_hpn));
WHB_CONCUR_LEAVING_stb_spec_0_s1_LEAVING_stb_com_0_s1: assert property (@(posedge clk_i) 
    ($past(stb_spec_0_s1, 2) && $past(stb_spec_0_s1) && (!(stb_spec_0_s1 || stb_spec_1_s1))) |-> 
