...
`ifndef WHB
HB_LEAVING_scb_0_s8_stb_spec_0_s1: assert property (@(posedge clk_i) 
    ($past(scb_0_s8, 2) && 
        $past(scb_0_s8) && (!(scb_0_s8 || scb_1_s8 || scb_2_s8 || scb_3_s8))) |-> 
    $past(!(stb_spec_0_s1_hpn || stb_spec_0_s1)));
`else 
WHB_LEAVING_scb_0_s8_hb_stb_spec_0_s1: assert property (@(posedge clk_i) 
    ($past(scb_0_s8, 2) && 
        $past(scb_0_s8) && (!(scb_0_s8 || scb_1_s8 || scb_2_s8 || scb_3_s8))) |-> $past(!(stb_spec_0_s1_hpn)));
WHB_CONCUR_LEAVING_scb_0_s8_hb_stb_spec_0_s1: assert property (@(posedge clk_i) 
    ($past(scb_0_s8, 2) && 
        $past(scb_0_s8) && (!(scb_0_s8 || scb_1_s8 || scb_2_s8 || scb_3_s8))) |-> $past(!(stb_spec_0_s1_hpn) && stb_spec_0_s1));
`endif 

// if precondition in unreachable meaning s2 already left when s1 enters
`ifndef WHB
HB_scb_0_s8_LEAVING_stb_spec_0_s1: assert property (@(posedge clk_i) 
    ($past(!scb_0_s8_hpn) && scb_0_s8 && (stb_spec_0_s1_hpn || stb_spec_0_s1)) |=>
     stb_spec_0_s1);
`else 
WHB_scb_0_s8_LEAVING_stb_spec_0_s1: assert property (@(posedge clk_i) 
    ($past(!scb_0_s8_hpn) && scb_0_s8 && stb_spec_0_s1_hpn) |->
    stb_spec_0_s1);
WHB_CONCUR_scb_0_s8_LEAVING_stb_spec_0_s1: assert property (@(posedge clk_i) 
    ($past(!scb_0_s8_hpn) && scb_0_s8 && stb_spec_0_s1_hpn && stb_spec_0_s1) |=>
    (!(stb_spec_0_s1 || stb_spec_1_s1)));
`endif 

`ifndef WHB
HB_LEAVING_scb_0_s8_LEAVING_stb_spec_0_s1: assert property (@(posedge clk_i) 
    ($past(scb_0_s8, 2) && $past(scb_0_s8) && (!(scb_0_s8 || scb_1_s8 || scb_2_s8 || scb_3_s8))) |-> 
    ((stb_spec_0_s1_hpn && stb_spec_0_s1) || !stb_spec_0_s1_hpn));
`else 
WHB_LEAVING_scb_0_s8_LEAVING_stb_spec_0_s1: assert property (@(posedge clk_i) 
    ($past(scb_0_s8, 2) && $past(scb_0_s8) && (!(scb_0_s8 || scb_1_s8 || scb_2_s8 || scb_3_s8))) |-> 
    $past((stb_spec_0_s1_hpn && stb_spec_0_s1) || !stb_spec_0_s1_hpn));
WHB_CONCUR_LEAVING_scb_0_s8_LEAVING_stb_spec_0_s1: assert property (@(posedge clk_i) 
    ($past(scb_0_s8, 2) && $past(scb_0_s8) && (!(scb_0_s8 || scb_1_s8 || scb_2_s8 || scb_3_s8))) |-> 
