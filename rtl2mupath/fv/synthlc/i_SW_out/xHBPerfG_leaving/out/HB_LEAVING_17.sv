...
`ifndef WHB
HB_LEAVING_lsq_enq_1_s1_store_unit_s1: assert property (@(posedge clk_i) 
    ($past(lsq_enq_1_s1, 2) && 
        $past(lsq_enq_1_s1) && (!(lsq_enq_1_s1))) |-> 
    $past(!(store_unit_s1_hpn || store_unit_s1)));
`else 
WHB_LEAVING_lsq_enq_1_s1_hb_store_unit_s1: assert property (@(posedge clk_i) 
    ($past(lsq_enq_1_s1, 2) && 
        $past(lsq_enq_1_s1) && (!(lsq_enq_1_s1))) |-> $past(!(store_unit_s1_hpn)));
WHB_CONCUR_LEAVING_lsq_enq_1_s1_hb_store_unit_s1: assert property (@(posedge clk_i) 
    ($past(lsq_enq_1_s1, 2) && 
        $past(lsq_enq_1_s1) && (!(lsq_enq_1_s1))) |-> $past(!(store_unit_s1_hpn) && store_unit_s1));
`endif 
