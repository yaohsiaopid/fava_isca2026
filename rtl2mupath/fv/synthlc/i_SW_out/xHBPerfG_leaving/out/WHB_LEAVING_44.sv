...
HB_LEAVING_stb_spec_0_s1_LEAVING_lsq_enq_0_s1: assert property (@(posedge clk_i) 
    ($past(stb_spec_0_s1, 2) && $past(stb_spec_0_s1) && (!stb_spec_0_s1)) |-> 
