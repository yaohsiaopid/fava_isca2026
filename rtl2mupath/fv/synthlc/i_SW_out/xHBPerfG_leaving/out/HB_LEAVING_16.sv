...
`ifndef WHB
HB_LEAVING_lsq_enq_1_s1_stb_com_0_s1: assert property (@(posedge clk_i) 
    ($past(lsq_enq_1_s1, 2) && 
        $past(lsq_enq_1_s1) && (!(lsq_enq_1_s1))) |-> 
    $past(!(stb_com_0_s1_hpn || stb_com_0_s1)));
`else 
WHB_LEAVING_lsq_enq_1_s1_hb_stb_com_0_s1: assert property (@(posedge clk_i) 
    ($past(lsq_enq_1_s1, 2) && 
        $past(lsq_enq_1_s1) && (!(lsq_enq_1_s1))) |-> $past(!(stb_com_0_s1_hpn)));
WHB_CONCUR_LEAVING_lsq_enq_1_s1_hb_stb_com_0_s1: assert property (@(posedge clk_i) 
    ($past(lsq_enq_1_s1, 2) && 
        $past(lsq_enq_1_s1) && (!(lsq_enq_1_s1))) |-> $past(!(stb_com_0_s1_hpn) && stb_com_0_s1));
`endif 

// if precondition in unreachable meaning s2 already left when s1 enters
`ifndef WHB
HB_lsq_enq_1_s1_LEAVING_stb_com_0_s1: assert property (@(posedge clk_i) 
    ($past(!lsq_enq_1_s1_hpn) && lsq_enq_1_s1 && (stb_com_0_s1_hpn || stb_com_0_s1)) |=>
     stb_com_0_s1);
`else 
WHB_lsq_enq_1_s1_LEAVING_stb_com_0_s1: assert property (@(posedge clk_i) 
    ($past(!lsq_enq_1_s1_hpn) && lsq_enq_1_s1 && stb_com_0_s1_hpn) |->
    stb_com_0_s1);
WHB_CONCUR_lsq_enq_1_s1_LEAVING_stb_com_0_s1: assert property (@(posedge clk_i) 
    ($past(!lsq_enq_1_s1_hpn) && lsq_enq_1_s1 && stb_com_0_s1_hpn && stb_com_0_s1) |=>
    (!(stb_com_0_s1 || stb_com_1_s1)));
`endif 

`ifndef WHB
HB_LEAVING_lsq_enq_1_s1_LEAVING_stb_com_0_s1: assert property (@(posedge clk_i) 
    ($past(lsq_enq_1_s1, 2) && $past(lsq_enq_1_s1) && (!(lsq_enq_1_s1))) |-> 
    ((stb_com_0_s1_hpn && stb_com_0_s1) || !stb_com_0_s1_hpn));
`else 
WHB_LEAVING_lsq_enq_1_s1_LEAVING_stb_com_0_s1: assert property (@(posedge clk_i) 
    ($past(lsq_enq_1_s1, 2) && $past(lsq_enq_1_s1) && (!(lsq_enq_1_s1))) |-> 
    $past((stb_com_0_s1_hpn && stb_com_0_s1) || !stb_com_0_s1_hpn));
WHB_CONCUR_LEAVING_lsq_enq_1_s1_LEAVING_stb_com_0_s1: assert property (@(posedge clk_i) 
    ($past(lsq_enq_1_s1, 2) && $past(lsq_enq_1_s1) && (!(lsq_enq_1_s1))) |-> 
