...
`ifndef WHB
HB_LEAVING_lsq_enq_1_s1_scb_0_s13: assert property (@(posedge clk_i) 
    ($past(lsq_enq_1_s1, 2) && 
        $past(lsq_enq_1_s1) && (!(lsq_enq_1_s1))) |-> 
    $past(!(scb_0_s13_hpn || scb_0_s13)));
`else 
WHB_LEAVING_lsq_enq_1_s1_hb_scb_0_s13: assert property (@(posedge clk_i) 
    ($past(lsq_enq_1_s1, 2) && 
        $past(lsq_enq_1_s1) && (!(lsq_enq_1_s1))) |-> $past(!(scb_0_s13_hpn)));
WHB_CONCUR_LEAVING_lsq_enq_1_s1_hb_scb_0_s13: assert property (@(posedge clk_i) 
    ($past(lsq_enq_1_s1, 2) && 
        $past(lsq_enq_1_s1) && (!(lsq_enq_1_s1))) |-> $past(!(scb_0_s13_hpn) && scb_0_s13));
`endif 
