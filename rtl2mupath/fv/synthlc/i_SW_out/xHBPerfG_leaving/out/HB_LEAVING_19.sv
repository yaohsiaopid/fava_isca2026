...
`ifndef WHB
HB_scb_0_s12_LEAVING_id_stage_s1: assert property (@(posedge clk_i) 
    ($past(!scb_0_s12_hpn) && scb_0_s12 && (id_stage_s1_hpn || id_stage_s1)) |=>
     id_stage_s1);
`else 
WHB_scb_0_s12_LEAVING_id_stage_s1: assert property (@(posedge clk_i) 
    ($past(!scb_0_s12_hpn) && scb_0_s12 && id_stage_s1_hpn) |->
    id_stage_s1);
WHB_CONCUR_scb_0_s12_LEAVING_id_stage_s1: assert property (@(posedge clk_i) 
    ($past(!scb_0_s12_hpn) && scb_0_s12 && id_stage_s1_hpn && id_stage_s1) |=>
    (!(id_stage_s1)));
`endif 

`ifndef WHB
HB_LEAVING_scb_0_s12_LEAVING_id_stage_s1: assert property (@(posedge clk_i) 
    ($past(scb_0_s12, 2) && $past(scb_0_s12) && (!(scb_0_s12 || scb_1_s12 || scb_2_s12 || scb_3_s12))) |-> 
    ((id_stage_s1_hpn && id_stage_s1) || !id_stage_s1_hpn));
`else 
WHB_LEAVING_scb_0_s12_LEAVING_id_stage_s1: assert property (@(posedge clk_i) 
    ($past(scb_0_s12, 2) && $past(scb_0_s12) && (!(scb_0_s12 || scb_1_s12 || scb_2_s12 || scb_3_s12))) |-> 
    $past((id_stage_s1_hpn && id_stage_s1) || !id_stage_s1_hpn));
WHB_CONCUR_LEAVING_scb_0_s12_LEAVING_id_stage_s1: assert property (@(posedge clk_i) 
    ($past(scb_0_s12, 2) && $past(scb_0_s12) && (!(scb_0_s12 || scb_1_s12 || scb_2_s12 || scb_3_s12))) |-> 
