...
`ifndef WHB
HB_LEAVING_lsq_enq_0_s1_scb_0_s12: assert property (@(posedge clk_i) 
    ($past(lsq_enq_0_s1, 2) && 
        $past(lsq_enq_0_s1) && (!(lsq_enq_0_s1))) |-> 
    $past(!(scb_0_s12_hpn || scb_0_s12)));
`else 
WHB_LEAVING_lsq_enq_0_s1_hb_scb_0_s12: assert property (@(posedge clk_i) 
    ($past(lsq_enq_0_s1, 2) && 
        $past(lsq_enq_0_s1) && (!(lsq_enq_0_s1))) |-> $past(!(scb_0_s12_hpn)));
WHB_CONCUR_LEAVING_lsq_enq_0_s1_hb_scb_0_s12: assert property (@(posedge clk_i) 
    ($past(lsq_enq_0_s1, 2) && 
        $past(lsq_enq_0_s1) && (!(lsq_enq_0_s1))) |-> $past(!(scb_0_s12_hpn) && scb_0_s12));
`endif 

// if precondition in unreachable meaning s2 already left when s1 enters
`ifndef WHB
HB_lsq_enq_0_s1_LEAVING_scb_0_s12: assert property (@(posedge clk_i) 
    ($past(!lsq_enq_0_s1_hpn) && lsq_enq_0_s1 && (scb_0_s12_hpn || scb_0_s12)) |=>
     scb_0_s12);
`else 
WHB_lsq_enq_0_s1_LEAVING_scb_0_s12: assert property (@(posedge clk_i) 
    ($past(!lsq_enq_0_s1_hpn) && lsq_enq_0_s1 && scb_0_s12_hpn) |->
    scb_0_s12);
WHB_CONCUR_lsq_enq_0_s1_LEAVING_scb_0_s12: assert property (@(posedge clk_i) 
    ($past(!lsq_enq_0_s1_hpn) && lsq_enq_0_s1 && scb_0_s12_hpn && scb_0_s12) |=>
    (!(scb_0_s12 || scb_1_s12 || scb_2_s12 || scb_3_s12)));
`endif 

`ifndef WHB
HB_LEAVING_lsq_enq_0_s1_LEAVING_scb_0_s12: assert property (@(posedge clk_i) 
    ($past(lsq_enq_0_s1, 2) && $past(lsq_enq_0_s1) && (!(lsq_enq_0_s1))) |-> 
    ((scb_0_s12_hpn && scb_0_s12) || !scb_0_s12_hpn));
`else 
WHB_LEAVING_lsq_enq_0_s1_LEAVING_scb_0_s12: assert property (@(posedge clk_i) 
    ($past(lsq_enq_0_s1, 2) && $past(lsq_enq_0_s1) && (!(lsq_enq_0_s1))) |-> 
    $past((scb_0_s12_hpn && scb_0_s12) || !scb_0_s12_hpn));
WHB_CONCUR_LEAVING_lsq_enq_0_s1_LEAVING_scb_0_s12: assert property (@(posedge clk_i) 
    ($past(lsq_enq_0_s1, 2) && $past(lsq_enq_0_s1) && (!(lsq_enq_0_s1))) |-> 
