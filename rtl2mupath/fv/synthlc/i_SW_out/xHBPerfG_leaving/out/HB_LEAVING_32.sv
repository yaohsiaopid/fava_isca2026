...
`ifndef WHB
HB_LEAVING_scb_0_s8_issue_s16: assert property (@(posedge clk_i) 
    ($past(scb_0_s8, 2) && 
        $past(scb_0_s8) && (!(scb_0_s8 || scb_1_s8 || scb_2_s8 || scb_3_s8))) |-> 
    $past(!(issue_s16_hpn || issue_s16)));
`else 
WHB_LEAVING_scb_0_s8_hb_issue_s16: assert property (@(posedge clk_i) 
    ($past(scb_0_s8, 2) && 
        $past(scb_0_s8) && (!(scb_0_s8 || scb_1_s8 || scb_2_s8 || scb_3_s8))) |-> $past(!(issue_s16_hpn)));
WHB_CONCUR_LEAVING_scb_0_s8_hb_issue_s16: assert property (@(posedge clk_i) 
    ($past(scb_0_s8, 2) && 
        $past(scb_0_s8) && (!(scb_0_s8 || scb_1_s8 || scb_2_s8 || scb_3_s8))) |-> $past(!(issue_s16_hpn) && issue_s16));
`endif 
