...
`ifndef WHB
HB_LEAVING_lsq_enq_0_s1_store_unit_s3: assert property (@(posedge clk_i) 
    ($past(lsq_enq_0_s1, 2) && 
        $past(lsq_enq_0_s1) && (!(lsq_enq_0_s1))) |-> 
    $past(!(store_unit_s3_hpn || store_unit_s3)));
`else 
WHB_LEAVING_lsq_enq_0_s1_hb_store_unit_s3: assert property (@(posedge clk_i) 
    ($past(lsq_enq_0_s1, 2) && 
        $past(lsq_enq_0_s1) && (!(lsq_enq_0_s1))) |-> $past(!(store_unit_s3_hpn)));
WHB_CONCUR_LEAVING_lsq_enq_0_s1_hb_store_unit_s3: assert property (@(posedge clk_i) 
    ($past(lsq_enq_0_s1, 2) && 
        $past(lsq_enq_0_s1) && (!(lsq_enq_0_s1))) |-> $past(!(store_unit_s3_hpn) && store_unit_s3));
`endif 

// if precondition in unreachable meaning s2 already left when s1 enters
`ifndef WHB
HB_lsq_enq_0_s1_LEAVING_store_unit_s3: assert property (@(posedge clk_i) 
    ($past(!lsq_enq_0_s1_hpn) && lsq_enq_0_s1 && (store_unit_s3_hpn || store_unit_s3)) |=>
     store_unit_s3);
`else 
WHB_lsq_enq_0_s1_LEAVING_store_unit_s3: assert property (@(posedge clk_i) 
    ($past(!lsq_enq_0_s1_hpn) && lsq_enq_0_s1 && store_unit_s3_hpn) |->
    store_unit_s3);
WHB_CONCUR_lsq_enq_0_s1_LEAVING_store_unit_s3: assert property (@(posedge clk_i) 
    ($past(!lsq_enq_0_s1_hpn) && lsq_enq_0_s1 && store_unit_s3_hpn && store_unit_s3) |=>
    (!(store_unit_s3)));
`endif 

`ifndef WHB
HB_LEAVING_lsq_enq_0_s1_LEAVING_store_unit_s3: assert property (@(posedge clk_i) 
    ($past(lsq_enq_0_s1, 2) && $past(lsq_enq_0_s1) && (!(lsq_enq_0_s1))) |-> 
    ((store_unit_s3_hpn && store_unit_s3) || !store_unit_s3_hpn));
`else 
WHB_LEAVING_lsq_enq_0_s1_LEAVING_store_unit_s3: assert property (@(posedge clk_i) 
    ($past(lsq_enq_0_s1, 2) && $past(lsq_enq_0_s1) && (!(lsq_enq_0_s1))) |-> 
    $past((store_unit_s3_hpn && store_unit_s3) || !store_unit_s3_hpn));
WHB_CONCUR_LEAVING_lsq_enq_0_s1_LEAVING_store_unit_s3: assert property (@(posedge clk_i) 
    ($past(lsq_enq_0_s1, 2) && $past(lsq_enq_0_s1) && (!(lsq_enq_0_s1))) |-> 
