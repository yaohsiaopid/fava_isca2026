...
`ifndef WHB
HB_store_unit_s1_LEAVING_scb_0_s12: assert property (@(posedge clk_i) 
    ($past(!store_unit_s1_hpn) && store_unit_s1 && (scb_0_s12_hpn || scb_0_s12)) |=>
     scb_0_s12);
`else 
WHB_store_unit_s1_LEAVING_scb_0_s12: assert property (@(posedge clk_i) 
    ($past(!store_unit_s1_hpn) && store_unit_s1 && scb_0_s12_hpn) |->
    scb_0_s12);
WHB_CONCUR_store_unit_s1_LEAVING_scb_0_s12: assert property (@(posedge clk_i) 
    ($past(!store_unit_s1_hpn) && store_unit_s1 && scb_0_s12_hpn && scb_0_s12) |=>
