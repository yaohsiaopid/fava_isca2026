...
`ifndef WHB
HB_store_unit_s1_LEAVING_lsq_enq_0_s1: assert property (@(posedge clk_i) 
    ($past(!store_unit_s1_hpn) && store_unit_s1 && (lsq_enq_0_s1_hpn || lsq_enq_0_s1)) |=>
     lsq_enq_0_s1);
`else 
WHB_store_unit_s1_LEAVING_lsq_enq_0_s1: assert property (@(posedge clk_i) 
    ($past(!store_unit_s1_hpn) && store_unit_s1 && lsq_enq_0_s1_hpn) |->
    lsq_enq_0_s1);
WHB_CONCUR_store_unit_s1_LEAVING_lsq_enq_0_s1: assert property (@(posedge clk_i) 
    ($past(!store_unit_s1_hpn) && store_unit_s1 && lsq_enq_0_s1_hpn && lsq_enq_0_s1) |=>
    (!(lsq_enq_0_s1)));
`endif 
