...
`ifndef WHB
HB_LEAVING_stb_com_0_s1_scb_0_s13: assert property (@(posedge clk_i) 
    ($past(stb_com_0_s1, 2) && 
        $past(stb_com_0_s1) && (!(stb_com_0_s1 || stb_com_1_s1))) |-> 
    $past(!(scb_0_s13_hpn || scb_0_s13)));
`else 
WHB_LEAVING_stb_com_0_s1_hb_scb_0_s13: assert property (@(posedge clk_i) 
    ($past(stb_com_0_s1, 2) && 
        $past(stb_com_0_s1) && (!(stb_com_0_s1 || stb_com_1_s1))) |-> $past(!(scb_0_s13_hpn)));
WHB_CONCUR_LEAVING_stb_com_0_s1_hb_scb_0_s13: assert property (@(posedge clk_i) 
    ($past(stb_com_0_s1, 2) && 
        $past(stb_com_0_s1) && (!(stb_com_0_s1 || stb_com_1_s1))) |-> $past(!(scb_0_s13_hpn) && scb_0_s13));
`endif 
