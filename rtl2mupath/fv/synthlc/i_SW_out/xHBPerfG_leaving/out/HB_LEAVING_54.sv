...
`ifndef WHB
HB_store_unit_s1_LEAVING_scb_0_s8: assert property (@(posedge clk_i) 
    ($past(!store_unit_s1_hpn) && store_unit_s1 && (scb_0_s8_hpn || scb_0_s8)) |=>
     scb_0_s8);
`else 
WHB_store_unit_s1_LEAVING_scb_0_s8: assert property (@(posedge clk_i) 
    ($past(!store_unit_s1_hpn) && store_unit_s1 && scb_0_s8_hpn) |->
    scb_0_s8);
WHB_CONCUR_store_unit_s1_LEAVING_scb_0_s8: assert property (@(posedge clk_i) 
    ($past(!store_unit_s1_hpn) && store_unit_s1 && scb_0_s8_hpn && scb_0_s8) |=>
