...
`ifndef WHB
HB_LEAVING_store_unit_s3_scb_0_s13: assert property (@(posedge clk_i) 
    ($past(store_unit_s3, 2) && 
        $past(store_unit_s3) && (!(store_unit_s3))) |-> 
    $past(!(scb_0_s13_hpn || scb_0_s13)));
`else 
WHB_LEAVING_store_unit_s3_hb_scb_0_s13: assert property (@(posedge clk_i) 
    ($past(store_unit_s3, 2) && 
        $past(store_unit_s3) && (!(store_unit_s3))) |-> $past(!(scb_0_s13_hpn)));
WHB_CONCUR_LEAVING_store_unit_s3_hb_scb_0_s13: assert property (@(posedge clk_i) 
    ($past(store_unit_s3, 2) && 
        $past(store_unit_s3) && (!(store_unit_s3))) |-> $past(!(scb_0_s13_hpn) && scb_0_s13));
`endif 
