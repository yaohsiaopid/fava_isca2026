...
`ifndef WHB
HB_LEAVING_store_unit_s3_lsq_enq_0_s1: assert property (@(posedge clk_i) 
    ($past(store_unit_s3, 2) && 
        $past(store_unit_s3) && (!(store_unit_s3))) |-> 
    $past(!(lsq_enq_0_s1_hpn || lsq_enq_0_s1)));
`else 
WHB_LEAVING_store_unit_s3_hb_lsq_enq_0_s1: assert property (@(posedge clk_i) 
    ($past(store_unit_s3, 2) && 
        $past(store_unit_s3) && (!(store_unit_s3))) |-> $past(!(lsq_enq_0_s1_hpn)));
WHB_CONCUR_LEAVING_store_unit_s3_hb_lsq_enq_0_s1: assert property (@(posedge clk_i) 
    ($past(store_unit_s3, 2) && 
        $past(store_unit_s3) && (!(store_unit_s3))) |-> $past(!(lsq_enq_0_s1_hpn) && lsq_enq_0_s1));
`endif 

// if precondition in unreachable meaning s2 already left when s1 enters
`ifndef WHB
HB_store_unit_s3_LEAVING_lsq_enq_0_s1: assert property (@(posedge clk_i) 
    ($past(!store_unit_s3_hpn) && store_unit_s3 && (lsq_enq_0_s1_hpn || lsq_enq_0_s1)) |=>
     lsq_enq_0_s1);
`else 
WHB_store_unit_s3_LEAVING_lsq_enq_0_s1: assert property (@(posedge clk_i) 
    ($past(!store_unit_s3_hpn) && store_unit_s3 && lsq_enq_0_s1_hpn) |->
    lsq_enq_0_s1);
WHB_CONCUR_store_unit_s3_LEAVING_lsq_enq_0_s1: assert property (@(posedge clk_i) 
    ($past(!store_unit_s3_hpn) && store_unit_s3 && lsq_enq_0_s1_hpn && lsq_enq_0_s1) |=>
    (!(lsq_enq_0_s1)));
`endif 

`ifndef WHB
HB_LEAVING_store_unit_s3_LEAVING_lsq_enq_0_s1: assert property (@(posedge clk_i) 
    ($past(store_unit_s3, 2) && $past(store_unit_s3) && (!(store_unit_s3))) |-> 
    ((lsq_enq_0_s1_hpn && lsq_enq_0_s1) || !lsq_enq_0_s1_hpn));
`else 
WHB_LEAVING_store_unit_s3_LEAVING_lsq_enq_0_s1: assert property (@(posedge clk_i) 
    ($past(store_unit_s3, 2) && $past(store_unit_s3) && (!(store_unit_s3))) |-> 
    $past((lsq_enq_0_s1_hpn && lsq_enq_0_s1) || !lsq_enq_0_s1_hpn));
WHB_CONCUR_LEAVING_store_unit_s3_LEAVING_lsq_enq_0_s1: assert property (@(posedge clk_i) 
    ($past(store_unit_s3, 2) && $past(store_unit_s3) && (!(store_unit_s3))) |-> 
