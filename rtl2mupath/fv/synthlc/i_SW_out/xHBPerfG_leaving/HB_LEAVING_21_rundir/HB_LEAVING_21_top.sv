...
`ifndef WHB
HB_LEAVING_scb_0_s12_lsq_enq_1_s1: assert property (@(posedge clk_i) 
    ($past(scb_0_s12, 2) && 
        $past(scb_0_s12) && (!(scb_0_s12 || scb_1_s12 || scb_2_s12 || scb_3_s12))) |-> 
    $past(!(lsq_enq_1_s1_hpn || lsq_enq_1_s1)));
`else 
WHB_LEAVING_scb_0_s12_hb_lsq_enq_1_s1: assert property (@(posedge clk_i) 
    ($past(scb_0_s12, 2) && 
        $past(scb_0_s12) && (!(scb_0_s12 || scb_1_s12 || scb_2_s12 || scb_3_s12))) |-> $past(!(lsq_enq_1_s1_hpn)));
WHB_CONCUR_LEAVING_scb_0_s12_hb_lsq_enq_1_s1: assert property (@(posedge clk_i) 
    ($past(scb_0_s12, 2) && 
        $past(scb_0_s12) && (!(scb_0_s12 || scb_1_s12 || scb_2_s12 || scb_3_s12))) |-> $past(!(lsq_enq_1_s1_hpn) && lsq_enq_1_s1));
`endif 

// if precondition in unreachable meaning s2 already left when s1 enters
`ifndef WHB
HB_scb_0_s12_LEAVING_lsq_enq_1_s1: assert property (@(posedge clk_i) 
    ($past(!scb_0_s12_hpn) && scb_0_s12 && (lsq_enq_1_s1_hpn || lsq_enq_1_s1)) |=>
     lsq_enq_1_s1);
`else 
WHB_scb_0_s12_LEAVING_lsq_enq_1_s1: assert property (@(posedge clk_i) 
    ($past(!scb_0_s12_hpn) && scb_0_s12 && lsq_enq_1_s1_hpn) |->
    lsq_enq_1_s1);
WHB_CONCUR_scb_0_s12_LEAVING_lsq_enq_1_s1: assert property (@(posedge clk_i) 
    ($past(!scb_0_s12_hpn) && scb_0_s12 && lsq_enq_1_s1_hpn && lsq_enq_1_s1) |=>
    (!(lsq_enq_1_s1)));
`endif 

`ifndef WHB
HB_LEAVING_scb_0_s12_LEAVING_lsq_enq_1_s1: assert property (@(posedge clk_i) 
    ($past(scb_0_s12, 2) && $past(scb_0_s12) && (!(scb_0_s12 || scb_1_s12 || scb_2_s12 || scb_3_s12))) |-> 
    ((lsq_enq_1_s1_hpn && lsq_enq_1_s1) || !lsq_enq_1_s1_hpn));
`else 
WHB_LEAVING_scb_0_s12_LEAVING_lsq_enq_1_s1: assert property (@(posedge clk_i) 
    ($past(scb_0_s12, 2) && $past(scb_0_s12) && (!(scb_0_s12 || scb_1_s12 || scb_2_s12 || scb_3_s12))) |-> 
    $past((lsq_enq_1_s1_hpn && lsq_enq_1_s1) || !lsq_enq_1_s1_hpn));
WHB_CONCUR_LEAVING_scb_0_s12_LEAVING_lsq_enq_1_s1: assert property (@(posedge clk_i) 
    ($past(scb_0_s12, 2) && $past(scb_0_s12) && (!(scb_0_s12 || scb_1_s12 || scb_2_s12 || scb_3_s12))) |-> 
