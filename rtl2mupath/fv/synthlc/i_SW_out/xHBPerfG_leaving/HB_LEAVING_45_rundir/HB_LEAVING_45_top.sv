...
S2_STAY_AT_LEAST_TWO: assume property (@(posedge clk_i) first |-> s_eventually
    ( !lsq_enq_1_s1 [*0:$] ##1 lsq_enq_1_s1 ##1 lsq_enq_1_s1));

`ifndef WHB
HB_LEAVING_stb_spec_0_s1_lsq_enq_1_s1: assert property (@(posedge clk_i) 
    ($past(stb_spec_0_s1, 2) && 
        $past(stb_spec_0_s1) && (!(stb_spec_0_s1 || stb_spec_1_s1))) |-> 
    $past(!(lsq_enq_1_s1_hpn || lsq_enq_1_s1)));
`else 
WHB_LEAVING_stb_spec_0_s1_hb_lsq_enq_1_s1: assert property (@(posedge clk_i) 
    ($past(stb_spec_0_s1, 2) && 
        $past(stb_spec_0_s1) && (!(stb_spec_0_s1 || stb_spec_1_s1))) |-> $past(!(lsq_enq_1_s1_hpn)));
WHB_CONCUR_LEAVING_stb_spec_0_s1_hb_lsq_enq_1_s1: assert property (@(posedge clk_i) 
    ($past(stb_spec_0_s1, 2) && 
        $past(stb_spec_0_s1) && (!(stb_spec_0_s1 || stb_spec_1_s1))) |-> $past(!(lsq_enq_1_s1_hpn) && lsq_enq_1_s1));
`endif 

// if precondition in unreachable meaning s2 already left when s1 enters
`ifndef WHB
HB_stb_spec_0_s1_LEAVING_lsq_enq_1_s1: assert property (@(posedge clk_i) 
    ($past(!stb_spec_0_s1_hpn) && stb_spec_0_s1 && (lsq_enq_1_s1_hpn || lsq_enq_1_s1)) |=>
     lsq_enq_1_s1);
`else 
WHB_stb_spec_0_s1_LEAVING_lsq_enq_1_s1: assert property (@(posedge clk_i) 
    ($past(!stb_spec_0_s1_hpn) && stb_spec_0_s1 && lsq_enq_1_s1_hpn) |->
    lsq_enq_1_s1);
WHB_CONCUR_stb_spec_0_s1_LEAVING_lsq_enq_1_s1: assert property (@(posedge clk_i) 
    ($past(!stb_spec_0_s1_hpn) && stb_spec_0_s1 && lsq_enq_1_s1_hpn && lsq_enq_1_s1) |=>
    (!(lsq_enq_1_s1)));
`endif 

`ifndef WHB
HB_LEAVING_stb_spec_0_s1_LEAVING_lsq_enq_1_s1: assert property (@(posedge clk_i) 
    ($past(stb_spec_0_s1, 2) && $past(stb_spec_0_s1) && (!(stb_spec_0_s1 || stb_spec_1_s1))) |-> 
    ((lsq_enq_1_s1_hpn && lsq_enq_1_s1) || !lsq_enq_1_s1_hpn));
`else 
WHB_LEAVING_stb_spec_0_s1_LEAVING_lsq_enq_1_s1: assert property (@(posedge clk_i) 
    ($past(stb_spec_0_s1, 2) && $past(stb_spec_0_s1) && (!(stb_spec_0_s1 || stb_spec_1_s1))) |-> 
    $past((lsq_enq_1_s1_hpn && lsq_enq_1_s1) || !lsq_enq_1_s1_hpn));
WHB_CONCUR_LEAVING_stb_spec_0_s1_LEAVING_lsq_enq_1_s1: assert property (@(posedge clk_i) 
    ($past(stb_spec_0_s1, 2) && $past(stb_spec_0_s1) && (!(stb_spec_0_s1 || stb_spec_1_s1))) |-> 
    ($past(lsq_enq_1_s1, 2) && $past(lsq_enq_1_s1) && (!(lsq_enq_1_s1)))); 
`endif 
