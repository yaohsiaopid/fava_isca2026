...
HB_LEAVING_stb_com_0_s1_LEAVING_lsq_enq_1_s1: assert property (@(posedge clk_i) 
    ($past(stb_com_0_s1, 2) && $past(stb_com_0_s1) && (!stb_com_0_s1)) |-> 
