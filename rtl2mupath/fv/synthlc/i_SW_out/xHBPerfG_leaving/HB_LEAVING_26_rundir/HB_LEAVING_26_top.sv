...
`ifndef WHB
HB_scb_0_s13_LEAVING_lsq_enq_0_s1: assert property (@(posedge clk_i) 
    ($past(!scb_0_s13_hpn) && scb_0_s13 && (lsq_enq_0_s1_hpn || lsq_enq_0_s1)) |=>
     lsq_enq_0_s1);
`else 
WHB_scb_0_s13_LEAVING_lsq_enq_0_s1: assert property (@(posedge clk_i) 
    ($past(!scb_0_s13_hpn) && scb_0_s13 && lsq_enq_0_s1_hpn) |->
    lsq_enq_0_s1);
WHB_CONCUR_scb_0_s13_LEAVING_lsq_enq_0_s1: assert property (@(posedge clk_i) 
    ($past(!scb_0_s13_hpn) && scb_0_s13 && lsq_enq_0_s1_hpn && lsq_enq_0_s1) |=>
    (!(lsq_enq_0_s1)));
`endif 
