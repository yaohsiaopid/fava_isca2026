...
`ifndef WHB
HB_LEAVING_stb_com_0_s1_scb_0_s8: assert property (@(posedge clk_i) 
    ($past(stb_com_0_s1, 2) && 
        $past(stb_com_0_s1) && (!(stb_com_0_s1 || stb_com_1_s1))) |-> 
    $past(!(scb_0_s8_hpn || scb_0_s8)));
`else 
WHB_LEAVING_stb_com_0_s1_hb_scb_0_s8: assert property (@(posedge clk_i) 
    ($past(stb_com_0_s1, 2) && 
        $past(stb_com_0_s1) && (!(stb_com_0_s1 || stb_com_1_s1))) |-> $past(!(scb_0_s8_hpn)));
WHB_CONCUR_LEAVING_stb_com_0_s1_hb_scb_0_s8: assert property (@(posedge clk_i) 
    ($past(stb_com_0_s1, 2) && 
        $past(stb_com_0_s1) && (!(stb_com_0_s1 || stb_com_1_s1))) |-> $past(!(scb_0_s8_hpn) && scb_0_s8));
`endif 

// if precondition in unreachable meaning s2 already left when s1 enters
`ifndef WHB
HB_stb_com_0_s1_LEAVING_scb_0_s8: assert property (@(posedge clk_i) 
    ($past(!stb_com_0_s1_hpn) && stb_com_0_s1 && (scb_0_s8_hpn || scb_0_s8)) |=>
     scb_0_s8);
`else 
WHB_stb_com_0_s1_LEAVING_scb_0_s8: assert property (@(posedge clk_i) 
    ($past(!stb_com_0_s1_hpn) && stb_com_0_s1 && scb_0_s8_hpn) |->
    scb_0_s8);
WHB_CONCUR_stb_com_0_s1_LEAVING_scb_0_s8: assert property (@(posedge clk_i) 
    ($past(!stb_com_0_s1_hpn) && stb_com_0_s1 && scb_0_s8_hpn && scb_0_s8) |=>
    (!(scb_0_s8 || scb_1_s8 || scb_2_s8 || scb_3_s8)));
`endif 

`ifndef WHB
HB_LEAVING_stb_com_0_s1_LEAVING_scb_0_s8: assert property (@(posedge clk_i) 
    ($past(stb_com_0_s1, 2) && $past(stb_com_0_s1) && (!(stb_com_0_s1 || stb_com_1_s1))) |-> 
    ((scb_0_s8_hpn && scb_0_s8) || !scb_0_s8_hpn));
`else 
WHB_LEAVING_stb_com_0_s1_LEAVING_scb_0_s8: assert property (@(posedge clk_i) 
    ($past(stb_com_0_s1, 2) && $past(stb_com_0_s1) && (!(stb_com_0_s1 || stb_com_1_s1))) |-> 
    $past((scb_0_s8_hpn && scb_0_s8) || !scb_0_s8_hpn));
WHB_CONCUR_LEAVING_stb_com_0_s1_LEAVING_scb_0_s8: assert property (@(posedge clk_i) 
    ($past(stb_com_0_s1, 2) && $past(stb_com_0_s1) && (!(stb_com_0_s1 || stb_com_1_s1))) |-> 
