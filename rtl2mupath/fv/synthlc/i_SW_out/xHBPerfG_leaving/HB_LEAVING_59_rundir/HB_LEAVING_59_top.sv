...
`ifndef WHB
HB_LEAVING_store_unit_s3_scb_0_s8: assert property (@(posedge clk_i) 
    ($past(store_unit_s3, 2) && 
        $past(store_unit_s3) && (!(store_unit_s3))) |-> 
    $past(!(scb_0_s8_hpn || scb_0_s8)));
`else 
WHB_LEAVING_store_unit_s3_hb_scb_0_s8: assert property (@(posedge clk_i) 
    ($past(store_unit_s3, 2) && 
        $past(store_unit_s3) && (!(store_unit_s3))) |-> $past(!(scb_0_s8_hpn)));
WHB_CONCUR_LEAVING_store_unit_s3_hb_scb_0_s8: assert property (@(posedge clk_i) 
    ($past(store_unit_s3, 2) && 
        $past(store_unit_s3) && (!(store_unit_s3))) |-> $past(!(scb_0_s8_hpn) && scb_0_s8));
`endif 

// if precondition in unreachable meaning s2 already left when s1 enters
`ifndef WHB
HB_store_unit_s3_LEAVING_scb_0_s8: assert property (@(posedge clk_i) 
    ($past(!store_unit_s3_hpn) && store_unit_s3 && (scb_0_s8_hpn || scb_0_s8)) |=>
     scb_0_s8);
`else 
WHB_store_unit_s3_LEAVING_scb_0_s8: assert property (@(posedge clk_i) 
    ($past(!store_unit_s3_hpn) && store_unit_s3 && scb_0_s8_hpn) |->
    scb_0_s8);
WHB_CONCUR_store_unit_s3_LEAVING_scb_0_s8: assert property (@(posedge clk_i) 
    ($past(!store_unit_s3_hpn) && store_unit_s3 && scb_0_s8_hpn && scb_0_s8) |=>
    (!(scb_0_s8 || scb_1_s8 || scb_2_s8 || scb_3_s8)));
`endif 

`ifndef WHB
HB_LEAVING_store_unit_s3_LEAVING_scb_0_s8: assert property (@(posedge clk_i) 
    ($past(store_unit_s3, 2) && $past(store_unit_s3) && (!(store_unit_s3))) |-> 
    ((scb_0_s8_hpn && scb_0_s8) || !scb_0_s8_hpn));
`else 
WHB_LEAVING_store_unit_s3_LEAVING_scb_0_s8: assert property (@(posedge clk_i) 
    ($past(store_unit_s3, 2) && $past(store_unit_s3) && (!(store_unit_s3))) |-> 
    $past((scb_0_s8_hpn && scb_0_s8) || !scb_0_s8_hpn));
WHB_CONCUR_LEAVING_store_unit_s3_LEAVING_scb_0_s8: assert property (@(posedge clk_i) 
    ($past(store_unit_s3, 2) && $past(store_unit_s3) && (!(store_unit_s3))) |-> 
