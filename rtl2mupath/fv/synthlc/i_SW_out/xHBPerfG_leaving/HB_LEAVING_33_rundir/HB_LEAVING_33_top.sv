...
`ifndef WHB
HB_LEAVING_scb_0_s8_lsq_enq_0_s1: assert property (@(posedge clk_i) 
    ($past(scb_0_s8, 2) && 
        $past(scb_0_s8) && (!(scb_0_s8 || scb_1_s8 || scb_2_s8 || scb_3_s8))) |-> 
    $past(!(lsq_enq_0_s1_hpn || lsq_enq_0_s1)));
`else 
WHB_LEAVING_scb_0_s8_hb_lsq_enq_0_s1: assert property (@(posedge clk_i) 
    ($past(scb_0_s8, 2) && 
        $past(scb_0_s8) && (!(scb_0_s8 || scb_1_s8 || scb_2_s8 || scb_3_s8))) |-> $past(!(lsq_enq_0_s1_hpn)));
WHB_CONCUR_LEAVING_scb_0_s8_hb_lsq_enq_0_s1: assert property (@(posedge clk_i) 
    ($past(scb_0_s8, 2) && 
        $past(scb_0_s8) && (!(scb_0_s8 || scb_1_s8 || scb_2_s8 || scb_3_s8))) |-> $past(!(lsq_enq_0_s1_hpn) && lsq_enq_0_s1));
`endif 

`ifndef WHB
HB_LEAVING_scb_0_s8_LEAVING_lsq_enq_0_s1: assert property (@(posedge clk_i) 
    ($past(scb_0_s8, 2) && $past(scb_0_s8) && (!(scb_0_s8 || scb_1_s8 || scb_2_s8 || scb_3_s8))) |-> 
    ((lsq_enq_0_s1_hpn && lsq_enq_0_s1) || !lsq_enq_0_s1_hpn));
`else 
WHB_LEAVING_scb_0_s8_LEAVING_lsq_enq_0_s1: assert property (@(posedge clk_i) 
    ($past(scb_0_s8, 2) && $past(scb_0_s8) && (!(scb_0_s8 || scb_1_s8 || scb_2_s8 || scb_3_s8))) |-> 
    $past((lsq_enq_0_s1_hpn && lsq_enq_0_s1) || !lsq_enq_0_s1_hpn));
WHB_CONCUR_LEAVING_scb_0_s8_LEAVING_lsq_enq_0_s1: assert property (@(posedge clk_i) 
    ($past(scb_0_s8, 2) && $past(scb_0_s8) && (!(scb_0_s8 || scb_1_s8 || scb_2_s8 || scb_3_s8))) |-> 
