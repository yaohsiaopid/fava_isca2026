...
`ifndef WHB
HB_scb_0_s13_LEAVING_id_stage_s1: assert property (@(posedge clk_i) 
    ($past(!scb_0_s13_hpn) && scb_0_s13 && (id_stage_s1_hpn || id_stage_s1)) |=>
     id_stage_s1);
`else 
WHB_scb_0_s13_LEAVING_id_stage_s1: assert property (@(posedge clk_i) 
    ($past(!scb_0_s13_hpn) && scb_0_s13 && id_stage_s1_hpn) |->
    id_stage_s1);
WHB_CONCUR_scb_0_s13_LEAVING_id_stage_s1: assert property (@(posedge clk_i) 
    ($past(!scb_0_s13_hpn) && scb_0_s13 && id_stage_s1_hpn && id_stage_s1) |=>
    (!(id_stage_s1)));
`endif 
