...
`ifndef WHB
HB_991: assert property (@(posedge clk_i) (stb_spec_0_s1 && !stb_spec_0_s1_hpn) |-> !(stb_com_0_s1_hpn || stb_com_0_s1));
`else 
//C_991: cover property (@(posedge clk_i) (stb_spec_0_s1 && !stb_spec_0_s1_hpn) && (stb_com_0_s1 && !stb_com_0_s1_hpn));
WHB_991: assert property (@(posedge clk_i) (stb_spec_0_s1 && !stb_spec_0_s1_hpn) |-> !stb_com_0_s1_hpn);
WHB_CONCUR_991: assert property (@(posedge clk_i) (stb_spec_0_s1 && !stb_spec_0_s1_hpn) |-> (stb_com_0_s1 && !stb_com_0_s1_hpn));
`endif 
