...
`ifndef WHB
HB_1048: assert property (@(posedge clk_i) (store_unit_s1 && !store_unit_s1_hpn) |-> !(scb_0_s12_hpn || scb_0_s12));
`else 
//C_1048: cover property (@(posedge clk_i) (store_unit_s1 && !store_unit_s1_hpn) && (scb_0_s12 && !scb_0_s12_hpn));
WHB_1048: assert property (@(posedge clk_i) (store_unit_s1 && !store_unit_s1_hpn) |-> !scb_0_s12_hpn);
WHB_CONCUR_1048: assert property (@(posedge clk_i) (store_unit_s1 && !store_unit_s1_hpn) |-> (scb_0_s12 && !scb_0_s12_hpn));
`endif 
