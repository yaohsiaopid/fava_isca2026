...
`ifndef WHB
HB_200: assert property (@(posedge clk_i) (issue_s16 && !issue_s16_hpn) |-> !(lsq_enq_0_s1_hpn || lsq_enq_0_s1));
`else 
//C_200: cover property (@(posedge clk_i) (issue_s16 && !issue_s16_hpn) && (lsq_enq_0_s1 && !lsq_enq_0_s1_hpn));
WHB_200: assert property (@(posedge clk_i) (issue_s16 && !issue_s16_hpn) |-> !lsq_enq_0_s1_hpn);
WHB_CONCUR_200: assert property (@(posedge clk_i) (issue_s16 && !issue_s16_hpn) |-> (lsq_enq_0_s1 && !lsq_enq_0_s1_hpn));
`endif 
