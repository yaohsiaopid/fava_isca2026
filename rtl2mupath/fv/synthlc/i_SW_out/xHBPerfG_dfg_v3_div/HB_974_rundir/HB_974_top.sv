...
`ifndef WHB
HB_974: assert property (@(posedge clk_i) (stb_spec_0_s1 && !stb_spec_0_s1_hpn) |-> !(lsq_enq_1_s1_hpn || lsq_enq_1_s1));
`else 
//C_974: cover property (@(posedge clk_i) (stb_spec_0_s1 && !stb_spec_0_s1_hpn) && (lsq_enq_1_s1 && !lsq_enq_1_s1_hpn));
WHB_974: assert property (@(posedge clk_i) (stb_spec_0_s1 && !stb_spec_0_s1_hpn) |-> !lsq_enq_1_s1_hpn);
WHB_CONCUR_974: assert property (@(posedge clk_i) (stb_spec_0_s1 && !stb_spec_0_s1_hpn) |-> (lsq_enq_1_s1 && !lsq_enq_1_s1_hpn));
`endif 
