...
`ifndef WHB
HB_1066: assert property (@(posedge clk_i) (store_unit_s1 && !store_unit_s1_hpn) |-> !(stb_spec_0_s1_hpn || stb_spec_0_s1));
`else 
//C_1066: cover property (@(posedge clk_i) (store_unit_s1 && !store_unit_s1_hpn) && (stb_spec_0_s1 && !stb_spec_0_s1_hpn));
WHB_1066: assert property (@(posedge clk_i) (store_unit_s1 && !store_unit_s1_hpn) |-> !stb_spec_0_s1_hpn);
WHB_CONCUR_1066: assert property (@(posedge clk_i) (store_unit_s1 && !store_unit_s1_hpn) |-> (stb_spec_0_s1 && !stb_spec_0_s1_hpn));
`endif 
