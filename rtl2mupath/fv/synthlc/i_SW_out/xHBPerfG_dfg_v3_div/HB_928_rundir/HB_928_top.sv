...
`ifndef WHB
HB_928: assert property (@(posedge clk_i) (stb_com_0_s1 && !stb_com_0_s1_hpn) |-> !(lsq_enq_1_s1_hpn || lsq_enq_1_s1));
`else 
//C_928: cover property (@(posedge clk_i) (stb_com_0_s1 && !stb_com_0_s1_hpn) && (lsq_enq_1_s1 && !lsq_enq_1_s1_hpn));
WHB_928: assert property (@(posedge clk_i) (stb_com_0_s1 && !stb_com_0_s1_hpn) |-> !lsq_enq_1_s1_hpn);
WHB_CONCUR_928: assert property (@(posedge clk_i) (stb_com_0_s1 && !stb_com_0_s1_hpn) |-> (lsq_enq_1_s1 && !lsq_enq_1_s1_hpn));
`endif 
