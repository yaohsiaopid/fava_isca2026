...
`ifndef WHB
HB_1098: assert property (@(posedge clk_i) (store_unit_s3 && !store_unit_s3_hpn) |-> !(stb_spec_0_s1_hpn || stb_spec_0_s1));
`else 
//C_1098: cover property (@(posedge clk_i) (store_unit_s3 && !store_unit_s3_hpn) && (stb_spec_0_s1 && !stb_spec_0_s1_hpn));
WHB_1098: assert property (@(posedge clk_i) (store_unit_s3 && !store_unit_s3_hpn) |-> !stb_spec_0_s1_hpn);
WHB_CONCUR_1098: assert property (@(posedge clk_i) (store_unit_s3 && !store_unit_s3_hpn) |-> (stb_spec_0_s1 && !stb_spec_0_s1_hpn));
`endif 
