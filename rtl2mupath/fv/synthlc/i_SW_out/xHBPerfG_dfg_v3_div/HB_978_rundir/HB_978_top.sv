...
`ifndef WHB
HB_978: assert property (@(posedge clk_i) (stb_spec_0_s1 && !stb_spec_0_s1_hpn) |-> !(scb_0_s8_hpn || scb_0_s8));
`else 
//C_978: cover property (@(posedge clk_i) (stb_spec_0_s1 && !stb_spec_0_s1_hpn) && (scb_0_s8 && !scb_0_s8_hpn));
WHB_978: assert property (@(posedge clk_i) (stb_spec_0_s1 && !stb_spec_0_s1_hpn) |-> !scb_0_s8_hpn);
WHB_CONCUR_978: assert property (@(posedge clk_i) (stb_spec_0_s1 && !stb_spec_0_s1_hpn) |-> (scb_0_s8 && !scb_0_s8_hpn));
`endif 
