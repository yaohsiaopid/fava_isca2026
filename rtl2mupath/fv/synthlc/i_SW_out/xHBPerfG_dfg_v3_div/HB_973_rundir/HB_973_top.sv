...
`ifndef WHB
HB_973: assert property (@(posedge clk_i) (stb_spec_0_s1 && !stb_spec_0_s1_hpn) |-> !(lsq_enq_0_s1_hpn || lsq_enq_0_s1));
`else 
//C_973: cover property (@(posedge clk_i) (stb_spec_0_s1 && !stb_spec_0_s1_hpn) && (lsq_enq_0_s1 && !lsq_enq_0_s1_hpn));
WHB_973: assert property (@(posedge clk_i) (stb_spec_0_s1 && !stb_spec_0_s1_hpn) |-> !lsq_enq_0_s1_hpn);
WHB_CONCUR_973: assert property (@(posedge clk_i) (stb_spec_0_s1 && !stb_spec_0_s1_hpn) |-> (lsq_enq_0_s1 && !lsq_enq_0_s1_hpn));
`endif 
