...
`ifndef WHB
HB_268: assert property (@(posedge clk_i) (lsq_enq_0_s1 && !lsq_enq_0_s1_hpn) |-> !(scb_0_s12_hpn || scb_0_s12));
`else 
//C_268: cover property (@(posedge clk_i) (lsq_enq_0_s1 && !lsq_enq_0_s1_hpn) && (scb_0_s12 && !scb_0_s12_hpn));
WHB_268: assert property (@(posedge clk_i) (lsq_enq_0_s1 && !lsq_enq_0_s1_hpn) |-> !scb_0_s12_hpn);
WHB_CONCUR_268: assert property (@(posedge clk_i) (lsq_enq_0_s1 && !lsq_enq_0_s1_hpn) |-> (scb_0_s12 && !scb_0_s12_hpn));
`endif 
