...
`ifndef WHB
HB_1076: assert property (@(posedge clk_i) (store_unit_s3 && !store_unit_s3_hpn) |-> !(issue_s16_hpn || issue_s16));
`else 
//C_1076: cover property (@(posedge clk_i) (store_unit_s3 && !store_unit_s3_hpn) && (issue_s16 && !issue_s16_hpn));
WHB_1076: assert property (@(posedge clk_i) (store_unit_s3 && !store_unit_s3_hpn) |-> !issue_s16_hpn);
WHB_CONCUR_1076: assert property (@(posedge clk_i) (store_unit_s3 && !store_unit_s3_hpn) |-> (issue_s16 && !issue_s16_hpn));
`endif 
