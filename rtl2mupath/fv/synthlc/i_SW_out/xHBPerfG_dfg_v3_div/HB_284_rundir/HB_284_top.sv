...
`ifndef WHB
HB_284: assert property (@(posedge clk_i) (lsq_enq_0_s1 && !lsq_enq_0_s1_hpn) |-> !(stb_com_0_s1_hpn || stb_com_0_s1));
`else 
//C_284: cover property (@(posedge clk_i) (lsq_enq_0_s1 && !lsq_enq_0_s1_hpn) && (stb_com_0_s1 && !stb_com_0_s1_hpn));
WHB_284: assert property (@(posedge clk_i) (lsq_enq_0_s1 && !lsq_enq_0_s1_hpn) |-> !stb_com_0_s1_hpn);
WHB_CONCUR_284: assert property (@(posedge clk_i) (lsq_enq_0_s1 && !lsq_enq_0_s1_hpn) |-> (stb_com_0_s1 && !stb_com_0_s1_hpn));
`endif 
