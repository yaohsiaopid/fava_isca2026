...
`ifndef WHB
HB_313: assert property (@(posedge clk_i) (lsq_enq_1_s1 && !lsq_enq_1_s1_hpn) |-> !(store_unit_s1_hpn || store_unit_s1));
`else 
//C_313: cover property (@(posedge clk_i) (lsq_enq_1_s1 && !lsq_enq_1_s1_hpn) && (store_unit_s1 && !store_unit_s1_hpn));
WHB_313: assert property (@(posedge clk_i) (lsq_enq_1_s1 && !lsq_enq_1_s1_hpn) |-> !store_unit_s1_hpn);
WHB_CONCUR_313: assert property (@(posedge clk_i) (lsq_enq_1_s1 && !lsq_enq_1_s1_hpn) |-> (store_unit_s1 && !store_unit_s1_hpn));
`endif 
