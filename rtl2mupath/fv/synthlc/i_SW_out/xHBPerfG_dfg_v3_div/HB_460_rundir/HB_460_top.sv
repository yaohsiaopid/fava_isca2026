...
`ifndef WHB
HB_460: assert property (@(posedge clk_i) (scb_0_s8 && !scb_0_s8_hpn) |-> !(stb_spec_0_s1_hpn || stb_spec_0_s1));
`else 
//C_460: cover property (@(posedge clk_i) (scb_0_s8 && !scb_0_s8_hpn) && (stb_spec_0_s1 && !stb_spec_0_s1_hpn));
WHB_460: assert property (@(posedge clk_i) (scb_0_s8 && !scb_0_s8_hpn) |-> !stb_spec_0_s1_hpn);
WHB_CONCUR_460: assert property (@(posedge clk_i) (scb_0_s8 && !scb_0_s8_hpn) |-> (stb_spec_0_s1 && !stb_spec_0_s1_hpn));
`endif 
