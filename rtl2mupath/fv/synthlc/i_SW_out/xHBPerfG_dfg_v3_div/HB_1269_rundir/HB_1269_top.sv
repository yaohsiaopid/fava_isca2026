...
`ifndef WHB
HB_1269: assert property (@(posedge clk_i) (store_unit_s1 && !store_unit_s1_hpn) |-> !(store_unit_s3_hpn || store_unit_s3));
`else 
//C_1269: cover property (@(posedge clk_i) (store_unit_s1 && !store_unit_s1_hpn) && (store_unit_s3 && !store_unit_s3_hpn));
WHB_1269: assert property (@(posedge clk_i) (store_unit_s1 && !store_unit_s1_hpn) |-> !store_unit_s3_hpn);
WHB_CONCUR_1269: assert property (@(posedge clk_i) (store_unit_s1 && !store_unit_s1_hpn) |-> (store_unit_s3 && !store_unit_s3_hpn));
`endif 
