...
`ifndef WHB
HB_59: assert property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) |-> !(issue_s16_hpn || issue_s16));
`else 
//C_59: cover property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) && (issue_s16 && !issue_s16_hpn));
WHB_59: assert property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) |-> !issue_s16_hpn);
WHB_CONCUR_59: assert property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) |-> (issue_s16 && !issue_s16_hpn));
`endif 
