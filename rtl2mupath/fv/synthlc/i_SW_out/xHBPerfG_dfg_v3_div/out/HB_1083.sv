...
`ifndef WHB
HB_1083: assert property (@(posedge clk_i) (store_unit_s3 && !store_unit_s3_hpn) |-> !(scb_0_s8_hpn || scb_0_s8));
`else 
//C_1083: cover property (@(posedge clk_i) (store_unit_s3 && !store_unit_s3_hpn) && (scb_0_s8 && !scb_0_s8_hpn));
WHB_1083: assert property (@(posedge clk_i) (store_unit_s3 && !store_unit_s3_hpn) |-> !scb_0_s8_hpn);
WHB_CONCUR_1083: assert property (@(posedge clk_i) (store_unit_s3 && !store_unit_s3_hpn) |-> (scb_0_s8 && !scb_0_s8_hpn));
`endif 
