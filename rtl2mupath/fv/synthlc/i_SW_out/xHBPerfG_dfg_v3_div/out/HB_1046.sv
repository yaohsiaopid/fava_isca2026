...
`ifndef WHB
HB_1046: assert property (@(posedge clk_i) (store_unit_s1 && !store_unit_s1_hpn) |-> !(lsq_enq_0_s1_hpn || lsq_enq_0_s1));
`else 
//C_1046: cover property (@(posedge clk_i) (store_unit_s1 && !store_unit_s1_hpn) && (lsq_enq_0_s1 && !lsq_enq_0_s1_hpn));
WHB_1046: assert property (@(posedge clk_i) (store_unit_s1 && !store_unit_s1_hpn) |-> !lsq_enq_0_s1_hpn);
WHB_CONCUR_1046: assert property (@(posedge clk_i) (store_unit_s1 && !store_unit_s1_hpn) |-> (lsq_enq_0_s1 && !lsq_enq_0_s1_hpn));
`endif 
