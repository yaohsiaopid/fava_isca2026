...
`ifndef WHB
HB_356: assert property (@(posedge clk_i) (scb_0_s12 && !scb_0_s12_hpn) |-> !(mem_req_s1_hpn || mem_req_s1));
`else 
//C_356: cover property (@(posedge clk_i) (scb_0_s12 && !scb_0_s12_hpn) && (mem_req_s1 && !mem_req_s1_hpn));
WHB_356: assert property (@(posedge clk_i) (scb_0_s12 && !scb_0_s12_hpn) |-> !mem_req_s1_hpn);
WHB_CONCUR_356: assert property (@(posedge clk_i) (scb_0_s12 && !scb_0_s12_hpn) |-> (mem_req_s1 && !mem_req_s1_hpn));
`endif 
