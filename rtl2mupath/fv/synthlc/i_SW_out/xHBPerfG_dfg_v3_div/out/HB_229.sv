...
`ifndef WHB
HB_229: assert property (@(posedge clk_i) (issue_s16 && !issue_s16_hpn) |-> !(mem_req_s1_hpn || mem_req_s1));
`else 
//C_229: cover property (@(posedge clk_i) (issue_s16 && !issue_s16_hpn) && (mem_req_s1 && !mem_req_s1_hpn));
WHB_229: assert property (@(posedge clk_i) (issue_s16 && !issue_s16_hpn) |-> !mem_req_s1_hpn);
WHB_CONCUR_229: assert property (@(posedge clk_i) (issue_s16 && !issue_s16_hpn) |-> (mem_req_s1 && !mem_req_s1_hpn));
`endif 
