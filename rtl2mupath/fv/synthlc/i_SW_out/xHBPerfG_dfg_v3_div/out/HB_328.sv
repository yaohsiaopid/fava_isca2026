...
`ifndef WHB
HB_328: assert property (@(posedge clk_i) (scb_0_s12 && !scb_0_s12_hpn) |-> !(lsq_enq_1_s1_hpn || lsq_enq_1_s1));
`else 
//C_328: cover property (@(posedge clk_i) (scb_0_s12 && !scb_0_s12_hpn) && (lsq_enq_1_s1 && !lsq_enq_1_s1_hpn));
WHB_328: assert property (@(posedge clk_i) (scb_0_s12 && !scb_0_s12_hpn) |-> !lsq_enq_1_s1_hpn);
WHB_CONCUR_328: assert property (@(posedge clk_i) (scb_0_s12 && !scb_0_s12_hpn) |-> (lsq_enq_1_s1 && !lsq_enq_1_s1_hpn));
`endif 
