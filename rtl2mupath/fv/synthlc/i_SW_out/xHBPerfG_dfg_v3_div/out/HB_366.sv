...
`ifndef WHB
HB_366: assert property (@(posedge clk_i) (scb_0_s13 && !scb_0_s13_hpn) |-> !(lsq_enq_1_s1_hpn || lsq_enq_1_s1));
`else 
//C_366: cover property (@(posedge clk_i) (scb_0_s13 && !scb_0_s13_hpn) && (lsq_enq_1_s1 && !lsq_enq_1_s1_hpn));
WHB_366: assert property (@(posedge clk_i) (scb_0_s13 && !scb_0_s13_hpn) |-> !lsq_enq_1_s1_hpn);
WHB_CONCUR_366: assert property (@(posedge clk_i) (scb_0_s13 && !scb_0_s13_hpn) |-> (lsq_enq_1_s1 && !lsq_enq_1_s1_hpn));
`endif 
