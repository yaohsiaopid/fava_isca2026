...
`ifndef WHB
HB_314: assert property (@(posedge clk_i) (lsq_enq_1_s1 && !lsq_enq_1_s1_hpn) |-> !(store_unit_s3_hpn || store_unit_s3));
`else 
//C_314: cover property (@(posedge clk_i) (lsq_enq_1_s1 && !lsq_enq_1_s1_hpn) && (store_unit_s3 && !store_unit_s3_hpn));
WHB_314: assert property (@(posedge clk_i) (lsq_enq_1_s1 && !lsq_enq_1_s1_hpn) |-> !store_unit_s3_hpn);
WHB_CONCUR_314: assert property (@(posedge clk_i) (lsq_enq_1_s1 && !lsq_enq_1_s1_hpn) |-> (store_unit_s3 && !store_unit_s3_hpn));
`endif 
