...
`ifndef WHB
HB_1264: assert property (@(posedge clk_i) (store_unit_s1 && !store_unit_s1_hpn) |-> !(mem_req_s1_hpn || mem_req_s1));
`else 
//C_1264: cover property (@(posedge clk_i) (store_unit_s1 && !store_unit_s1_hpn) && (mem_req_s1 && !mem_req_s1_hpn));
WHB_1264: assert property (@(posedge clk_i) (store_unit_s1 && !store_unit_s1_hpn) |-> !mem_req_s1_hpn);
WHB_CONCUR_1264: assert property (@(posedge clk_i) (store_unit_s1 && !store_unit_s1_hpn) |-> (mem_req_s1 && !mem_req_s1_hpn));
`endif 
