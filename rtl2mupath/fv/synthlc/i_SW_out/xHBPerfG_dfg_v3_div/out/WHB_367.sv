...
`ifndef WHB
HB_367: assert property (@(posedge clk_i) (scb_0_s13 && !scb_0_s13_hpn) |-> !(scb_0_s12_hpn || scb_0_s12));
`else 
//C_367: cover property (@(posedge clk_i) (scb_0_s13 && !scb_0_s13_hpn) && (scb_0_s12 && !scb_0_s12_hpn));
WHB_367: assert property (@(posedge clk_i) (scb_0_s13 && !scb_0_s13_hpn) |-> !scb_0_s12_hpn);
WHB_CONCUR_367: assert property (@(posedge clk_i) (scb_0_s13 && !scb_0_s13_hpn) |-> (scb_0_s12 && !scb_0_s12_hpn));
`endif 
