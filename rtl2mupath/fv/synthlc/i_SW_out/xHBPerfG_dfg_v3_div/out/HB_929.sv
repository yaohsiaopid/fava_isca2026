...
`ifndef WHB
HB_929: assert property (@(posedge clk_i) (stb_com_0_s1 && !stb_com_0_s1_hpn) |-> !(scb_0_s12_hpn || scb_0_s12));
`else 
//C_929: cover property (@(posedge clk_i) (stb_com_0_s1 && !stb_com_0_s1_hpn) && (scb_0_s12 && !scb_0_s12_hpn));
WHB_929: assert property (@(posedge clk_i) (stb_com_0_s1 && !stb_com_0_s1_hpn) |-> !scb_0_s12_hpn);
WHB_CONCUR_929: assert property (@(posedge clk_i) (stb_com_0_s1 && !stb_com_0_s1_hpn) |-> (scb_0_s12 && !scb_0_s12_hpn));
`endif 
