...
`ifndef WHB
HB_297: assert property (@(posedge clk_i) (lsq_enq_1_s1 && !lsq_enq_1_s1_hpn) |-> !(scb_0_s8_hpn || scb_0_s8));
`else 
//C_297: cover property (@(posedge clk_i) (lsq_enq_1_s1 && !lsq_enq_1_s1_hpn) && (scb_0_s8 && !scb_0_s8_hpn));
WHB_297: assert property (@(posedge clk_i) (lsq_enq_1_s1 && !lsq_enq_1_s1_hpn) |-> !scb_0_s8_hpn);
WHB_CONCUR_297: assert property (@(posedge clk_i) (lsq_enq_1_s1 && !lsq_enq_1_s1_hpn) |-> (scb_0_s8 && !scb_0_s8_hpn));
`endif 
