...
`ifndef WHB
HB_1064: assert property (@(posedge clk_i) (store_unit_s1 && !store_unit_s1_hpn) |-> !(stb_com_0_s1_hpn || stb_com_0_s1));
`else 
//C_1064: cover property (@(posedge clk_i) (store_unit_s1 && !store_unit_s1_hpn) && (stb_com_0_s1 && !stb_com_0_s1_hpn));
WHB_1064: assert property (@(posedge clk_i) (store_unit_s1 && !store_unit_s1_hpn) |-> !stb_com_0_s1_hpn);
WHB_CONCUR_1064: assert property (@(posedge clk_i) (store_unit_s1 && !store_unit_s1_hpn) |-> (stb_com_0_s1 && !stb_com_0_s1_hpn));
`endif 
