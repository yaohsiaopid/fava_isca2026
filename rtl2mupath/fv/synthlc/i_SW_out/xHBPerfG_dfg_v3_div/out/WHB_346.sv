...
`ifndef WHB
HB_346: assert property (@(posedge clk_i) (scb_0_s12 && !scb_0_s12_hpn) |-> !(stb_spec_0_s1_hpn || stb_spec_0_s1));
`else 
//C_346: cover property (@(posedge clk_i) (scb_0_s12 && !scb_0_s12_hpn) && (stb_spec_0_s1 && !stb_spec_0_s1_hpn));
WHB_346: assert property (@(posedge clk_i) (scb_0_s12 && !scb_0_s12_hpn) |-> !stb_spec_0_s1_hpn);
WHB_CONCUR_346: assert property (@(posedge clk_i) (scb_0_s12 && !scb_0_s12_hpn) |-> (stb_spec_0_s1 && !stb_spec_0_s1_hpn));
`endif 
