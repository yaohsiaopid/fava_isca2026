...
`ifndef WHB
HB_365: assert property (@(posedge clk_i) (scb_0_s13 && !scb_0_s13_hpn) |-> !(lsq_enq_0_s1_hpn || lsq_enq_0_s1));
`else 
//C_365: cover property (@(posedge clk_i) (scb_0_s13 && !scb_0_s13_hpn) && (lsq_enq_0_s1 && !lsq_enq_0_s1_hpn));
WHB_365: assert property (@(posedge clk_i) (scb_0_s13 && !scb_0_s13_hpn) |-> !lsq_enq_0_s1_hpn);
WHB_CONCUR_365: assert property (@(posedge clk_i) (scb_0_s13 && !scb_0_s13_hpn) |-> (lsq_enq_0_s1 && !lsq_enq_0_s1_hpn));
`endif 
