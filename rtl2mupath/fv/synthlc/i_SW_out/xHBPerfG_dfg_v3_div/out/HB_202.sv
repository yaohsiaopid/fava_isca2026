...
`ifndef WHB
HB_202: assert property (@(posedge clk_i) (issue_s16 && !issue_s16_hpn) |-> !(scb_0_s12_hpn || scb_0_s12));
`else 
//C_202: cover property (@(posedge clk_i) (issue_s16 && !issue_s16_hpn) && (scb_0_s12 && !scb_0_s12_hpn));
WHB_202: assert property (@(posedge clk_i) (issue_s16 && !issue_s16_hpn) |-> !scb_0_s12_hpn);
WHB_CONCUR_202: assert property (@(posedge clk_i) (issue_s16 && !issue_s16_hpn) |-> (scb_0_s12 && !scb_0_s12_hpn));
`endif 
