...
`ifndef WHB
HB_463: assert property (@(posedge clk_i) (scb_0_s8 && !scb_0_s8_hpn) |-> !(store_unit_s1_hpn || store_unit_s1));
`else 
//C_463: cover property (@(posedge clk_i) (scb_0_s8 && !scb_0_s8_hpn) && (store_unit_s1 && !store_unit_s1_hpn));
WHB_463: assert property (@(posedge clk_i) (scb_0_s8 && !scb_0_s8_hpn) |-> !store_unit_s1_hpn);
WHB_CONCUR_463: assert property (@(posedge clk_i) (scb_0_s8 && !scb_0_s8_hpn) |-> (store_unit_s1 && !store_unit_s1_hpn));
`endif 
