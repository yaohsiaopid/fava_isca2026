...
`ifndef WHB
HB_288: assert property (@(posedge clk_i) (lsq_enq_0_s1 && !lsq_enq_0_s1_hpn) |-> !(store_unit_s3_hpn || store_unit_s3));
`else 
//C_288: cover property (@(posedge clk_i) (lsq_enq_0_s1 && !lsq_enq_0_s1_hpn) && (store_unit_s3 && !store_unit_s3_hpn));
WHB_288: assert property (@(posedge clk_i) (lsq_enq_0_s1 && !lsq_enq_0_s1_hpn) |-> !store_unit_s3_hpn);
WHB_CONCUR_288: assert property (@(posedge clk_i) (lsq_enq_0_s1 && !lsq_enq_0_s1_hpn) |-> (store_unit_s3 && !store_unit_s3_hpn));
`endif 
