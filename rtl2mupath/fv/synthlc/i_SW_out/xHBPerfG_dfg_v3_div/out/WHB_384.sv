...
`ifndef WHB
HB_384: assert property (@(posedge clk_i) (scb_0_s13 && !scb_0_s13_hpn) |-> !(stb_spec_0_s1_hpn || stb_spec_0_s1));
`else 
//C_384: cover property (@(posedge clk_i) (scb_0_s13 && !scb_0_s13_hpn) && (stb_spec_0_s1 && !stb_spec_0_s1_hpn));
WHB_384: assert property (@(posedge clk_i) (scb_0_s13 && !scb_0_s13_hpn) |-> !stb_spec_0_s1_hpn);
WHB_CONCUR_384: assert property (@(posedge clk_i) (scb_0_s13 && !scb_0_s13_hpn) |-> (stb_spec_0_s1 && !stb_spec_0_s1_hpn));
`endif 
