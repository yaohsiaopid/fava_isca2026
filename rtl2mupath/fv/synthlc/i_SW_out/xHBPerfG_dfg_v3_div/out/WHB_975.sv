...
`ifndef WHB
HB_975: assert property (@(posedge clk_i) (stb_spec_0_s1 && !stb_spec_0_s1_hpn) |-> !(scb_0_s12_hpn || scb_0_s12));
`else 
//C_975: cover property (@(posedge clk_i) (stb_spec_0_s1 && !stb_spec_0_s1_hpn) && (scb_0_s12 && !scb_0_s12_hpn));
WHB_975: assert property (@(posedge clk_i) (stb_spec_0_s1 && !stb_spec_0_s1_hpn) |-> !scb_0_s12_hpn);
WHB_CONCUR_975: assert property (@(posedge clk_i) (stb_spec_0_s1 && !stb_spec_0_s1_hpn) |-> (scb_0_s12 && !scb_0_s12_hpn));
`endif 
