...
`ifndef WHB
HB_927: assert property (@(posedge clk_i) (stb_com_0_s1 && !stb_com_0_s1_hpn) |-> !(lsq_enq_0_s1_hpn || lsq_enq_0_s1));
`else 
//C_927: cover property (@(posedge clk_i) (stb_com_0_s1 && !stb_com_0_s1_hpn) && (lsq_enq_0_s1 && !lsq_enq_0_s1_hpn));
WHB_927: assert property (@(posedge clk_i) (stb_com_0_s1 && !stb_com_0_s1_hpn) |-> !lsq_enq_0_s1_hpn);
WHB_CONCUR_927: assert property (@(posedge clk_i) (stb_com_0_s1 && !stb_com_0_s1_hpn) |-> (lsq_enq_0_s1 && !lsq_enq_0_s1_hpn));
`endif 
