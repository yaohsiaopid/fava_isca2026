...
`ifndef WHB
HB_1265: assert property (@(posedge clk_i) (store_unit_s3 && !store_unit_s3_hpn) |-> !(mem_req_s1_hpn || mem_req_s1));
`else 
//C_1265: cover property (@(posedge clk_i) (store_unit_s3 && !store_unit_s3_hpn) && (mem_req_s1 && !mem_req_s1_hpn));
WHB_1265: assert property (@(posedge clk_i) (store_unit_s3 && !store_unit_s3_hpn) |-> !mem_req_s1_hpn);
WHB_CONCUR_1265: assert property (@(posedge clk_i) (store_unit_s3 && !store_unit_s3_hpn) |-> (mem_req_s1 && !mem_req_s1_hpn));
`endif 
