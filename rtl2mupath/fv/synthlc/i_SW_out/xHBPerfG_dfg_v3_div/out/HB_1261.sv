...
`ifndef WHB
HB_1261: assert property (@(posedge clk_i) (stb_com_0_s1 && !stb_com_0_s1_hpn) |-> !(mem_req_s1_hpn || mem_req_s1));
`else 
//C_1261: cover property (@(posedge clk_i) (stb_com_0_s1 && !stb_com_0_s1_hpn) && (mem_req_s1 && !mem_req_s1_hpn));
WHB_1261: assert property (@(posedge clk_i) (stb_com_0_s1 && !stb_com_0_s1_hpn) |-> !mem_req_s1_hpn);
WHB_CONCUR_1261: assert property (@(posedge clk_i) (stb_com_0_s1 && !stb_com_0_s1_hpn) |-> (mem_req_s1 && !mem_req_s1_hpn));
`endif 
