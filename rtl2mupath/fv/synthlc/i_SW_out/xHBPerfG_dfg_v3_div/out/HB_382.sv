...
`ifndef WHB
HB_382: assert property (@(posedge clk_i) (scb_0_s13 && !scb_0_s13_hpn) |-> !(stb_com_0_s1_hpn || stb_com_0_s1));
`else 
//C_382: cover property (@(posedge clk_i) (scb_0_s13 && !scb_0_s13_hpn) && (stb_com_0_s1 && !stb_com_0_s1_hpn));
WHB_382: assert property (@(posedge clk_i) (scb_0_s13 && !scb_0_s13_hpn) |-> !stb_com_0_s1_hpn);
WHB_CONCUR_382: assert property (@(posedge clk_i) (scb_0_s13 && !scb_0_s13_hpn) |-> (stb_com_0_s1 && !stb_com_0_s1_hpn));
`endif 
