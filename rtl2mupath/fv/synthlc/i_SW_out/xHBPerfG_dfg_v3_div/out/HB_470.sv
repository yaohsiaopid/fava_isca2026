...
`ifndef WHB
HB_470: assert property (@(posedge clk_i) (scb_0_s8 && !scb_0_s8_hpn) |-> !(mem_req_s1_hpn || mem_req_s1));
`else 
//C_470: cover property (@(posedge clk_i) (scb_0_s8 && !scb_0_s8_hpn) && (mem_req_s1 && !mem_req_s1_hpn));
WHB_470: assert property (@(posedge clk_i) (scb_0_s8 && !scb_0_s8_hpn) |-> !mem_req_s1_hpn);
WHB_CONCUR_470: assert property (@(posedge clk_i) (scb_0_s8 && !scb_0_s8_hpn) |-> (mem_req_s1 && !mem_req_s1_hpn));
`endif 
