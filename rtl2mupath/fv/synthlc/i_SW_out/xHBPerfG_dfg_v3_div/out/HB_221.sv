...
`ifndef WHB
HB_221: assert property (@(posedge clk_i) (issue_s16 && !issue_s16_hpn) |-> !(store_unit_s1_hpn || store_unit_s1));
`else 
//C_221: cover property (@(posedge clk_i) (issue_s16 && !issue_s16_hpn) && (store_unit_s1 && !store_unit_s1_hpn));
WHB_221: assert property (@(posedge clk_i) (issue_s16 && !issue_s16_hpn) |-> !store_unit_s1_hpn);
WHB_CONCUR_221: assert property (@(posedge clk_i) (issue_s16 && !issue_s16_hpn) |-> (store_unit_s1 && !store_unit_s1_hpn));
`endif 
