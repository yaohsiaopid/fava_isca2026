...
`ifndef WHB
HB_439: assert property (@(posedge clk_i) (scb_0_s8 && !scb_0_s8_hpn) |-> !(issue_s16_hpn || issue_s16));
`else 
//C_439: cover property (@(posedge clk_i) (scb_0_s8 && !scb_0_s8_hpn) && (issue_s16 && !issue_s16_hpn));
WHB_439: assert property (@(posedge clk_i) (scb_0_s8 && !scb_0_s8_hpn) |-> !issue_s16_hpn);
WHB_CONCUR_439: assert property (@(posedge clk_i) (scb_0_s8 && !scb_0_s8_hpn) |-> (issue_s16 && !issue_s16_hpn));
`endif 
