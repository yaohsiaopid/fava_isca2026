...
`ifndef WHB
HB_222: assert property (@(posedge clk_i) (issue_s16 && !issue_s16_hpn) |-> !(store_unit_s3_hpn || store_unit_s3));
`else 
//C_222: cover property (@(posedge clk_i) (issue_s16 && !issue_s16_hpn) && (store_unit_s3 && !store_unit_s3_hpn));
WHB_222: assert property (@(posedge clk_i) (issue_s16 && !issue_s16_hpn) |-> !store_unit_s3_hpn);
WHB_CONCUR_222: assert property (@(posedge clk_i) (issue_s16 && !issue_s16_hpn) |-> (store_unit_s3 && !store_unit_s3_hpn));
`endif 
