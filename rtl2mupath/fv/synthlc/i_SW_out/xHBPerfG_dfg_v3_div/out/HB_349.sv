...
`ifndef WHB
HB_349: assert property (@(posedge clk_i) (scb_0_s12 && !scb_0_s12_hpn) |-> !(store_unit_s1_hpn || store_unit_s1));
`else 
//C_349: cover property (@(posedge clk_i) (scb_0_s12 && !scb_0_s12_hpn) && (store_unit_s1 && !store_unit_s1_hpn));
WHB_349: assert property (@(posedge clk_i) (scb_0_s12 && !scb_0_s12_hpn) |-> !store_unit_s1_hpn);
WHB_CONCUR_349: assert property (@(posedge clk_i) (scb_0_s12 && !scb_0_s12_hpn) |-> (store_unit_s1 && !store_unit_s1_hpn));
`endif 
