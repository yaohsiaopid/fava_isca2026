...
`ifndef WHB
HB_997: assert property (@(posedge clk_i) (stb_spec_0_s1 && !stb_spec_0_s1_hpn) |-> !(mem_req_s1_hpn || mem_req_s1));
`else 
//C_997: cover property (@(posedge clk_i) (stb_spec_0_s1 && !stb_spec_0_s1_hpn) && (mem_req_s1 && !mem_req_s1_hpn));
WHB_997: assert property (@(posedge clk_i) (stb_spec_0_s1 && !stb_spec_0_s1_hpn) |-> !mem_req_s1_hpn);
WHB_CONCUR_997: assert property (@(posedge clk_i) (stb_spec_0_s1 && !stb_spec_0_s1_hpn) |-> (mem_req_s1 && !mem_req_s1_hpn));
`endif 
