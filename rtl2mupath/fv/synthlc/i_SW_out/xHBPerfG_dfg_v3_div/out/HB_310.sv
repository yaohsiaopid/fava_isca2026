...
`ifndef WHB
HB_310: assert property (@(posedge clk_i) (lsq_enq_1_s1 && !lsq_enq_1_s1_hpn) |-> !(stb_com_0_s1_hpn || stb_com_0_s1));
`else 
//C_310: cover property (@(posedge clk_i) (lsq_enq_1_s1 && !lsq_enq_1_s1_hpn) && (stb_com_0_s1 && !stb_com_0_s1_hpn));
WHB_310: assert property (@(posedge clk_i) (lsq_enq_1_s1 && !lsq_enq_1_s1_hpn) |-> !stb_com_0_s1_hpn);
WHB_CONCUR_310: assert property (@(posedge clk_i) (lsq_enq_1_s1 && !lsq_enq_1_s1_hpn) |-> (stb_com_0_s1 && !stb_com_0_s1_hpn));
`endif 
