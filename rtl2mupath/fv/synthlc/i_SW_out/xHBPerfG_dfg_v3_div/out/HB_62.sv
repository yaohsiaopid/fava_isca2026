...
`ifndef WHB
HB_62: assert property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) |-> !(scb_0_s13_hpn || scb_0_s13));
`else 
//C_62: cover property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) && (scb_0_s13 && !scb_0_s13_hpn));
WHB_62: assert property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) |-> !scb_0_s13_hpn);
WHB_CONCUR_62: assert property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) |-> (scb_0_s13 && !scb_0_s13_hpn));
`endif 
