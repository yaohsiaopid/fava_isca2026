...
`ifndef WHB
HB_294: assert property (@(posedge clk_i) (lsq_enq_1_s1 && !lsq_enq_1_s1_hpn) |-> !(scb_0_s12_hpn || scb_0_s12));
`else 
//C_294: cover property (@(posedge clk_i) (lsq_enq_1_s1 && !lsq_enq_1_s1_hpn) && (scb_0_s12 && !scb_0_s12_hpn));
WHB_294: assert property (@(posedge clk_i) (lsq_enq_1_s1 && !lsq_enq_1_s1_hpn) |-> !scb_0_s12_hpn);
WHB_CONCUR_294: assert property (@(posedge clk_i) (lsq_enq_1_s1 && !lsq_enq_1_s1_hpn) |-> (scb_0_s12 && !scb_0_s12_hpn));
`endif 
