...
`ifndef WHB
HB_932: assert property (@(posedge clk_i) (stb_com_0_s1 && !stb_com_0_s1_hpn) |-> !(scb_0_s8_hpn || scb_0_s8));
`else 
//C_932: cover property (@(posedge clk_i) (stb_com_0_s1 && !stb_com_0_s1_hpn) && (scb_0_s8 && !scb_0_s8_hpn));
WHB_932: assert property (@(posedge clk_i) (stb_com_0_s1 && !stb_com_0_s1_hpn) |-> !scb_0_s8_hpn);
WHB_CONCUR_932: assert property (@(posedge clk_i) (stb_com_0_s1 && !stb_com_0_s1_hpn) |-> (scb_0_s8 && !scb_0_s8_hpn));
`endif 
