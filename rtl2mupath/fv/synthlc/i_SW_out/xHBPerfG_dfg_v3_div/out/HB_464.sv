...
`ifndef WHB
HB_464: assert property (@(posedge clk_i) (scb_0_s8 && !scb_0_s8_hpn) |-> !(store_unit_s3_hpn || store_unit_s3));
`else 
//C_464: cover property (@(posedge clk_i) (scb_0_s8 && !scb_0_s8_hpn) && (store_unit_s3 && !store_unit_s3_hpn));
WHB_464: assert property (@(posedge clk_i) (scb_0_s8 && !scb_0_s8_hpn) |-> !store_unit_s3_hpn);
WHB_CONCUR_464: assert property (@(posedge clk_i) (scb_0_s8 && !scb_0_s8_hpn) |-> (store_unit_s3 && !store_unit_s3_hpn));
`endif 
