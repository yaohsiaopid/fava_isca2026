...
`ifndef WHB
HB_930: assert property (@(posedge clk_i) (stb_com_0_s1 && !stb_com_0_s1_hpn) |-> !(scb_0_s13_hpn || scb_0_s13));
`else 
//C_930: cover property (@(posedge clk_i) (stb_com_0_s1 && !stb_com_0_s1_hpn) && (scb_0_s13 && !scb_0_s13_hpn));
WHB_930: assert property (@(posedge clk_i) (stb_com_0_s1 && !stb_com_0_s1_hpn) |-> !scb_0_s13_hpn);
WHB_CONCUR_930: assert property (@(posedge clk_i) (stb_com_0_s1 && !stb_com_0_s1_hpn) |-> (scb_0_s13 && !scb_0_s13_hpn));
`endif 
