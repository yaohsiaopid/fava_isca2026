...
`ifndef WHB
HB_388: assert property (@(posedge clk_i) (scb_0_s13 && !scb_0_s13_hpn) |-> !(store_unit_s3_hpn || store_unit_s3));
`else 
//C_388: cover property (@(posedge clk_i) (scb_0_s13 && !scb_0_s13_hpn) && (store_unit_s3 && !store_unit_s3_hpn));
WHB_388: assert property (@(posedge clk_i) (scb_0_s13 && !scb_0_s13_hpn) |-> !store_unit_s3_hpn);
WHB_CONCUR_388: assert property (@(posedge clk_i) (scb_0_s13 && !scb_0_s13_hpn) |-> (store_unit_s3 && !store_unit_s3_hpn));
`endif 
