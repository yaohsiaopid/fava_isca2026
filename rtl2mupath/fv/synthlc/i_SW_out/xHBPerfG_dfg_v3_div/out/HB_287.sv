...
`ifndef WHB
HB_287: assert property (@(posedge clk_i) (lsq_enq_0_s1 && !lsq_enq_0_s1_hpn) |-> !(store_unit_s1_hpn || store_unit_s1));
`else 
//C_287: cover property (@(posedge clk_i) (lsq_enq_0_s1 && !lsq_enq_0_s1_hpn) && (store_unit_s1 && !store_unit_s1_hpn));
WHB_287: assert property (@(posedge clk_i) (lsq_enq_0_s1 && !lsq_enq_0_s1_hpn) |-> !store_unit_s1_hpn);
WHB_CONCUR_287: assert property (@(posedge clk_i) (lsq_enq_0_s1 && !lsq_enq_0_s1_hpn) |-> (store_unit_s1 && !store_unit_s1_hpn));
`endif 
