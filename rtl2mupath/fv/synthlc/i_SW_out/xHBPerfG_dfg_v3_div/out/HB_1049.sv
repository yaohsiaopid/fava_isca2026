...
`ifndef WHB
HB_1049: assert property (@(posedge clk_i) (store_unit_s1 && !store_unit_s1_hpn) |-> !(scb_0_s13_hpn || scb_0_s13));
`else 
//C_1049: cover property (@(posedge clk_i) (store_unit_s1 && !store_unit_s1_hpn) && (scb_0_s13 && !scb_0_s13_hpn));
WHB_1049: assert property (@(posedge clk_i) (store_unit_s1 && !store_unit_s1_hpn) |-> !scb_0_s13_hpn);
WHB_CONCUR_1049: assert property (@(posedge clk_i) (store_unit_s1 && !store_unit_s1_hpn) |-> (scb_0_s13 && !scb_0_s13_hpn));
`endif 
