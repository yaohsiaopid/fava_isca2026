...
`ifndef WHB
HB_64: assert property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) |-> !(scb_0_s8_hpn || scb_0_s8));
`else 
//C_64: cover property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) && (scb_0_s8 && !scb_0_s8_hpn));
WHB_64: assert property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) |-> !scb_0_s8_hpn);
WHB_CONCUR_64: assert property (@(posedge clk_i) (id_stage_s1 && !id_stage_s1_hpn) |-> (scb_0_s8 && !scb_0_s8_hpn));
`endif 
