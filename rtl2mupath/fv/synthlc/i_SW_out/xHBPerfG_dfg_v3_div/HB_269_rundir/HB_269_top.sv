...
`ifndef WHB
HB_269: assert property (@(posedge clk_i) (lsq_enq_0_s1 && !lsq_enq_0_s1_hpn) |-> !(scb_0_s13_hpn || scb_0_s13));
`else 
//C_269: cover property (@(posedge clk_i) (lsq_enq_0_s1 && !lsq_enq_0_s1_hpn) && (scb_0_s13 && !scb_0_s13_hpn));
WHB_269: assert property (@(posedge clk_i) (lsq_enq_0_s1 && !lsq_enq_0_s1_hpn) |-> !scb_0_s13_hpn);
WHB_CONCUR_269: assert property (@(posedge clk_i) (lsq_enq_0_s1 && !lsq_enq_0_s1_hpn) |-> (scb_0_s13 && !scb_0_s13_hpn));
`endif 
