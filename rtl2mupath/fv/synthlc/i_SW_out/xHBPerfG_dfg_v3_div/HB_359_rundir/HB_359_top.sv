...
`ifndef WHB
HB_359: assert property (@(posedge clk_i) (scb_0_s13 && !scb_0_s13_hpn) |-> !(id_stage_s1_hpn || id_stage_s1));
`else 
//C_359: cover property (@(posedge clk_i) (scb_0_s13 && !scb_0_s13_hpn) && (id_stage_s1 && !id_stage_s1_hpn));
WHB_359: assert property (@(posedge clk_i) (scb_0_s13 && !scb_0_s13_hpn) |-> !id_stage_s1_hpn);
WHB_CONCUR_359: assert property (@(posedge clk_i) (scb_0_s13 && !scb_0_s13_hpn) |-> (id_stage_s1 && !id_stage_s1_hpn));
`endif 
