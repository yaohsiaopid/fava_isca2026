...
`ifndef WHB
HB_1259: assert property (@(posedge clk_i) (lsq_enq_0_s1 && !lsq_enq_0_s1_hpn) |-> !(mem_req_s1_hpn || mem_req_s1));
`else 
//C_1259: cover property (@(posedge clk_i) (lsq_enq_0_s1 && !lsq_enq_0_s1_hpn) && (mem_req_s1 && !mem_req_s1_hpn));
WHB_1259: assert property (@(posedge clk_i) (lsq_enq_0_s1 && !lsq_enq_0_s1_hpn) |-> !mem_req_s1_hpn);
WHB_CONCUR_1259: assert property (@(posedge clk_i) (lsq_enq_0_s1 && !lsq_enq_0_s1_hpn) |-> (mem_req_s1 && !mem_req_s1_hpn));
`endif 
