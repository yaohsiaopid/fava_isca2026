...
`ifndef WHB
HB_1044: assert property (@(posedge clk_i) (store_unit_s1 && !store_unit_s1_hpn) |-> !(issue_s16_hpn || issue_s16));
`else 
//C_1044: cover property (@(posedge clk_i) (store_unit_s1 && !store_unit_s1_hpn) && (issue_s16 && !issue_s16_hpn));
WHB_1044: assert property (@(posedge clk_i) (store_unit_s1 && !store_unit_s1_hpn) |-> !issue_s16_hpn);
WHB_CONCUR_1044: assert property (@(posedge clk_i) (store_unit_s1 && !store_unit_s1_hpn) |-> (issue_s16 && !issue_s16_hpn));
`endif 
