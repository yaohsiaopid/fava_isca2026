...
`ifndef WHB
HB_1260: assert property (@(posedge clk_i) (lsq_enq_1_s1 && !lsq_enq_1_s1_hpn) |-> !(mem_req_s1_hpn || mem_req_s1));
`else 
//C_1260: cover property (@(posedge clk_i) (lsq_enq_1_s1 && !lsq_enq_1_s1_hpn) && (mem_req_s1 && !mem_req_s1_hpn));
WHB_1260: assert property (@(posedge clk_i) (lsq_enq_1_s1 && !lsq_enq_1_s1_hpn) |-> !mem_req_s1_hpn);
WHB_CONCUR_1260: assert property (@(posedge clk_i) (lsq_enq_1_s1 && !lsq_enq_1_s1_hpn) |-> (mem_req_s1 && !mem_req_s1_hpn));
`endif 
