...
`ifndef WHB
HB_442: assert property (@(posedge clk_i) (scb_0_s8 && !scb_0_s8_hpn) |-> !(lsq_enq_1_s1_hpn || lsq_enq_1_s1));
`else 
//C_442: cover property (@(posedge clk_i) (scb_0_s8 && !scb_0_s8_hpn) && (lsq_enq_1_s1 && !lsq_enq_1_s1_hpn));
WHB_442: assert property (@(posedge clk_i) (scb_0_s8 && !scb_0_s8_hpn) |-> !lsq_enq_1_s1_hpn);
WHB_CONCUR_442: assert property (@(posedge clk_i) (scb_0_s8 && !scb_0_s8_hpn) |-> (lsq_enq_1_s1 && !lsq_enq_1_s1_hpn));
`endif 
