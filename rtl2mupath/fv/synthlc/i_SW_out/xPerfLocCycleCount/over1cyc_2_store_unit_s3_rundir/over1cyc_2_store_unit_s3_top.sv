...
CS_gt_store_unit_s3_2: cover property (@(posedge clk_i) store_unit_s3 [*2] ##1 !store_unit_s3 ##[0:$] (id_stage_s1_hpn && issue_s16_hpn && lsq_enq_1_s1_hpn && scb_0_s13_hpn && scb_0_s8_hpn && stb_com_0_s1_hpn && stb_spec_0_s1_hpn && store_unit_s1_hpn && store_unit_s3_hpn && mem_req_s1_hpn && 1'b1 & !(id_stage_s1 | issue_s16 | lsq_enq_1_s1 | scb_0_s13 | scb_0_s8 | stb_com_0_s1 | stb_spec_0_s1 | store_unit_s1 | store_unit_s3 | mem_req_s1 | 1'b0))); 
endmodule // ariane
