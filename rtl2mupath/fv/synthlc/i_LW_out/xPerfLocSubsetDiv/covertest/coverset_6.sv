...
assume property (@(posedge clk_i) !lsq_enq_0_s1); 
assume property (@(posedge clk_i) !lsq_enq_1_s1); 
assume property (@(posedge clk_i) !scb_1_s12); 
assume property (@(posedge clk_i) !scb_1_s13); 
assume property (@(posedge clk_i) !scb_1_s8); 
assume property (@(posedge clk_i) !scb_2_s12); 
assume property (@(posedge clk_i) !scb_2_s13); 
assume property (@(posedge clk_i) !scb_2_s8); 
assume property (@(posedge clk_i) !scb_3_s12); 
assume property (@(posedge clk_i) !scb_3_s13); 
assume property (@(posedge clk_i) !scb_3_s8); 
assume property (@(posedge clk_i) !load_unit_op_s1); 
assume property (@(posedge clk_i) !load_unit_op_s2); 
assume property (@(posedge clk_i) !load_unit_op_s3); 
C_6_N: cover property (@(posedge clk_i) id_stage_s1_hpn & issue_s16_hpn & scb_0_s12_hpn & scb_0_s13_hpn & scb_0_s8_hpn & load_unit_s1_hpn & load_unit_buff_s1_hpn & mem_req_s1_hpn & 1'b1 & !(id_stage_s1 | issue_s16 | scb_0_s12 | scb_0_s13 | scb_0_s8 | load_unit_s1 | load_unit_buff_s1 | mem_req_s1 | 1'b0));