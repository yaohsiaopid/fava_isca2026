...
C_0_N: cover property (@(posedge clk_i) id_stage_s1_hpn & ____________________________ & 1'b1 & !(id_stage_s1 | issue_s16 | scb_0_s13 | scb_0_s8 | load_unit_s1 | load_unit_buff_s1 | mem_req_s1 | 1'b0));
