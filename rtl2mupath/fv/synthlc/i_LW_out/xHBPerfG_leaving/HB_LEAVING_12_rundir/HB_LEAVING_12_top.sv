...
`ifndef WHB
HB_LEAVING_lsq_enq_0_s1_load_unit_s1: assert property (@(posedge clk_i) 
    ($past(lsq_enq_0_s1, 2) && 
        $past(lsq_enq_0_s1) && (!(lsq_enq_0_s1))) |-> 
    $past(!(load_unit_s1_hpn || load_unit_s1)));
`else 
WHB_LEAVING_lsq_enq_0_s1_hb_load_unit_s1: assert property (@(posedge clk_i) 
    ($past(lsq_enq_0_s1, 2) && 
        $past(lsq_enq_0_s1) && (!(lsq_enq_0_s1))) |-> $past(!(load_unit_s1_hpn)));
WHB_CONCUR_LEAVING_lsq_enq_0_s1_hb_load_unit_s1: assert property (@(posedge clk_i) 
    ($past(lsq_enq_0_s1, 2) && 
        $past(lsq_enq_0_s1) && (!(lsq_enq_0_s1))) |-> $past(!(load_unit_s1_hpn) && load_unit_s1));
`endif 
