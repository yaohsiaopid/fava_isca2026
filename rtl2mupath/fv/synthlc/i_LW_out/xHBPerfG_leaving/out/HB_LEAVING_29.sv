...
`ifndef WHB
HB_LEAVING_scb_0_s12_load_unit_op_s1: assert property (@(posedge clk_i) 
    ($past(scb_0_s12, 2) && 
        $past(scb_0_s12) && (!(scb_0_s12 || scb_1_s12 || scb_2_s12 || scb_3_s12))) |-> 
    $past(!(load_unit_op_s1_hpn || load_unit_op_s1)));
`else 
WHB_LEAVING_scb_0_s12_hb_load_unit_op_s1: assert property (@(posedge clk_i) 
    ($past(scb_0_s12, 2) && 
        $past(scb_0_s12) && (!(scb_0_s12 || scb_1_s12 || scb_2_s12 || scb_3_s12))) |-> $past(!(load_unit_op_s1_hpn)));
WHB_CONCUR_LEAVING_scb_0_s12_hb_load_unit_op_s1: assert property (@(posedge clk_i) 
    ($past(scb_0_s12, 2) && 
        $past(scb_0_s12) && (!(scb_0_s12 || scb_1_s12 || scb_2_s12 || scb_3_s12))) |-> $past(!(load_unit_op_s1_hpn) && load_unit_op_s1));
`endif 
