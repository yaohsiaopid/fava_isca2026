...
`ifndef WHB
HB_scb_0_s8_LEAVING_id_stage_s1: assert property (@(posedge clk_i) 
    ($past(!scb_0_s8_hpn) && scb_0_s8 && (id_stage_s1_hpn || id_stage_s1)) |=>
     id_stage_s1);
`else 
WHB_scb_0_s8_LEAVING_id_stage_s1: assert property (@(posedge clk_i) 
    ($past(!scb_0_s8_hpn) && scb_0_s8 && id_stage_s1_hpn) |->
    id_stage_s1);
WHB_CONCUR_scb_0_s8_LEAVING_id_stage_s1: assert property (@(posedge clk_i) 
    ($past(!scb_0_s8_hpn) && scb_0_s8 && id_stage_s1_hpn && id_stage_s1) |=>
    (!(id_stage_s1)));
`endif 

`ifndef WHB
HB_LEAVING_scb_0_s8_LEAVING_id_stage_s1: assert property (@(posedge clk_i) 
    ($past(scb_0_s8, 2) && $past(scb_0_s8) && (!(scb_0_s8 || scb_1_s8 || scb_2_s8 || scb_3_s8))) |-> 
    ((id_stage_s1_hpn && id_stage_s1) || !id_stage_s1_hpn));
`else 
WHB_LEAVING_scb_0_s8_LEAVING_id_stage_s1: assert property (@(posedge clk_i) 
    ($past(scb_0_s8, 2) && $past(scb_0_s8) && (!(scb_0_s8 || scb_1_s8 || scb_2_s8 || scb_3_s8))) |-> 
    $past((id_stage_s1_hpn && id_stage_s1) || !id_stage_s1_hpn));
WHB_CONCUR_LEAVING_scb_0_s8_LEAVING_id_stage_s1: assert property (@(posedge clk_i) 
    ($past(scb_0_s8, 2) && $past(scb_0_s8) && (!(scb_0_s8 || scb_1_s8 || scb_2_s8 || scb_3_s8))) |-> 
