...
`ifndef WHB
HB_LEAVING_load_unit_op_s3_scb_0_s12: assert property (@(posedge clk_i) 
    ($past(load_unit_op_s3, 2) && 
        $past(load_unit_op_s3) && (!(load_unit_op_s3))) |-> 
    $past(!(scb_0_s12_hpn || scb_0_s12)));
`else 
WHB_LEAVING_load_unit_op_s3_hb_scb_0_s12: assert property (@(posedge clk_i) 
    ($past(load_unit_op_s3, 2) && 
        $past(load_unit_op_s3) && (!(load_unit_op_s3))) |-> $past(!(scb_0_s12_hpn)));
WHB_CONCUR_LEAVING_load_unit_op_s3_hb_scb_0_s12: assert property (@(posedge clk_i) 
    ($past(load_unit_op_s3, 2) && 
        $past(load_unit_op_s3) && (!(load_unit_op_s3))) |-> $past(!(scb_0_s12_hpn) && scb_0_s12));
`endif 

// if precondition in unreachable meaning s2 already left when s1 enters
`ifndef WHB
HB_load_unit_op_s3_LEAVING_scb_0_s12: assert property (@(posedge clk_i) 
    ($past(!load_unit_op_s3_hpn) && load_unit_op_s3 && (scb_0_s12_hpn || scb_0_s12)) |=>
     scb_0_s12);
`else 
WHB_load_unit_op_s3_LEAVING_scb_0_s12: assert property (@(posedge clk_i) 
    ($past(!load_unit_op_s3_hpn) && load_unit_op_s3 && scb_0_s12_hpn) |->
    scb_0_s12);
WHB_CONCUR_load_unit_op_s3_LEAVING_scb_0_s12: assert property (@(posedge clk_i) 
    ($past(!load_unit_op_s3_hpn) && load_unit_op_s3 && scb_0_s12_hpn && scb_0_s12) |=>
    (!(scb_0_s12 || scb_1_s12 || scb_2_s12 || scb_3_s12)));
`endif 

`ifndef WHB
HB_LEAVING_load_unit_op_s3_LEAVING_scb_0_s12: assert property (@(posedge clk_i) 
    ($past(load_unit_op_s3, 2) && $past(load_unit_op_s3) && (!(load_unit_op_s3))) |-> 
    ((scb_0_s12_hpn && scb_0_s12) || !scb_0_s12_hpn));
`else 
WHB_LEAVING_load_unit_op_s3_LEAVING_scb_0_s12: assert property (@(posedge clk_i) 
    ($past(load_unit_op_s3, 2) && $past(load_unit_op_s3) && (!(load_unit_op_s3))) |-> 
    $past((scb_0_s12_hpn && scb_0_s12) || !scb_0_s12_hpn));
WHB_CONCUR_LEAVING_load_unit_op_s3_LEAVING_scb_0_s12: assert property (@(posedge clk_i) 
    ($past(load_unit_op_s3, 2) && $past(load_unit_op_s3) && (!(load_unit_op_s3))) |-> 
