...
`ifndef WHB
HB_LEAVING_scb_0_s12_issue_s16: assert property (@(posedge clk_i) 
    ($past(scb_0_s12, 2) && 
        $past(scb_0_s12) && (!(scb_0_s12 || scb_1_s12 || scb_2_s12 || scb_3_s12))) |-> 
    $past(!(issue_s16_hpn || issue_s16)));
`else 
WHB_LEAVING_scb_0_s12_hb_issue_s16: assert property (@(posedge clk_i) 
    ($past(scb_0_s12, 2) && 
        $past(scb_0_s12) && (!(scb_0_s12 || scb_1_s12 || scb_2_s12 || scb_3_s12))) |-> $past(!(issue_s16_hpn)));
WHB_CONCUR_LEAVING_scb_0_s12_hb_issue_s16: assert property (@(posedge clk_i) 
    ($past(scb_0_s12, 2) && 
        $past(scb_0_s12) && (!(scb_0_s12 || scb_1_s12 || scb_2_s12 || scb_3_s12))) |-> $past(!(issue_s16_hpn) && issue_s16));
`endif 
