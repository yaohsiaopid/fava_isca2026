...
`ifndef WHB
HB_lsq_enq_1_s1_LEAVING_scb_0_s8: assert property (@(posedge clk_i) 
    ($past(!lsq_enq_1_s1_hpn) && lsq_enq_1_s1 && (scb_0_s8_hpn || scb_0_s8)) |=>
     scb_0_s8);
`else 
WHB_lsq_enq_1_s1_LEAVING_scb_0_s8: assert property (@(posedge clk_i) 
    ($past(!lsq_enq_1_s1_hpn) && lsq_enq_1_s1 && scb_0_s8_hpn) |->
    scb_0_s8);
WHB_CONCUR_lsq_enq_1_s1_LEAVING_scb_0_s8: assert property (@(posedge clk_i) 
    ($past(!lsq_enq_1_s1_hpn) && lsq_enq_1_s1 && scb_0_s8_hpn && scb_0_s8) |=>
    (!(scb_0_s8 || scb_1_s8 || scb_2_s8 || scb_3_s8)));
`endif 

`ifndef WHB
HB_LEAVING_lsq_enq_1_s1_LEAVING_scb_0_s8: assert property (@(posedge clk_i) 
    ($past(lsq_enq_1_s1, 2) && $past(lsq_enq_1_s1) && (!(lsq_enq_1_s1))) |-> 
    ((scb_0_s8_hpn && scb_0_s8) || !scb_0_s8_hpn));
`else 
WHB_LEAVING_lsq_enq_1_s1_LEAVING_scb_0_s8: assert property (@(posedge clk_i) 
    ($past(lsq_enq_1_s1, 2) && $past(lsq_enq_1_s1) && (!(lsq_enq_1_s1))) |-> 
    $past((scb_0_s8_hpn && scb_0_s8) || !scb_0_s8_hpn));
WHB_CONCUR_LEAVING_lsq_enq_1_s1_LEAVING_scb_0_s8: assert property (@(posedge clk_i) 
    ($past(lsq_enq_1_s1, 2) && $past(lsq_enq_1_s1) && (!(lsq_enq_1_s1))) |-> 
