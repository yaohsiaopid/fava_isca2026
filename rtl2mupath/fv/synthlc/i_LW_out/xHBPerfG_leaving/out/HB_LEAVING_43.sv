...
`ifndef WHB
HB_load_unit_buff_s1_LEAVING_scb_0_s12: assert property (@(posedge clk_i) 
    ($past(!load_unit_buff_s1_hpn) && load_unit_buff_s1 && (scb_0_s12_hpn || scb_0_s12)) |=>
     scb_0_s12);
`else 
WHB_load_unit_buff_s1_LEAVING_scb_0_s12: assert property (@(posedge clk_i) 
    ($past(!load_unit_buff_s1_hpn) && load_unit_buff_s1 && scb_0_s12_hpn) |->
    scb_0_s12);
WHB_CONCUR_load_unit_buff_s1_LEAVING_scb_0_s12: assert property (@(posedge clk_i) 
    ($past(!load_unit_buff_s1_hpn) && load_unit_buff_s1 && scb_0_s12_hpn && scb_0_s12) |=>
