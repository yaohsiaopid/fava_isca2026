...
`ifndef WHB
HB_LEAVING_lsq_enq_1_s1_load_unit_op_s2: assert property (@(posedge clk_i) 
    ($past(lsq_enq_1_s1, 2) && 
        $past(lsq_enq_1_s1) && (!lsq_enq_1_s1)) |-> 
    $past(!(load_unit_op_s2_hpn || load_unit_op_s2)));
`else 
WHB_LEAVING_lsq_enq_1_s1_hb_load_unit_op_s2: assert property (@(posedge clk_i) 
    ($past(lsq_enq_1_s1, 2) && 
        $past(lsq_enq_1_s1) && (!lsq_enq_1_s1)) |-> $past(!(load_unit_op_s2_hpn)));
WHB_CONCUR_LEAVING_lsq_enq_1_s1_hb_load_unit_op_s2: assert property (@(posedge clk_i) 
    ($past(lsq_enq_1_s1, 2) && 
        $past(lsq_enq_1_s1) && (!lsq_enq_1_s1)) |-> $past(!(load_unit_op_s2_hpn) && load_unit_op_s2));
`endif 
