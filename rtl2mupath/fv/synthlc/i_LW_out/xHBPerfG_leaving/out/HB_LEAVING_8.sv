...
`ifndef WHB
HB_issue_s16_LEAVING_scb_0_s12: assert property (@(posedge clk_i) 
    ($past(!issue_s16_hpn) && issue_s16 && (scb_0_s12_hpn || scb_0_s12)) |=>
     scb_0_s12);
`else 
WHB_issue_s16_LEAVING_scb_0_s12: assert property (@(posedge clk_i) 
    ($past(!issue_s16_hpn) && issue_s16 && scb_0_s12_hpn) |->
    scb_0_s12);
WHB_CONCUR_issue_s16_LEAVING_scb_0_s12: assert property (@(posedge clk_i) 
    ($past(!issue_s16_hpn) && issue_s16 && scb_0_s12_hpn && scb_0_s12) |=>
