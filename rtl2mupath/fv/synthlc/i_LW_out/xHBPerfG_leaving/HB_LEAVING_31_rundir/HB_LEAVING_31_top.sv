...
S2_STAY_AT_LEAST_TWO: assume property (@(posedge clk_i) first |-> s_eventually
    ( !load_unit_op_s3 [*0:$] ##1 load_unit_op_s3 ##1 load_unit_op_s3));

`ifndef WHB
HB_LEAVING_scb_0_s12_load_unit_op_s3: assert property (@(posedge clk_i) 
    ($past(scb_0_s12, 2) && 
        $past(scb_0_s12) && (!(scb_0_s12 || scb_1_s12 || scb_2_s12 || scb_3_s12))) |-> 
    $past(!(load_unit_op_s3_hpn || load_unit_op_s3)));
`else 
WHB_LEAVING_scb_0_s12_hb_load_unit_op_s3: assert property (@(posedge clk_i) 
    ($past(scb_0_s12, 2) && 
        $past(scb_0_s12) && (!(scb_0_s12 || scb_1_s12 || scb_2_s12 || scb_3_s12))) |-> $past(!(load_unit_op_s3_hpn)));
WHB_CONCUR_LEAVING_scb_0_s12_hb_load_unit_op_s3: assert property (@(posedge clk_i) 
    ($past(scb_0_s12, 2) && 
        $past(scb_0_s12) && (!(scb_0_s12 || scb_1_s12 || scb_2_s12 || scb_3_s12))) |-> $past(!(load_unit_op_s3_hpn) && load_unit_op_s3));
`endif 

// if precondition in unreachable meaning s2 already left when s1 enters
`ifndef WHB
HB_scb_0_s12_LEAVING_load_unit_op_s3: assert property (@(posedge clk_i) 
    ($past(!scb_0_s12_hpn) && scb_0_s12 && (load_unit_op_s3_hpn || load_unit_op_s3)) |=>
     load_unit_op_s3);
`else 
WHB_scb_0_s12_LEAVING_load_unit_op_s3: assert property (@(posedge clk_i) 
    ($past(!scb_0_s12_hpn) && scb_0_s12 && load_unit_op_s3_hpn) |->
    load_unit_op_s3);
WHB_CONCUR_scb_0_s12_LEAVING_load_unit_op_s3: assert property (@(posedge clk_i) 
    ($past(!scb_0_s12_hpn) && scb_0_s12 && load_unit_op_s3_hpn && load_unit_op_s3) |=>
    (!(load_unit_op_s3)));
`endif 

`ifndef WHB
HB_LEAVING_scb_0_s12_LEAVING_load_unit_op_s3: assert property (@(posedge clk_i) 
    ($past(scb_0_s12, 2) && $past(scb_0_s12) && (!(scb_0_s12 || scb_1_s12 || scb_2_s12 || scb_3_s12))) |-> 
    ((load_unit_op_s3_hpn && load_unit_op_s3) || !load_unit_op_s3_hpn));
`else 
WHB_LEAVING_scb_0_s12_LEAVING_load_unit_op_s3: assert property (@(posedge clk_i) 
    ($past(scb_0_s12, 2) && $past(scb_0_s12) && (!(scb_0_s12 || scb_1_s12 || scb_2_s12 || scb_3_s12))) |-> 
    $past((load_unit_op_s3_hpn && load_unit_op_s3) || !load_unit_op_s3_hpn));
WHB_CONCUR_LEAVING_scb_0_s12_LEAVING_load_unit_op_s3: assert property (@(posedge clk_i) 
    ($past(scb_0_s12, 2) && $past(scb_0_s12) && (!(scb_0_s12 || scb_1_s12 || scb_2_s12 || scb_3_s12))) |-> 
