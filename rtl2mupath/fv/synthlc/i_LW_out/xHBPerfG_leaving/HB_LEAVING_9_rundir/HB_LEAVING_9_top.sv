...
`ifndef WHB
HB_issue_s16_LEAVING_scb_0_s8: assert property (@(posedge clk_i) 
    ($past(!issue_s16_hpn) && issue_s16 && (scb_0_s8_hpn || scb_0_s8)) |=>
     scb_0_s8);
`else 
WHB_issue_s16_LEAVING_scb_0_s8: assert property (@(posedge clk_i) 
    ($past(!issue_s16_hpn) && issue_s16 && scb_0_s8_hpn) |->
    scb_0_s8);
WHB_CONCUR_issue_s16_LEAVING_scb_0_s8: assert property (@(posedge clk_i) 
    ($past(!issue_s16_hpn) && issue_s16 && scb_0_s8_hpn && scb_0_s8) |=>
