...
`ifndef WHB
HB_load_unit_op_s2_LEAVING_scb_0_s8: assert property (@(posedge clk_i) 
    ($past(!load_unit_op_s2_hpn) && load_unit_op_s2 && (scb_0_s8_hpn || scb_0_s8)) |=>
     scb_0_s8);
`else 
WHB_load_unit_op_s2_LEAVING_scb_0_s8: assert property (@(posedge clk_i) 
    ($past(!load_unit_op_s2_hpn) && load_unit_op_s2 && scb_0_s8_hpn) |->
    scb_0_s8);
WHB_CONCUR_load_unit_op_s2_LEAVING_scb_0_s8: assert property (@(posedge clk_i) 
    ($past(!load_unit_op_s2_hpn) && load_unit_op_s2 && scb_0_s8_hpn && scb_0_s8) |=>
