...
`ifndef WHB
HB_LEAVING_scb_0_s8_load_unit_op_s1: assert property (@(posedge clk_i) 
    ($past(scb_0_s8, 2) && 
        $past(scb_0_s8) && (!(scb_0_s8 || scb_1_s8 || scb_2_s8 || scb_3_s8))) |-> 
    $past(!(load_unit_op_s1_hpn || load_unit_op_s1)));
`else 
WHB_LEAVING_scb_0_s8_hb_load_unit_op_s1: assert property (@(posedge clk_i) 
    ($past(scb_0_s8, 2) && 
        $past(scb_0_s8) && (!(scb_0_s8 || scb_1_s8 || scb_2_s8 || scb_3_s8))) |-> $past(!(load_unit_op_s1_hpn)));
WHB_CONCUR_LEAVING_scb_0_s8_hb_load_unit_op_s1: assert property (@(posedge clk_i) 
    ($past(scb_0_s8, 2) && 
        $past(scb_0_s8) && (!(scb_0_s8 || scb_1_s8 || scb_2_s8 || scb_3_s8))) |-> $past(!(load_unit_op_s1_hpn) && load_unit_op_s1));
`endif 
