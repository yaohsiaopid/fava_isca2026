...
`ifndef WHB
HB_load_unit_op_s2_LEAVING_lsq_enq_1_s1: assert property (@(posedge clk_i) 
    ($past(!load_unit_op_s2_hpn) && load_unit_op_s2 && (lsq_enq_1_s1_hpn || lsq_enq_1_s1)) |=>
     lsq_enq_1_s1);
`else 
WHB_load_unit_op_s2_LEAVING_lsq_enq_1_s1: assert property (@(posedge clk_i) 
    ($past(!load_unit_op_s2_hpn) && load_unit_op_s2 && lsq_enq_1_s1_hpn) |->
    lsq_enq_1_s1);
WHB_CONCUR_load_unit_op_s2_LEAVING_lsq_enq_1_s1: assert property (@(posedge clk_i) 
    ($past(!load_unit_op_s2_hpn) && load_unit_op_s2 && lsq_enq_1_s1_hpn && lsq_enq_1_s1) |=>
    (!(lsq_enq_1_s1)));
`endif 
