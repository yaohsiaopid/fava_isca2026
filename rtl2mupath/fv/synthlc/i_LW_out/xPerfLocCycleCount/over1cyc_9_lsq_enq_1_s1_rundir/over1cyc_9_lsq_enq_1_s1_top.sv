...
always @(posedge clk_i) begin
    if (!rst_ni)
        scb_0_s12_hpn <= 1'b0;
    else if (scb_0_s12 || scb_1_s12 || scb_2_s12 || scb_3_s12)
        scb_0_s12_hpn <= 1'b1;
end
...
always @(posedge clk_i) begin
    if (!rst_ni)
        scb_0_s13_hpn <= 1'b0;
    else if (scb_0_s13 || scb_1_s13 || scb_2_s13 || scb_3_s13)
        scb_0_s13_hpn <= 1'b1;
end
...
always @(posedge clk_i) begin
    if (!rst_ni)
        scb_0_s8_hpn <= 1'b0;
    else if (scb_0_s8 || scb_1_s8 || scb_2_s8 || scb_3_s8)
        scb_0_s8_hpn <= 1'b1;
end
...
reg load_unit_s1_hpn;
always @(posedge clk_i) begin
    if (!rst_ni)
        load_unit_s1_hpn <= 1'b0;
    else if (load_unit_s1)
        load_unit_s1_hpn <= 1'b1;
end

reg load_unit_buff_s1_hpn;
always @(posedge clk_i) begin
    if (!rst_ni)
        load_unit_buff_s1_hpn <= 1'b0;
    else if (load_unit_buff_s1)
        load_unit_buff_s1_hpn <= 1'b1;
end

reg load_unit_op_s1_hpn;
always @(posedge clk_i) begin
    if (!rst_ni)
        load_unit_op_s1_hpn <= 1'b0;
    else if (load_unit_op_s1)
        load_unit_op_s1_hpn <= 1'b1;
end

reg load_unit_op_s2_hpn;
always @(posedge clk_i) begin
    if (!rst_ni)
        load_unit_op_s2_hpn <= 1'b0;
    else if (load_unit_op_s2)
        load_unit_op_s2_hpn <= 1'b1;
end

reg load_unit_op_s3_hpn;
always @(posedge clk_i) begin
    if (!rst_ni)
        load_unit_op_s3_hpn <= 1'b0;
    else if (load_unit_op_s3)
        load_unit_op_s3_hpn <= 1'b1;
end
...
A_PATH: assume property (@(posedge clk_i) first |-> s_eventually (id_stage_s1_hpn && issue_s16_hpn && lsq_enq_1_s1_hpn && scb_0_s12_hpn && scb_0_s13_hpn && scb_0_s8_hpn && load_unit_s1_hpn && load_unit_buff_s1_hpn && load_unit_op_s1_hpn && load_unit_op_s2_hpn && load_unit_op_s3_hpn && mem_req_s1_hpn && 1'b1));
CS_gt_lsq_enq_1_s1_2: cover property (@(posedge clk_i) lsq_enq_1_s1 [*2] ##1 !lsq_enq_1_s1 ##[0:$] (id_stage_s1_hpn && issue_s16_hpn && lsq_enq_1_s1_hpn && scb_0_s12_hpn && scb_0_s13_hpn && scb_0_s8_hpn && load_unit_s1_hpn && load_unit_buff_s1_hpn && load_unit_op_s1_hpn && load_unit_op_s2_hpn && load_unit_op_s3_hpn && mem_req_s1_hpn && 1'b1 & !(id_stage_s1 | issue_s16 | lsq_enq_1_s1 | scb_0_s12 | scb_0_s13 | scb_0_s8 | load_unit_s1 | load_unit_buff_s1 | load_unit_op_s1 | load_unit_op_s2 | load_unit_op_s3 | mem_req_s1 | 1'b0))); 
endmodule // ariane
