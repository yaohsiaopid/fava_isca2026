...
A_PATH: assume property (@(posedge clk_i) first |-> s_eventually (id_stage_s1_hpn && issue_s16_hpn && scb_0_s13_hpn && scb_0_s8_hpn && load_unit_s1_hpn && load_unit_buff_s1_hpn && mem_req_s1_hpn && 1'b1));
CS_gt_id_stage_s1_2: cover property (@(posedge clk_i) id_stage_s1 [*2] ##1 !id_stage_s1 ##[0:$] (id_stage_s1_hpn && issue_s16_hpn && scb_0_s13_hpn && scb_0_s8_hpn && load_unit_s1_hpn && load_unit_buff_s1_hpn && mem_req_s1_hpn && 1'b1 & !(id_stage_s1 | issue_s16 | scb_0_s13 | scb_0_s8 | load_unit_s1 | load_unit_buff_s1 | mem_req_s1 | 1'b0))); 
endmodule // ariane
