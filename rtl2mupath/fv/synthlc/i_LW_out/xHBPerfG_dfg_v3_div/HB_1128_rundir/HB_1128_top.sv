...
`ifndef WHB
HB_1128: assert property (@(posedge clk_i) ((load_unit_buff_s1) && !load_unit_buff_s1_hpn) |-> !(load_unit_op_s2_hpn || (load_unit_op_s2)));
`else
WHB_1128: assert property (@(posedge clk_i) ((load_unit_buff_s1) && !load_unit_buff_s1_hpn) |-> !load_unit_op_s2_hpn);
WHB_CONCUR_1128: assert property (@(posedge clk_i) ((load_unit_buff_s1) && !load_unit_buff_s1_hpn) |-> ((load_unit_op_s2) && !load_unit_op_s2_hpn));
`endif
