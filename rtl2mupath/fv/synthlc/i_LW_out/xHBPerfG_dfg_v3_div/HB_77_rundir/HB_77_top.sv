...
`ifndef WHB
HB_77: assert property (@(posedge clk_i) ((id_stage_s1) && !id_stage_s1_hpn) |-> !(load_unit_s1_hpn || (load_unit_s1)));
`else
WHB_77: assert property (@(posedge clk_i) ((id_stage_s1) && !id_stage_s1_hpn) |-> !load_unit_s1_hpn);
WHB_CONCUR_77: assert property (@(posedge clk_i) ((id_stage_s1) && !id_stage_s1_hpn) |-> ((load_unit_s1) && !load_unit_s1_hpn));
`endif
