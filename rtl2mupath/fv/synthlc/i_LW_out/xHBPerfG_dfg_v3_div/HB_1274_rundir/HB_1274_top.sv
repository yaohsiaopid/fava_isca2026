...
`ifndef WHB
HB_1274: assert property (@(posedge clk_i) ((load_unit_s1) && !load_unit_s1_hpn) |-> !(load_unit_op_s3_hpn || (load_unit_op_s3)));
`else
WHB_1274: assert property (@(posedge clk_i) ((load_unit_s1) && !load_unit_s1_hpn) |-> !load_unit_op_s3_hpn);
WHB_CONCUR_1274: assert property (@(posedge clk_i) ((load_unit_s1) && !load_unit_s1_hpn) |-> ((load_unit_op_s3) && !load_unit_op_s3_hpn));
`endif
