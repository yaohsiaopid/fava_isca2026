...
`ifndef WHB
HB_1236: assert property (@(posedge clk_i) ((load_unit_op_s3) && !load_unit_op_s3_hpn) |-> !(lsq_enq_1_s1_hpn || (lsq_enq_1_s1)));
`else
WHB_1236: assert property (@(posedge clk_i) ((load_unit_op_s3) && !load_unit_op_s3_hpn) |-> !lsq_enq_1_s1_hpn);
WHB_CONCUR_1236: assert property (@(posedge clk_i) ((load_unit_op_s3) && !load_unit_op_s3_hpn) |-> ((lsq_enq_1_s1) && !lsq_enq_1_s1_hpn));
`endif
