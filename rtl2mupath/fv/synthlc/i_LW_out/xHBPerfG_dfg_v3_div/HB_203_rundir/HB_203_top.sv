...
`ifndef WHB
HB_203: assert property (@(posedge clk_i) ((issue_s16) && !issue_s16_hpn) |-> !(scb_0_s13_hpn || (scb_0_s13 || scb_1_s13 || scb_2_s13 || scb_3_s13)));
`else
WHB_203: assert property (@(posedge clk_i) ((issue_s16) && !issue_s16_hpn) |-> !scb_0_s13_hpn);
WHB_CONCUR_203: assert property (@(posedge clk_i) ((issue_s16) && !issue_s16_hpn) |-> ((scb_0_s13 || scb_1_s13 || scb_2_s13 || scb_3_s13) && !scb_0_s13_hpn));
`endif
