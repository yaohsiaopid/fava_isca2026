...
`ifndef WHB
HB_223: assert property (@(posedge clk_i) ((issue_s16) && !issue_s16_hpn) |-> !(load_unit_buff_s1_hpn || (load_unit_buff_s1)));
`else
WHB_223: assert property (@(posedge clk_i) ((issue_s16) && !issue_s16_hpn) |-> !load_unit_buff_s1_hpn);
WHB_CONCUR_223: assert property (@(posedge clk_i) ((issue_s16) && !issue_s16_hpn) |-> ((load_unit_buff_s1) && !load_unit_buff_s1_hpn));
`endif
