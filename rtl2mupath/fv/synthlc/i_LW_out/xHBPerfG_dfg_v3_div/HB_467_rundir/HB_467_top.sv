...
`ifndef WHB
HB_467: assert property (@(posedge clk_i) ((scb_0_s8 || scb_1_s8 || scb_2_s8 || scb_3_s8) && !scb_0_s8_hpn) |-> !(load_unit_op_s1_hpn || (load_unit_op_s1)));
`else
WHB_467: assert property (@(posedge clk_i) ((scb_0_s8 || scb_1_s8 || scb_2_s8 || scb_3_s8) && !scb_0_s8_hpn) |-> !load_unit_op_s1_hpn);
WHB_CONCUR_467: assert property (@(posedge clk_i) ((scb_0_s8 || scb_1_s8 || scb_2_s8 || scb_3_s8) && !scb_0_s8_hpn) |-> ((load_unit_op_s1) && !load_unit_op_s1_hpn));
`endif
