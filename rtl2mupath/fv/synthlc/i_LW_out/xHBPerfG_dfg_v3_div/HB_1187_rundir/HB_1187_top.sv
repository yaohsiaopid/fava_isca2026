...
`ifndef WHB
HB_1187: assert property (@(posedge clk_i) ((load_unit_op_s1) && !load_unit_op_s1_hpn) |-> !(lsq_enq_0_s1_hpn || (lsq_enq_0_s1)));
`else
WHB_1187: assert property (@(posedge clk_i) ((load_unit_op_s1) && !load_unit_op_s1_hpn) |-> !lsq_enq_0_s1_hpn);
WHB_CONCUR_1187: assert property (@(posedge clk_i) ((load_unit_op_s1) && !load_unit_op_s1_hpn) |-> ((lsq_enq_0_s1) && !lsq_enq_0_s1_hpn));
`endif
