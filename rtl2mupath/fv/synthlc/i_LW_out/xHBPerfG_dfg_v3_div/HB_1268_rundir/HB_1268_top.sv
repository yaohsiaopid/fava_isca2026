...
`ifndef WHB
HB_1268: assert property (@(posedge clk_i) ((load_unit_op_s3) && !load_unit_op_s3_hpn) |-> !(mem_req_s1_hpn || (mem_req_s1)));
`else
WHB_1268: assert property (@(posedge clk_i) ((load_unit_op_s3) && !load_unit_op_s3_hpn) |-> !mem_req_s1_hpn);
WHB_CONCUR_1268: assert property (@(posedge clk_i) ((load_unit_op_s3) && !load_unit_op_s3_hpn) |-> ((mem_req_s1) && !mem_req_s1_hpn));
`endif
