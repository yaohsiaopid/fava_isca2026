...
`ifndef WHB
HB_353: assert property (@(posedge clk_i) ((scb_0_s12 || scb_1_s12 || scb_2_s12 || scb_3_s12) && !scb_0_s12_hpn) |-> !(load_unit_op_s1_hpn || (load_unit_op_s1)));
`else
WHB_353: assert property (@(posedge clk_i) ((scb_0_s12 || scb_1_s12 || scb_2_s12 || scb_3_s12) && !scb_0_s12_hpn) |-> !load_unit_op_s1_hpn);
WHB_CONCUR_353: assert property (@(posedge clk_i) ((scb_0_s12 || scb_1_s12 || scb_2_s12 || scb_3_s12) && !scb_0_s12_hpn) |-> ((load_unit_op_s1) && !load_unit_op_s1_hpn));
`endif
