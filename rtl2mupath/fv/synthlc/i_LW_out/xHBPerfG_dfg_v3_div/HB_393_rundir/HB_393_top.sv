...
`ifndef WHB
HB_393: assert property (@(posedge clk_i) ((scb_0_s13 || scb_1_s13 || scb_2_s13 || scb_3_s13) && !scb_0_s13_hpn) |-> !(load_unit_op_s3_hpn || (load_unit_op_s3)));
`else
WHB_393: assert property (@(posedge clk_i) ((scb_0_s13 || scb_1_s13 || scb_2_s13 || scb_3_s13) && !scb_0_s13_hpn) |-> !load_unit_op_s3_hpn);
WHB_CONCUR_393: assert property (@(posedge clk_i) ((scb_0_s13 || scb_1_s13 || scb_2_s13 || scb_3_s13) && !scb_0_s13_hpn) |-> ((load_unit_op_s3) && !load_unit_op_s3_hpn));
`endif
