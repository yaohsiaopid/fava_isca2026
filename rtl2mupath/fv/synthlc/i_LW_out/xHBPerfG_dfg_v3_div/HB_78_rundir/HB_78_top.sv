...
`ifndef WHB
HB_78: assert property (@(posedge clk_i) ((id_stage_s1) && !id_stage_s1_hpn) |-> !(load_unit_op_s1_hpn || (load_unit_op_s1)));
`else
WHB_78: assert property (@(posedge clk_i) ((id_stage_s1) && !id_stage_s1_hpn) |-> !load_unit_op_s1_hpn);
WHB_CONCUR_78: assert property (@(posedge clk_i) ((id_stage_s1) && !id_stage_s1_hpn) |-> ((load_unit_op_s1) && !load_unit_op_s1_hpn));
`endif
