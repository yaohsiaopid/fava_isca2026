...
`ifndef WHB
HB_290: assert property (@(posedge clk_i) ((lsq_enq_0_s1) && !lsq_enq_0_s1_hpn) |-> !(load_unit_op_s1_hpn || (load_unit_op_s1)));
`else
WHB_290: assert property (@(posedge clk_i) ((lsq_enq_0_s1) && !lsq_enq_0_s1_hpn) |-> !load_unit_op_s1_hpn);
WHB_CONCUR_290: assert property (@(posedge clk_i) ((lsq_enq_0_s1) && !lsq_enq_0_s1_hpn) |-> ((load_unit_op_s1) && !load_unit_op_s1_hpn));
`endif
