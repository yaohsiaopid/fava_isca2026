...
`ifndef WHB
HB_462: assert property (@(posedge clk_i) ((scb_0_s8 || scb_1_s8 || scb_2_s8 || scb_3_s8) && !scb_0_s8_hpn) |-> !(load_unit_s1_hpn || (load_unit_s1)));
`else
WHB_462: assert property (@(posedge clk_i) ((scb_0_s8 || scb_1_s8 || scb_2_s8 || scb_3_s8) && !scb_0_s8_hpn) |-> !load_unit_s1_hpn);
WHB_CONCUR_462: assert property (@(posedge clk_i) ((scb_0_s8 || scb_1_s8 || scb_2_s8 || scb_3_s8) && !scb_0_s8_hpn) |-> ((load_unit_s1) && !load_unit_s1_hpn));
`endif
