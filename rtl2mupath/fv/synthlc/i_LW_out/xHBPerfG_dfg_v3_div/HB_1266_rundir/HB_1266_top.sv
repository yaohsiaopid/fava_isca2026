...
`ifndef WHB
HB_1266: assert property (@(posedge clk_i) ((load_unit_op_s1) && !load_unit_op_s1_hpn) |-> !(mem_req_s1_hpn || (mem_req_s1)));
`else
WHB_1266: assert property (@(posedge clk_i) ((load_unit_op_s1) && !load_unit_op_s1_hpn) |-> !mem_req_s1_hpn);
WHB_CONCUR_1266: assert property (@(posedge clk_i) ((load_unit_op_s1) && !load_unit_op_s1_hpn) |-> ((mem_req_s1) && !mem_req_s1_hpn));
`endif
