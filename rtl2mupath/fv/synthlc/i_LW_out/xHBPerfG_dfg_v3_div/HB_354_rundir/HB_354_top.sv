...
`ifndef WHB
HB_354: assert property (@(posedge clk_i) ((scb_0_s12 || scb_1_s12 || scb_2_s12 || scb_3_s12) && !scb_0_s12_hpn) |-> !(load_unit_op_s2_hpn || (load_unit_op_s2)));
`else
WHB_354: assert property (@(posedge clk_i) ((scb_0_s12 || scb_1_s12 || scb_2_s12 || scb_3_s12) && !scb_0_s12_hpn) |-> !load_unit_op_s2_hpn);
WHB_CONCUR_354: assert property (@(posedge clk_i) ((scb_0_s12 || scb_1_s12 || scb_2_s12 || scb_3_s12) && !scb_0_s12_hpn) |-> ((load_unit_op_s2) && !load_unit_op_s2_hpn));
`endif
