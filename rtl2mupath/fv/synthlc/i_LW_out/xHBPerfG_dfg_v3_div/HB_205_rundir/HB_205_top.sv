...
`ifndef WHB
HB_205: assert property (@(posedge clk_i) ((issue_s16) && !issue_s16_hpn) |-> !(scb_0_s8_hpn || (scb_0_s8 || scb_1_s8 || scb_2_s8 || scb_3_s8)));
`else
WHB_205: assert property (@(posedge clk_i) ((issue_s16) && !issue_s16_hpn) |-> !scb_0_s8_hpn);
WHB_CONCUR_205: assert property (@(posedge clk_i) ((issue_s16) && !issue_s16_hpn) |-> ((scb_0_s8 || scb_1_s8 || scb_2_s8 || scb_3_s8) && !scb_0_s8_hpn));
`endif
