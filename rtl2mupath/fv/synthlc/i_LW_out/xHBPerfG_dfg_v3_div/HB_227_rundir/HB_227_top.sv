...
`ifndef WHB
HB_227: assert property (@(posedge clk_i) ((issue_s16) && !issue_s16_hpn) |-> !(load_unit_op_s2_hpn || (load_unit_op_s2)));
`else
WHB_227: assert property (@(posedge clk_i) ((issue_s16) && !issue_s16_hpn) |-> !load_unit_op_s2_hpn);
WHB_CONCUR_227: assert property (@(posedge clk_i) ((issue_s16) && !issue_s16_hpn) |-> ((load_unit_op_s2) && !load_unit_op_s2_hpn));
`endif
