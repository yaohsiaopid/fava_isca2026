...
`ifndef WHB
HB_355: assert property (@(posedge clk_i) ((scb_0_s12 || scb_1_s12 || scb_2_s12 || scb_3_s12) && !scb_0_s12_hpn) |-> !(load_unit_op_s3_hpn || (load_unit_op_s3)));
`else
WHB_355: assert property (@(posedge clk_i) ((scb_0_s12 || scb_1_s12 || scb_2_s12 || scb_3_s12) && !scb_0_s12_hpn) |-> !load_unit_op_s3_hpn);
WHB_CONCUR_355: assert property (@(posedge clk_i) ((scb_0_s12 || scb_1_s12 || scb_2_s12 || scb_3_s12) && !scb_0_s12_hpn) |-> ((load_unit_op_s3) && !load_unit_op_s3_hpn));
`endif
