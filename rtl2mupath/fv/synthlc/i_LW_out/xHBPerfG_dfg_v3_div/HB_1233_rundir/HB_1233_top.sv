...
`ifndef WHB
HB_1233: assert property (@(posedge clk_i) ((load_unit_op_s2) && !load_unit_op_s2_hpn) |-> !(load_unit_op_s1_hpn || (load_unit_op_s1)));
`else
WHB_1233: assert property (@(posedge clk_i) ((load_unit_op_s2) && !load_unit_op_s2_hpn) |-> !load_unit_op_s1_hpn);
WHB_CONCUR_1233: assert property (@(posedge clk_i) ((load_unit_op_s2) && !load_unit_op_s2_hpn) |-> ((load_unit_op_s1) && !load_unit_op_s1_hpn));
`endif
