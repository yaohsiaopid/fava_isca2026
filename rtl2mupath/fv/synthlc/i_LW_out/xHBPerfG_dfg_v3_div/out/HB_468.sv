...
`ifndef WHB
HB_468: assert property (@(posedge clk_i) ((scb_0_s8 || scb_1_s8 || scb_2_s8 || scb_3_s8) && !scb_0_s8_hpn) |-> !(load_unit_op_s2_hpn || (load_unit_op_s2)));
`else
WHB_468: assert property (@(posedge clk_i) ((scb_0_s8 || scb_1_s8 || scb_2_s8 || scb_3_s8) && !scb_0_s8_hpn) |-> !load_unit_op_s2_hpn);
WHB_CONCUR_468: assert property (@(posedge clk_i) ((scb_0_s8 || scb_1_s8 || scb_2_s8 || scb_3_s8) && !scb_0_s8_hpn) |-> ((load_unit_op_s2) && !load_unit_op_s2_hpn));
`endif
