...
`ifndef WHB
HB_291: assert property (@(posedge clk_i) ((lsq_enq_0_s1) && !lsq_enq_0_s1_hpn) |-> !(load_unit_op_s2_hpn || (load_unit_op_s2)));
`else
WHB_291: assert property (@(posedge clk_i) ((lsq_enq_0_s1) && !lsq_enq_0_s1_hpn) |-> !load_unit_op_s2_hpn);
WHB_CONCUR_291: assert property (@(posedge clk_i) ((lsq_enq_0_s1) && !lsq_enq_0_s1_hpn) |-> ((load_unit_op_s2) && !load_unit_op_s2_hpn));
`endif
