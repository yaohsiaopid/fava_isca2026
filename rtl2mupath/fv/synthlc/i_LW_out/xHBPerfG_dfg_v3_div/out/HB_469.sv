...
`ifndef WHB
HB_469: assert property (@(posedge clk_i) ((scb_0_s8 || scb_1_s8 || scb_2_s8 || scb_3_s8) && !scb_0_s8_hpn) |-> !(load_unit_op_s3_hpn || (load_unit_op_s3)));
`else
WHB_469: assert property (@(posedge clk_i) ((scb_0_s8 || scb_1_s8 || scb_2_s8 || scb_3_s8) && !scb_0_s8_hpn) |-> !load_unit_op_s3_hpn);
WHB_CONCUR_469: assert property (@(posedge clk_i) ((scb_0_s8 || scb_1_s8 || scb_2_s8 || scb_3_s8) && !scb_0_s8_hpn) |-> ((load_unit_op_s3) && !load_unit_op_s3_hpn));
`endif
