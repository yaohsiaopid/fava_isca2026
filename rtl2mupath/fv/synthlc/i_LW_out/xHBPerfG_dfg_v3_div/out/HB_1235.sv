...
`ifndef WHB
HB_1235: assert property (@(posedge clk_i) ((load_unit_op_s3) && !load_unit_op_s3_hpn) |-> !(lsq_enq_0_s1_hpn || (lsq_enq_0_s1)));
`else
WHB_1235: assert property (@(posedge clk_i) ((load_unit_op_s3) && !load_unit_op_s3_hpn) |-> !lsq_enq_0_s1_hpn);
WHB_CONCUR_1235: assert property (@(posedge clk_i) ((load_unit_op_s3) && !load_unit_op_s3_hpn) |-> ((lsq_enq_0_s1) && !lsq_enq_0_s1_hpn));
`endif
