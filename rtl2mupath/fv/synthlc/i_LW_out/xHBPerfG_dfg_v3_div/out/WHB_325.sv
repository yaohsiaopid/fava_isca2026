...
`ifndef WHB
HB_325: assert property (@(posedge clk_i) ((scb_0_s12 || scb_1_s12 || scb_2_s12 || scb_3_s12) && !scb_0_s12_hpn) |-> !(issue_s16_hpn || (issue_s16)));
`else
WHB_325: assert property (@(posedge clk_i) ((scb_0_s12 || scb_1_s12 || scb_2_s12 || scb_3_s12) && !scb_0_s12_hpn) |-> !issue_s16_hpn);
WHB_CONCUR_325: assert property (@(posedge clk_i) ((scb_0_s12 || scb_1_s12 || scb_2_s12 || scb_3_s12) && !scb_0_s12_hpn) |-> ((issue_s16) && !issue_s16_hpn));
`endif
