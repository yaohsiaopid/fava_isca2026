...
`ifndef WHB
HB_1129: assert property (@(posedge clk_i) ((load_unit_buff_s1) && !load_unit_buff_s1_hpn) |-> !(load_unit_op_s3_hpn || (load_unit_op_s3)));
`else
WHB_1129: assert property (@(posedge clk_i) ((load_unit_buff_s1) && !load_unit_buff_s1_hpn) |-> !load_unit_op_s3_hpn);
WHB_CONCUR_1129: assert property (@(posedge clk_i) ((load_unit_buff_s1) && !load_unit_buff_s1_hpn) |-> ((load_unit_op_s3) && !load_unit_op_s3_hpn));
`endif
