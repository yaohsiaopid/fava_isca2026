...
`ifndef WHB
HB_363: assert property (@(posedge clk_i) ((scb_0_s13 || scb_1_s13 || scb_2_s13 || scb_3_s13) && !scb_0_s13_hpn) |-> !(issue_s16_hpn || (issue_s16)));
`else
WHB_363: assert property (@(posedge clk_i) ((scb_0_s13 || scb_1_s13 || scb_2_s13 || scb_3_s13) && !scb_0_s13_hpn) |-> !issue_s16_hpn);
WHB_CONCUR_363: assert property (@(posedge clk_i) ((scb_0_s13 || scb_1_s13 || scb_2_s13 || scb_3_s13) && !scb_0_s13_hpn) |-> ((issue_s16) && !issue_s16_hpn));
`endif
