...
`ifndef WHB
HB_1214: assert property (@(posedge clk_i) ((load_unit_op_s2) && !load_unit_op_s2_hpn) |-> !(scb_0_s13_hpn || (scb_0_s13 || scb_1_s13 || scb_2_s13 || scb_3_s13)));
`else
WHB_1214: assert property (@(posedge clk_i) ((load_unit_op_s2) && !load_unit_op_s2_hpn) |-> !scb_0_s13_hpn);
WHB_CONCUR_1214: assert property (@(posedge clk_i) ((load_unit_op_s2) && !load_unit_op_s2_hpn) |-> ((scb_0_s13 || scb_1_s13 || scb_2_s13 || scb_3_s13) && !scb_0_s13_hpn));
`endif
