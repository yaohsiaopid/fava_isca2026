...
`ifndef WHB
HB_61: assert property (@(posedge clk_i) ((id_stage_s1) && !id_stage_s1_hpn) |-> !(scb_0_s12_hpn || (scb_0_s12 || scb_1_s12 || scb_2_s12 || scb_3_s12)));
`else
WHB_61: assert property (@(posedge clk_i) ((id_stage_s1) && !id_stage_s1_hpn) |-> !scb_0_s12_hpn);
WHB_CONCUR_61: assert property (@(posedge clk_i) ((id_stage_s1) && !id_stage_s1_hpn) |-> ((scb_0_s12 || scb_1_s12 || scb_2_s12 || scb_3_s12) && !scb_0_s12_hpn));
`endif
