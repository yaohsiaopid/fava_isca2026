...
`ifndef WHB
HB_1026: assert property (@(posedge clk_i) ((load_unit_s1) && !load_unit_s1_hpn) |-> !(scb_0_s8_hpn || (scb_0_s8 || scb_1_s8 || scb_2_s8 || scb_3_s8)));
`else
WHB_1026: assert property (@(posedge clk_i) ((load_unit_s1) && !load_unit_s1_hpn) |-> !scb_0_s8_hpn);
WHB_CONCUR_1026: assert property (@(posedge clk_i) ((load_unit_s1) && !load_unit_s1_hpn) |-> ((scb_0_s8 || scb_1_s8 || scb_2_s8 || scb_3_s8) && !scb_0_s8_hpn));
`endif
