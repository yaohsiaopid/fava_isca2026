...
`ifndef WHB
HB_1127: assert property (@(posedge clk_i) ((load_unit_buff_s1) && !load_unit_buff_s1_hpn) |-> !(load_unit_op_s1_hpn || (load_unit_op_s1)));
`else
WHB_1127: assert property (@(posedge clk_i) ((load_unit_buff_s1) && !load_unit_buff_s1_hpn) |-> !load_unit_op_s1_hpn);
WHB_CONCUR_1127: assert property (@(posedge clk_i) ((load_unit_buff_s1) && !load_unit_buff_s1_hpn) |-> ((load_unit_op_s1) && !load_unit_op_s1_hpn));
`endif
