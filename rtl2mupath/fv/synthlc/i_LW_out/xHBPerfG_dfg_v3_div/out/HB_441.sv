...
`ifndef WHB
HB_441: assert property (@(posedge clk_i) ((scb_0_s8 || scb_1_s8 || scb_2_s8 || scb_3_s8) && !scb_0_s8_hpn) |-> !(lsq_enq_0_s1_hpn || (lsq_enq_0_s1)));
`else
WHB_441: assert property (@(posedge clk_i) ((scb_0_s8 || scb_1_s8 || scb_2_s8 || scb_3_s8) && !scb_0_s8_hpn) |-> !lsq_enq_0_s1_hpn);
WHB_CONCUR_441: assert property (@(posedge clk_i) ((scb_0_s8 || scb_1_s8 || scb_2_s8 || scb_3_s8) && !scb_0_s8_hpn) |-> ((lsq_enq_0_s1) && !lsq_enq_0_s1_hpn));
`endif
