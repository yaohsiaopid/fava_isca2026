...
`ifndef WHB
HB_1207: assert property (@(posedge clk_i) ((load_unit_op_s1) && !load_unit_op_s1_hpn) |-> !(load_unit_s1_hpn || (load_unit_s1)));
`else
WHB_1207: assert property (@(posedge clk_i) ((load_unit_op_s1) && !load_unit_op_s1_hpn) |-> !load_unit_s1_hpn);
WHB_CONCUR_1207: assert property (@(posedge clk_i) ((load_unit_op_s1) && !load_unit_op_s1_hpn) |-> ((load_unit_s1) && !load_unit_s1_hpn));
`endif
