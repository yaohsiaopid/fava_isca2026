...
`ifndef WHB
HB_79: assert property (@(posedge clk_i) ((id_stage_s1) && !id_stage_s1_hpn) |-> !(load_unit_op_s2_hpn || (load_unit_op_s2)));
`else
WHB_79: assert property (@(posedge clk_i) ((id_stage_s1) && !id_stage_s1_hpn) |-> !load_unit_op_s2_hpn);
WHB_CONCUR_79: assert property (@(posedge clk_i) ((id_stage_s1) && !id_stage_s1_hpn) |-> ((load_unit_op_s2) && !load_unit_op_s2_hpn));
`endif
