...
`ifndef WHB
HB_386: assert property (@(posedge clk_i) ((scb_0_s13 || scb_1_s13 || scb_2_s13 || scb_3_s13) && !scb_0_s13_hpn) |-> !(load_unit_s1_hpn || (load_unit_s1)));
`else
WHB_386: assert property (@(posedge clk_i) ((scb_0_s13 || scb_1_s13 || scb_2_s13 || scb_3_s13) && !scb_0_s13_hpn) |-> !load_unit_s1_hpn);
WHB_CONCUR_386: assert property (@(posedge clk_i) ((scb_0_s13 || scb_1_s13 || scb_2_s13 || scb_3_s13) && !scb_0_s13_hpn) |-> ((load_unit_s1) && !load_unit_s1_hpn));
`endif
