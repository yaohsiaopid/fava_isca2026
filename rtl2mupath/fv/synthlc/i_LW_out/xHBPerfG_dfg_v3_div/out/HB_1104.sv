...
`ifndef WHB
HB_1104: assert property (@(posedge clk_i) ((load_unit_buff_s1) && !load_unit_buff_s1_hpn) |-> !(id_stage_s1_hpn || (id_stage_s1)));
`else
WHB_1104: assert property (@(posedge clk_i) ((load_unit_buff_s1) && !load_unit_buff_s1_hpn) |-> !id_stage_s1_hpn);
WHB_CONCUR_1104: assert property (@(posedge clk_i) ((load_unit_buff_s1) && !load_unit_buff_s1_hpn) |-> ((id_stage_s1) && !id_stage_s1_hpn));
`endif
