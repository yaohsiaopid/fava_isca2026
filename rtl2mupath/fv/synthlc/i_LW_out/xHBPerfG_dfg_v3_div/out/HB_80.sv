...
`ifndef WHB
HB_80: assert property (@(posedge clk_i) ((id_stage_s1) && !id_stage_s1_hpn) |-> !(load_unit_op_s3_hpn || (load_unit_op_s3)));
`else
WHB_80: assert property (@(posedge clk_i) ((id_stage_s1) && !id_stage_s1_hpn) |-> !load_unit_op_s3_hpn);
WHB_CONCUR_80: assert property (@(posedge clk_i) ((id_stage_s1) && !id_stage_s1_hpn) |-> ((load_unit_op_s3) && !load_unit_op_s3_hpn));
`endif
