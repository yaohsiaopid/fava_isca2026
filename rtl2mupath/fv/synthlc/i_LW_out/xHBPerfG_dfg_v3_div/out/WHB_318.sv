...
`ifndef WHB
HB_318: assert property (@(posedge clk_i) ((lsq_enq_1_s1) && !lsq_enq_1_s1_hpn) |-> !(load_unit_op_s3_hpn || (load_unit_op_s3)));
`else
WHB_318: assert property (@(posedge clk_i) ((lsq_enq_1_s1) && !lsq_enq_1_s1_hpn) |-> !load_unit_op_s3_hpn);
WHB_CONCUR_318: assert property (@(posedge clk_i) ((lsq_enq_1_s1) && !lsq_enq_1_s1_hpn) |-> ((load_unit_op_s3) && !load_unit_op_s3_hpn));
`endif
