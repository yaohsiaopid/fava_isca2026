...
`ifndef WHB
HB_312: assert property (@(posedge clk_i) ((lsq_enq_1_s1) && !lsq_enq_1_s1_hpn) |-> !(load_unit_s1_hpn || (load_unit_s1)));
`else
WHB_312: assert property (@(posedge clk_i) ((lsq_enq_1_s1) && !lsq_enq_1_s1_hpn) |-> !load_unit_s1_hpn);
WHB_CONCUR_312: assert property (@(posedge clk_i) ((lsq_enq_1_s1) && !lsq_enq_1_s1_hpn) |-> ((load_unit_s1) && !load_unit_s1_hpn));
`endif
