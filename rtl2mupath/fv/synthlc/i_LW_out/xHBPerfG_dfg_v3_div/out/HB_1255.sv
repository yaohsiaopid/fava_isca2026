...
`ifndef WHB
HB_1255: assert property (@(posedge clk_i) ((load_unit_op_s3) && !load_unit_op_s3_hpn) |-> !(load_unit_s1_hpn || (load_unit_s1)));
`else
WHB_1255: assert property (@(posedge clk_i) ((load_unit_op_s3) && !load_unit_op_s3_hpn) |-> !load_unit_s1_hpn);
WHB_CONCUR_1255: assert property (@(posedge clk_i) ((load_unit_op_s3) && !load_unit_op_s3_hpn) |-> ((load_unit_s1) && !load_unit_s1_hpn));
`endif
