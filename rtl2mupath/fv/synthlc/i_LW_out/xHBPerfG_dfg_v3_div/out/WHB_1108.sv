...
`ifndef WHB
HB_1108: assert property (@(posedge clk_i) ((load_unit_buff_s1) && !load_unit_buff_s1_hpn) |-> !(issue_s16_hpn || (issue_s16)));
`else
WHB_1108: assert property (@(posedge clk_i) ((load_unit_buff_s1) && !load_unit_buff_s1_hpn) |-> !issue_s16_hpn);
WHB_CONCUR_1108: assert property (@(posedge clk_i) ((load_unit_buff_s1) && !load_unit_buff_s1_hpn) |-> ((issue_s16) && !issue_s16_hpn));
`endif
