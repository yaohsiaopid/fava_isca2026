...
`ifndef WHB
HB_1267: assert property (@(posedge clk_i) ((load_unit_op_s2) && !load_unit_op_s2_hpn) |-> !(mem_req_s1_hpn || (mem_req_s1)));
`else
WHB_1267: assert property (@(posedge clk_i) ((load_unit_op_s2) && !load_unit_op_s2_hpn) |-> !mem_req_s1_hpn);
WHB_CONCUR_1267: assert property (@(posedge clk_i) ((load_unit_op_s2) && !load_unit_op_s2_hpn) |-> ((mem_req_s1) && !mem_req_s1_hpn));
`endif
