...
`ifndef WHB
HB_1189: assert property (@(posedge clk_i) ((load_unit_op_s1) && !load_unit_op_s1_hpn) |-> !(scb_0_s12_hpn || (scb_0_s12 || scb_1_s12 || scb_2_s12 || scb_3_s12)));
`else
WHB_1189: assert property (@(posedge clk_i) ((load_unit_op_s1) && !load_unit_op_s1_hpn) |-> !scb_0_s12_hpn);
WHB_CONCUR_1189: assert property (@(posedge clk_i) ((load_unit_op_s1) && !load_unit_op_s1_hpn) |-> ((scb_0_s12 || scb_1_s12 || scb_2_s12 || scb_3_s12) && !scb_0_s12_hpn));
`endif
