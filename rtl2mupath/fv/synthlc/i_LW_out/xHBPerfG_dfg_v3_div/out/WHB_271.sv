...
`ifndef WHB
HB_271: assert property (@(posedge clk_i) ((lsq_enq_0_s1) && !lsq_enq_0_s1_hpn) |-> !(scb_0_s8_hpn || (scb_0_s8 || scb_1_s8 || scb_2_s8 || scb_3_s8)));
`else
WHB_271: assert property (@(posedge clk_i) ((lsq_enq_0_s1) && !lsq_enq_0_s1_hpn) |-> !scb_0_s8_hpn);
WHB_CONCUR_271: assert property (@(posedge clk_i) ((lsq_enq_0_s1) && !lsq_enq_0_s1_hpn) |-> ((scb_0_s8 || scb_1_s8 || scb_2_s8 || scb_3_s8) && !scb_0_s8_hpn));
`endif
