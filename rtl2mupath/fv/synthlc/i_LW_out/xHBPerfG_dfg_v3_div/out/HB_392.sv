...
`ifndef WHB
HB_392: assert property (@(posedge clk_i) ((scb_0_s13 || scb_1_s13 || scb_2_s13 || scb_3_s13) && !scb_0_s13_hpn) |-> !(load_unit_op_s2_hpn || (load_unit_op_s2)));
`else
WHB_392: assert property (@(posedge clk_i) ((scb_0_s13 || scb_1_s13 || scb_2_s13 || scb_3_s13) && !scb_0_s13_hpn) |-> !load_unit_op_s2_hpn);
WHB_CONCUR_392: assert property (@(posedge clk_i) ((scb_0_s13 || scb_1_s13 || scb_2_s13 || scb_3_s13) && !scb_0_s13_hpn) |-> ((load_unit_op_s2) && !load_unit_op_s2_hpn));
`endif
