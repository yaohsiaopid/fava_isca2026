...
`ifndef WHB
HB_317: assert property (@(posedge clk_i) ((lsq_enq_1_s1) && !lsq_enq_1_s1_hpn) |-> !(load_unit_op_s2_hpn || (load_unit_op_s2)));
`else
WHB_317: assert property (@(posedge clk_i) ((lsq_enq_1_s1) && !lsq_enq_1_s1_hpn) |-> !load_unit_op_s2_hpn);
WHB_CONCUR_317: assert property (@(posedge clk_i) ((lsq_enq_1_s1) && !lsq_enq_1_s1_hpn) |-> ((load_unit_op_s2) && !load_unit_op_s2_hpn));
`endif
