...
`ifndef WHB
HB_1258: assert property (@(posedge clk_i) ((load_unit_op_s3) && !load_unit_op_s3_hpn) |-> !(load_unit_op_s2_hpn || (load_unit_op_s2)));
`else
WHB_1258: assert property (@(posedge clk_i) ((load_unit_op_s3) && !load_unit_op_s3_hpn) |-> !load_unit_op_s2_hpn);
WHB_CONCUR_1258: assert property (@(posedge clk_i) ((load_unit_op_s3) && !load_unit_op_s3_hpn) |-> ((load_unit_op_s2) && !load_unit_op_s2_hpn));
`endif
