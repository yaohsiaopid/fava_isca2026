...
`ifndef WHB
HB_1211: assert property (@(posedge clk_i) ((load_unit_op_s2) && !load_unit_op_s2_hpn) |-> !(lsq_enq_0_s1_hpn || (lsq_enq_0_s1)));
`else
WHB_1211: assert property (@(posedge clk_i) ((load_unit_op_s2) && !load_unit_op_s2_hpn) |-> !lsq_enq_0_s1_hpn);
WHB_CONCUR_1211: assert property (@(posedge clk_i) ((load_unit_op_s2) && !load_unit_op_s2_hpn) |-> ((lsq_enq_0_s1) && !lsq_enq_0_s1_hpn));
`endif
