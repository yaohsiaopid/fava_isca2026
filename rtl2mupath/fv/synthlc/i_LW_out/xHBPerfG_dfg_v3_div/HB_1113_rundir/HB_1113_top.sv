...
`ifndef WHB
HB_1113: assert property (@(posedge clk_i) ((load_unit_buff_s1) && !load_unit_buff_s1_hpn) |-> !(scb_0_s8_hpn || (scb_0_s8 || scb_1_s8 || scb_2_s8 || scb_3_s8)));
`else
WHB_1113: assert property (@(posedge clk_i) ((load_unit_buff_s1) && !load_unit_buff_s1_hpn) |-> !scb_0_s8_hpn);
WHB_CONCUR_1113: assert property (@(posedge clk_i) ((load_unit_buff_s1) && !load_unit_buff_s1_hpn) |-> ((scb_0_s8 || scb_1_s8 || scb_2_s8 || scb_3_s8) && !scb_0_s8_hpn));
`endif
