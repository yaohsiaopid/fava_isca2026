...
`ifndef WHB
HB_1039: assert property (@(posedge clk_i) ((load_unit_s1) && !load_unit_s1_hpn) |-> !(load_unit_buff_s1_hpn || (load_unit_buff_s1)));
`else
WHB_1039: assert property (@(posedge clk_i) ((load_unit_s1) && !load_unit_s1_hpn) |-> !load_unit_buff_s1_hpn);
WHB_CONCUR_1039: assert property (@(posedge clk_i) ((load_unit_s1) && !load_unit_s1_hpn) |-> ((load_unit_buff_s1) && !load_unit_buff_s1_hpn));
`endif
