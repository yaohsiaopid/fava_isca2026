...
reg stb_com_1_s1_hpn;
always @(posedge clk_i) begin
    if (!rst_ni)
        stb_com_1_s1_hpn <= 1'b0;
    else if (stb_com_1_s1)
        stb_com_1_s1_hpn <= 1'b1;
end
...
reg stb_spec_1_s1_hpn;
always @(posedge clk_i) begin
    if (!rst_ni)
        stb_spec_1_s1_hpn <= 1'b0;
    else if (stb_spec_1_s1)
        stb_spec_1_s1_hpn <= 1'b1;
end
