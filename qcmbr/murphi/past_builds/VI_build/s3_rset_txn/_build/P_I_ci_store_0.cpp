/******************************
  Program "past_builds/VI_build/s3_rset_txn/out/P_I_ci_store_0.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_build/s3_rset_txn/out/P_I_ci_store_0"
...
mu_0_boolean mu_tracked("tracked",0);

/*** Variable declaration ***/
mu_0_boolean mu_start("start",8);

/*** Variable declaration ***/
mu_1__type_2 mu_cur_idx("cur_idx",16);

/*** Variable declaration ***/
mu_1__type_3 mu_tar("tar",24);
...
/*** Variable declaration ***/
mu_1__type_4 mu_Procs("Procs",96);
...
/*** Variable declaration ***/
mu_1__type_5 mu_ackBus("ackBus",192);

/*** Variable declaration ***/
mu_1__type_6 mu_msgBuf("msgBuf",224);

/*** Variable declaration ***/
mu_0_boolean mu_msgBufNonEmpty("msgBufNonEmpty",352);

/*** Variable declaration ***/
mu_1__type_7 mu_curRequsts("curRequsts",360);
...
{
bool mu__boolexpr9;
  if (!((mu_cur_idx) < (2))) mu__boolexpr9 = FALSE ;
  else {
  mu__boolexpr9 = ((mu_cur_state) == (mu_tar[mu_cur_idx])) ; 
}
if ( mu__boolexpr9 )
{
...
bool mu__boolexpr14;
bool mu__boolexpr15;
  if (!(!(mu_tracked))) mu__boolexpr15 = FALSE ;
  else {
  mu__boolexpr15 = (!(mu_prevProcs.isundefined())) ; 
}
  if (!(mu__boolexpr15)) mu__boolexpr14 = FALSE ;
  else {
  mu__boolexpr14 = ((mu_prevProcs) == (mu_P_I)) ; 
}
  if (!(mu__boolexpr14)) mu__boolexpr13 = FALSE ;
  else {
  mu__boolexpr13 = (!(mu_prevProcReq.mu_tp.isundefined())) ; 
}
  if (!(mu__boolexpr13)) mu__boolexpr12 = FALSE ;
  else {
  mu__boolexpr12 = ((mu_prevProcReq.mu_tp) == (mu_ci_store)) ; 
}
...
bool mu__boolexpr18;
bool mu__boolexpr19;
  if (!(!(mu_tracked))) mu__boolexpr19 = FALSE ;
  else {
  mu__boolexpr19 = (!(mu_prevProcs.isundefined())) ; 
}
  if (!(mu__boolexpr19)) mu__boolexpr18 = FALSE ;
  else {
  mu__boolexpr18 = ((mu_prevProcs) == (mu_P_I)) ; 
}
  if (!(mu__boolexpr18)) mu__boolexpr17 = FALSE ;
  else {
  mu__boolexpr17 = (!(mu_prevProcReq.mu_tp.isundefined())) ; 
}
  if (!(mu__boolexpr17)) mu__boolexpr16 = FALSE ;
  else {
  mu__boolexpr16 = ((mu_prevProcReq.mu_tp) == (mu_ci_store)) ; 
}
	      if (mu__boolexpr16) {
		if ( ( TRUE  ) )
		  return;
...
for(int mu_n = 1; mu_n <= 6; mu_n++)
  if (( ( mu_n >= 1 ) && ( mu_n <= 3 ) )|| ( ( mu_n >= 6 ) && ( mu_n <= 6 ) )) {
bool mu__boolexpr20;
  if (!(mu_allAck)) mu__boolexpr20 = FALSE ;
  else {
  mu__boolexpr20 = (mu_ackBus[mu_n]) ; 
}
mu_allAck = mu__boolexpr20;
};
};
if ( mu_allAck )
{
...
bool mu__boolexpr25;
bool mu__boolexpr26;
  if (!((mu_p.mu_state) == (mu_P_V))) mu__boolexpr26 = FALSE ;
  else {
...
/********************
  Invariant records
 ********************/
int mu__invariant_35() // Invariant "P_I_ci_store_rset_0"
{
bool mu__boolexpr36;
bool mu__boolexpr37;
  if (!(mu_tracked)) mu__boolexpr37 = FALSE ;
  else {
  mu__boolexpr37 = (!(mu_start)) ; 
}
  if (!(mu__boolexpr37)) mu__boolexpr36 = TRUE ;
  else {
  mu__boolexpr36 = ((mu_cur_idx) != (2)) ; 
}
return mu__boolexpr36;
};

bool mu__condition_38() // Condition for Rule "P_I_ci_store_rset_0"
{
...
{"P_I_ci_store_rset_0", &mu__condition_38, NULL, },
};
