/******************************
  Program "build/s1_msg_per_transition_iter/out/P_I_P_IVD_rec_1.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "build/s1_msg_per_transition_iter/out/P_I_P_IVD_rec_1"
...
bool mu__boolexpr32;
bool mu__boolexpr33;
  if (!((mu_msg_imm_rec_set[mu_GetMsg]) == (mu_false))) mu__boolexpr33 = FALSE ;
  else {
  mu__boolexpr33 = ((mu_msg_imm_rec_set[mu_PutMsg]) == (mu_false)) ; 
}
  if (!(mu__boolexpr33)) mu__boolexpr32 = FALSE ;
  else {
  mu__boolexpr32 = ((mu_msg_imm_rec_set[mu_DataRespMsg]) == (mu_false)) ; 
}
  if (mu__boolexpr32) mu__boolexpr31 = TRUE ;
  else {
bool mu__boolexpr34;
bool mu__boolexpr35;
  if (!((mu_msg_imm_rec_set[mu_GetMsg]) == (mu_true))) mu__boolexpr35 = FALSE ;
  else {
  mu__boolexpr35 = ((mu_msg_imm_rec_set[mu_PutMsg]) == (mu_false)) ; 
}
  if (!(mu__boolexpr35)) mu__boolexpr34 = FALSE ;
  else {
  mu__boolexpr34 = ((mu_msg_imm_rec_set[mu_DataRespMsg]) == (mu_true)) ; 
}
...
bool mu__condition_36() // Condition for Rule "P_I_to_P_IVD"
{
...
{"P_I_to_P_IVD", &mu__condition_36, NULL, },
};
