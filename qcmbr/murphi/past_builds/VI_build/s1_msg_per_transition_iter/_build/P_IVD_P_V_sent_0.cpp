/******************************
  Program "build/s1_msg_per_transition_iter/out/P_IVD_P_V_sent_0.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "build/s1_msg_per_transition_iter/out/P_IVD_P_V_sent_0"
...
/********************
  Invariant records
 ********************/
int mu__invariant_27() // Invariant "P_IVD_to_P_V"
{
bool mu__boolexpr28;
bool mu__boolexpr29;
bool mu__boolexpr30;
  ...
  mu__boolexpr30 = ((mu_prevProcs) == (mu_P_IVD)) ; 
}
  if (!(mu__boolexpr30)) mu__boolexpr29 = FALSE ;
  else {
  mu__boolexpr29 = ((mu_Procs[mu_selc].mu_state) == (mu_P_V)) ; 
}
  if (!(mu__boolexpr29)) mu__boolexpr28 = TRUE ;
  else {
bool mu__boolexpr31;
bool mu__boolexpr32;
  if (!((mu_msg_imm_sent_set[mu_GetMsg]) == (mu_false))) mu__boolexpr32 = FALSE ;
  else {
  mu__boolexpr32 = ((mu_msg_imm_sent_set[mu_PutMsg]) == (mu_false)) ; 
}
  if (!(mu__boolexpr32)) mu__boolexpr31 = FALSE ;
  else {
  mu__boolexpr31 = ((mu_msg_imm_sent_set[mu_DataRespMsg]) == (mu_false)) ; 
}
...
bool mu__condition_33() // Condition for Rule "P_IVD_to_P_V"
{
...
{"P_IVD_to_P_V", &mu__condition_33, NULL, },
};
