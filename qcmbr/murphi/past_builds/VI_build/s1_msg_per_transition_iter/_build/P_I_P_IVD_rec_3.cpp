/******************************
  Program "build/s1_msg_per_transition_iter/out/P_I_P_IVD_rec_3.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "build/s1_msg_per_transition_iter/out/P_I_P_IVD_rec_3"
...
bool mu__condition_42() // Condition for Rule "P_I_to_P_IVD"
{
...
int mu__invariant_43() // Invariant "swmr"
{
bool mu__quant44; 
mu__quant44 = TRUE;
{
...
bool mu__boolexpr46;
bool mu__boolexpr47;
  if (!((mu_c1) != (mu_c2))) mu__boolexpr47 = FALSE ;
  else {
  mu__boolexpr47 = ((mu_Procs[mu_c1].mu_state) == (mu_P_V)) ; 
}
  if (!(mu__boolexpr47)) mu__boolexpr46 = TRUE ;
  else {
  mu__boolexpr46 = ((mu_Procs[mu_c2].mu_state) != (mu_P_V)) ; 
}
if ( !(mu__boolexpr46) )
...
bool mu__condition_48() // Condition for Rule "swmr"
{
...
for(int mu_n = 1; mu_n <= 3; mu_n++) {
bool mu__boolexpr51;
  if (!((mu_Procs[mu_n].mu_state) == (mu_P_V))) mu__boolexpr51 = TRUE ;
  else {
...
bool mu__boolexpr54;
  ...
  mu__boolexpr54 = ((mu_MainMemory) == (mu_LastWrite)) ; 
}
...
int mu__invariant_56() // Invariant "Invalid implies empty owner"
{
bool mu__boolexpr57;
...
bool mu__condition_59() // Condition for Rule "Invalid implies empty owner"
{
...
{"Invalid implies empty owner", &mu__condition_59, NULL, },
{"value in memory matches value of last write, when invalid", &mu__condition_55, NULL, },
{"values in valid state match last write", &mu__condition_52, NULL, },
{"swmr", &mu__condition_48, NULL, },
{"P_I_to_P_IVD", &mu__condition_42, NULL, },
};
