/******************************
  Program "build/s1_msg_per_transition_iter/out/P_IVD_P_V_rec_0.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "build/s1_msg_per_transition_iter/out/P_IVD_P_V_rec_0"
...
bool mu__boolexpr31;
bool mu__boolexpr32;
  if (!((mu_msg_imm_rec_set[mu_GetMsg]) == (mu_true))) mu__boolexpr32 = FALSE ;
  else {
  mu__boolexpr32 = ((mu_msg_imm_rec_set[mu_PutMsg]) == (mu_false)) ; 
}
  if (!(mu__boolexpr32)) mu__boolexpr31 = FALSE ;
  else {
  mu__boolexpr31 = ((mu_msg_imm_rec_set[mu_DataRespMsg]) == (mu_true)) ; 
}
