/******************************
  Program "build/s1_msg_per_transition_iter/out/P_I_P_IVD_rec_4.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "build/s1_msg_per_transition_iter/out/P_I_P_IVD_rec_4"
...
bool mu__boolexpr35;
bool mu__boolexpr36;
  if (!((mu_msg_imm_rec_set[mu_GetMsg]) == (mu_false))) mu__boolexpr36 = FALSE ;
  else {
  mu__boolexpr36 = ((mu_msg_imm_rec_set[mu_PutMsg]) == (mu_false)) ; 
}
  if (!(mu__boolexpr36)) mu__boolexpr35 = FALSE ;
  else {
  mu__boolexpr35 = ((mu_msg_imm_rec_set[mu_DataRespMsg]) == (mu_false)) ; 
}
  if (mu__boolexpr35) mu__boolexpr34 = TRUE ;
  else {
bool mu__boolexpr37;
bool mu__boolexpr38;
  if (!((mu_msg_imm_rec_set[mu_GetMsg]) == (mu_true))) mu__boolexpr38 = FALSE ;
  else {
  mu__boolexpr38 = ((mu_msg_imm_rec_set[mu_PutMsg]) == (mu_false)) ; 
}
  if (!(mu__boolexpr38)) mu__boolexpr37 = FALSE ;
  else {
  mu__boolexpr37 = ((mu_msg_imm_rec_set[mu_DataRespMsg]) == (mu_true)) ; 
}
  mu__boolexpr34 = (mu__boolexpr37) ; 
}
  if (mu__boolexpr34) mu__boolexpr33 = TRUE ;
  else {
bool mu__boolexpr39;
bool mu__boolexpr40;
  if (!((mu_msg_imm_rec_set[mu_GetMsg]) == (mu_false))) mu__boolexpr40 = FALSE ;
  else {
  mu__boolexpr40 = ((mu_msg_imm_rec_set[mu_PutMsg]) == (mu_true)) ; 
}
  if (!(mu__boolexpr40)) mu__boolexpr39 = FALSE ;
  else {
  mu__boolexpr39 = ((mu_msg_imm_rec_set[mu_DataRespMsg]) == (mu_false)) ; 
}
  mu__boolexpr33 = (mu__boolexpr39) ; 
}
  if (mu__boolexpr33) mu__boolexpr32 = TRUE ;
  else {
bool mu__boolexpr41;
bool mu__boolexpr42;
  if (!((mu_msg_imm_rec_set[mu_GetMsg]) == (mu_true))) mu__boolexpr42 = FALSE ;
  else {
  mu__boolexpr42 = ((mu_msg_imm_rec_set[mu_PutMsg]) == (mu_true)) ; 
}
  if (!(mu__boolexpr42)) mu__boolexpr41 = FALSE ;
  else {
  mu__boolexpr41 = ((mu_msg_imm_rec_set[mu_DataRespMsg]) == (mu_true)) ; 
}
  mu__boolexpr32 = (mu__boolexpr41) ; 
}
  if (mu__boolexpr32) mu__boolexpr31 = TRUE ;
  else {
bool mu__boolexpr43;
bool mu__boolexpr44;
  if (!((mu_msg_imm_rec_set[mu_GetMsg]) == (mu_false))) mu__boolexpr44 = FALSE ;
  else {
  mu__boolexpr44 = ((mu_msg_imm_rec_set[mu_PutMsg]) == (mu_false)) ; 
}
  if (!(mu__boolexpr44)) mu__boolexpr43 = FALSE ;
  else {
  mu__boolexpr43 = ((mu_msg_imm_rec_set[mu_DataRespMsg]) == (mu_true)) ; 
}
  mu__boolexpr31 = (mu__boolexpr43) ; 
}
...
bool mu__condition_45() // Condition for Rule "P_I_to_P_IVD"
{
...
{"P_I_to_P_IVD", &mu__condition_45, NULL, },
};
