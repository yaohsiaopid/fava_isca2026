/******************************
  Program "past_builds/VI_build/s2_3_req_proc_val/out/P_V_ci_store_val_req.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_build/s2_3_req_proc_val/out/P_V_ci_store_val_req"
...
/********************
  Invariant records
 ********************/
int mu__invariant_23() // Invariant "P_V_accept_and_perform_as_specified_ci_store"
{
bool mu__boolexpr24;
bool mu__boolexpr25;
bool mu__boolexpr26;
bool mu__boolexpr27;
  ...
  mu__boolexpr25 = ((mu_prevProcReq.mu_tp) == (mu_ci_store)) ; 
}
  if (!(mu__boolexpr25)) mu__boolexpr24 = TRUE ;
  else {
  mu__boolexpr24 = ((mu_Procs[mu_selc].mu_val) == (mu_prevProcReq.mu_cl)) ; 
}
return mu__boolexpr24;
};

bool mu__condition_28() // Condition for Rule "P_V_accept_and_perform_as_specified_ci_store"
{
...
{"P_V_accept_and_perform_as_specified_ci_store", &mu__condition_28, NULL, },
};
