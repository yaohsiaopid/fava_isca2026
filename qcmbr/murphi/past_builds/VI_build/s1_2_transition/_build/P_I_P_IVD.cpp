/******************************
  Program "build/s1_2_transition/out/P_I_P_IVD.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "build/s1_2_transition/out/P_I_P_IVD"
...
/********************
  Invariant records
 ********************/
int mu__invariant_23() // Invariant "P_I_to_P_IVD"
{
bool mu__boolexpr24;
bool mu__boolexpr25;
  ...
  mu__boolexpr24 = (!((mu_Procs[mu_selc].mu_state) == (mu_P_IVD))) ; 
}
return mu__boolexpr24;
};

bool mu__condition_26() // Condition for Rule "P_I_to_P_IVD"
{
...
{"P_I_to_P_IVD", &mu__condition_26, NULL, },
};
