/******************************
  Program "build/s1_2_transition/out/P_IVD_P_V.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "build/s1_2_transition/out/P_IVD_P_V"
...
/********************
  Invariant records
 ********************/
int mu__invariant_23() // Invariant "P_IVD_to_P_V"
{
bool mu__boolexpr24;
bool mu__boolexpr25;
  if (!(!(mu_prevProcs.isundefined()))) mu__boolexpr25 = FALSE ;
  else {
  mu__boolexpr25 = ((mu_prevProcs) == (mu_P_IVD)) ; 
}
  if (!(mu__boolexpr25)) mu__boolexpr24 = TRUE ;
  else {
  mu__boolexpr24 = (!((mu_Procs[mu_selc].mu_state) == (mu_P_V))) ; 
}
return mu__boolexpr24;
};

bool mu__condition_26() // Condition for Rule "P_IVD_to_P_V"
{
...
{"P_IVD_to_P_V", &mu__condition_26, NULL, },
};
