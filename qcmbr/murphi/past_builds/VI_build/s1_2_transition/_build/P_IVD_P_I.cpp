/******************************
  Program "build/s1_2_transition/out/P_IVD_P_I.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "build/s1_2_transition/out/P_IVD_P_I"
...
/********************
  Invariant records
 ********************/
int mu__invariant_23() // Invariant "P_IVD_to_P_I"
{
bool mu__boolexpr24;
bool mu__boolexpr25;
  ...
  mu__boolexpr24 = (!((mu_Procs[mu_selc].mu_state) == (mu_P_I))) ; 
}
return mu__boolexpr24;
};

bool mu__condition_26() // Condition for Rule "P_IVD_to_P_I"
{
...
{"P_IVD_to_P_I", &mu__condition_26, NULL, },
};
