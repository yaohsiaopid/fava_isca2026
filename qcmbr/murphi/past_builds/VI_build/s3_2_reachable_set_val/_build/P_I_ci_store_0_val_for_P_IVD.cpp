/******************************
  Program "past_builds/VI_build/s3_2_reachable_set_val/out/P_I_ci_store_0_val_for_P_IVD.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_build/s3_2_reachable_set_val/out/P_I_ci_store_0_val_for_P_IVD"
#define BITS_IN_WORLD 448
#define ALIGN
...
/*** Variable declaration ***/
mu_0_boolean mu_val_chk("val_chk",88);

/*** Variable declaration ***/
mu_1_HomeState mu_HomeNode("HomeNode",96);

/*** Variable declaration ***/
mu_1__type_4 mu_Procs("Procs",112);

/*** Variable declaration ***/
mu_1_Value mu_LastWrite("LastWrite",160);

/*** Variable declaration ***/
mu_1_Value mu_MainMemory("MainMemory",168);

/*** Variable declaration ***/
mu_1_Message mu_gBuf("gBuf",176);

/*** Variable declaration ***/
mu_1__type_5 mu_ackBus("ackBus",208);

/*** Variable declaration ***/
mu_1__type_6 mu_msgBuf("msgBuf",240);

/*** Variable declaration ***/
mu_0_boolean mu_msgBufNonEmpty("msgBufNonEmpty",368);

/*** Variable declaration ***/
mu_1__type_7 mu_curRequsts("curRequsts",376);
...
{
bool mu__boolexpr9;
  if (!((mu_Procs[mu_selc].mu_state) == (mu_P_IVD))) mu__boolexpr9 = FALSE ;
  else {
  mu__boolexpr9 = ((mu_prevStateVal) != (mu_Procs[mu_selc].mu_val)) ; 
}
if ( mu__boolexpr9 )
{
mu_val_chk = mu_true;
