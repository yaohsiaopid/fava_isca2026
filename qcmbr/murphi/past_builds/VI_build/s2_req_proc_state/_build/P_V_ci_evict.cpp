/******************************
  Program "build/s2_req_proc_state/out/P_V_ci_evict.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "build/s2_req_proc_state/out/P_V_ci_evict"
...
/********************
  Invariant records
 ********************/
int mu__invariant_23() // Invariant "P_V_accept_and_perform_ci_evict"
{
bool mu__boolexpr24;
bool mu__boolexpr25;
bool mu__boolexpr26;
bool mu__boolexpr27;
  ...
  mu__boolexpr25 = ((mu_prevProcReq_2.mu_tp) == (mu_ci_evict)) ; 
}
...
bool mu__boolexpr28;
  ...
  mu__boolexpr28 = ((mu_prevProcReq.mu_tp) != (mu_ci_evict)) ; 
}
...
bool mu__condition_29() // Condition for Rule "P_V_accept_and_perform_ci_evict"
{
...
{"P_V_accept_and_perform_ci_evict", &mu__condition_29, NULL, },
};
