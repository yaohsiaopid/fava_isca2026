/******************************
  Program "past_builds/VI_build/s1_gmsg_cnt/out/home_DataRespMsg_cnt.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_build/s1_gmsg_cnt/out/home_DataRespMsg_cnt"
...
/*** Variable declaration ***/
mu_1__type_2 mu_cnt("cnt",24);

/*** Variable declaration ***/
mu_1_HomeState mu_HomeNode("HomeNode",32);

/*** Variable declaration ***/
mu_1__type_3 mu_Procs("Procs",48);
...
/*** Variable declaration ***/
mu_1__type_4 mu_ackBus("ackBus",144);

/*** Variable declaration ***/
mu_1__type_5 mu_msgBuf("msgBuf",176);

/*** Variable declaration ***/
mu_0_boolean mu_msgBufNonEmpty("msgBufNonEmpty",304);

/*** Variable declaration ***/
mu_1__type_6 mu_curRequsts("curRequsts",312);

void mu_book_keep(const mu_1_Node& mu_m)
{
bool mu__boolexpr7;
  if (!(!(mu_prevHomeNode.isundefined()))) mu__boolexpr7 = FALSE ;
  else {
  mu__boolexpr7 = ((mu_prevHomeNode) != (mu_HomeNode.mu_state)) ; 
}
if ( mu__boolexpr7 )
{
mu_cnt = 0;
...
bool mu__boolexpr12;
bool mu__boolexpr13;
  if (!(!(mu_curRequsts[mu_p].mu_vld.isundefined()))) mu__boolexpr13 = FALSE ;
  else {
  mu__boolexpr13 = (mu_curRequsts[mu_p].mu_vld) ; 
}
  if (!(mu__boolexpr13)) mu__boolexpr12 = FALSE ;
  else {
  mu__boolexpr12 = ((mu_curRequsts[mu_p].mu_tp) == (mu_store)) ; 
}
if ( mu__boolexpr12 )
{
...
/********************
  Invariant records
 ********************/
int mu__invariant_29() // Invariant "home_sent_DataRespMsg_cnt"
{
return (mu_cnt) <= (1);
};

bool mu__condition_30() // Condition for Rule "home_sent_DataRespMsg_cnt"
{
...
{"home_sent_DataRespMsg_cnt", &mu__condition_30, NULL, },
};
