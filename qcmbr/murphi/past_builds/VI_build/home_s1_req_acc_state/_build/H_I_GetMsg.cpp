/******************************
  Program "past_builds/VI_build/home_s1_req_acc_state/out/H_I_GetMsg.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_build/home_s1_req_acc_state/out/H_I_GetMsg"
...
/*** Variable declaration ***/
mu_1_MessageType mu_prevSentMsg("prevSentMsg",24);

/*** Variable declaration ***/
mu_1_Node mu_prevMsgDst("prevMsgDst",32);

/*** Variable declaration ***/
mu_1_Node mu_prevMsgSrc("prevMsgSrc",40);

/*** Variable declaration ***/
mu_1_MessageType mu_prevMsg("prevMsg",48);
...
bool mu__boolexpr6;
  ...
  mu__boolexpr6 = ((mu_cur_node) == (mu_selh)) ; 
}
if ( mu__boolexpr6 )
{
...
/********************
  Invariant records
 ********************/
int mu__invariant_27() // Invariant "H_I_consistent_w_GetMsg"
{
bool mu__boolexpr28;
bool mu__boolexpr29;
bool mu__boolexpr30;
bool mu__boolexpr31;
  if (!(!(mu_prevHomeNode.isundefined()))) mu__boolexpr31 = FALSE ;
  else {
  mu__boolexpr31 = ((mu_prevHomeNode) == (mu_H_I)) ; 
}
  if (!(mu__boolexpr31)) mu__boolexpr30 = FALSE ;
  else {
  mu__boolexpr30 = (!(mu_prevMsg.isundefined())) ; 
}
  if (!(mu__boolexpr30)) mu__boolexpr29 = FALSE ;
  else {
  mu__boolexpr29 = ((mu_prevMsg) == (mu_GetMsg)) ; 
}
  if (!(mu__boolexpr29)) mu__boolexpr28 = TRUE ;
  else {
bool mu__boolexpr32;
bool mu__boolexpr33;
  if ((mu_prevHomeNode) != (mu_HomeNode.mu_state)) mu__boolexpr33 = TRUE ;
  else {
bool mu__boolexpr34;
  if (!(!(mu_prevMsgDst.isundefined()))) mu__boolexpr34 = FALSE ;
  else {
  mu__boolexpr34 = ((mu_prevMsgDst) == (mu_selh)) ; 
}
  mu__boolexpr33 = (mu__boolexpr34) ; 
}
  if (mu__boolexpr33) mu__boolexpr32 = TRUE ;
  else {
  mu__boolexpr32 = (!(mu_prevSentMsg.isundefined())) ; 
}
...
bool mu__condition_35() // Condition for Rule "H_I_consistent_w_GetMsg"
{
...
{"H_I_consistent_w_GetMsg", &mu__condition_35, NULL, },
};
