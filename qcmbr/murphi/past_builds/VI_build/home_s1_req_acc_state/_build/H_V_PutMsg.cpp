/******************************
  Program "past_builds/VI_build/home_s1_req_acc_state/out/H_V_PutMsg.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_build/home_s1_req_acc_state/out/H_V_PutMsg"
...
/********************
  Invariant records
 ********************/
int mu__invariant_27() // Invariant "H_V_consistent_w_PutMsg"
{
bool mu__boolexpr28;
bool mu__boolexpr29;
bool mu__boolexpr30;
bool mu__boolexpr31;
  ...
  mu__boolexpr31 = ((mu_prevHomeNode) == (mu_H_V)) ; 
}
  ...
  mu__boolexpr29 = ((mu_prevMsg) == (mu_PutMsg)) ; 
}
...
bool mu__condition_35() // Condition for Rule "H_V_consistent_w_PutMsg"
{
...
{"H_V_consistent_w_PutMsg", &mu__condition_35, NULL, },
};
