/******************************
  Program "past_builds/VI_build/s4_3_v2_src_dst/out/P_I_ci_store_0_trace_0_0_1.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_build/s4_3_v2_src_dst/out/P_I_ci_store_0_trace_0_0_1"
...
bool mu__boolexpr24;
  ...
  mu__boolexpr21 = ((mu_prevProcReq.mu_tp) == (mu_ci_store)) ; 
}
...
bool mu__boolexpr38;
  ...
  mu__boolexpr38 = ((mu_gBuf.mu_src>=6 && mu_gBuf.mu_src<=6)) ; 
}
...
bool mu__boolexpr48;
  ...
  mu__boolexpr48 = ((mu_gBuf.mu_src>=6 && mu_gBuf.mu_src<=6)) ; 
}
...
/********************
  Invariant records
 ********************/
int mu__invariant_64() // Invariant "P_I_ci_store_rset_0"
{
bool mu__boolexpr65;
bool mu__boolexpr66;
bool mu__boolexpr67;
...
bool mu__condition_79() // Condition for Rule "P_I_ci_store_rset_0"
{
...
{"P_I_ci_store_rset_0", &mu__condition_79, NULL, },
};
