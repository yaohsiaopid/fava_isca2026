/******************************
  Program "build/home_s2_msg_out/out/H_I_GetMsg_H_V_val_inmsg.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "build/home_s2_msg_out/out/H_I_GetMsg_H_V_val_inmsg"
...
bool mu__boolexpr30;
  ...
  mu__boolexpr27 = ((mu_HomeNode.mu_state) == (mu_H_V)) ; 
}
  if (!(mu__boolexpr27)) mu__boolexpr26 = TRUE ;
  else {
  mu__boolexpr26 = ((mu_HomeNode.mu_val) == (mu_prevRecProcMsgVal)) ; 
}
return mu__boolexpr26;
};

bool mu__condition_31() // Condition for Rule "H_I_accept_req_GetMsg"
{
...
{"H_I_accept_req_GetMsg", &mu__condition_31, NULL, },
};
