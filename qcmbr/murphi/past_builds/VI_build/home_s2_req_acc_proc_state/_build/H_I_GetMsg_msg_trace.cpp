/******************************
  Program "build/home_s2_req_acc_proc_state/out/H_I_GetMsg_msg_trace.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "build/home_s2_req_acc_proc_state/out/H_I_GetMsg_msg_trace"
...
/********************
  Invariant records
 ********************/
int mu__invariant_28() // Invariant "H_I_consistent_w_GetMsg"
{
bool mu__boolexpr29;
bool mu__boolexpr30;
  if (!(!(mu_prevHomeNode.isundefined()))) mu__boolexpr30 = FALSE ;
  else {
  mu__boolexpr30 = ((mu_prevHomeNode) == (mu_H_I)) ; 
}
...
bool mu__boolexpr31;
  ...
  mu__boolexpr31 = ((mu_prevRecProcMsg) != (mu_GetMsg)) ; 
}
...
bool mu__condition_32() // Condition for Rule "H_I_consistent_w_GetMsg"
{
...
{"H_I_consistent_w_GetMsg", &mu__condition_32, NULL, },
};
