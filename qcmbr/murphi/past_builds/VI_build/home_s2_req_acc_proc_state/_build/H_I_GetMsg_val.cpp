/******************************
  Program "build/home_s2_req_acc_proc_state/out/H_I_GetMsg_val.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "build/home_s2_req_acc_proc_state/out/H_I_GetMsg_val"
...
/********************
  Invariant records
 ********************/
int mu__invariant_25() // Invariant "H_I_accept_req_GetMsg"
{
bool mu__boolexpr26;
bool mu__boolexpr27;
bool mu__boolexpr28;
bool mu__boolexpr29;
  ...
  mu__boolexpr27 = ((mu_prevRecProcMsg) == (mu_GetMsg)) ; 
}
...
bool mu__condition_30() // Condition for Rule "H_I_accept_req_GetMsg"
{
...
{"H_I_accept_req_GetMsg", &mu__condition_30, NULL, },
};
