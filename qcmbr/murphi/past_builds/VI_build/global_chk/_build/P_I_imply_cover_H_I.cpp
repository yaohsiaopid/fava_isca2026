/******************************
  Program "past_builds/VI_build/global_chk/out/P_I_imply_cover_H_I.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_build/global_chk/out/P_I_imply_cover_H_I"
...
/********************
  Invariant records
 ********************/
int mu__invariant_23() // Invariant "P_I_imply_H_I"
{
bool mu__quant24; 
mu__quant24 = TRUE;
{
...
if ( !(mu__boolexpr31) )
  ...
  mu__boolexpr26 = ((mu_Procs[mu_n].mu_state) == (mu_P_I)) ; 
}
...
mu__quant32 = TRUE;
{
for(int mu_dir = 6; mu_dir <= 6; mu_dir++) {
if ( !((mu_HomeNode.mu_state) == (mu_H_I)) )
...
bool mu__condition_33() // Condition for Rule "P_I_imply_H_I"
{
...
{"P_I_imply_H_I", &mu__condition_33, NULL, },
};
