/******************************
  Program "build/home_s0_transition/out/H_I_H_V.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "build/home_s0_transition/out/H_I_H_V"
...
/********************
  Invariant records
 ********************/
int mu__invariant_23() // Invariant "H_I_to_H_V"
{
bool mu__boolexpr24;
bool mu__boolexpr25;
  if (!(!(mu_prevHomeNode.isundefined()))) mu__boolexpr25 = FALSE ;
  else {
  mu__boolexpr25 = ((mu_prevHomeNode) == (mu_H_I)) ; 
}
...
bool mu__condition_26() // Condition for Rule "H_I_to_H_V"
{
...
int mu__invariant_27() // Invariant "swmr"
{
bool mu__quant28; 
mu__quant28 = TRUE;
{
...
bool mu__boolexpr30;
bool mu__boolexpr31;
  if (!((mu_c1) != (mu_c2))) mu__boolexpr31 = FALSE ;
  else {
  mu__boolexpr31 = ((mu_Procs[mu_c1].mu_state) == (mu_P_V)) ; 
}
  if (!(mu__boolexpr31)) mu__boolexpr30 = TRUE ;
  else {
  mu__boolexpr30 = ((mu_Procs[mu_c2].mu_state) != (mu_P_V)) ; 
}
if ( !(mu__boolexpr30) )
...
bool mu__condition_32() // Condition for Rule "swmr"
{
...
int mu__invariant_33() // Invariant "values in valid state match last write"
{
bool mu__quant34; 
mu__quant34 = TRUE;
{
...
bool mu__boolexpr35;
  if (!((mu_Procs[mu_n].mu_state) == (mu_P_V))) mu__boolexpr35 = TRUE ;
  else {
  mu__boolexpr35 = ((mu_Procs[mu_n].mu_val) == (mu_LastWrite)) ; 
}
if ( !(mu__boolexpr35) )
...
bool mu__condition_36() // Condition for Rule "values in valid state match last write"
{
...
int mu__invariant_37() // Invariant "value in memory matches value of last write, when invalid"
{
bool mu__boolexpr38;
  if (!((mu_HomeNode.mu_state) == (mu_H_I))) mu__boolexpr38 = TRUE ;
  else {
  mu__boolexpr38 = ((mu_MainMemory) == (mu_LastWrite)) ; 
}
return mu__boolexpr38;
};

bool mu__condition_39() // Condition for Rule "value in memory matches value of last write, when invalid"
{
...
int mu__invariant_40() // Invariant "Invalid implies empty owner"
{
bool mu__boolexpr41;
...
if ( !(!((mu_Procs[mu_n].mu_state) == (mu_P_V))) )
  ...
  mu__boolexpr41 = (mu__quant42) ; 
}
return mu__boolexpr41;
};

bool mu__condition_43() // Condition for Rule "Invalid implies empty owner"
{
...
{"Invalid implies empty owner", &mu__condition_43, NULL, },
{"value in memory matches value of last write, when invalid", &mu__condition_39, NULL, },
{"values in valid state match last write", &mu__condition_36, NULL, },
{"swmr", &mu__condition_32, NULL, },
{"H_I_to_H_V", &mu__condition_26, NULL, },
};
