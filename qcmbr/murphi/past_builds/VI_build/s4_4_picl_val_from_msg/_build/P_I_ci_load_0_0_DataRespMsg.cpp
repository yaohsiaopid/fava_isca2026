/******************************
  Program "past_builds/VI_build/s4_4_picl_val_from_msg/out/P_I_ci_load_0_0_DataRespMsg.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_build/s4_4_picl_val_from_msg/out/P_I_ci_load_0_0_DataRespMsg"
...
/*** Variable declaration ***/
mu_0_boolean mu_chk("chk",144);

/*** Variable declaration ***/
mu_1_Value mu_prevMsgVal("prevMsgVal",152);
...
if ( mu_start )
{
if ( (mu_cur_state) == (mu_P_V) )
{
bool mu__boolexpr9;
  if (!(!(mu_prevMsgVal.isundefined()))) mu__boolexpr9 = FALSE ;
  else {
  mu__boolexpr9 = ((mu_Procs[mu_selc].mu_val) == (mu_prevMsgVal)) ; 
}
mu_chk = mu__boolexpr9;
}
...
void world_class::print_diff( state *prevstate )
{
  if ( prevstate != NULL )
  {
    ...
    mu_prevMsgVal.print_diff(prevstate);
...
void world_class::to_state(state *newstate)
{
  ...
  mu_prevMsgVal.to_state( newstate );
...
if ( (mu_gBuf.mu_mtype) == (mu_DataRespMsg) )
{
if (mu_gBuf.mu_val.isundefined())
  mu_prevMsgVal.undefine();
else
  mu_prevMsgVal = mu_gBuf.mu_val;
}
}
...
/********************
  Invariant records
 ********************/
int mu__invariant_40() // Invariant "ASSERT_P_I_ci_load_rset_0"
{
bool mu__boolexpr41;
bool mu__boolexpr42;
bool mu__boolexpr43;
...
bool mu__boolexpr51;
  ...
  mu__boolexpr41 = (mu_chk) ; 
}
return mu__boolexpr41;
};

bool mu__condition_52() // Condition for Rule "ASSERT_P_I_ci_load_rset_0"
{
...
{"ASSERT_P_I_ci_load_rset_0", &mu__condition_52, NULL, },
};
...
void SymmetryClass::Heuristic_Fast_Canonicalize(state* s)
{
  ...
  mu_prevMsgVal.SimpleCanonicalize(Perm);
