/******************************
  Program "build/s4_6_ret_val/out/P_V_ci_load_no_txn_ini_trace.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "build/s4_6_ret_val/out/P_V_ci_load_no_txn_ini_trace"
...
/*** Variable declaration ***/
mu_1_CoreReq mu_prevProcReq("prevProcReq",16);

/*** Variable declaration ***/
mu_1_Proc mu_selc("selc",40);

/*** Variable declaration ***/
mu_1_ProcStateEnum mu_state_ret_val("state_ret_val",48);
...
bool mu__boolexpr12;
bool mu__boolexpr13;
  if (!((mu_p.mu_state) == (mu_P_V))) mu__boolexpr13 = FALSE ;
  else {
  mu__boolexpr13 = (!(mu_msgBufNonEmpty)) ; 
}
  if (!(mu__boolexpr13)) mu__boolexpr12 = FALSE ;
  else {
  mu__boolexpr12 = (mu_gBuf.mu_src.isundefined()) ; 
}
...
/********************
  Invariant records
 ********************/
int mu__invariant_25() // Invariant "P_V_accept_and_perform_ci_load"
{
bool mu__boolexpr26;
bool mu__boolexpr27;
  if (!(!(mu_prevProcs.isundefined()))) mu__boolexpr27 = FALSE ;
  else {
  mu__boolexpr27 = ((mu_prevProcs) == (mu_P_V)) ; 
}
