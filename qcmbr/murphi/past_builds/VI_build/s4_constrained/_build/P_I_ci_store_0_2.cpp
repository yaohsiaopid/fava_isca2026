/******************************
  Program "past_builds/VI_build/s4_constrained/out/P_I_ci_store_0_2.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_build/s4_constrained/out/P_I_ci_store_0_2"
...
bool mu__boolexpr12;
  ...
  mu__boolexpr11 = ((mu_msg_imm_sent_set[mu_DataRespMsg]) == (mu_false)) ; 
}
if ( mu__boolexpr11 )
{
mu_match = (mu_match) + (1);
