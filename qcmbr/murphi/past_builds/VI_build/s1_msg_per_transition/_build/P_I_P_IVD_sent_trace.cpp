/******************************
  Program "past_builds/VI_build/s1_msg_per_transition/out/P_I_P_IVD_sent_trace.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_build/s1_msg_per_transition/out/P_I_P_IVD_sent_trace"
...
bool mu__boolexpr29;
  ...
  mu__boolexpr28 = (!((mu_Procs[mu_selc].mu_state) == (mu_P_IVD))) ; 
}
return mu__boolexpr28;
};

bool mu__condition_30() // Condition for Rule "P_I_to_P_IVD"
{
...
{"P_I_to_P_IVD", &mu__condition_30, NULL, },
};
