/******************************
  Program "past_builds/VI_build/globl_dir_imp/out/P_I_imply_no_other_P_V.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_build/globl_dir_imp/out/P_I_imply_no_other_P_V"
...
/********************
  Invariant records
 ********************/
int mu__invariant_23() // Invariant "P_I_imply_not_P_V_others"
{
bool mu__quant24; 
mu__quant24 = TRUE;
{
...
bool mu__boolexpr29;
  if ((mu_Procs[mu_tmpn].mu_state) == (mu_P_I)) mu__boolexpr29 = TRUE ;
  else {
  mu__boolexpr29 = ((mu_Procs[mu_tmpn].mu_state) == (mu_P_V)) ; 
}
if ( !(mu__boolexpr29) )
  { mu__quant28 = FALSE; break; }
};
};
  if (!(mu__quant28)) mu__boolexpr27 = FALSE ;
  else {
bool mu__quant30; 
mu__quant30 = TRUE;
{
...
bool mu__boolexpr31;
  ...
  mu__boolexpr31 = ((mu_HomeNode.mu_state) == (mu_H_V)) ; 
}
if ( !(mu__boolexpr31) )
  { mu__quant30 = FALSE; break; }
};
};
  mu__boolexpr27 = (mu__quant30) ; 
}
  if (!(mu__boolexpr27)) mu__boolexpr26 = FALSE ;
  else {
  mu__boolexpr26 = ((mu_Procs[mu_n1].mu_state) == (mu_P_I)) ; 
}
...
bool mu__boolexpr33;
  if (!((mu_n2) != (mu_n1))) mu__boolexpr33 = TRUE ;
  else {
  mu__boolexpr33 = ((mu_Procs[mu_n2].mu_state) != (mu_P_V)) ; 
}
if ( !(mu__boolexpr33) )
...
bool mu__condition_34() // Condition for Rule "P_I_imply_not_P_V_others"
{
...
{"P_I_imply_not_P_V_others", &mu__condition_34, NULL, },
};
