/******************************
  Program "past_builds/VI_build/globl_dir_imp/out/P_I_imply_no_other_P_I.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_build/globl_dir_imp/out/P_I_imply_no_other_P_I"
...
/********************
  Invariant records
 ********************/
int mu__invariant_23() // Invariant "P_I_imply_not_P_I_others"
{
bool mu__quant24; 
mu__quant24 = TRUE;
{
...
bool mu__boolexpr33;
  ...
  mu__boolexpr33 = ((mu_Procs[mu_n2].mu_state) != (mu_P_I)) ; 
}
if ( !(mu__boolexpr33) )
...
bool mu__condition_34() // Condition for Rule "P_I_imply_not_P_I_others"
{
...
{"P_I_imply_not_P_I_others", &mu__condition_34, NULL, },
};
