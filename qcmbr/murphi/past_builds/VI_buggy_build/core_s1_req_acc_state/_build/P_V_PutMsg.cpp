/******************************
  Program "past_builds/VI_buggy_build/core_s1_req_acc_state/out/P_V_PutMsg.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_buggy_build/core_s1_req_acc_state/out/P_V_PutMsg"
...
/********************
  Invariant records
 ********************/
int mu__invariant_25() // Invariant "P_V_rec_PutMsg"
{
bool mu__boolexpr26;
bool mu__boolexpr27;
bool mu__boolexpr28;
bool mu__boolexpr29;
  if (!(!(mu_prevProcs.isundefined()))) mu__boolexpr29 = FALSE ;
  else {
  mu__boolexpr29 = ((mu_prevProcs) == (mu_P_V)) ; 
}
...
bool mu__boolexpr32;
  ...
  mu__boolexpr32 = ((mu_prevProcs) != (mu_Procs[mu_selc].mu_state)) ; 
}
  if (mu__boolexpr32) mu__boolexpr31 = TRUE ;
  else {
bool mu__boolexpr33;
  if (!(!(mu_prevMsgDst.isundefined()))) mu__boolexpr33 = FALSE ;
  else {
  mu__boolexpr33 = ((mu_prevMsgDst) == (mu_selc)) ; 
}
  mu__boolexpr31 = (mu__boolexpr33) ; 
}
...
bool mu__condition_34() // Condition for Rule "P_V_rec_PutMsg"
{
...
{"P_V_rec_PutMsg", &mu__condition_34, NULL, },
};
