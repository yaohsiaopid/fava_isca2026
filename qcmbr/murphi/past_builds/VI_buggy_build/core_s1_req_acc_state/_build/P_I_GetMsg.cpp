/******************************
  Program "past_builds/VI_buggy_build/core_s1_req_acc_state/out/P_I_GetMsg.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_buggy_build/core_s1_req_acc_state/out/P_I_GetMsg"
...
/********************
  Invariant records
 ********************/
int mu__invariant_25() // Invariant "P_I_rec_GetMsg"
{
bool mu__boolexpr26;
bool mu__boolexpr27;
bool mu__boolexpr28;
bool mu__boolexpr29;
  ...
  mu__boolexpr29 = ((mu_prevProcs) == (mu_P_I)) ; 
}
...
bool mu__condition_34() // Condition for Rule "P_I_rec_GetMsg"
{
...
{"P_I_rec_GetMsg", &mu__condition_34, NULL, },
};
