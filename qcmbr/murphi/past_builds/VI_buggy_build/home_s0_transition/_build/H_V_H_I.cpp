/******************************
  Program "past_builds/VI_buggy_build/home_s0_transition/out/H_V_H_I.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_buggy_build/home_s0_transition/out/H_V_H_I"
#define BITS_IN_WORLD 376
#define ALIGN
...
/*** Variable declaration ***/
mu_1_HomeState mu_HomeNode("HomeNode",24);

/*** Variable declaration ***/
mu_1__type_2 mu_Procs("Procs",40);

/*** Variable declaration ***/
mu_1_Value mu_LastWrite("LastWrite",88);

/*** Variable declaration ***/
mu_1_Value mu_MainMemory("MainMemory",96);

/*** Variable declaration ***/
mu_1_Message mu_gBuf("gBuf",104);

/*** Variable declaration ***/
mu_1__type_3 mu_ackBus("ackBus",136);

/*** Variable declaration ***/
mu_1__type_4 mu_msgBuf("msgBuf",168);

/*** Variable declaration ***/
mu_0_boolean mu_msgBufNonEmpty("msgBufNonEmpty",296);

/*** Variable declaration ***/
mu_1__type_5 mu_curRequsts("curRequsts",304);
...
/********************
  Invariant records
 ********************/
int mu__invariant_21() // Invariant "H_V_to_H_I"
{
bool mu__boolexpr22;
bool mu__boolexpr23;
  if (!(!(mu_prevHomeNode.isundefined()))) mu__boolexpr23 = FALSE ;
  else {
  mu__boolexpr23 = ((mu_prevHomeNode) == (mu_H_V)) ; 
}
  if (!(mu__boolexpr23)) mu__boolexpr22 = TRUE ;
  else {
  mu__boolexpr22 = (!((mu_HomeNode.mu_state) == (mu_H_I))) ; 
}
return mu__boolexpr22;
};

bool mu__condition_24() // Condition for Rule "H_V_to_H_I"
{
...
int mu__invariant_25() // Invariant "swmr"
{
bool mu__quant26; 
mu__quant26 = TRUE;
{
...
bool mu__boolexpr28;
bool mu__boolexpr29;
  if (!((mu_c1) != (mu_c2))) mu__boolexpr29 = FALSE ;
  else {
  mu__boolexpr29 = ((mu_Procs[mu_c1].mu_state) == (mu_P_V)) ; 
}
  if (!(mu__boolexpr29)) mu__boolexpr28 = TRUE ;
  else {
  mu__boolexpr28 = ((mu_Procs[mu_c2].mu_state) != (mu_P_V)) ; 
}
if ( !(mu__boolexpr28) )
...
bool mu__condition_30() // Condition for Rule "swmr"
{
...
int mu__invariant_31() // Invariant "values in valid state match last write"
{
bool mu__quant32; 
mu__quant32 = TRUE;
{
...
bool mu__boolexpr33;
  if (!((mu_Procs[mu_n].mu_state) == (mu_P_V))) mu__boolexpr33 = TRUE ;
  else {
  mu__boolexpr33 = ((mu_Procs[mu_n].mu_val) == (mu_LastWrite)) ; 
}
if ( !(mu__boolexpr33) )
...
bool mu__condition_34() // Condition for Rule "values in valid state match last write"
{
...
int mu__invariant_35() // Invariant "value in memory matches value of last write, when invalid"
{
bool mu__boolexpr36;
  if (!((mu_HomeNode.mu_state) == (mu_H_I))) mu__boolexpr36 = TRUE ;
  else {
  mu__boolexpr36 = ((mu_MainMemory) == (mu_LastWrite)) ; 
}
return mu__boolexpr36;
};

bool mu__condition_37() // Condition for Rule "value in memory matches value of last write, when invalid"
{
...
int mu__invariant_38() // Invariant "Invalid implies empty owner"
{
bool mu__boolexpr39;
...
bool mu__condition_41() // Condition for Rule "Invalid implies empty owner"
{
...
{"Invalid implies empty owner", &mu__condition_41, NULL, },
{"value in memory matches value of last write, when invalid", &mu__condition_37, NULL, },
{"values in valid state match last write", &mu__condition_34, NULL, },
{"swmr", &mu__condition_30, NULL, },
{"H_V_to_H_I", &mu__condition_24, NULL, },
};
