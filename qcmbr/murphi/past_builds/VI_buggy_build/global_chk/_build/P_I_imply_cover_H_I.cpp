/******************************
  Program "past_builds/VI_buggy_build/global_chk/out/P_I_imply_cover_H_I.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_buggy_build/global_chk/out/P_I_imply_cover_H_I"
...
/********************
  Invariant records
 ********************/
int mu__invariant_21() // Invariant "P_I_imply_H_I"
{
bool mu__quant22; 
mu__quant22 = TRUE;
{
...
if ( !(mu__boolexpr29) )
  ...
  mu__boolexpr24 = ((mu_Procs[mu_n].mu_state) == (mu_P_I)) ; 
}
...
bool mu__condition_31() // Condition for Rule "P_I_imply_H_I"
{
...
{"P_I_imply_H_I", &mu__condition_31, NULL, },
};
