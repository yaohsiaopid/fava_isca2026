/******************************
  Program "past_builds/VI_buggy_build/s1_2_transition/out/P_IVD_P_V.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_buggy_build/s1_2_transition/out/P_IVD_P_V"
...
/********************
  Invariant records
 ********************/
int mu__invariant_21() // Invariant "P_IVD_to_P_V"
{
bool mu__boolexpr22;
bool mu__boolexpr23;
  ...
  mu__boolexpr22 = (!((mu_Procs[mu_selc].mu_state) == (mu_P_V))) ; 
}
return mu__boolexpr22;
};

bool mu__condition_24() // Condition for Rule "P_IVD_to_P_V"
{
...
{"P_IVD_to_P_V", &mu__condition_24, NULL, },
};
