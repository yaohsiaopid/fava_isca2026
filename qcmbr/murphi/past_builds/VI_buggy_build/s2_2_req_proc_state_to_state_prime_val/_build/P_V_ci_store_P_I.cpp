/******************************
  Program "past_builds/VI_buggy_build/s2_2_req_proc_state_to_state_prime_val/out/P_V_ci_store_P_I.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_buggy_build/s2_2_req_proc_state_to_state_prime_val/out/P_V_ci_store_P_I"
...
mu_1_CoreReq mu_prevProcReq_2("prevProcReq_2",0);

/*** Variable declaration ***/
mu_1_ProcStateEnum mu_prevProcs_2("prevProcs_2",24);

/*** Variable declaration ***/
mu_1_ProcStateEnum mu_prevProcs("prevProcs",32);

/*** Variable declaration ***/
mu_1_CoreReq mu_prevProcReq("prevProcReq",40);
...
/********************
  Invariant records
 ********************/
int mu__invariant_21() // Invariant "P_V_accept_and_perform_ci_store_change_to_P_I"
{
bool mu__boolexpr22;
bool mu__boolexpr23;
bool mu__boolexpr24;
...
bool mu__boolexpr27;
bool mu__boolexpr28;
  if (mu_prevProcs.isundefined()) mu__boolexpr28 = TRUE ;
  else {
...
bool mu__condition_29() // Condition for Rule "P_V_accept_and_perform_ci_store_change_to_P_I"
{
...
{"P_V_accept_and_perform_ci_store_change_to_P_I", &mu__condition_29, NULL, },
};
