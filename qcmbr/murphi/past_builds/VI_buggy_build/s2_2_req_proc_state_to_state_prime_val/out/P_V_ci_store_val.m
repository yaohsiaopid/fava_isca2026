...
-- } CI
var
prevStateVal_2: Value;
prevProcReq_2: CoreReq;
prevProcs_2: ProcStateEnum;
prevStateVal: Value;
...
invariant "P_V_accept_and_perform_ci_store_value_change"
  (!IsUndefined(prevProcs_2) & (prevProcs_2 = P_V) & 
  !IsUndefined(prevProcReq_2.tp) & (prevProcReq_2.tp = ci_store)) -> 
