/******************************
  Program "past_builds/VI_buggy_build/s1_msg_per_transition_iter/out/P_I_P_IVD_rec_2.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_buggy_build/s1_msg_per_transition_iter/out/P_I_P_IVD_rec_2"
...
bool mu__boolexpr31;
bool mu__boolexpr32;
  if (!((mu_msg_imm_rec_set[mu_GetMsg]) == (mu_false))) mu__boolexpr32 = FALSE ;
  else {
  mu__boolexpr32 = ((mu_msg_imm_rec_set[mu_PutMsg]) == (mu_false)) ; 
}
  if (!(mu__boolexpr32)) mu__boolexpr31 = FALSE ;
  else {
  mu__boolexpr31 = ((mu_msg_imm_rec_set[mu_DataRespMsg]) == (mu_false)) ; 
}
  if (mu__boolexpr31) mu__boolexpr30 = TRUE ;
  else {
bool mu__boolexpr33;
bool mu__boolexpr34;
  if (!((mu_msg_imm_rec_set[mu_GetMsg]) == (mu_true))) mu__boolexpr34 = FALSE ;
  else {
  mu__boolexpr34 = ((mu_msg_imm_rec_set[mu_PutMsg]) == (mu_false)) ; 
}
  if (!(mu__boolexpr34)) mu__boolexpr33 = FALSE ;
  else {
  mu__boolexpr33 = ((mu_msg_imm_rec_set[mu_DataRespMsg]) == (mu_true)) ; 
}
  mu__boolexpr30 = (mu__boolexpr33) ; 
}
...
bool mu__condition_37() // Condition for Rule "P_I_to_P_IVD"
{
...
{"P_I_to_P_IVD", &mu__condition_37, NULL, },
};
