/******************************
  Program "past_builds/VI_buggy_build/s1_msg_per_transition_iter/out/P_I_P_IVD_rec_4.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_buggy_build/s1_msg_per_transition_iter/out/P_I_P_IVD_rec_4"
...
bool mu__boolexpr33;
bool mu__boolexpr34;
  if (!((mu_msg_imm_rec_set[mu_GetMsg]) == (mu_false))) mu__boolexpr34 = FALSE ;
  else {
  mu__boolexpr34 = ((mu_msg_imm_rec_set[mu_PutMsg]) == (mu_false)) ; 
}
  if (!(mu__boolexpr34)) mu__boolexpr33 = FALSE ;
  else {
  mu__boolexpr33 = ((mu_msg_imm_rec_set[mu_DataRespMsg]) == (mu_false)) ; 
}
  if (mu__boolexpr33) mu__boolexpr32 = TRUE ;
  else {
bool mu__boolexpr35;
bool mu__boolexpr36;
  if (!((mu_msg_imm_rec_set[mu_GetMsg]) == (mu_true))) mu__boolexpr36 = FALSE ;
  else {
  mu__boolexpr36 = ((mu_msg_imm_rec_set[mu_PutMsg]) == (mu_false)) ; 
}
  if (!(mu__boolexpr36)) mu__boolexpr35 = FALSE ;
  else {
  mu__boolexpr35 = ((mu_msg_imm_rec_set[mu_DataRespMsg]) == (mu_true)) ; 
}
  mu__boolexpr32 = (mu__boolexpr35) ; 
}
  if (mu__boolexpr32) mu__boolexpr31 = TRUE ;
  else {
bool mu__boolexpr37;
bool mu__boolexpr38;
  if (!((mu_msg_imm_rec_set[mu_GetMsg]) == (mu_false))) mu__boolexpr38 = FALSE ;
  else {
  mu__boolexpr38 = ((mu_msg_imm_rec_set[mu_PutMsg]) == (mu_true)) ; 
}
  if (!(mu__boolexpr38)) mu__boolexpr37 = FALSE ;
  else {
  mu__boolexpr37 = ((mu_msg_imm_rec_set[mu_DataRespMsg]) == (mu_false)) ; 
}
  mu__boolexpr31 = (mu__boolexpr37) ; 
}
  if (mu__boolexpr31) mu__boolexpr30 = TRUE ;
  else {
bool mu__boolexpr39;
bool mu__boolexpr40;
  if (!((mu_msg_imm_rec_set[mu_GetMsg]) == (mu_true))) mu__boolexpr40 = FALSE ;
  else {
  mu__boolexpr40 = ((mu_msg_imm_rec_set[mu_PutMsg]) == (mu_true)) ; 
}
  if (!(mu__boolexpr40)) mu__boolexpr39 = FALSE ;
  else {
  mu__boolexpr39 = ((mu_msg_imm_rec_set[mu_DataRespMsg]) == (mu_true)) ; 
}
  mu__boolexpr30 = (mu__boolexpr39) ; 
}
  if (mu__boolexpr30) mu__boolexpr29 = TRUE ;
  else {
bool mu__boolexpr41;
bool mu__boolexpr42;
  if (!((mu_msg_imm_rec_set[mu_GetMsg]) == (mu_false))) mu__boolexpr42 = FALSE ;
  else {
  mu__boolexpr42 = ((mu_msg_imm_rec_set[mu_PutMsg]) == (mu_false)) ; 
}
  if (!(mu__boolexpr42)) mu__boolexpr41 = FALSE ;
  else {
  mu__boolexpr41 = ((mu_msg_imm_rec_set[mu_DataRespMsg]) == (mu_true)) ; 
}
  mu__boolexpr29 = (mu__boolexpr41) ; 
}
...
bool mu__condition_43() // Condition for Rule "P_I_to_P_IVD"
{
...
int mu__invariant_44() // Invariant "swmr"
{
bool mu__quant45; 
mu__quant45 = TRUE;
{
...
bool mu__boolexpr47;
bool mu__boolexpr48;
  if (!((mu_c1) != (mu_c2))) mu__boolexpr48 = FALSE ;
  else {
  mu__boolexpr48 = ((mu_Procs[mu_c1].mu_state) == (mu_P_V)) ; 
}
  if (!(mu__boolexpr48)) mu__boolexpr47 = TRUE ;
  else {
  mu__boolexpr47 = ((mu_Procs[mu_c2].mu_state) != (mu_P_V)) ; 
}
if ( !(mu__boolexpr47) )
...
bool mu__condition_49() // Condition for Rule "swmr"
{
...
for(int mu_n = 1; mu_n <= 3; mu_n++) {
bool mu__boolexpr52;
  if (!((mu_Procs[mu_n].mu_state) == (mu_P_V))) mu__boolexpr52 = TRUE ;
  else {
...
bool mu__condition_53() // Condition for Rule "values in valid state match last write"
{
...
int mu__invariant_54() // Invariant "value in memory matches value of last write, when invalid"
{
bool mu__boolexpr55;
  if (!((mu_HomeNode.mu_state) == (mu_H_I))) mu__boolexpr55 = TRUE ;
  else {
  mu__boolexpr55 = ((mu_MainMemory) == (mu_LastWrite)) ; 
}
return mu__boolexpr55;
};

bool mu__condition_56() // Condition for Rule "value in memory matches value of last write, when invalid"
{
...
int mu__invariant_57() // Invariant "Invalid implies empty owner"
{
bool mu__boolexpr58;
...
if ( !(!((mu_Procs[mu_n].mu_state) == (mu_P_V))) )
  ...
  mu__boolexpr58 = (mu__quant59) ; 
}
return mu__boolexpr58;
};

bool mu__condition_60() // Condition for Rule "Invalid implies empty owner"
{
...
{"Invalid implies empty owner", &mu__condition_60, NULL, },
{"value in memory matches value of last write, when invalid", &mu__condition_56, NULL, },
{"values in valid state match last write", &mu__condition_53, NULL, },
{"swmr", &mu__condition_49, NULL, },
{"P_I_to_P_IVD", &mu__condition_43, NULL, },
};
