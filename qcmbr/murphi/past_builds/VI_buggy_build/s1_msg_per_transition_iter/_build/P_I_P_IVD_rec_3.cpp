/******************************
  Program "past_builds/VI_buggy_build/s1_msg_per_transition_iter/out/P_I_P_IVD_rec_3.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_buggy_build/s1_msg_per_transition_iter/out/P_I_P_IVD_rec_3"
...
bool mu__condition_40() // Condition for Rule "P_I_to_P_IVD"
{
...
int mu__invariant_41() // Invariant "swmr"
{
bool mu__quant42; 
mu__quant42 = TRUE;
{
...
bool mu__boolexpr44;
bool mu__boolexpr45;
  if (!((mu_c1) != (mu_c2))) mu__boolexpr45 = FALSE ;
  else {
  mu__boolexpr45 = ((mu_Procs[mu_c1].mu_state) == (mu_P_V)) ; 
}
  if (!(mu__boolexpr45)) mu__boolexpr44 = TRUE ;
  else {
  mu__boolexpr44 = ((mu_Procs[mu_c2].mu_state) != (mu_P_V)) ; 
}
if ( !(mu__boolexpr44) )
...
bool mu__condition_46() // Condition for Rule "swmr"
{
...
for(int mu_n = 1; mu_n <= 3; mu_n++) {
bool mu__boolexpr49;
  if (!((mu_Procs[mu_n].mu_state) == (mu_P_V))) mu__boolexpr49 = TRUE ;
  else {
...
bool mu__condition_50() // Condition for Rule "values in valid state match last write"
{
...
int mu__invariant_51() // Invariant "value in memory matches value of last write, when invalid"
{
bool mu__boolexpr52;
  if (!((mu_HomeNode.mu_state) == (mu_H_I))) mu__boolexpr52 = TRUE ;
  else {
  mu__boolexpr52 = ((mu_MainMemory) == (mu_LastWrite)) ; 
}
return mu__boolexpr52;
};

bool mu__condition_53() // Condition for Rule "value in memory matches value of last write, when invalid"
{
...
int mu__invariant_54() // Invariant "Invalid implies empty owner"
{
bool mu__boolexpr55;
...
{"Invalid implies empty owner", &mu__condition_57, NULL, },
{"value in memory matches value of last write, when invalid", &mu__condition_53, NULL, },
{"values in valid state match last write", &mu__condition_50, NULL, },
{"swmr", &mu__condition_46, NULL, },
{"P_I_to_P_IVD", &mu__condition_40, NULL, },
};
