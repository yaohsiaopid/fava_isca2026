/******************************
  Program "past_builds/VI_buggy_build/s1_msg_per_transition_iter/out/P_I_P_IVD_rec_5.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_buggy_build/s1_msg_per_transition_iter/out/P_I_P_IVD_rec_5"
...
/********************
  Invariant records
 ********************/
int mu__invariant_25() // Invariant "P_I_to_P_IVD"
{
bool mu__boolexpr26;
bool mu__boolexpr27;
bool mu__boolexpr28;
  ...
  mu__boolexpr27 = ((mu_Procs[mu_selc].mu_state) == (mu_P_IVD)) ; 
}
...
bool mu__boolexpr34;
bool mu__boolexpr35;
  if (!((mu_msg_imm_rec_set[mu_GetMsg]) == (mu_false))) mu__boolexpr35 = FALSE ;
  else {
  mu__boolexpr35 = ((mu_msg_imm_rec_set[mu_PutMsg]) == (mu_false)) ; 
}
  if (!(mu__boolexpr35)) mu__boolexpr34 = FALSE ;
  else {
  mu__boolexpr34 = ((mu_msg_imm_rec_set[mu_DataRespMsg]) == (mu_false)) ; 
}
  if (mu__boolexpr34) mu__boolexpr33 = TRUE ;
  else {
bool mu__boolexpr36;
bool mu__boolexpr37;
  if (!((mu_msg_imm_rec_set[mu_GetMsg]) == (mu_true))) mu__boolexpr37 = FALSE ;
  else {
  mu__boolexpr37 = ((mu_msg_imm_rec_set[mu_PutMsg]) == (mu_false)) ; 
}
  if (!(mu__boolexpr37)) mu__boolexpr36 = FALSE ;
  else {
  mu__boolexpr36 = ((mu_msg_imm_rec_set[mu_DataRespMsg]) == (mu_true)) ; 
}
...
bool mu__boolexpr38;
bool mu__boolexpr39;
  if (!((mu_msg_imm_rec_set[mu_GetMsg]) == (mu_false))) mu__boolexpr39 = FALSE ;
  else {
  mu__boolexpr39 = ((mu_msg_imm_rec_set[mu_PutMsg]) == (mu_true)) ; 
}
  if (!(mu__boolexpr39)) mu__boolexpr38 = FALSE ;
  else {
  mu__boolexpr38 = ((mu_msg_imm_rec_set[mu_DataRespMsg]) == (mu_false)) ; 
}
  mu__boolexpr32 = (mu__boolexpr38) ; 
}
  if (mu__boolexpr32) mu__boolexpr31 = TRUE ;
  else {
bool mu__boolexpr40;
bool mu__boolexpr41;
  if (!((mu_msg_imm_rec_set[mu_GetMsg]) == (mu_true))) mu__boolexpr41 = FALSE ;
  else {
  mu__boolexpr41 = ((mu_msg_imm_rec_set[mu_PutMsg]) == (mu_true)) ; 
}
  if (!(mu__boolexpr41)) mu__boolexpr40 = FALSE ;
  else {
  mu__boolexpr40 = ((mu_msg_imm_rec_set[mu_DataRespMsg]) == (mu_true)) ; 
}
  mu__boolexpr31 = (mu__boolexpr40) ; 
}
  if (mu__boolexpr31) mu__boolexpr30 = TRUE ;
  else {
bool mu__boolexpr42;
bool mu__boolexpr43;
  if (!((mu_msg_imm_rec_set[mu_GetMsg]) == (mu_false))) mu__boolexpr43 = FALSE ;
  else {
  mu__boolexpr43 = ((mu_msg_imm_rec_set[mu_PutMsg]) == (mu_false)) ; 
}
  if (!(mu__boolexpr43)) mu__boolexpr42 = FALSE ;
  else {
  mu__boolexpr42 = ((mu_msg_imm_rec_set[mu_DataRespMsg]) == (mu_true)) ; 
}
  mu__boolexpr30 = (mu__boolexpr42) ; 
}
...
bool mu__condition_46() // Condition for Rule "P_I_to_P_IVD"
{
...
int mu__invariant_47() // Invariant "swmr"
{
bool mu__quant48; 
mu__quant48 = TRUE;
{
...
bool mu__boolexpr50;
bool mu__boolexpr51;
  if (!((mu_c1) != (mu_c2))) mu__boolexpr51 = FALSE ;
  else {
  mu__boolexpr51 = ((mu_Procs[mu_c1].mu_state) == (mu_P_V)) ; 
}
  if (!(mu__boolexpr51)) mu__boolexpr50 = TRUE ;
  else {
  mu__boolexpr50 = ((mu_Procs[mu_c2].mu_state) != (mu_P_V)) ; 
}
if ( !(mu__boolexpr50) )
...
bool mu__condition_52() // Condition for Rule "swmr"
{
...
int mu__invariant_53() // Invariant "values in valid state match last write"
{
bool mu__quant54; 
mu__quant54 = TRUE;
{
for(int mu_n = 1; mu_n <= 3; mu_n++) {
bool mu__boolexpr55;
  if (!((mu_Procs[mu_n].mu_state) == (mu_P_V))) mu__boolexpr55 = TRUE ;
  else {
  mu__boolexpr55 = ((mu_Procs[mu_n].mu_val) == (mu_LastWrite)) ; 
}
if ( !(mu__boolexpr55) )
...
bool mu__condition_56() // Condition for Rule "values in valid state match last write"
{
...
int mu__invariant_57() // Invariant "value in memory matches value of last write, when invalid"
{
bool mu__boolexpr58;
  if (!((mu_HomeNode.mu_state) == (mu_H_I))) mu__boolexpr58 = TRUE ;
  else {
  mu__boolexpr58 = ((mu_MainMemory) == (mu_LastWrite)) ; 
}
return mu__boolexpr58;
};

bool mu__condition_59() // Condition for Rule "value in memory matches value of last write, when invalid"
{
...
bool mu__condition_63() // Condition for Rule "Invalid implies empty owner"
{
...
{"Invalid implies empty owner", &mu__condition_63, NULL, },
{"value in memory matches value of last write, when invalid", &mu__condition_59, NULL, },
{"values in valid state match last write", &mu__condition_56, NULL, },
{"swmr", &mu__condition_52, NULL, },
{"P_I_to_P_IVD", &mu__condition_46, NULL, },
};
