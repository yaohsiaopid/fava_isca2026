/******************************
  Program "past_builds/VI_buggy_build/core_s2_req_acc_state_prime/out/P_V_GetMsg_trace.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_buggy_build/core_s2_req_acc_state_prime/out/P_V_GetMsg_trace"
...
for(int mu_n = 1; mu_n <= 6; mu_n++)
  if (( ( mu_n >= 1 ) && ( mu_n <= 3 ) )|| ( ( mu_n >= 6 ) && ( mu_n <= 6 ) )) {
bool mu__boolexpr9;
  if (!(mu_allAck)) mu__boolexpr9 = FALSE ;
  else {
  mu__boolexpr9 = (mu_ackBus[mu_n]) ; 
}
mu_allAck = mu__boolexpr9;
};
};
if ( mu_allAck )
{
...
bool mu__boolexpr14;
bool mu__boolexpr15;
  if (!((mu_p.mu_state) == (mu_P_V))) mu__boolexpr15 = FALSE ;
  else {
  mu__boolexpr15 = (!(mu_msgBufNonEmpty)) ; 
}
  if (!(mu__boolexpr15)) mu__boolexpr14 = FALSE ;
  else {
  mu__boolexpr14 = (mu_gBuf.mu_src.isundefined()) ; 
}
...
bool mu__boolexpr18;
bool mu__boolexpr19;
  if (!((mu_p.mu_state) == (mu_P_I))) mu__boolexpr19 = FALSE ;
  else {
...
/********************
  Invariant records
 ********************/
int mu__invariant_26() // Invariant "P_V_rec_GetMsg"
{
bool mu__boolexpr27;
bool mu__boolexpr28;
bool mu__boolexpr29;
bool mu__boolexpr30;
  if (!(!(mu_prevProcs.isundefined()))) mu__boolexpr30 = FALSE ;
  else {
  mu__boolexpr30 = ((mu_prevProcs) == (mu_P_V)) ; 
}
  if (!(mu__boolexpr30)) mu__boolexpr29 = FALSE ;
  else {
  mu__boolexpr29 = (!(mu_prevMsg.isundefined())) ; 
}
  if (!(mu__boolexpr29)) mu__boolexpr28 = FALSE ;
  else {
  mu__boolexpr28 = ((mu_prevMsg) == (mu_GetMsg)) ; 
}
...
bool mu__boolexpr32;
bool mu__boolexpr33;
  if (!(!(mu_prevProcs.isundefined()))) mu__boolexpr33 = FALSE ;
  else {
  mu__boolexpr33 = ((mu_prevProcs) != (mu_Procs[mu_selc].mu_state)) ; 
}
  if (mu__boolexpr33) mu__boolexpr32 = TRUE ;
  else {
bool mu__boolexpr34;
  if (!(!(mu_prevMsgDst.isundefined()))) mu__boolexpr34 = FALSE ;
  else {
  mu__boolexpr34 = ((mu_prevMsgDst) == (mu_selc)) ; 
}
  mu__boolexpr32 = (mu__boolexpr34) ; 
}
  if (mu__boolexpr32) mu__boolexpr31 = TRUE ;
  else {
  mu__boolexpr31 = (!(mu_prevSentMsg.isundefined())) ; 
}
  mu__boolexpr27 = (!(mu__boolexpr31)) ; 
}
