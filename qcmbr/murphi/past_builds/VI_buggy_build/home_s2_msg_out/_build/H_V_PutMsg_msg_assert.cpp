/******************************
  Program "past_builds/VI_buggy_build/home_s2_msg_out/out/H_V_PutMsg_msg_assert.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_buggy_build/home_s2_msg_out/out/H_V_PutMsg_msg_assert"
...
bool mu__boolexpr12;
  ...
  mu__boolexpr12 = ((mu_cur_node) == (mu_selh)) ; 
}
if ( mu__boolexpr12 )
{
...
/********************
  Invariant records
 ********************/
int mu__invariant_26() // Invariant "ASSERT_H_V_accept_req_PutMsg"
{
bool mu__boolexpr27;
bool mu__boolexpr28;
bool mu__boolexpr29;
bool mu__boolexpr30;
  ...
  mu__boolexpr29 = (!(mu_prevRecProcMsg.isundefined())) ; 
}
  if (!(mu__boolexpr29)) mu__boolexpr28 = FALSE ;
  else {
  mu__boolexpr28 = ((mu_prevRecProcMsg) == (mu_PutMsg)) ; 
}
  if (!(mu__boolexpr28)) mu__boolexpr27 = TRUE ;
  else {
bool mu__boolexpr31;
bool mu__boolexpr32;
  if (!((mu_prevSentMsgSet[mu_GetMsg]) == (mu_false))) mu__boolexpr32 = FALSE ;
  else {
  mu__boolexpr32 = ((mu_prevSentMsgSet[mu_PutMsg]) == (mu_false)) ; 
}
  if (!(mu__boolexpr32)) mu__boolexpr31 = FALSE ;
  else {
  mu__boolexpr31 = ((mu_prevSentMsgSet[mu_DataRespMsg]) == (mu_false)) ; 
}
...
bool mu__condition_33() // Condition for Rule "ASSERT_H_V_accept_req_PutMsg"
{
...
int mu__invariant_34() // Invariant "swmr"
{
bool mu__quant35; 
mu__quant35 = TRUE;
{
...
bool mu__boolexpr38;
  ...
  mu__boolexpr38 = ((mu_Procs[mu_c1].mu_state) == (mu_P_V)) ; 
}
  if (!(mu__boolexpr38)) mu__boolexpr37 = TRUE ;
  else {
  mu__boolexpr37 = ((mu_Procs[mu_c2].mu_state) != (mu_P_V)) ; 
}
if ( !(mu__boolexpr37) )
...
bool mu__condition_39() // Condition for Rule "swmr"
{
...
int mu__invariant_40() // Invariant "values in valid state match last write"
{
bool mu__quant41; 
mu__quant41 = TRUE;
{
...
bool mu__boolexpr42;
  if (!((mu_Procs[mu_n].mu_state) == (mu_P_V))) mu__boolexpr42 = TRUE ;
  else {
  mu__boolexpr42 = ((mu_Procs[mu_n].mu_val) == (mu_LastWrite)) ; 
}
if ( !(mu__boolexpr42) )
...
bool mu__condition_43() // Condition for Rule "values in valid state match last write"
{
...
bool mu__boolexpr45;
  ...
  mu__boolexpr45 = ((mu_MainMemory) == (mu_LastWrite)) ; 
}
...
if ( !(!((mu_Procs[mu_n].mu_state) == (mu_P_V))) )
  ...
  mu__boolexpr48 = (mu__quant49) ; 
}
return mu__boolexpr48;
};

bool mu__condition_50() // Condition for Rule "Invalid implies empty owner"
{
...
{"Invalid implies empty owner", &mu__condition_50, NULL, },
{"value in memory matches value of last write, when invalid", &mu__condition_46, NULL, },
{"values in valid state match last write", &mu__condition_43, NULL, },
{"swmr", &mu__condition_39, NULL, },
{"ASSERT_H_V_accept_req_PutMsg", &mu__condition_33, NULL, },
};
