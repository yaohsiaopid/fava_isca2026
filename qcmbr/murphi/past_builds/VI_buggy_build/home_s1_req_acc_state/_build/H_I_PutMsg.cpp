/******************************
  Program "past_builds/VI_buggy_build/home_s1_req_acc_state/out/H_I_PutMsg.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_buggy_build/home_s1_req_acc_state/out/H_I_PutMsg"
...
/********************
  Invariant records
 ********************/
int mu__invariant_25() // Invariant "H_I_consistent_w_PutMsg"
{
bool mu__boolexpr26;
bool mu__boolexpr27;
bool mu__boolexpr28;
bool mu__boolexpr29;
  if (!(!(mu_prevHomeNode.isundefined()))) mu__boolexpr29 = FALSE ;
  else {
  mu__boolexpr29 = ((mu_prevHomeNode) == (mu_H_I)) ; 
}
  if (!(mu__boolexpr29)) mu__boolexpr28 = FALSE ;
  else {
  mu__boolexpr28 = (!(mu_prevMsg.isundefined())) ; 
}
...
bool mu__boolexpr30;
bool mu__boolexpr31;
  if ((mu_prevHomeNode) != (mu_HomeNode.mu_state)) mu__boolexpr31 = TRUE ;
  else {
bool mu__boolexpr32;
  if (!(!(mu_prevMsgDst.isundefined()))) mu__boolexpr32 = FALSE ;
  else {
  mu__boolexpr32 = ((mu_prevMsgDst) == (mu_selh)) ; 
}
  mu__boolexpr31 = (mu__boolexpr32) ; 
}
  if (mu__boolexpr31) mu__boolexpr30 = TRUE ;
  else {
  mu__boolexpr30 = (!(mu_prevSentMsg.isundefined())) ; 
}
  mu__boolexpr26 = (!(mu__boolexpr30)) ; 
}
return mu__boolexpr26;
};

bool mu__condition_33() // Condition for Rule "H_I_consistent_w_PutMsg"
{
...
{"H_I_consistent_w_PutMsg", &mu__condition_33, NULL, },
};
