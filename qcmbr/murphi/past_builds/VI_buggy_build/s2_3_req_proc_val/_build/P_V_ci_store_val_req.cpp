/******************************
  Program "past_builds/VI_buggy_build/s2_3_req_proc_val/out/P_V_ci_store_val_req.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_buggy_build/s2_3_req_proc_val/out/P_V_ci_store_val_req"
...
mu_1_ProcStateEnum mu_prevProcs("prevProcs",0);

/*** Variable declaration ***/
mu_1_CoreReq mu_prevProcReq("prevProcReq",8);

/*** Variable declaration ***/
mu_1_Proc mu_selc("selc",32);
...
/********************
  Invariant records
 ********************/
int mu__invariant_21() // Invariant "P_V_accept_and_perform_as_specified_ci_store"
{
bool mu__boolexpr22;
bool mu__boolexpr23;
bool mu__boolexpr24;
bool mu__boolexpr25;
  ...
  mu__boolexpr22 = ((mu_Procs[mu_selc].mu_val) == (mu_prevProcReq.mu_cl)) ; 
}
return mu__boolexpr22;
};

bool mu__condition_26() // Condition for Rule "P_V_accept_and_perform_as_specified_ci_store"
{
...
{"P_V_accept_and_perform_as_specified_ci_store", &mu__condition_26, NULL, },
};
