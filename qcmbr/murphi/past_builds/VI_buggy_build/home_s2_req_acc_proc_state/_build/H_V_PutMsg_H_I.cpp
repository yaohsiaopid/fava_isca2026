/******************************
  Program "past_builds/VI_buggy_build/home_s2_req_acc_proc_state/out/H_V_PutMsg_H_I.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_buggy_build/home_s2_req_acc_proc_state/out/H_V_PutMsg_H_I"
...
/*** Variable declaration ***/
mu_1_MessageType mu_prevRecProcMsg("prevRecProcMsg",24);

/*** Variable declaration ***/
mu_1_HomeState mu_HomeNode("HomeNode",32);

/*** Variable declaration ***/
mu_1__type_2 mu_Procs("Procs",48);

/*** Variable declaration ***/
mu_1_Value mu_LastWrite("LastWrite",96);

/*** Variable declaration ***/
mu_1_Value mu_MainMemory("MainMemory",104);

/*** Variable declaration ***/
mu_1_Message mu_gBuf("gBuf",112);

/*** Variable declaration ***/
mu_1__type_3 mu_ackBus("ackBus",144);

/*** Variable declaration ***/
mu_1__type_4 mu_msgBuf("msgBuf",176);

/*** Variable declaration ***/
mu_0_boolean mu_msgBufNonEmpty("msgBufNonEmpty",304);

/*** Variable declaration ***/
mu_1__type_5 mu_curRequsts("curRequsts",312);
...
bool mu__boolexpr27;
  ...
  mu__boolexpr24 = (!((mu_HomeNode.mu_state) == (mu_H_I))) ; 
}
