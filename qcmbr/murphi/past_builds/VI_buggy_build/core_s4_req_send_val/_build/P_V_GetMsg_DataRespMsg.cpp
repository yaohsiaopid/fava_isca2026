/******************************
  Program "past_builds/VI_buggy_build/core_s4_req_send_val/out/P_V_GetMsg_DataRespMsg.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_buggy_build/core_s4_req_send_val/out/P_V_GetMsg_DataRespMsg"
...
/********************
  Invariant records
 ********************/
int mu__invariant_25() // Invariant "ASSERT_P_V_rec_GetMsg"
{
bool mu__boolexpr26;
bool mu__boolexpr27;
bool mu__boolexpr28;
...
bool mu__boolexpr35;
  if (!(!(mu_prevSentMsgVal.isundefined()))) mu__boolexpr35 = FALSE ;
  else {
  mu__boolexpr35 = ((mu_prevSentMsgVal) == (mu_prevStateVal)) ; 
}
  mu__boolexpr26 = (mu__boolexpr35) ; 
}
return mu__boolexpr26;
};

bool mu__condition_36() // Condition for Rule "ASSERT_P_V_rec_GetMsg"
{
...
int mu__invariant_37() // Invariant "swmr"
{
bool mu__quant38; 
mu__quant38 = TRUE;
{
...
bool mu__boolexpr40;
bool mu__boolexpr41;
  if (!((mu_c1) != (mu_c2))) mu__boolexpr41 = FALSE ;
  else {
  mu__boolexpr41 = ((mu_Procs[mu_c1].mu_state) == (mu_P_V)) ; 
}
  if (!(mu__boolexpr41)) mu__boolexpr40 = TRUE ;
  else {
  mu__boolexpr40 = ((mu_Procs[mu_c2].mu_state) != (mu_P_V)) ; 
}
if ( !(mu__boolexpr40) )
...
bool mu__condition_42() // Condition for Rule "swmr"
{
...
int mu__invariant_43() // Invariant "values in valid state match last write"
{
bool mu__quant44; 
mu__quant44 = TRUE;
{
for(int mu_n = 1; mu_n <= 3; mu_n++) {
bool mu__boolexpr45;
  if (!((mu_Procs[mu_n].mu_state) == (mu_P_V))) mu__boolexpr45 = TRUE ;
  else {
...
bool mu__condition_46() // Condition for Rule "values in valid state match last write"
{
...
int mu__invariant_47() // Invariant "value in memory matches value of last write, when invalid"
{
bool mu__boolexpr48;
  if (!((mu_HomeNode.mu_state) == (mu_H_I))) mu__boolexpr48 = TRUE ;
  else {
  mu__boolexpr48 = ((mu_MainMemory) == (mu_LastWrite)) ; 
}
return mu__boolexpr48;
};

bool mu__condition_49() // Condition for Rule "value in memory matches value of last write, when invalid"
{
...
int mu__invariant_50() // Invariant "Invalid implies empty owner"
{
bool mu__boolexpr51;
...
bool mu__condition_53() // Condition for Rule "Invalid implies empty owner"
{
...
{"Invalid implies empty owner", &mu__condition_53, NULL, },
{"value in memory matches value of last write, when invalid", &mu__condition_49, NULL, },
{"values in valid state match last write", &mu__condition_46, NULL, },
{"swmr", &mu__condition_42, NULL, },
{"ASSERT_P_V_rec_GetMsg", &mu__condition_36, NULL, },
};
