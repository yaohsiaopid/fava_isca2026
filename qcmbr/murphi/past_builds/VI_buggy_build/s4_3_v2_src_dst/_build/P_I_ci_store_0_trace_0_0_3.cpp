/******************************
  Program "past_builds/VI_buggy_build/s4_3_v2_src_dst/out/P_I_ci_store_0_trace_0_0_3.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_buggy_build/s4_3_v2_src_dst/out/P_I_ci_store_0_trace_0_0_3"
...
bool mu__boolexpr23;
  ...
  mu__boolexpr22 = ((mu_prevProcs) == (mu_P_I)) ; 
}
  ...
  mu__boolexpr20 = ((mu_prevProcReq.mu_tp) == (mu_ci_store)) ; 
}
...
bool mu__boolexpr27;
  ...
  mu__boolexpr26 = ((mu_prevProcs) == (mu_P_I)) ; 
}
  ...
  mu__boolexpr24 = ((mu_prevProcReq.mu_tp) == (mu_ci_store)) ; 
}
	      if (mu__boolexpr24) {
		if ( ( TRUE  ) )
		  return;
...
{
bool mu__boolexpr31;
  if (!(!(mu_cur_node.isundefined()))) mu__boolexpr31 = FALSE ;
  else {
  mu__boolexpr31 = ((mu_cur_node) == (mu_selc)) ; 
}
if ( mu__boolexpr31 )
{
if (mu_gBuf.mu_mtype.isundefined())
...
bool mu__boolexpr32;
bool mu__boolexpr33;
  if (!(mu_start)) mu__boolexpr33 = FALSE ;
  else {
  mu__boolexpr33 = (!(mu_cur_node.isundefined())) ; 
}
...
bool mu__boolexpr35;
bool mu__boolexpr36;
  if (!(mu_start)) mu__boolexpr36 = FALSE ;
  else {
  mu__boolexpr36 = ((mu_gBuf.mu_mtype) == (mu_DataRespMsg)) ; 
}
...
{
bool mu__boolexpr37;
  if (!(mu_chk)) mu__boolexpr37 = FALSE ;
  else {
  mu__boolexpr37 = ((mu_gBuf.mu_src>=6 && mu_gBuf.mu_src<=6)) ; 
}
mu_chk = mu__boolexpr37;
}
bool mu__boolexpr38;
bool mu__boolexpr39;
bool mu__boolexpr40;
  if (!(mu_start)) mu__boolexpr40 = FALSE ;
  else {
  mu__boolexpr40 = ((mu_gBuf.mu_mtype) == (mu_GetMsg)) ; 
}
  if (!(mu__boolexpr40)) mu__boolexpr39 = FALSE ;
  else {
  mu__boolexpr39 = ((mu_gBuf.mu_src) == (mu_selc)) ; 
}
  if (!(mu__boolexpr39)) mu__boolexpr38 = FALSE ;
  else {
  mu__boolexpr38 = ((mu_cur_node>=6 && mu_cur_node<=6)) ; 
}
if ( mu__boolexpr38 )
{
...
{
bool mu__boolexpr41;
  if (!(!(mu_cur_node.isundefined()))) mu__boolexpr41 = FALSE ;
  else {
  mu__boolexpr41 = ((mu_cur_node) == (mu_selc)) ; 
}
if ( mu__boolexpr41 )
{
if (mu_gBuf.mu_mtype.isundefined())
...
bool mu__boolexpr42;
bool mu__boolexpr43;
  if (!(mu_start)) mu__boolexpr43 = FALSE ;
  else {
  mu__boolexpr43 = (!(mu_cur_node.isundefined())) ; 
}
...
bool mu__boolexpr45;
bool mu__boolexpr46;
  if (!(mu_start)) mu__boolexpr46 = FALSE ;
  else {
  mu__boolexpr46 = ((mu_gBuf.mu_mtype) == (mu_DataRespMsg)) ; 
}
...
{
bool mu__boolexpr47;
  if (!(mu_chk)) mu__boolexpr47 = FALSE ;
  else {
  mu__boolexpr47 = ((mu_gBuf.mu_src>=6 && mu_gBuf.mu_src<=6)) ; 
}
mu_chk = mu__boolexpr47;
}
bool mu__boolexpr48;
bool mu__boolexpr49;
bool mu__boolexpr50;
  if (!(mu_start)) mu__boolexpr50 = FALSE ;
  else {
  mu__boolexpr50 = ((mu_gBuf.mu_mtype) == (mu_GetMsg)) ; 
}
  if (!(mu__boolexpr50)) mu__boolexpr49 = FALSE ;
  else {
  mu__boolexpr49 = ((mu_gBuf.mu_src) == (mu_selc)) ; 
}
  if (!(mu__boolexpr49)) mu__boolexpr48 = FALSE ;
  else {
  mu__boolexpr48 = ((mu_cur_node>=6 && mu_cur_node<=6)) ; 
}
if ( mu__boolexpr48 )
{
if (mu_cur_node.isundefined())
...
bool mu__boolexpr51;
bool mu__boolexpr52;
  if (!((mu_p.mu_state) == (mu_P_V))) mu__boolexpr52 = FALSE ;
  else {
  mu__boolexpr52 = (!(mu_msgBufNonEmpty)) ; 
}
  if (!(mu__boolexpr52)) mu__boolexpr51 = FALSE ;
  else {
  mu__boolexpr51 = (mu_gBuf.mu_src.isundefined()) ; 
}
...
bool mu__boolexpr55;
bool mu__boolexpr56;
  if (!((mu_p.mu_state) == (mu_P_I))) mu__boolexpr56 = FALSE ;
  else {
...
/********************
  Invariant records
 ********************/
int mu__invariant_63() // Invariant "P_I_ci_store_rset_0"
{
bool mu__boolexpr64;
bool mu__boolexpr65;
bool mu__boolexpr66;
...
bool mu__boolexpr68;
bool mu__boolexpr69;
  if (!(mu_tracked)) mu__boolexpr69 = FALSE ;
  else {
  mu__boolexpr69 = (!(mu_start)) ; 
}
  ...
  for (mu_i = 0; ; mu_i=mu_i+1)
    {
      if (mu_reached_set.valid[(int)mu_i].value())
	{
	  if ( (mu_reached_set[mu_i]) == (mu_P_I) ) mu__intexpr70++;
	}
      if (mu_i == 3-1) break;
    }
  }
/*** end multisetcount 1 declaration ***/
  mu__boolexpr68 = ((mu__intexpr70) == (0)) ; 
}
  ...
  for (mu_i = 0; ; mu_i=mu_i+1)
    {
      if (mu_reached_set.valid[(int)mu_i].value())
	{
	  if ( (mu_reached_set[mu_i]) == (mu_P_IVD) ) mu__intexpr71++;
	}
      if (mu_i == 3-1) break;
    }
  }
/*** end multisetcount 2 declaration ***/
  mu__boolexpr67 = ((mu__intexpr71) == (1)) ; 
}
  ...
  for (mu_i = 0; ; mu_i=mu_i+1)
    {
      if (mu_reached_set.valid[(int)mu_i].value())
	{
	  if ( (mu_reached_set[mu_i]) == (mu_P_V) ) mu__intexpr72++;
	}
      if (mu_i == 3-1) break;
    }
  }
/*** end multisetcount 3 declaration ***/
  mu__boolexpr66 = ((mu__intexpr72) == (1)) ; 
}
...
bool mu__boolexpr76;
bool mu__boolexpr77;
  if (!((mu_msg_rec_set[mu_GetMsg]) == (mu_true))) mu__boolexpr77 = FALSE ;
  else {
  mu__boolexpr77 = ((mu_msg_rec_set[mu_PutMsg]) == (mu_false)) ; 
}
  if (!(mu__boolexpr77)) mu__boolexpr76 = FALSE ;
  else {
  mu__boolexpr76 = ((mu_msg_rec_set[mu_DataRespMsg]) == (mu_true)) ; 
}
  if (!(mu__boolexpr76)) mu__boolexpr75 = FALSE ;
  else {
  mu__boolexpr75 = ((mu_msg_sent_set[mu_GetMsg]) == (mu_true)) ; 
}
  if (!(mu__boolexpr75)) mu__boolexpr74 = FALSE ;
  else {
  mu__boolexpr74 = ((mu_msg_sent_set[mu_PutMsg]) == (mu_false)) ; 
}
  if (!(mu__boolexpr74)) mu__boolexpr73 = FALSE ;
  else {
  mu__boolexpr73 = ((mu_msg_sent_set[mu_DataRespMsg]) == (mu_false)) ; 
}
  mu__boolexpr65 = (mu__boolexpr73) ; 
}
  if (!(mu__boolexpr65)) mu__boolexpr64 = TRUE ;
  else {
  mu__boolexpr64 = (!(mu_chk)) ; 
}
return mu__boolexpr64;
};

bool mu__condition_78() // Condition for Rule "P_I_ci_store_rset_0"
{
...
int mu__invariant_79() // Invariant "swmr"
{
bool mu__quant80; 
mu__quant80 = TRUE;
{
...
bool mu__boolexpr82;
bool mu__boolexpr83;
  if (!((mu_c1) != (mu_c2))) mu__boolexpr83 = FALSE ;
  else {
  mu__boolexpr83 = ((mu_Procs[mu_c1].mu_state) == (mu_P_V)) ; 
}
  if (!(mu__boolexpr83)) mu__boolexpr82 = TRUE ;
  else {
  mu__boolexpr82 = ((mu_Procs[mu_c2].mu_state) != (mu_P_V)) ; 
}
if ( !(mu__boolexpr82) )
...
bool mu__condition_84() // Condition for Rule "swmr"
{
...
int mu__invariant_85() // Invariant "values in valid state match last write"
{
bool mu__quant86; 
mu__quant86 = TRUE;
{
for(int mu_n = 1; mu_n <= 3; mu_n++) {
bool mu__boolexpr87;
  if (!((mu_Procs[mu_n].mu_state) == (mu_P_V))) mu__boolexpr87 = TRUE ;
  else {
  mu__boolexpr87 = ((mu_Procs[mu_n].mu_val) == (mu_LastWrite)) ; 
}
if ( !(mu__boolexpr87) )
...
bool mu__condition_88() // Condition for Rule "values in valid state match last write"
{
...
int mu__invariant_89() // Invariant "value in memory matches value of last write, when invalid"
{
bool mu__boolexpr90;
  if (!((mu_HomeNode.mu_state) == (mu_H_I))) mu__boolexpr90 = TRUE ;
  else {
  mu__boolexpr90 = ((mu_MainMemory) == (mu_LastWrite)) ; 
}
return mu__boolexpr90;
};

bool mu__condition_91() // Condition for Rule "value in memory matches value of last write, when invalid"
{
  return mu__invariant_89( );
}

/**** end rule declaration ****/

int mu__invariant_92() // Invariant "Invalid implies empty owner"
{
bool mu__boolexpr93;
  if (!((mu_HomeNode.mu_state) == (mu_H_I))) mu__boolexpr93 = TRUE ;
  else {
bool mu__quant94; 
mu__quant94 = TRUE;
{
...
if ( !(!((mu_Procs[mu_n].mu_state) == (mu_P_V))) )
  ...
  mu__boolexpr93 = (mu__quant94) ; 
}
return mu__boolexpr93;
};

bool mu__condition_95() // Condition for Rule "Invalid implies empty owner"
{
  return mu__invariant_92( );
}

/**** end rule declaration ****/

const rulerec invariants[] = {
{"Invalid implies empty owner", &mu__condition_95, NULL, },
{"value in memory matches value of last write, when invalid", &mu__condition_91, NULL, },
{"values in valid state match last write", &mu__condition_88, NULL, },
{"swmr", &mu__condition_84, NULL, },
{"P_I_ci_store_rset_0", &mu__condition_78, NULL, },
};
