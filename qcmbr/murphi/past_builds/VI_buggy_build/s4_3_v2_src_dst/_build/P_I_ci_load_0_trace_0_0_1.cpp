/******************************
  Program "past_builds/VI_buggy_build/s4_3_v2_src_dst/out/P_I_ci_load_0_trace_0_0_1.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_buggy_build/s4_3_v2_src_dst/out/P_I_ci_load_0_trace_0_0_1"
...
bool mu__boolexpr22;
  ...
  mu__boolexpr19 = ((mu_prevProcReq.mu_tp) == (mu_ci_load)) ; 
}
...
bool mu__boolexpr26;
  ...
  mu__boolexpr23 = ((mu_prevProcReq.mu_tp) == (mu_ci_load)) ; 
}
	      if (mu__boolexpr23) {
		if ( ( TRUE  ) )
		  return;
...
/********************
  Invariant records
 ********************/
int mu__invariant_62() // Invariant "P_I_ci_load_rset_0"
{
bool mu__boolexpr63;
bool mu__boolexpr64;
bool mu__boolexpr65;
...
bool mu__condition_77() // Condition for Rule "P_I_ci_load_rset_0"
{
...
{"P_I_ci_load_rset_0", &mu__condition_77, NULL, },
};
