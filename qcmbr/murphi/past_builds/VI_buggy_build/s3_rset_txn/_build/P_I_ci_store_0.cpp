/******************************
  Program "past_builds/VI_buggy_build/s3_rset_txn/out/P_I_ci_store_0.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_buggy_build/s3_rset_txn/out/P_I_ci_store_0"
...
bool mu__boolexpr12;
bool mu__boolexpr13;
  if (!(!(mu_tracked))) mu__boolexpr13 = FALSE ;
  else {
  mu__boolexpr13 = (!(mu_prevProcs.isundefined())) ; 
}
  if (!(mu__boolexpr13)) mu__boolexpr12 = FALSE ;
  else {
  mu__boolexpr12 = ((mu_prevProcs) == (mu_P_I)) ; 
}
  if (!(mu__boolexpr12)) mu__boolexpr11 = FALSE ;
  else {
  mu__boolexpr11 = (!(mu_prevProcReq.mu_tp.isundefined())) ; 
}
  if (!(mu__boolexpr11)) mu__boolexpr10 = FALSE ;
  else {
  mu__boolexpr10 = ((mu_prevProcReq.mu_tp) == (mu_ci_store)) ; 
}
...
bool mu__boolexpr16;
bool mu__boolexpr17;
  if (!(!(mu_tracked))) mu__boolexpr17 = FALSE ;
  else {
  mu__boolexpr17 = (!(mu_prevProcs.isundefined())) ; 
}
  if (!(mu__boolexpr17)) mu__boolexpr16 = FALSE ;
  else {
  mu__boolexpr16 = ((mu_prevProcs) == (mu_P_I)) ; 
}
  if (!(mu__boolexpr16)) mu__boolexpr15 = FALSE ;
  else {
  mu__boolexpr15 = (!(mu_prevProcReq.mu_tp.isundefined())) ; 
}
  if (!(mu__boolexpr15)) mu__boolexpr14 = FALSE ;
  else {
  mu__boolexpr14 = ((mu_prevProcReq.mu_tp) == (mu_ci_store)) ; 
}
	      if (mu__boolexpr14) {
		if ( ( TRUE  ) )
		  return;
...
for(int mu_n = 1; mu_n <= 6; mu_n++)
  if (( ( mu_n >= 1 ) && ( mu_n <= 3 ) )|| ( ( mu_n >= 6 ) && ( mu_n <= 6 ) )) {
bool mu__boolexpr18;
  if (!(mu_allAck)) mu__boolexpr18 = FALSE ;
  else {
  mu__boolexpr18 = (mu_ackBus[mu_n]) ; 
}
mu_allAck = mu__boolexpr18;
};
};
if ( mu_allAck )
{
...
public:
  ...
  bool Condition(unsigned r)
  {
    ...
    r = r / 4;
bool mu__boolexpr19;
  if (!(!(mu_gBuf.mu_src.isundefined()))) mu__boolexpr19 = FALSE ;
  else {
...
/********************
  Invariant records
 ********************/
int mu__invariant_33() // Invariant "P_I_ci_store_rset_0"
{
bool mu__boolexpr34;
bool mu__boolexpr35;
  if (!(mu_tracked)) mu__boolexpr35 = FALSE ;
  else {
  mu__boolexpr35 = (!(mu_start)) ; 
}
  if (!(mu__boolexpr35)) mu__boolexpr34 = TRUE ;
  else {
  mu__boolexpr34 = ((mu_cur_idx) != (2)) ; 
}
return mu__boolexpr34;
};

bool mu__condition_36() // Condition for Rule "P_I_ci_store_rset_0"
{
...
{"P_I_ci_store_rset_0", &mu__condition_36, NULL, },
};
