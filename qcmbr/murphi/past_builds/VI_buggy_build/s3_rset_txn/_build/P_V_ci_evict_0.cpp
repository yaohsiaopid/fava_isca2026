/******************************
  Program "past_builds/VI_buggy_build/s3_rset_txn/out/P_V_ci_evict_0.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_buggy_build/s3_rset_txn/out/P_V_ci_evict_0"
...
bool mu__boolexpr13;
  ...
  mu__boolexpr12 = ((mu_prevProcs) == (mu_P_V)) ; 
}
  ...
  mu__boolexpr10 = ((mu_prevProcReq.mu_tp) == (mu_ci_evict)) ; 
}
...
bool mu__boolexpr17;
  ...
  mu__boolexpr16 = ((mu_prevProcs) == (mu_P_V)) ; 
}
  ...
  mu__boolexpr14 = ((mu_prevProcReq.mu_tp) == (mu_ci_evict)) ; 
}
	      if (mu__boolexpr14) {
		if ( ( TRUE  ) )
		  return;
...
/********************
  Invariant records
 ********************/
int mu__invariant_33() // Invariant "P_V_ci_evict_rset_0"
{
bool mu__boolexpr34;
bool mu__boolexpr35;
  ...
  mu__boolexpr34 = ((mu_cur_idx) != (1)) ; 
}
return mu__boolexpr34;
};

bool mu__condition_36() // Condition for Rule "P_V_ci_evict_rset_0"
{
...
{"P_V_ci_evict_rset_0", &mu__condition_36, NULL, },
};
