/******************************
  Program "past_builds/VI_buggy_build/s3_rset_txn/out/P_I_ci_load_0.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "past_builds/VI_buggy_build/s3_rset_txn/out/P_I_ci_load_0"
...
bool mu__boolexpr13;
  ...
  mu__boolexpr10 = ((mu_prevProcReq.mu_tp) == (mu_ci_load)) ; 
}
...
bool mu__boolexpr17;
  ...
  mu__boolexpr14 = ((mu_prevProcReq.mu_tp) == (mu_ci_load)) ; 
}
	      if (mu__boolexpr14) {
		if ( ( TRUE  ) )
		  return;
...
/********************
  Invariant records
 ********************/
int mu__invariant_33() // Invariant "P_I_ci_load_rset_0"
{
bool mu__boolexpr34;
bool mu__boolexpr35;
...
bool mu__condition_36() // Condition for Rule "P_I_ci_load_rset_0"
{
...
{"P_I_ci_load_rset_0", &mu__condition_36, NULL, },
};
